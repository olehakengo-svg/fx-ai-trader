...
class GotobiFix(StrategyBase):
    ...
    # ══════════════════════════════════════════════════
    # 時間帯パラメータ (UTC)
    # UTC 23:45 - 01:00 = JST 08:45 - 10:00
    # ══════════════════════════════════════════════════
    # NOTE: エントリーウィンドウはUTC日付境界をまたぐ
    # UTC 23:45 = 1425分, UTC 01:00 = 60分
    ENTRY_START_LATE = 1425    # UTC 23:45 (前日の分)
    ENTRY_END_EARLY = 60       # UTC 01:00

    # Exit: UTC 01:00 (JST 10:00) or TP hit
    EXIT_TIME = 60             # UTC 01:00
