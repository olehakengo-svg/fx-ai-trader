...
class ScalperEngine:
    ...
    def split_shadow_always(self, candidates: list[Candidate],
        ...
        if (os.environ.get("SESSION_VOL_EXPANSION_REDESIGN_V2") == "1"
                and os.environ.get("SESSION_VOL_EXPANSION_REDESIGN_V2_SHADOW_PROMOTE") == "1"):
            _shadow_always = _shadow_always | {"session_vol_expansion"}
        ...
        _vol_momentum_shadow_promote = (
            os.environ.get("VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE") == "1"
            or os.environ.get("VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE") == "1"
        )
        if _vol_momentum_redesign_v2 and _vol_momentum_shadow_promote:
