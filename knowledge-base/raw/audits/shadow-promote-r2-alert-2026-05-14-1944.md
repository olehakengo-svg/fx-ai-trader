# SHADOW_PROMOTE R2 Alert - 2026-05-14T19:44:04.533841+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 56 | -1.179 | 16.1% | 8.7% | 0.54 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 64 | -1.086 | 18.8% | 11.1% | 0.67 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 30 | -1.130 | 33.3% | 19.2% | 0.76 |
...
| **WARN** | `stoch_trend_pullback` | `USD_JPY` | 12 | -5.608 | 16.7% | 4.7% | 0.33 |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 56 | 9 | 47 | -1.179 | 16.1% | 8.7%-27.8% | 0.54 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 64 | 12 | 52 | -1.086 | 18.8% | 11.1%-30.0% | 0.67 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `USD_JPY` | 20 | 6 | 14 | +0.580 | 30.0% | 14.5%-51.9% | 1.10 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `post_news_vol` | `EUR_USD` | 5 | 0 | 5 | -15.840 | 0.0% | 0.0%-43.4% | 0.00 | `POST_NEWS_VOL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 30 | 10 | 20 | -1.130 | 33.3% | 19.2%-51.2% | 0.76 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `stoch_trend_pullback` | `USD_JPY` | 12 | 2 | 10 | -5.608 | 16.7% | 4.7%-44.8% | 0.33 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `USD_JPY` | 7 | 1 | 6 | -2.771 | 14.3% | 2.6%-51.3% | 0.28 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `xs_momentum` | `USD_JPY` | 16 | 8 | 8 | +1.587 | 50.0% | 28.0%-72.0% | 1.25 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
