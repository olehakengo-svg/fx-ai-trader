# SHADOW_PROMOTE R2 Alert - 2026-05-21T19:51:44.311715+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_rsi_reversion` | `EUR_USD` | 20 | -0.300 | 40.0% | 21.9% | 0.84 |
...
| **WARN** | `ema_trend_scalp` | `EUR_USD` | 17 | -1.659 | 11.8% | 3.3% | 0.30 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 35 | -1.677 | 14.3% | 6.3% | 0.48 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 73 | -1.314 | 17.8% | 10.7% | 0.60 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 32 | -0.619 | 25.0% | 13.3% | 0.73 |
...
| WARN | `bb_rsi_reversion` | `EUR_USD` | 20 | 8 | 12 | -0.300 | 40.0% | 21.9%-61.3% | 0.84 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 7 | 4 | 3 | +3.629 | 57.1% | 25.0%-84.2% | 2.05 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema_trend_scalp` | `EUR_USD` | 17 | 2 | 15 | -1.659 | 11.8% | 3.3%-34.3% | 0.30 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 35 | 5 | 30 | -1.677 | 14.3% | 6.3%-29.4% | 0.48 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `USD_CHF` | 4 | 0 | 4 | -2.925 | 0.0% | 0.0%-49.0% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 73 | 13 | 60 | -1.314 | 17.8% | 10.7%-28.1% | 0.60 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 32 | 8 | 24 | -0.619 | 25.0% | 13.3%-42.1% | 0.73 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_JPY` | 18 | 4 | 14 | +1.111 | 22.2% | 9.0%-45.2% | 1.36 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_channel_reversal` | `EUR_USD` | 13 | 3 | 10 | -0.515 | 23.1% | 8.2%-50.3% | 0.80 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 34 | 5 | 29 | -2.315 | 14.7% | 6.4%-30.1% | 0.32 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 38 | 8 | 30 | -1.866 | 21.1% | 11.1%-36.3% | 0.57 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 37 | 5 | 32 | -9.292 | 13.5% | 5.9%-28.0% | 0.45 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 68 | 14 | 54 | -3.290 | 20.6% | 12.7%-31.6% | 0.53 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
