# SHADOW_PROMOTE R2 Alert - 2026-09-17T03:26:58.555322+00:00
...
| **WARN** | `donchian_momentum_breakout` | `USD_JPY` | 11 | -1.136 | 81.8% | 52.3% | 0.78 |
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 14 | -1.257 | 42.9% | 21.4% | 0.63 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 47 | -0.823 | 53.2% | 39.2% | 0.82 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 59 | -1.053 | 55.9% | 43.3% | 0.75 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 22 | -2.973 | 31.8% | 16.4% | 0.20 |
...
| WARN | `donchian_momentum_breakout` | `USD_JPY` | 11 | 9 | 2 | -1.136 | 81.8% | 52.3%-94.9% | 0.78 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 14 | 6 | 8 | -1.257 | 42.9% | 21.4%-67.4% | 0.63 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 47 | 25 | 22 | -0.823 | 53.2% | 39.2%-66.7% | 0.82 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 59 | 33 | 26 | -1.053 | 55.9% | 43.3%-67.8% | 0.75 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 22 | 7 | 15 | -2.973 | 31.8% | 16.4%-52.7% | 0.20 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
