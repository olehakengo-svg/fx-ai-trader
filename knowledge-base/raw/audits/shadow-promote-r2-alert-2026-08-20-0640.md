# SHADOW_PROMOTE R2 Alert - 2026-08-20T06:40:33.239590+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `AUD_JPY` | 14 | -7.436 | 28.6% | 11.7% | 0.12 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 32 | -2.997 | 40.6% | 25.5% | 0.42 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 15 | -3.427 | 60.0% | 35.7% | 0.51 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 11 | 8 | 3 | +1.082 | 72.7% | 43.4%-90.3% | 1.22 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `AUD_JPY` | 14 | 4 | 10 | -7.436 | 28.6% | 11.7%-54.6% | 0.12 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `GBP_JPY` | 10 | 9 | 1 | +0.430 | 90.0% | 59.6%-98.2% | 1.10 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 32 | 13 | 19 | -2.997 | 40.6% | 25.5%-57.7% | 0.42 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 15 | 9 | 6 | -3.427 | 60.0% | 35.7%-80.2% | 0.51 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 14 | 5 | 9 | -7.964 | 35.7% | 16.3%-61.2% | 0.20 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `GBP_USD` | 9 | 4 | 5 | -2.789 | 44.4% | 18.9%-73.3% | 0.31 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
