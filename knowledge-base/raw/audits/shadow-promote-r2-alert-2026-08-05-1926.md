# SHADOW_PROMOTE R2 Alert - 2026-08-05T19:26:12.409634+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 20 | -3.280 | 45.0% | 25.8% | 0.35 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 68 | -1.485 | 36.8% | 26.3% | 0.54 |
...
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 59 | -0.449 | 61.0% | 48.3% | 0.91 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 20 | 9 | 11 | -3.280 | 45.0% | 25.8%-65.8% | 0.35 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 16 | 14 | 2 | +5.844 | 87.5% | 64.0%-96.5% | 11.39 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 21 | 14 | 7 | +0.610 | 66.7% | 45.4%-82.8% | 1.22 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema200_trend_reversal` | `USD_JPY` | 8 | 6 | 2 | +1.488 | 75.0% | 40.9%-92.9% | 1.89 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 68 | 25 | 43 | -1.485 | 36.8% | 26.3%-48.6% | 0.54 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `USD_JPY` | 59 | 36 | 23 | -0.449 | 61.0% | 48.3%-72.4% | 0.91 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
