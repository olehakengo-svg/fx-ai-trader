# SHADOW_PROMOTE R2 Alert - 2026-06-26T14:21:22.869352+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | -3.030 | 10.0% | 1.8% | 0.07 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | -4.483 | 50.0% | 31.4% | 0.19 |
...
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 40 | -0.195 | 50.0% | 35.2% | 0.90 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -4.033 | 33.3% | 13.8% | 0.12 |
| **WARN** | `london_breakout` | `USD_CHF` | 22 | -2.605 | 27.3% | 13.2% | 0.17 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 52 | -1.446 | 34.6% | 23.2% | 0.31 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 40 | -1.837 | 67.5% | 52.0% | 0.52 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 39 | -3.305 | 61.5% | 45.9% | 0.44 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 42 | -2.314 | 50.0% | 35.5% | 0.44 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 44 | -0.389 | 52.3% | 37.9% | 0.83 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 27 | -4.344 | 40.7% | 24.5% | 0.28 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 7 | 4 | 3 | +0.786 | 57.1% | 25.0%-84.2% | 1.25 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 2 | 1 | 1 | -2.950 | 50.0% | 9.5%-90.5% | 0.12 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | 1 | 9 | -3.030 | 10.0% | 1.8%-40.4% | 0.07 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | 12 | 12 | -4.483 | 50.0% | 31.4%-68.6% | 0.19 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 23 | 18 | 5 | +0.891 | 78.3% | 58.1%-90.3% | 1.65 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `GBP_USD` | 40 | 20 | 20 | -0.195 | 50.0% | 35.2%-64.8% | 0.90 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 52 | 18 | 34 | -1.446 | 34.6% | 23.2%-48.2% | 0.31 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 6 | 4 | 2 | -0.400 | 66.7% | 30.0%-90.3% | 0.72 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 40 | 27 | 13 | -1.837 | 67.5% | 52.0%-79.9% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 39 | 24 | 15 | -3.305 | 61.5% | 45.9%-75.1% | 0.44 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 42 | 21 | 21 | -2.314 | 50.0% | 35.5%-64.5% | 0.44 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `USD_JPY` | 19 | 12 | 7 | +0.058 | 63.2% | 41.0%-80.9% | 1.02 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 44 | 23 | 21 | -0.389 | 52.3% | 37.9%-66.2% | 0.83 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 7 | 4 | 3 | -2.386 | 57.1% | 25.0%-84.2% | 0.45 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_CHF` | 4 | 2 | 2 | -0.525 | 50.0% | 15.0%-85.0% | 0.66 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 27 | 11 | 16 | -4.344 | 40.7% | 24.5%-59.3% | 0.28 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
