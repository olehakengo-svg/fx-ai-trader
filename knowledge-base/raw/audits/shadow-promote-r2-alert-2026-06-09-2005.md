# SHADOW_PROMOTE R2 Alert - 2026-06-09T20:05:22.598845+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 103 | -1.626 | 7.8% | 4.0% | 0.23 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 23 | -4.317 | 26.1% | 12.5% | 0.26 |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 103 | 8 | 95 | -1.626 | 7.8% | 4.0%-14.6% | 0.23 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 23 | 6 | 17 | -4.317 | 26.1% | 12.5%-46.5% | 0.26 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `USD_CHF` | 51 | 4 | 47 | -2.143 | 7.8% | 3.1%-18.5% | 0.14 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_GBP` | 1 | 0 | 1 | -5.700 | 0.0% | 0.0%-79.3% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_USD` | 68 | 37 | 31 | +2.157 | 54.4% | 42.7%-65.7% | 2.16 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 14 | 5 | 9 | -3.236 | 35.7% | 16.3%-61.2% | 0.16 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 15 | 3 | 12 | -2.393 | 20.0% | 7.0%-45.2% | 0.23 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 38 | 25 | 13 | +7.263 | 65.8% | 49.9%-78.8% | 11.34 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
