# SHADOW_PROMOTE R2 Alert - 2026-09-16T03:21:11.129911+00:00
...
| **WARN** | `donchian_momentum_breakout` | `USD_JPY` | 10 | -0.990 | 80.0% | 49.0% | 0.79 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_JPY` | 31 | -4.871 | 35.5% | 21.1% | 0.25 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 38 | -1.471 | 47.4% | 32.5% | 0.68 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 26 | -1.135 | 42.3% | 25.5% | 0.51 |
| **WARN** | `trend_rebound` | `EUR_USD` | 14 | -0.414 | 35.7% | 16.3% | 0.74 |
| **WARN** | `trend_rebound` | `USD_JPY` | 12 | -1.692 | 33.3% | 13.8% | 0.28 |
| **CRITICAL** | `trendline_sweep` | `GBP_USD` | 30 | -2.883 | 53.3% | 36.1% | 0.27 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 22 | -1.664 | 13.6% | 4.7% | 0.27 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 55 | -1.095 | 58.2% | 45.0% | 0.73 |
...
| WARN | `donchian_momentum_breakout` | `USD_JPY` | 10 | 8 | 2 | -0.990 | 80.0% | 49.0%-94.3% | 0.79 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_JPY` | 31 | 11 | 20 | -4.871 | 35.5% | 21.1%-53.1% | 0.25 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 38 | 18 | 20 | -1.471 | 47.4% | 32.5%-62.7% | 0.68 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `EUR_USD` | 14 | 5 | 9 | -0.414 | 35.7% | 16.3%-61.2% | 0.74 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `trendline_sweep` | `GBP_USD` | 30 | 16 | 14 | -2.883 | 53.3% | 36.1%-69.8% | 0.27 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 55 | 32 | 23 | -1.095 | 58.2% | 45.0%-70.3% | 0.73 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
