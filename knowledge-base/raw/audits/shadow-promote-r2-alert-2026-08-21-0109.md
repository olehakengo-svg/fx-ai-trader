# SHADOW_PROMOTE R2 Alert - 2026-08-21T01:09:12.096257+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 14 | -3.493 | 7.1% | 1.3% | 0.03 |
...
| **WARN** | `engulfing_bb` | `GBP_USD` | 18 | -0.828 | 27.8% | 12.5% | 0.72 |
...
| **WARN** | `trendline_sweep` | `GBP_USD` | 21 | -3.710 | 57.1% | 36.5% | 0.16 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 17 | -3.894 | 41.2% | 21.6% | 0.29 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 37 | -1.676 | 37.8% | 24.1% | 0.63 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 22 | -1.036 | 22.7% | 10.1% | 0.49 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -0.900 | 33.3% | 13.8% | 0.70 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 36 | -0.936 | 47.2% | 32.0% | 0.75 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 25 | -2.024 | 52.0% | 33.5% | 0.63 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 14 | 1 | 13 | -3.493 | 7.1% | 1.3%-31.5% | 0.03 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema200_trend_reversal` | `USD_JPY` | 7 | 4 | 3 | -4.200 | 57.1% | 25.0%-84.2% | 0.11 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `GBP_USD` | 18 | 5 | 13 | -0.828 | 27.8% | 12.5%-50.9% | 0.72 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `lin_reg_channel` | `EUR_USD` | 9 | 2 | 7 | -3.767 | 22.2% | 6.3%-54.7% | 0.27 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 21 | 12 | 9 | -3.710 | 57.1% | 36.5%-75.5% | 0.16 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 37 | 14 | 23 | -1.676 | 37.8% | 24.1%-53.9% | 0.63 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 22 | 5 | 17 | -1.036 | 22.7% | 10.1%-43.4% | 0.49 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 25 | 13 | 12 | -2.024 | 52.0% | 33.5%-70.0% | 0.63 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
