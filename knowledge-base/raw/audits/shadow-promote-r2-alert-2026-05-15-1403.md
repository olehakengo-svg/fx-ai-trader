# SHADOW_PROMOTE R2 Alert - 2026-05-15T14:03:48.845531+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 49 | -1.020 | 18.4% | 10.0% | 0.61 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 63 | -0.984 | 19.0% | 11.2% | 0.70 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 184 | -1.985 | 19.0% | 14.0% | 0.49 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 16 | -0.544 | 31.2% | 14.2% | 0.93 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 22 | -7.586 | 9.1% | 2.5% | 0.33 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 31 | -1.113 | 38.7% | 23.7% | 0.82 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 17 | -1.112 | 17.6% | 6.2% | 0.58 |
...
| OK | `bb_rsi_reversion` | `USD_JPY` | 67 | 30 | 37 | +0.061 | 44.8% | 33.5%-56.6% | 1.02 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `EUR_JPY` | 16 | 7 | 9 | +7.406 | 43.8% | 23.1%-66.8% | 2.29 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 49 | 9 | 40 | -1.020 | 18.4% | 10.0%-31.4% | 0.61 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 63 | 12 | 51 | -0.984 | 19.0% | 11.2%-30.4% | 0.70 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 184 | 35 | 149 | -1.985 | 19.0% | 14.0%-25.3% | 0.49 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 16 | 5 | 11 | -0.544 | 31.2% | 14.2%-55.6% | 0.93 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_channel_reversal` | `EUR_USD` | 17 | 3 | 14 | -1.112 | 17.6% | 6.2%-41.0% | 0.58 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `xs_momentum` | `GBP_USD` | 43 | 15 | 28 | +1.205 | 34.9% | 22.4%-49.8% | 1.17 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
