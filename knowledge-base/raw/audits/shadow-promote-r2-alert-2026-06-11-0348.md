# SHADOW_PROMOTE R2 Alert - 2026-06-11T03:48:25.237803+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 12 | -8.075 | 25.0% | 8.9% | 0.28 |
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 35 | -2.434 | 5.7% | 1.6% | 0.04 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 43 | -0.819 | 34.9% | 22.4% | 0.60 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 21 | -4.619 | 47.6% | 28.3% | 0.19 |
...
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 79 | -0.784 | 39.2% | 29.2% | 0.69 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 27 | -0.530 | 22.2% | 10.6% | 0.72 |
...
| OK | `donchian_momentum_breakout` | `NZD_JPY` | 9 | 7 | 2 | +24.567 | 77.8% | 45.3%-93.7% | 8.13 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 14 | 6 | 8 | +1.743 | 42.9% | 21.4%-67.4% | 1.90 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 12 | 3 | 9 | -8.075 | 25.0% | 8.9%-53.2% | 0.28 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 35 | 2 | 33 | -2.434 | 5.7% | 1.6%-18.6% | 0.04 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 43 | 15 | 28 | -0.819 | 34.9% | 22.4%-49.8% | 0.60 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `USD_CHF` | 8 | 2 | 6 | -1.912 | 25.0% | 7.1%-59.1% | 0.21 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 21 | 10 | 11 | -4.619 | 47.6% | 28.3%-67.6% | 0.19 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 79 | 31 | 48 | -0.784 | 39.2% | 29.2%-50.3% | 0.69 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `USD_CHF` | 27 | 6 | 21 | -0.530 | 22.2% | 10.6%-40.8% | 0.72 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_JPY` | 8 | 5 | 3 | -1.575 | 62.5% | 30.6%-86.3% | 0.62 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
