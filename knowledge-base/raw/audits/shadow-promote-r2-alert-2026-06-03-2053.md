# SHADOW_PROMOTE R2 Alert - 2026-06-03T20:53:59.658294+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `USD_CHF` | 38 | -2.303 | 0.0% | 0.0% | 0.00 |
...
| **CRITICAL** | `ob_retest` | `EUR_USD` | 34 | -0.618 | 26.5% | 14.6% | 0.84 |
| **WARN** | `ob_retest` | `GBP_USD` | 10 | -2.210 | 40.0% | 16.8% | 0.60 |
| **WARN** | `ob_retest` | `USD_JPY` | 13 | -3.223 | 38.5% | 17.7% | 0.14 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `GBP_USD` | 41 | -0.010 | 29.3% | 17.6% | 1.00 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 54 | -6.343 | 16.7% | 9.0% | 0.12 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 41 | -0.873 | 43.9% | 29.9% | 0.81 |
...
- `wick_imbalance_reversion` x `GBP_USD`: remove `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`, `WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE`
...
- Add `('wick_imbalance_reversion', 'GBP_USD')`
...
| CRITICAL | `bb_rsi_reversion` | `USD_CHF` | 38 | 0 | 38 | -2.303 | 0.0% | 0.0%-9.2% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ob_retest` | `EUR_USD` | 34 | 9 | 25 | -0.618 | 26.5% | 14.6%-43.1% | 0.84 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `USD_JPY` | 13 | 5 | 8 | -3.223 | 38.5% | 17.7%-64.5% | 0.14 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_JPY` | 29 | 3 | 26 | -7.528 | 10.3% | 3.6%-26.4% | 0.14 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 47 | 13 | 34 | -0.902 | 27.7% | 16.9%-41.8% | 0.67 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `GBP_USD` | 41 | 12 | 29 | -0.010 | 29.3% | 17.6%-44.5% | 1.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 54 | 9 | 45 | -6.343 | 16.7% | 9.0%-28.7% | 0.12 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 41 | 18 | 23 | -0.873 | 43.9% | 29.9%-59.0% | 0.81 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
