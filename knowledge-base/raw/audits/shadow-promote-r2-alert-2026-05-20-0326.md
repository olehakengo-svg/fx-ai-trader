# SHADOW_PROMOTE R2 Alert - 2026-05-20T03:26:15.423870+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_rsi_reversion` | `EUR_USD` | 27 | -0.467 | 37.0% | 21.5% | 0.78 |
...
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 33 | -0.758 | 21.2% | 10.7% | 0.70 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 56 | -0.827 | 19.6% | 11.3% | 0.75 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 130 | -1.272 | 20.8% | 14.7% | 0.62 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 21 | -3.271 | 23.8% | 10.6% | 0.58 |
...
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 50 | -2.248 | 22.0% | 12.8% | 0.45 |
...
| **WARN** | `sr_fib_confluence` | `EUR_JPY` | 28 | -12.643 | 7.1% | 2.0% | 0.24 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 32 | -0.428 | 28.1% | 15.6% | 0.89 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_JPY` | 57 | -12.440 | 8.8% | 3.8% | 0.28 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 65 | -2.820 | 23.1% | 14.5% | 0.60 |
| **CRITICAL** | `sr_fib_confluence` | `USD_JPY` | 30 | -4.463 | 16.7% | 7.3% | 0.62 |
...
| WARN | `bb_rsi_reversion` | `EUR_USD` | 27 | 10 | 17 | -0.467 | 37.0% | 21.5%-55.8% | 0.78 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `bb_rsi_reversion` | `USD_JPY` | 47 | 22 | 25 | +0.279 | 46.8% | 33.3%-60.8% | 1.10 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 6 | 2 | 4 | -1.967 | 33.3% | 9.7%-70.0% | 0.65 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 33 | 7 | 26 | -0.758 | 21.2% | 10.7%-37.8% | 0.70 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 56 | 11 | 45 | -0.827 | 19.6% | 11.3%-31.8% | 0.75 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 130 | 27 | 103 | -1.272 | 20.8% | 14.7%-28.5% | 0.62 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 21 | 5 | 16 | -3.271 | 23.8% | 10.6%-45.1% | 0.58 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 50 | 11 | 39 | -2.248 | 22.0% | 12.8%-35.2% | 0.45 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_fib_confluence` | `EUR_JPY` | 28 | 2 | 26 | -12.643 | 7.1% | 2.0%-22.6% | 0.24 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 32 | 9 | 23 | -0.428 | 28.1% | 15.6%-45.4% | 0.89 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 57 | 5 | 52 | -12.440 | 8.8% | 3.8%-18.9% | 0.28 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 65 | 15 | 50 | -2.820 | 23.1% | 14.5%-34.6% | 0.60 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `USD_JPY` | 30 | 5 | 25 | -4.463 | 16.7% | 7.3%-33.6% | 0.62 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
