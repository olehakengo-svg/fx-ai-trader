# SHADOW_PROMOTE R2 Alert - 2026-05-13T14:30:11.754091+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 75 | -0.656 | 22.7% | 14.7% | 0.79 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 201 | -1.656 | 21.4% | 16.3% | 0.57 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 24 | -1.358 | 20.8% | 9.2% | 0.53 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 14 | -3.929 | 14.3% | 4.0% | 0.18 |
| **CRITICAL** | `engulfing_bb` | `USD_JPY` | 33 | -2.161 | 18.2% | 8.6% | 0.56 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 14 | -4.221 | 21.4% | 7.6% | 0.39 |
...
| **WARN** | `sr_break_retest` | `GBP_USD` | 24 | -2.896 | 37.5% | 21.2% | 0.60 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 25 | -2.224 | 32.0% | 17.2% | 0.58 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 25 | -2.536 | 12.0% | 4.2% | 0.29 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 39 | -2.897 | 17.9% | 9.0% | 0.37 |
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 49 | -1.924 | 20.4% | 11.5% | 0.43 |
...
| OK | `bb_rsi_reversion` | `USD_JPY` | 72 | 33 | 39 | +0.199 | 45.8% | 34.8%-57.3% | 1.07 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 75 | 17 | 58 | -0.656 | 22.7% | 14.7%-33.3% | 0.79 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 201 | 43 | 158 | -1.656 | 21.4% | 16.3%-27.6% | 0.57 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `EUR_USD` | 24 | 5 | 19 | -1.358 | 20.8% | 9.2%-40.5% | 0.53 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 14 | 2 | 12 | -3.929 | 14.3% | 4.0%-39.9% | 0.18 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `USD_JPY` | 33 | 6 | 27 | -2.161 | 18.2% | 8.6%-34.4% | 0.56 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `intraday_seasonality` | `GBP_USD` | 6 | 3 | 3 | +4.700 | 50.0% | 18.8%-81.2% | 2.46 | `ALPHA_INTRADAY_SEASONALITY_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 14 | 3 | 11 | -4.221 | 21.4% | 7.6%-47.6% | 0.39 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_USD` | 24 | 9 | 15 | -2.896 | 37.5% | 21.2%-57.3% | 0.60 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 25 | 8 | 17 | -2.224 | 32.0% | 17.2%-51.6% | 0.58 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 49 | 10 | 39 | -1.924 | 20.4% | 11.5%-33.6% | 0.43 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 27 | 9 | 18 | +0.130 | 33.3% | 18.6%-52.2% | 1.03 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 65 | 9 | 56 | -9.395 | 13.8% | 7.5%-24.3% | 0.42 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 41 | 10 | 31 | -2.185 | 24.4% | 13.8%-39.3% | 0.65 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `stoch_trend_pullback` | `USD_JPY` | 15 | 3 | 12 | -4.253 | 20.0% | 7.0%-45.2% | 0.41 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 11 | 4 | 7 | +0.627 | 36.4% | 15.2%-64.6% | 1.22 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 24 | 4 | 20 | -3.183 | 16.7% | 6.7%-35.9% | 0.48 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
