# SHADOW_PROMOTE R2 Alert - 2026-07-22T19:14:06.097031+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 16 | -6.413 | 18.8% | 6.6% | 0.05 |
| **WARN** | `dt_sr_channel_reversal` | `AUD_JPY` | 17 | -0.029 | 58.8% | 36.0% | 0.99 |
...
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 17 | -0.347 | 47.1% | 26.2% | 0.91 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 90 | -0.789 | 43.3% | 33.6% | 0.59 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 32 | -1.688 | 37.5% | 22.9% | 0.40 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 65 | -1.409 | 35.4% | 24.9% | 0.38 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 36 | -2.153 | 50.0% | 34.5% | 0.51 |
...
| **WARN** | `trendline_sweep` | `EUR_USD` | 18 | -0.056 | 77.8% | 54.8% | 0.98 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 12 | -2.125 | 66.7% | 39.1% | 0.34 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 68 | -1.013 | 41.2% | 30.3% | 0.55 |
...
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 16 | 3 | 13 | -6.413 | 18.8% | 6.6%-43.0% | 0.05 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 4 | 2 | 2 | -0.900 | 50.0% | 15.0%-85.0% | 0.74 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `AUD_JPY` | 17 | 10 | 7 | -0.029 | 58.8% | 36.0%-78.4% | 0.99 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 17 | 8 | 9 | -0.347 | 47.1% | 26.2%-69.0% | 0.91 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 90 | 39 | 51 | -0.789 | 43.3% | 33.6%-53.6% | 0.59 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 32 | 12 | 20 | -1.688 | 37.5% | 22.9%-54.7% | 0.40 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 65 | 23 | 42 | -1.409 | 35.4% | 24.9%-47.5% | 0.38 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `EUR_JPY` | 2 | 1 | 1 | -6.900 | 50.0% | 9.5%-90.5% | 0.14 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 7 | 5 | 2 | -1.329 | 71.4% | 35.9%-91.8% | 0.42 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 6 | 2 | 4 | -16.900 | 33.3% | 9.7%-70.0% | 0.06 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 36 | 18 | 18 | -2.153 | 50.0% | 34.5%-65.5% | 0.51 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_USD` | 18 | 14 | 4 | -0.056 | 77.8% | 54.8%-91.0% | 0.98 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 68 | 28 | 40 | -1.013 | 41.2% | 30.3%-53.0% | 0.55 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
