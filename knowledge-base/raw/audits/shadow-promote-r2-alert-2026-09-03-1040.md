# SHADOW_PROMOTE R2 Alert - 2026-09-03T10:40:23.791886+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 19 | -0.026 | 57.9% | 36.3% | 0.99 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 12 | -1.483 | 16.7% | 4.7% | 0.36 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 23 | -1.630 | 34.8% | 18.8% | 0.61 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 27 | -0.748 | 44.4% | 27.6% | 0.73 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | -3.814 | 51.7% | 34.4% | 0.36 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 32 | -2.509 | 31.2% | 18.0% | 0.28 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 28 | -0.375 | 53.6% | 35.8% | 0.87 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 46 | -0.472 | 39.1% | 26.4% | 0.74 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `EUR_JPY` | 34 | -0.665 | 50.0% | 34.1% | 0.80 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 18 | -0.622 | 66.7% | 43.7% | 0.84 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 45 | -1.982 | 46.7% | 32.9% | 0.57 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 52 | -0.681 | 48.1% | 35.1% | 0.79 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 26 | -0.146 | 46.2% | 28.8% | 0.94 |
| **WARN** | `trend_rebound` | `USD_JPY` | 13 | -0.623 | 38.5% | 17.7% | 0.72 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 27 | -3.733 | 44.4% | 27.6% | 0.21 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 24 | -0.796 | 25.0% | 12.0% | 0.54 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 14 | -0.900 | 35.7% | 16.3% | 0.71 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 54 | -0.306 | 57.4% | 44.2% | 0.91 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 25 | -2.152 | 48.0% | 30.0% | 0.61 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 25 | -3.804 | 32.0% | 17.2% | 0.18 |
| **WARN** | `xs_momentum` | `GBP_USD` | 11 | -6.582 | 27.3% | 9.7% | 0.05 |
...
| OK | `donchian_momentum_breakout` | `EUR_USD` | 8 | 6 | 2 | -1.000 | 75.0% | 40.9%-92.9% | 0.74 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 19 | 11 | 8 | -0.026 | 57.9% | 36.3%-76.9% | 0.99 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 23 | 8 | 15 | -1.630 | 34.8% | 18.8%-55.1% | 0.61 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 32 | 10 | 22 | -2.509 | 31.2% | 18.0%-48.6% | 0.28 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `EUR_USD` | 6 | 2 | 4 | -0.733 | 33.3% | 9.7%-70.0% | 0.49 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `GBP_USD` | 2 | 1 | 1 | -1.650 | 50.0% | 9.5%-90.5% | 0.28 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ma_regime_switch` | `USD_JPY` | 3 | 0 | 3 | -8.333 | 0.0% | 0.0%-56.2% | 0.00 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_anti_hunt_bounce` | `EUR_JPY` | 34 | 17 | 17 | -0.665 | 50.0% | 34.1%-65.9% | 0.80 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `EUR_JPY` | 5 | 4 | 1 | +1.000 | 80.0% | 37.6%-96.4% | 1.38 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `GBP_JPY` | 4 | 2 | 2 | -6.225 | 50.0% | 15.0%-85.0% | 0.32 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `GBP_USD` | 1 | 0 | 1 | -5.800 | 0.0% | 0.0%-79.3% | 0.00 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 52 | 25 | 27 | -0.681 | 48.1% | 35.1%-61.3% | 0.79 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 26 | 12 | 14 | -0.146 | 46.2% | 28.8%-64.5% | 0.94 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `EUR_USD` | 9 | 4 | 5 | +0.544 | 44.4% | 18.9%-73.3% | 1.46 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 27 | 12 | 15 | -3.733 | 44.4% | 27.6%-62.7% | 0.21 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `USD_JPY` | 9 | 3 | 6 | -0.889 | 33.3% | 12.1%-64.6% | 0.74 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 24 | 6 | 18 | -0.796 | 25.0% | 12.0%-44.9% | 0.54 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 54 | 31 | 23 | -0.306 | 57.4% | 44.2%-69.7% | 0.91 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 25 | 12 | 13 | -2.152 | 48.0% | 30.0%-66.5% | 0.61 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `GBP_USD` | 11 | 3 | 8 | -6.582 | 27.3% | 9.7%-56.6% | 0.05 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
