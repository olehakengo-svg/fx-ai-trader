# SHADOW_PROMOTE R2 Alert - 2026-06-25T14:29:07.659815+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | -5.107 | 46.7% | 24.8% | 0.17 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 33 | -2.924 | 54.5% | 38.0% | 0.50 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 12 | -1.408 | 66.7% | 39.1% | 0.49 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 87 | -0.901 | 40.2% | 30.6% | 0.56 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 43 | -0.591 | 46.5% | 32.5% | 0.74 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 14 | -4.536 | 28.6% | 11.7% | 0.10 |
| **WARN** | `london_breakout` | `USD_CHF` | 19 | -2.305 | 31.6% | 15.4% | 0.21 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 50 | -0.906 | 40.0% | 27.6% | 0.48 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 16 | -3.100 | 37.5% | 18.5% | 0.16 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 45 | -1.333 | 71.1% | 56.6% | 0.60 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 42 | -1.586 | 69.0% | 54.0% | 0.64 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 38 | -1.842 | 52.6% | 37.3% | 0.51 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 55 | -0.327 | 52.7% | 39.8% | 0.85 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 20 | -0.175 | 35.0% | 18.1% | 0.90 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 41 | -3.363 | 24.4% | 13.8% | 0.14 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 36 | -3.017 | 61.1% | 44.9% | 0.35 |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 15 | 7 | 8 | +0.313 | 46.7% | 24.8%-69.9% | 1.10 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | 7 | 8 | -5.107 | 46.7% | 24.8%-69.9% | 0.17 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 15 | 12 | 3 | +1.647 | 80.0% | 54.8%-93.0% | 2.11 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 33 | 18 | 15 | -2.924 | 54.5% | 38.0%-70.2% | 0.50 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 12 | 8 | 4 | -1.408 | 66.7% | 39.1%-86.2% | 0.49 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema_trend_scalp` | `USD_CHF` | 8 | 0 | 8 | -3.975 | 0.0% | 0.0%-32.4% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 87 | 35 | 52 | -0.901 | 40.2% | 30.6%-50.7% | 0.56 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 43 | 20 | 23 | -0.591 | 46.5% | 32.5%-61.1% | 0.74 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 50 | 20 | 30 | -0.906 | 40.0% | 27.6%-53.8% | 0.48 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 45 | 32 | 13 | -1.333 | 71.1% | 56.6%-82.3% | 0.60 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 42 | 29 | 13 | -1.586 | 69.0% | 54.0%-80.9% | 0.64 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 38 | 20 | 18 | -1.842 | 52.6% | 37.3%-67.5% | 0.51 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `USD_JPY` | 16 | 11 | 5 | +0.613 | 68.8% | 44.4%-85.8% | 1.26 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 55 | 29 | 26 | -0.327 | 52.7% | 39.8%-65.3% | 0.85 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `USD_CHF` | 20 | 7 | 13 | -0.175 | 35.0% | 18.1%-56.7% | 0.90 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 41 | 10 | 31 | -3.363 | 24.4% | 13.8%-39.3% | 0.14 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 6 | 2 | 4 | -2.133 | 33.3% | 9.7%-70.0% | 0.15 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 36 | 22 | 14 | -3.017 | 61.1% | 44.9%-75.2% | 0.35 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
