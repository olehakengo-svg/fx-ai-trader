# SHADOW_PROMOTE R2 Alert - 2026-07-10T09:31:30.446891+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 86 | -0.491 | 45.3% | 35.3% | 0.72 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 36 | -0.494 | 44.4% | 29.5% | 0.78 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -3.158 | 33.3% | 13.8% | 0.22 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 81 | -1.567 | 34.6% | 25.1% | 0.34 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 86 | 39 | 47 | -0.491 | 45.3% | 35.3%-55.8% | 0.72 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 36 | 16 | 20 | -0.494 | 44.4% | 29.5%-60.4% | 0.78 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 12 | 4 | 8 | -3.158 | 33.3% | 13.8%-60.9% | 0.22 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 81 | 28 | 53 | -1.567 | 34.6% | 25.1%-45.4% | 0.34 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 29 | 19 | 10 | -1.986 | 65.5% | 47.3%-80.1% | 0.47 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 27 | 14 | 13 | -2.433 | 51.9% | 34.0%-69.3% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_JPY` | 19 | 15 | 4 | +0.537 | 78.9% | 56.7%-91.5% | 1.23 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
