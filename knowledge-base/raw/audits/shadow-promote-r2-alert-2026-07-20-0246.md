# SHADOW_PROMOTE R2 Alert - 2026-07-20T02:46:31.612195+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 25 | -1.464 | 40.0% | 23.4% | 0.37 |
...
| **WARN** | `lin_reg_channel` | `EUR_USD` | 19 | -1.279 | 52.6% | 31.7% | 0.53 |
| **WARN** | `london_breakout` | `EUR_USD` | 12 | -1.825 | 33.3% | 13.8% | 0.30 |
| **WARN** | `london_breakout` | `GBP_USD` | 18 | -2.906 | 38.9% | 20.3% | 0.21 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 78 | -1.508 | 35.9% | 26.1% | 0.37 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 36 | -2.819 | 55.6% | 39.6% | 0.28 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 25 | 10 | 15 | -1.464 | 40.0% | 23.4%-59.3% | 0.37 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 19 | 10 | 9 | -1.279 | 52.6% | 31.7%-72.7% | 0.53 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 78 | 28 | 50 | -1.508 | 35.9% | 26.1%-47.0% | 0.37 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `EUR_USD` | 4 | 2 | 2 | +0.475 | 50.0% | 15.0%-85.0% | 1.33 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 36 | 20 | 16 | -2.819 | 55.6% | 39.6%-70.5% | 0.28 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
