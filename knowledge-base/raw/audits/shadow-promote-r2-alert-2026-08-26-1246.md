# SHADOW_PROMOTE R2 Alert - 2026-08-26T12:46:52.943079+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 32 | -1.622 | 25.0% | 13.3% | 0.25 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 15 | -0.853 | 26.7% | 10.9% | 0.72 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 13 | -2.715 | 53.8% | 29.1% | 0.40 |
| **WARN** | `xs_momentum` | `GBP_USD` | 26 | -0.815 | 65.4% | 46.2% | 0.75 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 32 | 8 | 24 | -1.622 | 25.0% | 13.3%-42.1% | 0.25 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 15 | 4 | 11 | -0.853 | 26.7% | 10.9%-52.0% | 0.72 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 35 | 14 | 21 | -2.997 | 40.0% | 25.6%-56.4% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 61 | 30 | 31 | -2.059 | 49.2% | 37.1%-61.4% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 11 | 5 | 6 | -0.136 | 45.5% | 21.3%-72.0% | 0.93 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 33 | 12 | 21 | -2.015 | 36.4% | 22.2%-53.4% | 0.59 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 42 | 22 | 20 | -0.002 | 52.4% | 37.7%-66.6% | 1.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 13 | 7 | 6 | -2.715 | 53.8% | 29.1%-76.8% | 0.40 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `GBP_USD` | 26 | 17 | 9 | -0.815 | 65.4% | 46.2%-80.6% | 0.75 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
