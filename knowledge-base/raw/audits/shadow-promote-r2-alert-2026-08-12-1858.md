# SHADOW_PROMOTE R2 Alert - 2026-08-12T18:58:36.631675+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `AUD_JPY` | 21 | -5.067 | 38.1% | 20.8% | 0.19 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 24 | -0.637 | 41.7% | 24.5% | 0.70 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 23 | -2.609 | 34.8% | 18.8% | 0.53 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 24 | -0.496 | 45.8% | 27.9% | 0.82 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 28 | -4.096 | 50.0% | 32.6% | 0.34 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 28 | -0.514 | 57.1% | 39.1% | 0.84 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 58 | -2.033 | 17.2% | 9.6% | 0.14 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 26 | -0.692 | 34.6% | 19.4% | 0.75 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 42 | -1.050 | 45.2% | 31.2% | 0.67 |
| **WARN** | `ob_retest` | `USD_JPY` | 18 | -2.600 | 44.4% | 24.6% | 0.64 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 11 | -4.418 | 9.1% | 1.6% | 0.21 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 16 | -1.081 | 50.0% | 28.0% | 0.71 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 12 | -1.850 | 50.0% | 25.4% | 0.53 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 25 | -2.292 | 44.0% | 26.7% | 0.50 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 29 | -4.024 | 51.7% | 34.4% | 0.36 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 28 | -7.179 | 42.9% | 26.5% | 0.20 |
| **WARN** | `sr_break_retest` | `GBP_USD` | 29 | -1.800 | 55.2% | 37.5% | 0.47 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 36 | -2.761 | 47.2% | 32.0% | 0.50 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 14 | -0.514 | 42.9% | 21.4% | 0.68 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 20 | -4.150 | 60.0% | 38.7% | 0.15 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 36 | -2.572 | 47.2% | 32.0% | 0.33 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 57 | -1.653 | 36.8% | 25.5% | 0.55 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 18 | -1.461 | 27.8% | 12.5% | 0.37 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 10 | -1.100 | 30.0% | 10.8% | 0.69 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 12 | -1.233 | 66.7% | 39.1% | 0.77 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 19 | -3.837 | 36.8% | 19.1% | 0.18 |
...
| WARN | `dt_sr_channel_reversal` | `AUD_JPY` | 21 | 8 | 13 | -5.067 | 38.1% | 20.8%-59.1% | 0.19 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 24 | 10 | 14 | -0.637 | 41.7% | 24.5%-61.2% | 0.70 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 23 | 8 | 15 | -2.609 | 34.8% | 18.8%-55.1% | 0.53 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 24 | 11 | 13 | -0.496 | 45.8% | 27.9%-64.9% | 0.82 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 28 | 14 | 14 | -4.096 | 50.0% | 32.6%-67.4% | 0.34 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 22 | 13 | 9 | +1.932 | 59.1% | 38.7%-76.7% | 1.85 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 28 | 16 | 12 | -0.514 | 57.1% | 39.1%-73.5% | 0.84 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 58 | 10 | 48 | -2.033 | 17.2% | 9.6%-28.9% | 0.14 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 26 | 9 | 17 | -0.692 | 34.6% | 19.4%-53.8% | 0.75 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 42 | 19 | 23 | -1.050 | 45.2% | 31.2%-60.1% | 0.67 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `EUR_JPY` | 3 | 1 | 2 | -11.667 | 33.3% | 6.1%-79.2% | 0.28 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 16 | 8 | 8 | -1.081 | 50.0% | 28.0%-72.0% | 0.71 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_anti_hunt_bounce` | `EUR_USD` | 12 | 6 | 6 | -1.850 | 50.0% | 25.4%-74.6% | 0.53 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 29 | 15 | 14 | -4.024 | 51.7% | 34.4%-68.6% | 0.36 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 28 | 12 | 16 | -7.179 | 42.9% | 26.5%-60.9% | 0.20 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_USD` | 29 | 16 | 13 | -1.800 | 55.2% | 37.5%-71.6% | 0.47 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 36 | 17 | 19 | -2.761 | 47.2% | 32.0%-63.0% | 0.50 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `USD_JPY` | 14 | 9 | 5 | +2.650 | 64.3% | 38.8%-83.7% | 2.72 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 8 | 5 | 3 | +0.650 | 62.5% | 30.6%-86.3% | 1.47 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_GBP` | 7 | 1 | 6 | -4.800 | 14.3% | 2.6%-51.3% | 0.04 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 20 | 12 | 8 | -4.150 | 60.0% | 38.7%-78.1% | 0.15 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 36 | 17 | 19 | -2.572 | 47.2% | 32.0%-63.0% | 0.33 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 57 | 21 | 36 | -1.653 | 36.8% | 25.5%-49.8% | 0.55 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 18 | 5 | 13 | -1.461 | 27.8% | 12.5%-50.9% | 0.37 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `GBP_USD` | 8 | 1 | 7 | -3.325 | 12.5% | 2.2%-47.1% | 0.07 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 10 | 3 | 7 | -1.100 | 30.0% | 10.8%-60.3% | 0.69 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 12 | 8 | 4 | -1.233 | 66.7% | 39.1%-86.2% | 0.77 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 19 | 7 | 12 | -3.837 | 36.8% | 19.1%-59.0% | 0.18 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
