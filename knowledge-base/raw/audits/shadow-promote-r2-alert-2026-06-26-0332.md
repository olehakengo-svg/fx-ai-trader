# SHADOW_PROMOTE R2 Alert - 2026-06-26T03:32:22.468155+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 89 | -0.916 | 40.4% | 30.9% | 0.55 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 42 | -0.376 | 47.6% | 33.4% | 0.82 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 13 | -4.300 | 30.8% | 12.7% | 0.11 |
| **WARN** | `london_breakout` | `USD_CHF` | 19 | -2.305 | 31.6% | 15.4% | 0.21 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 52 | -1.242 | 36.5% | 24.8% | 0.37 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 28 | -3.611 | 46.4% | 29.5% | 0.36 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 33 | -3.491 | 60.6% | 43.7% | 0.32 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 89 | 36 | 53 | -0.916 | 40.4% | 30.9%-50.8% | 0.55 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 13 | 4 | 9 | -4.300 | 30.8% | 12.7%-57.6% | 0.11 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 52 | 19 | 33 | -1.242 | 36.5% | 24.8%-50.1% | 0.37 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `GBP_USD` | 12 | 9 | 3 | +0.983 | 75.0% | 46.8%-91.1% | 1.92 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 40 | 21 | 19 | -1.810 | 52.5% | 37.5%-67.1% | 0.53 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 13 | 8 | 5 | -1.462 | 61.5% | 35.5%-82.3% | 0.44 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 28 | 13 | 15 | -3.611 | 46.4% | 29.5%-64.2% | 0.36 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 33 | 20 | 13 | -3.491 | 60.6% | 43.7%-75.3% | 0.32 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
