# SHADOW_PROMOTE R2 Alert - 2026-08-03T09:39:43.244341+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 20 | -0.505 | 60.0% | 38.7% | 0.82 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 71 | -2.135 | 22.5% | 14.4% | 0.20 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 27 | -0.996 | 33.3% | 18.6% | 0.64 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 48 | -0.704 | 47.9% | 34.5% | 0.71 |
| **WARN** | `ob_retest` | `USD_JPY` | 17 | -2.700 | 47.1% | 26.2% | 0.65 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 15 | -2.260 | 40.0% | 19.8% | 0.45 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 18 | -2.344 | 50.0% | 29.0% | 0.44 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 15 | -1.207 | 60.0% | 35.7% | 0.62 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 26 | -2.046 | 53.8% | 35.5% | 0.49 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 40 | -2.657 | 52.5% | 37.5% | 0.46 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 27 | -7.019 | 44.4% | 27.6% | 0.16 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 38 | -1.545 | 52.6% | 37.3% | 0.56 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 27 | -4.693 | 44.4% | 27.6% | 0.30 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 61 | -0.851 | 50.8% | 38.6% | 0.74 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 72 | -1.561 | 38.9% | 28.5% | 0.48 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -1.541 | 29.4% | 13.3% | 0.32 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 12 | -2.267 | 25.0% | 8.9% | 0.19 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 11 | -1.573 | 63.6% | 35.4% | 0.64 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 8 | 5 | 3 | -2.375 | 62.5% | 30.6%-86.3% | 0.67 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 7 | 6 | 1 | +2.914 | 85.7% | 48.7%-97.4% | 3.46 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 20 | 12 | 8 | -0.505 | 60.0% | 38.7%-78.1% | 0.82 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 15 | 11 | 4 | +4.607 | 73.3% | 48.0%-89.1% | 5.43 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 71 | 16 | 55 | -2.135 | 22.5% | 14.4%-33.5% | 0.20 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 27 | 9 | 18 | -0.996 | 33.3% | 18.6%-52.2% | 0.64 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 48 | 23 | 25 | -0.704 | 47.9% | 34.5%-61.7% | 0.71 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 15 | 6 | 9 | -2.260 | 40.0% | 19.8%-64.3% | 0.45 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 26 | 14 | 12 | -2.046 | 53.8% | 35.5%-71.2% | 0.49 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 40 | 21 | 19 | -2.657 | 52.5% | 37.5%-67.1% | 0.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 27 | 12 | 15 | -7.019 | 44.4% | 27.6%-62.7% | 0.16 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 38 | 20 | 18 | -1.545 | 52.6% | 37.3%-67.5% | 0.56 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 27 | 12 | 15 | -4.693 | 44.4% | 27.6%-62.7% | 0.30 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 61 | 31 | 30 | -0.851 | 50.8% | 38.6%-62.9% | 0.74 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 72 | 28 | 44 | -1.561 | 38.9% | 28.5%-50.4% | 0.48 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 11 | 7 | 4 | -1.573 | 63.6% | 35.4%-84.8% | 0.64 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `xs_momentum` | `USD_JPY` | 50 | 29 | 21 | +0.446 | 58.0% | 44.2%-70.6% | 1.11 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
