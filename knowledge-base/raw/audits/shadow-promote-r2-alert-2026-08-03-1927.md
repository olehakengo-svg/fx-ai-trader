# SHADOW_PROMOTE R2 Alert - 2026-08-03T19:27:18.626551+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 75 | -1.859 | 21.3% | 13.6% | 0.18 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 36 | -2.661 | 55.6% | 39.6% | 0.48 |
...
| **WARN** | `three_bar_reversal` | `EUR_USD` | 15 | -0.693 | 46.7% | 24.8% | 0.55 |
...
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 11 | -5.882 | 36.4% | 15.2% | 0.07 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 43 | -1.372 | 60.5% | 45.6% | 0.55 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 53 | -0.011 | 58.5% | 45.1% | 1.00 |
...
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 16 | 8 | 8 | +0.319 | 50.0% | 28.0%-72.0% | 1.14 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 20 | 14 | 6 | -0.960 | 70.0% | 48.1%-85.5% | 0.70 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 14 | 12 | 2 | +5.471 | 85.7% | 60.1%-96.0% | 9.51 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 75 | 16 | 59 | -1.859 | 21.3% | 13.6%-31.9% | 0.18 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `orb_trap` | `USD_JPY` | 2 | 1 | 1 | -3.500 | 50.0% | 9.5%-90.5% | 0.67 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 36 | 20 | 16 | -2.661 | 55.6% | 39.6%-70.5% | 0.48 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `EUR_USD` | 15 | 7 | 8 | -0.693 | 46.7% | 24.8%-69.9% | 0.55 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `USD_JPY` | 11 | 4 | 7 | -5.882 | 36.4% | 15.2%-64.6% | 0.07 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `EUR_USD` | 43 | 26 | 17 | -1.372 | 60.5% | 45.6%-73.6% | 0.55 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 60 | 44 | 16 | +0.852 | 73.3% | 61.0%-82.9% | 1.33 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 53 | 31 | 22 | -0.011 | 58.5% | 45.1%-70.7% | 1.00 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
