# SHADOW_PROMOTE R2 Alert - 2026-05-08T13:44:04.636035+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 96 | -0.902 | 20.8% | 13.9% | 0.72 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 223 | -1.553 | 21.5% | 16.6% | 0.58 |
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 10 | -4.690 | 20.0% | 5.7% | 0.23 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 28 | -2.443 | 14.3% | 5.7% | 0.32 |
| **WARN** | `sr_channel_reversal` | `GBP_USD` | 20 | -1.855 | 20.0% | 8.1% | 0.54 |
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 82 | -1.480 | 20.7% | 13.4% | 0.47 |
...
| **WARN** | `vol_surge_detector` | `GBP_USD` | 13 | -4.162 | 0.0% | 0.0% | 0.00 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 21 | -3.376 | 14.3% | 5.0% | 0.47 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 11 | -2.664 | 9.1% | 1.6% | 0.57 |
| **WARN** | `xs_momentum` | `EUR_USD` | 19 | -1.579 | 26.3% | 11.8% | 0.75 |
...
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 96 | 20 | 76 | -0.902 | 20.8% | 13.9%-30.0% | 0.72 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 223 | 48 | 175 | -1.553 | 21.5% | 16.6%-27.4% | 0.58 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ma_regime_switch` | `USD_JPY` | 2 | 0 | 2 | -6.950 | 0.0% | 0.0%-65.8% | 0.00 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `GBP_USD` | 10 | 7 | 3 | +7.130 | 70.0% | 39.7%-89.2% | 3.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 10 | 2 | 8 | -4.690 | 20.0% | 5.7%-51.0% | 0.23 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 82 | 17 | 65 | -1.480 | 20.7% | 13.4%-30.7% | 0.47 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `GBP_USD` | 13 | 0 | 13 | -4.162 | 0.0% | 0.0%-22.8% | 0.00 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 21 | 3 | 18 | -3.376 | 14.3% | 5.0%-34.6% | 0.47 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 11 | 1 | 10 | -2.664 | 9.1% | 1.6%-37.7% | 0.57 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 19 | 5 | 14 | -1.579 | 26.3% | 11.8%-48.8% | 0.75 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 25 | 8 | 17 | +1.508 | 32.0% | 17.2%-51.6% | 1.19 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 12 | 6 | 6 | +0.683 | 50.0% | 25.4%-74.6% | 1.13 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
