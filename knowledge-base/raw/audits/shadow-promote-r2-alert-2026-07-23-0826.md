# SHADOW_PROMOTE R2 Alert - 2026-07-23T08:26:01.003363+00:00
...
| **WARN** | `donchian_momentum_breakout` | `USD_JPY` | 10 | -0.670 | 70.0% | 39.7% | 0.88 |
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 27 | -0.770 | 51.9% | 34.0% | 0.75 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 14 | -0.557 | 42.9% | 21.4% | 0.86 |
| **WARN** | `ema200_trend_reversal` | `USD_JPY` | 20 | -1.080 | 55.0% | 34.2% | 0.64 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 89 | -0.783 | 42.7% | 32.9% | 0.59 |
...
| **WARN** | `london_breakout` | `GBP_USD` | 19 | -2.653 | 36.8% | 19.1% | 0.21 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 60 | -1.488 | 33.3% | 22.7% | 0.36 |
| **WARN** | `ob_retest` | `EUR_USD` | 11 | -1.609 | 63.6% | 35.4% | 0.58 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 22 | -1.491 | 59.1% | 38.7% | 0.55 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 16 | -3.175 | 50.0% | 28.0% | 0.20 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 18 | -2.528 | 55.6% | 33.7% | 0.34 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 36 | -2.233 | 50.0% | 34.5% | 0.50 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 29 | -3.724 | 65.5% | 47.3% | 0.34 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 34 | -1.129 | 55.9% | 39.5% | 0.64 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 30 | -2.783 | 50.0% | 33.2% | 0.32 |
| **WARN** | `trend_rebound` | `USD_JPY` | 15 | -1.573 | 26.7% | 10.9% | 0.25 |
| **CRITICAL** | `trendline_sweep` | `EUR_GBP` | 31 | -1.935 | 48.4% | 32.0% | 0.32 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 41 | -0.373 | 61.0% | 45.7% | 0.92 |
...
| WARN | `donchian_momentum_breakout` | `USD_JPY` | 10 | 7 | 3 | -0.670 | 70.0% | 39.7%-89.2% | 0.88 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 27 | 14 | 13 | -0.770 | 51.9% | 34.0%-69.3% | 0.75 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 14 | 6 | 8 | -0.557 | 42.9% | 21.4%-67.4% | 0.86 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 89 | 38 | 51 | -0.783 | 42.7% | 32.9%-53.1% | 0.59 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `GBP_USD` | 19 | 7 | 12 | -2.653 | 36.8% | 19.1%-59.0% | 0.21 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 60 | 20 | 40 | -1.488 | 33.3% | 22.7%-45.9% | 0.36 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `EUR_USD` | 18 | 12 | 6 | +0.300 | 66.7% | 43.7%-83.7% | 1.17 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `squeeze_release_momentum` | `GBP_USD` | 22 | 13 | 9 | -1.491 | 59.1% | 38.7%-76.7% | 0.55 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 36 | 18 | 18 | -2.233 | 50.0% | 34.5%-65.5% | 0.50 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 29 | 19 | 10 | -3.724 | 65.5% | 47.3%-80.1% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 34 | 19 | 15 | -1.129 | 55.9% | 39.5%-71.1% | 0.64 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `trendline_sweep` | `EUR_GBP` | 31 | 15 | 16 | -1.935 | 48.4% | 32.0%-65.2% | 0.32 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 5 | 2 | 3 | -5.860 | 40.0% | 11.8%-76.9% | 0.08 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 41 | 25 | 16 | -0.373 | 61.0% | 45.7%-74.3% | 0.92 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
