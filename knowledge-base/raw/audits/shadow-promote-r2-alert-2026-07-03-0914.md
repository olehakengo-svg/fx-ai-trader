# SHADOW_PROMOTE R2 Alert - 2026-07-03T09:14:58.476818+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 81 | -0.699 | 44.4% | 34.1% | 0.64 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 39 | -0.167 | 51.3% | 36.2% | 0.92 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -3.967 | 33.3% | 13.8% | 0.18 |
| **WARN** | `london_breakout` | `USD_CHF` | 26 | -1.485 | 30.8% | 16.5% | 0.30 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 62 | -1.606 | 35.5% | 24.7% | 0.32 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 31 | -1.494 | 67.7% | 50.1% | 0.57 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 34 | -0.853 | 73.5% | 56.9% | 0.77 |
...
| **WARN** | `trendline_sweep` | `GBP_USD` | 15 | -1.240 | 73.3% | 48.0% | 0.48 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 37 | -3.454 | 24.3% | 13.4% | 0.18 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 21 | -2.295 | 33.3% | 17.2% | 0.21 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 2 | 2 | 0 | +6.750 | 100.0% | 34.2%-100.0% | n/a | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 27 | 18 | 9 | +0.141 | 66.7% | 47.8%-81.4% | 1.12 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 15 | 8 | 7 | +0.427 | 53.3% | 30.1%-75.2% | 1.14 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 81 | 36 | 45 | -0.699 | 44.4% | 34.1%-55.3% | 0.64 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 39 | 20 | 19 | -0.167 | 51.3% | 36.2%-66.1% | 0.92 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 62 | 22 | 40 | -1.606 | 35.5% | 24.7%-47.9% | 0.32 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `orb_trap` | `EUR_USD` | 4 | 2 | 2 | +0.175 | 50.0% | 15.0%-85.0% | 1.05 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 8 | 6 | 2 | -3.425 | 75.0% | 40.9%-92.9% | 0.42 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 31 | 21 | 10 | -1.494 | 67.7% | 50.1%-81.4% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 34 | 25 | 9 | -0.853 | 73.5% | 56.9%-85.4% | 0.77 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `GBP_USD` | 7 | 7 | 0 | +4.743 | 100.0% | 64.6%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 15 | 11 | 4 | -1.240 | 73.3% | 48.0%-89.1% | 0.48 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 37 | 9 | 28 | -3.454 | 24.3% | 13.4%-40.1% | 0.18 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_momentum_scalp` | `USD_JPY` | 3 | 2 | 1 | +2.233 | 66.7% | 20.8%-93.9% | 2.81 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 21 | 7 | 14 | -2.295 | 33.3% | 17.2%-54.6% | 0.21 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
