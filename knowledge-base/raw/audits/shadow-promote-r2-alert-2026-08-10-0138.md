# SHADOW_PROMOTE R2 Alert - 2026-08-10T01:38:12.139677+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | -3.021 | 37.5% | 21.2% | 0.40 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 17 | -0.112 | 52.9% | 31.0% | 0.96 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 28 | -2.918 | 57.1% | 39.1% | 0.44 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 64 | -1.444 | 37.5% | 26.7% | 0.56 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 15 | -0.993 | 33.3% | 15.2% | 0.56 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 13 | -0.554 | 30.8% | 12.7% | 0.81 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | 9 | 15 | -3.021 | 37.5% | 21.2%-57.3% | 0.40 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 17 | 9 | 8 | -0.112 | 52.9% | 31.0%-73.8% | 0.96 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 28 | 16 | 12 | -2.918 | 57.1% | 39.1%-73.5% | 0.44 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 64 | 24 | 40 | -1.444 | 37.5% | 26.7%-49.7% | 0.56 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 13 | 4 | 9 | -0.554 | 30.8% | 12.7%-57.6% | 0.81 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `EUR_GBP` | 6 | 3 | 3 | +1.317 | 50.0% | 18.8%-81.2% | 1.66 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
