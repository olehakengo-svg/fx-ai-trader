# SHADOW_PROMOTE R2 Alert - 2026-08-28T21:42:55.380557+00:00
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 41 | -2.249 | 43.9% | 29.9% | 0.55 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 10 | -3.290 | 60.0% | 31.3% | 0.54 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 60 | -1.943 | 48.3% | 36.2% | 0.60 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 25 | -3.204 | 36.0% | 20.2% | 0.26 |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 41 | 18 | 23 | -2.249 | 43.9% | 29.9%-59.0% | 0.55 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 60 | 29 | 31 | -1.943 | 48.3% | 36.2%-60.7% | 0.60 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 24 | 18 | 6 | +1.487 | 75.0% | 55.1%-88.0% | 1.42 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 25 | 9 | 16 | -3.204 | 36.0% | 20.2%-55.5% | 0.26 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `USD_JPY` | 30 | 21 | 9 | +3.617 | 70.0% | 52.1%-83.3% | 2.29 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
