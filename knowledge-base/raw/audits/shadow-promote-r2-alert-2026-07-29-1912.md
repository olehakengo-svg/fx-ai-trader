# SHADOW_PROMOTE R2 Alert - 2026-07-29T19:12:26.759192+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 86 | -1.595 | 31.4% | 22.6% | 0.28 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 33 | -1.573 | 36.4% | 22.2% | 0.45 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 25 | -1.188 | 52.0% | 33.5% | 0.54 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 52 | -1.244 | 32.7% | 21.5% | 0.42 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 41 | -2.202 | 56.1% | 41.0% | 0.37 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 86 | 27 | 59 | -1.595 | 31.4% | 22.6%-41.8% | 0.28 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 25 | 13 | 12 | -1.188 | 52.0% | 33.5%-70.0% | 0.54 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 52 | 17 | 35 | -1.244 | 32.7% | 21.5%-46.2% | 0.42 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 46 | 25 | 21 | -1.943 | 54.3% | 40.2%-67.8% | 0.54 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 25 | 11 | 14 | -2.064 | 44.0% | 26.7%-62.9% | 0.44 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_USD` | 11 | 8 | 3 | +0.173 | 72.7% | 43.4%-90.3% | 1.05 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 41 | 23 | 18 | -2.202 | 56.1% | 41.0%-70.1% | 0.37 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 55 | 37 | 18 | +0.085 | 67.3% | 54.1%-78.2% | 1.02 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
