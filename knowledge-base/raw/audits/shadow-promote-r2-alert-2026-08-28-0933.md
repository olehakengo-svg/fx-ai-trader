# SHADOW_PROMOTE R2 Alert - 2026-08-28T09:33:19.972165+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `donchian_momentum_breakout` | `AUD_USD` | 14 | -4.029 | 35.7% | 16.3% | 0.28 |
| **WARN** | `donchian_momentum_breakout` | `NZD_USD` | 16 | -0.537 | 62.5% | 38.6% | 0.90 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 30 | -0.583 | 43.3% | 27.4% | 0.81 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 33 | -0.336 | 51.5% | 35.2% | 0.90 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 26 | -1.746 | 23.1% | 11.0% | 0.21 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 38 | -1.889 | 47.4% | 32.5% | 0.61 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 11 | -4.764 | 54.5% | 28.0% | 0.42 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 58 | -1.841 | 50.0% | 37.5% | 0.63 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 27 | -2.900 | 48.1% | 30.7% | 0.51 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 22 | -0.364 | 72.7% | 51.8% | 0.91 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 23 | -3.030 | 39.1% | 22.2% | 0.29 |
| **WARN** | `xs_momentum` | `EUR_USD` | 10 | -2.780 | 50.0% | 23.7% | 0.44 |
| **WARN** | `xs_momentum` | `GBP_USD` | 24 | -0.987 | 62.5% | 42.7% | 0.72 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 45 | -2.713 | 53.3% | 39.1% | 0.63 |
...
| WARN | `donchian_momentum_breakout` | `AUD_USD` | 14 | 5 | 9 | -4.029 | 35.7% | 16.3%-61.2% | 0.28 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `donchian_momentum_breakout` | `NZD_USD` | 16 | 10 | 6 | -0.537 | 62.5% | 38.6%-81.5% | 0.90 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 30 | 13 | 17 | -0.583 | 43.3% | 27.4%-60.8% | 0.81 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `EUR_USD` | 26 | 6 | 20 | -1.746 | 23.1% | 11.0%-42.1% | 0.21 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `AUD_JPY` | 7 | 7 | 0 | +11.771 | 100.0% | 64.6%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 38 | 18 | 20 | -1.889 | 47.4% | 32.5%-62.7% | 0.61 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 58 | 29 | 29 | -1.841 | 50.0% | 37.5%-62.5% | 0.63 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 27 | 13 | 14 | -2.900 | 48.1% | 30.7%-66.0% | 0.51 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 22 | 16 | 6 | -0.364 | 72.7% | 51.8%-86.8% | 0.91 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 23 | 9 | 14 | -3.030 | 39.1% | 22.2%-59.2% | 0.29 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `USD_JPY` | 22 | 13 | 9 | +1.050 | 59.1% | 38.7%-76.7% | 1.28 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `EUR_USD` | 10 | 5 | 5 | -2.780 | 50.0% | 23.7%-76.3% | 0.44 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `GBP_USD` | 24 | 15 | 9 | -0.987 | 62.5% | 42.7%-78.8% | 0.72 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 45 | 24 | 21 | -2.713 | 53.3% | 39.1%-67.1% | 0.63 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
