# SHADOW_PROMOTE R2 Alert - 2026-08-19T06:39:22.590513+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | -2.600 | 36.0% | 20.2% | 0.52 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 25 | -0.268 | 44.0% | 26.7% | 0.90 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 26 | -3.750 | 53.8% | 35.5% | 0.38 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 34 | -1.276 | 47.1% | 31.5% | 0.66 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 21 | -1.643 | 19.0% | 7.7% | 0.22 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -0.900 | 33.3% | 13.8% | 0.70 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 31 | -1.265 | 45.2% | 29.2% | 0.69 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 38 | -1.329 | 63.2% | 47.3% | 0.64 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | 9 | 16 | -2.600 | 36.0% | 20.2%-55.5% | 0.52 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 25 | 11 | 14 | -0.268 | 44.0% | 26.7%-62.9% | 0.90 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 26 | 14 | 12 | -3.750 | 53.8% | 35.5%-71.2% | 0.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 34 | 16 | 18 | -1.276 | 47.1% | 31.5%-63.3% | 0.66 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 21 | 4 | 17 | -1.643 | 19.0% | 7.7%-40.0% | 0.22 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 31 | 14 | 17 | -1.265 | 45.2% | 29.2%-62.2% | 0.69 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 38 | 24 | 14 | -1.329 | 63.2% | 47.3%-76.6% | 0.64 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
