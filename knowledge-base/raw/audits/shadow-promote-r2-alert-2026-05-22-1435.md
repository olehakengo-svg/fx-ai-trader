# SHADOW_PROMOTE R2 Alert - 2026-05-22T14:35:54.041336+00:00
...
| **WARN** | `ema_trend_scalp` | `GBP_USD` | 21 | -0.890 | 19.0% | 7.7% | 0.68 |
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 19 | -2.100 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 67 | -1.078 | 19.4% | 11.7% | 0.66 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 73 | -3.666 | 20.5% | 12.9% | 0.48 |
...
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -2.592 | 16.7% | 4.7% | 0.29 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 49 | -4.520 | 24.5% | 14.6% | 0.39 |
...
| OK | `bb_rsi_reversion` | `USD_JPY` | 26 | 12 | 14 | +0.104 | 46.2% | 28.8%-64.5% | 1.04 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 12 | 9 | 3 | +6.500 | 75.0% | 46.8%-91.1% | 6.00 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `EUR_JPY` | 9 | 1 | 8 | -7.689 | 11.1% | 2.0%-43.5% | 0.12 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema_trend_scalp` | `GBP_USD` | 21 | 4 | 17 | -0.890 | 19.0% | 7.7%-40.0% | 0.68 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `ema_trend_scalp` | `USD_CHF` | 19 | 0 | 19 | -2.100 | 0.0% | 0.0%-16.8% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 67 | 13 | 54 | -1.078 | 19.4% | 11.7%-30.4% | 0.66 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 25 | 7 | 18 | -2.304 | 28.0% | 14.3%-47.6% | 0.68 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 43 | 14 | 29 | -0.519 | 32.6% | 20.5%-47.5% | 0.89 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_channel_reversal` | `USD_JPY` | 24 | 5 | 19 | -1.421 | 20.8% | 9.2%-40.5% | 0.52 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 73 | 15 | 58 | -3.666 | 20.5% | 12.9%-31.2% | 0.48 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 12 | 2 | 10 | -2.592 | 16.7% | 4.7%-44.8% | 0.29 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 49 | 12 | 37 | -4.520 | 24.5% | 14.6%-38.1% | 0.39 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
