# SHADOW_PROMOTE R2 Alert - 2026-05-13T19:52:45.052658+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 73 | -0.751 | 21.9% | 14.0% | 0.76 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 198 | -1.771 | 20.7% | 15.6% | 0.54 |
...
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 46 | -2.100 | 19.6% | 10.7% | 0.40 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 46 | -2.646 | 21.7% | 12.3% | 0.58 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 4 | 0 | 4 | -6.600 | 0.0% | 0.0%-49.0% | 0.00 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 14 | 7 | 7 | +5.436 | 50.0% | 26.8%-73.2% | 3.23 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `EUR_JPY` | 6 | 2 | 4 | -3.833 | 33.3% | 9.7%-70.0% | 0.67 | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema_cross` | `USD_JPY` | 3 | 2 | 1 | +5.433 | 66.7% | 20.8%-93.9% | 2.57 | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 73 | 16 | 57 | -0.751 | 21.9% | 14.0%-32.7% | 0.76 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 198 | 41 | 157 | -1.771 | 20.7% | 15.6%-26.9% | 0.54 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `macdh_reversal` | `USD_JPY` | 11 | 4 | 7 | +0.318 | 36.4% | 15.2%-64.6% | 1.13 | `MACDH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 46 | 9 | 37 | -2.100 | 19.6% | 10.7%-33.2% | 0.40 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 46 | 10 | 36 | -2.646 | 21.7% | 12.3%-35.6% | 0.58 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 23 | 4 | 19 | -3.174 | 17.4% | 7.0%-37.1% | 0.49 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 35 | 11 | 24 | -0.540 | 31.4% | 18.6%-48.0% | 0.93 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
