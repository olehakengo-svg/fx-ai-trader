# SHADOW_PROMOTE R2 Alert - 2026-06-08T10:50:14.744651+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 17 | -7.094 | 35.3% | 17.3% | 0.30 |
| **WARN** | `ema200_trend_reversal` | `USD_JPY` | 10 | -0.630 | 60.0% | 31.3% | 0.53 |
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 93 | -1.746 | 4.3% | 1.7% | 0.20 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 29 | -1.193 | 27.6% | 14.7% | 0.48 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 16 | -2.713 | 12.5% | 3.5% | 0.20 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 38 | -0.818 | 28.9% | 17.0% | 0.60 |
| **WARN** | `london_breakout` | `GBP_USD` | 20 | -0.535 | 35.0% | 18.1% | 0.75 |
| **WARN** | `london_breakout` | `USD_CHF` | 17 | -2.159 | 11.8% | 3.3% | 0.10 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 44 | -1.214 | 27.3% | 16.3% | 0.38 |
...
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 12 | -2.142 | 50.0% | 25.4% | 0.59 |
| **WARN** | `sr_anti_hunt_bounce` | `USD_JPY` | 28 | -1.607 | 10.7% | 3.7% | 0.10 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 24 | -6.171 | 16.7% | 6.7% | 0.14 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 35 | -5.980 | 25.7% | 14.2% | 0.20 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 61 | -2.049 | 31.1% | 20.9% | 0.57 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 37 | -2.097 | 29.7% | 17.5% | 0.29 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 49 | -0.998 | 34.7% | 22.9% | 0.59 |
| **CRITICAL** | `sr_channel_reversal` | `USD_CHF` | 35 | -2.149 | 5.7% | 1.6% | 0.15 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 65 | -3.900 | 16.9% | 9.7% | 0.29 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 10 | -2.000 | 30.0% | 10.8% | 0.21 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 13 | -8.385 | 23.1% | 8.2% | 0.07 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 26 | -3.200 | 15.4% | 6.1% | 0.21 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 11 | -3.191 | 45.5% | 21.3% | 0.37 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 19 | -2.789 | 63.2% | 41.0% | 0.27 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 51 | -1.600 | 41.2% | 28.8% | 0.59 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 51 | -0.410 | 49.0% | 35.9% | 0.90 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 52 | -2.846 | 32.7% | 21.5% | 0.35 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 17 | 12 | 5 | +1.712 | 70.6% | 46.9%-86.7% | 1.76 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 17 | 6 | 11 | -7.094 | 35.3% | 17.3%-58.7% | 0.30 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema200_trend_reversal` | `USD_JPY` | 10 | 6 | 4 | -0.630 | 60.0% | 31.3%-83.2% | 0.53 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_cross` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_ribbon_ride` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_RIBBON_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 93 | 4 | 89 | -1.746 | 4.3% | 1.7%-10.5% | 0.20 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `EUR_USD` | 29 | 8 | 21 | -1.193 | 27.6% | 14.7%-45.7% | 0.48 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 16 | 2 | 14 | -2.713 | 12.5% | 3.5%-36.0% | 0.20 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `inducement_ob` | `GBP_USD` | 4 | 0 | 4 | -5.200 | 0.0% | 0.0%-49.0% | 0.00 | `INDUCEMENT_OB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `USD_CHF` | 17 | 2 | 15 | -2.159 | 11.8% | 3.3%-34.3% | 0.10 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 44 | 12 | 32 | -1.214 | 27.3% | 16.3%-41.8% | 0.38 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `USD_JPY` | 20 | 15 | 5 | +0.430 | 75.0% | 53.1%-88.8% | 1.34 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_USD` | 12 | 6 | 6 | -2.142 | 50.0% | 25.4%-74.6% | 0.59 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 3 | 0 | 3 | -0.400 | 0.0% | 0.0%-56.2% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 1 | 1 | 0 | +2.300 | 100.0% | 20.7%-100.0% | n/a | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_anti_hunt_bounce` | `USD_JPY` | 28 | 3 | 25 | -1.607 | 10.7% | 3.7%-27.2% | 0.10 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 61 | 19 | 42 | -2.049 | 31.1% | 20.9%-43.6% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 37 | 11 | 26 | -2.097 | 29.7% | 17.5%-45.8% | 0.29 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 49 | 17 | 32 | -0.998 | 34.7% | 22.9%-48.7% | 0.59 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 85 | 36 | 49 | +0.433 | 42.4% | 32.4%-53.0% | 1.16 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 65 | 11 | 54 | -3.900 | 16.9% | 9.7%-27.8% | 0.29 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 10 | 3 | 7 | -2.000 | 30.0% | 10.8%-60.3% | 0.21 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_USD` | 10 | 6 | 4 | +4.270 | 60.0% | 31.3%-83.2% | 2.65 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 13 | 3 | 10 | -8.385 | 23.1% | 8.2%-50.3% | 0.07 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 26 | 4 | 22 | -3.200 | 15.4% | 6.1%-33.5% | 0.21 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_momentum_scalp` | `USD_JPY` | 4 | 1 | 3 | -1.425 | 25.0% | 4.6%-69.9% | 0.15 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 11 | 5 | 6 | -3.191 | 45.5% | 21.3%-72.0% | 0.37 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 42 | 16 | 26 | +0.393 | 38.1% | 25.0%-53.2% | 1.13 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 51 | 21 | 30 | -1.600 | 41.2% | 28.8%-54.8% | 0.59 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 51 | 25 | 26 | -0.410 | 49.0% | 35.9%-62.3% | 0.90 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 52 | 17 | 35 | -2.846 | 32.7% | 21.5%-46.2% | 0.35 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
