# SHADOW_PROMOTE R2 Alert - 2026-06-08T20:12:26.776076+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 91 | -1.618 | 8.8% | 4.5% | 0.25 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 34 | -1.250 | 26.5% | 14.6% | 0.46 |
...
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 11 | -1.973 | 54.5% | 28.0% | 0.63 |
| **WARN** | `sr_anti_hunt_bounce` | `USD_JPY` | 26 | -1.723 | 11.5% | 4.0% | 0.10 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 23 | -6.026 | 17.4% | 7.0% | 0.15 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 35 | -5.980 | 25.7% | 14.2% | 0.20 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 59 | -2.132 | 30.5% | 20.3% | 0.57 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 40 | -1.615 | 37.5% | 24.2% | 0.41 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 57 | -0.946 | 36.8% | 25.5% | 0.62 |
| **CRITICAL** | `sr_channel_reversal` | `USD_CHF` | 39 | -2.179 | 5.1% | 1.4% | 0.13 |
...
| OK | `dt_sr_channel_reversal` | `EUR_GBP` | 7 | 2 | 5 | -0.357 | 28.6% | 8.2%-64.1% | 0.85 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 91 | 8 | 83 | -1.618 | 8.8% | 4.5%-16.4% | 0.25 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 34 | 9 | 25 | -1.250 | 26.5% | 14.6%-43.1% | 0.46 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `EUR_USD` | 2 | 2 | 0 | +8.800 | 100.0% | 34.2%-100.0% | n/a | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_USD` | 11 | 6 | 5 | -1.973 | 54.5% | 28.0%-78.7% | 0.63 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 23 | 4 | 19 | -6.026 | 17.4% | 7.0%-37.1% | 0.15 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 40 | 15 | 25 | -1.615 | 37.5% | 24.2%-53.0% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 57 | 21 | 36 | -0.946 | 36.8% | 25.5%-49.8% | 0.62 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_CHF` | 39 | 2 | 37 | -2.179 | 5.1% | 1.4%-16.9% | 0.13 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_GBP` | 1 | 0 | 1 | -5.700 | 0.0% | 0.0%-79.3% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_USD` | 72 | 33 | 39 | +1.163 | 45.8% | 34.8%-57.3% | 1.51 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
