# SHADOW_PROMOTE R2 Alert - 2026-07-21T19:18:12.292193+00:00
...
| **WARN** | `donchian_momentum_breakout` | `USD_JPY` | 10 | -4.670 | 60.0% | 31.3% | 0.45 |
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 18 | -5.633 | 22.2% | 9.0% | 0.07 |
...
| **WARN** | `engulfing_bb` | `GBP_USD` | 29 | -1.852 | 37.9% | 22.7% | 0.33 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 67 | -1.242 | 38.8% | 28.0% | 0.44 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 33 | -1.827 | 51.5% | 35.2% | 0.57 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 30 | -2.420 | 73.3% | 55.6% | 0.46 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 32 | -1.181 | 56.2% | 39.3% | 0.63 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 30 | -2.887 | 46.7% | 30.2% | 0.30 |
| **WARN** | `trend_rebound` | `USD_JPY` | 16 | -1.362 | 31.2% | 14.2% | 0.31 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 28 | -1.421 | 53.6% | 35.8% | 0.42 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 15 | -0.273 | 80.0% | 54.8% | 0.89 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 11 | -2.500 | 63.6% | 35.4% | 0.29 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 66 | -1.073 | 40.9% | 29.9% | 0.54 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 23 | -2.374 | 26.1% | 12.5% | 0.14 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 16 | -1.406 | 68.8% | 44.4% | 0.69 |
...
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 33 | -0.091 | 66.7% | 49.6% | 0.97 |
...
| WARN | `donchian_momentum_breakout` | `USD_JPY` | 10 | 6 | 4 | -4.670 | 60.0% | 31.3%-83.2% | 0.45 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 6 | 4 | 2 | +2.067 | 66.7% | 30.0%-90.3% | 2.57 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 18 | 4 | 14 | -5.633 | 22.2% | 9.0%-45.2% | 0.07 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `GBP_USD` | 29 | 11 | 18 | -1.852 | 37.9% | 22.7%-56.0% | 0.33 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 67 | 26 | 41 | -1.242 | 38.8% | 28.0%-50.8% | 0.44 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `mtf_reversal_confluence` | `USD_JPY` | 4 | 1 | 3 | -2.250 | 25.0% | 4.6%-69.9% | 0.32 | `MTF_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 7 | 2 | 5 | -16.229 | 28.6% | 8.2%-64.1% | 0.06 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 33 | 17 | 16 | -1.827 | 51.5% | 35.2%-67.5% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 30 | 22 | 8 | -2.420 | 73.3% | 55.6%-85.8% | 0.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 32 | 18 | 14 | -1.181 | 56.2% | 39.3%-71.8% | 0.63 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 16 | 5 | 11 | -1.362 | 31.2% | 14.2%-55.6% | 0.31 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_GBP` | 28 | 15 | 13 | -1.421 | 53.6% | 35.8%-70.5% | 0.42 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_USD` | 15 | 12 | 3 | -0.273 | 80.0% | 54.8%-93.0% | 0.89 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 11 | 7 | 4 | -2.500 | 63.6% | 35.4%-84.8% | 0.29 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 66 | 27 | 39 | -1.073 | 40.9% | 29.9%-53.0% | 0.54 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 23 | 6 | 17 | -2.374 | 26.1% | 12.5%-46.5% | 0.14 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 16 | 11 | 5 | -1.406 | 68.8% | 44.4%-85.8% | 0.69 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `USD_JPY` | 33 | 22 | 11 | -0.091 | 66.7% | 49.6%-80.2% | 0.97 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
