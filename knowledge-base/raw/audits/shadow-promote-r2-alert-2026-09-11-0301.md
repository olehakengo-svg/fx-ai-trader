# SHADOW_PROMOTE R2 Alert - 2026-09-11T03:01:45.810637+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 10 | -0.180 | 60.0% | 31.3% | 0.91 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 33 | -0.639 | 57.6% | 40.8% | 0.78 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 58 | -0.684 | 39.7% | 28.1% | 0.63 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 27 | -2.804 | 44.4% | 27.6% | 0.47 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 15 | -1.887 | 60.0% | 35.7% | 0.59 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 45 | -0.480 | 55.6% | 41.2% | 0.89 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 46 | -1.026 | 47.8% | 34.1% | 0.70 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 10 | -0.210 | 40.0% | 16.8% | 0.88 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 25 | -0.700 | 44.0% | 26.7% | 0.64 |
| **WARN** | `trend_rebound` | `EUR_USD` | 15 | -0.393 | 33.3% | 15.2% | 0.74 |
| **WARN** | `trend_rebound` | `USD_JPY` | 13 | -2.146 | 23.1% | 8.2% | 0.19 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 26 | -3.192 | 53.8% | 35.5% | 0.26 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 24 | -1.358 | 20.8% | 9.2% | 0.32 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 10 | -1.610 | 50.0% | 23.7% | 0.47 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 60 | -0.608 | 58.3% | 45.7% | 0.84 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 20 | -2.535 | 50.0% | 29.9% | 0.56 |
| **WARN** | `wick_imbalance_reversion` | `EUR_USD` | 12 | -3.758 | 33.3% | 13.8% | 0.39 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 21 | -1.000 | 66.7% | 45.4% | 0.81 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 23 | -2.983 | 34.8% | 18.8% | 0.30 |
...
| OK | `bb_squeeze_breakout` | `USD_JPY` | 1 | 0 | 1 | -3.100 | 0.0% | 0.0%-79.3% | 0.00 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 10 | 6 | 4 | -0.180 | 60.0% | 31.3%-83.2% | 0.91 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 33 | 19 | 14 | -0.639 | 57.6% | 40.8%-72.8% | 0.78 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 6 | 3 | 3 | -8.367 | 50.0% | 18.8%-81.2% | 0.04 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_anti_hunt_bounce` | `GBP_JPY` | 15 | 9 | 6 | -1.887 | 60.0% | 35.7%-80.2% | 0.59 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 46 | 22 | 24 | -1.026 | 47.8% | 34.1%-61.9% | 0.70 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_liquidity_grab` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `SR_LIQUIDITY_GRAB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `stoch_trend_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `three_bar_reversal` | `EUR_USD` | 10 | 4 | 6 | -0.210 | 40.0% | 16.8%-68.7% | 0.88 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 13 | 3 | 10 | -2.146 | 23.1% | 8.2%-50.3% | 0.19 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 26 | 14 | 12 | -3.192 | 53.8% | 35.5%-71.2% | 0.26 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `turtle_soup` | `GBP_USD` | 5 | 4 | 1 | -0.300 | 80.0% | 37.6%-96.4% | 0.78 | `TURTLE_SOUP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `tvsm` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `TVSM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `v_reversal` | `USD_JPY` | 5 | 3 | 2 | +0.160 | 60.0% | 23.1%-88.2% | 1.08 | `V_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 24 | 5 | 19 | -1.358 | 20.8% | 9.2%-40.5% | 0.32 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 60 | 35 | 25 | -0.608 | 58.3% | 45.7%-69.9% | 0.84 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 20 | 10 | 10 | -2.535 | 50.0% | 29.9%-70.1% | 0.56 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_USD` | 12 | 4 | 8 | -3.758 | 33.3% | 13.8%-60.9% | 0.39 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 21 | 14 | 7 | -1.000 | 66.7% | 45.4%-82.8% | 0.81 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 23 | 8 | 15 | -2.983 | 34.8% | 18.8%-55.1% | 0.30 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
