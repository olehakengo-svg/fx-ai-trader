# SHADOW_PROMOTE R2 Alert - 2026-09-08T10:34:44.599991+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 17 | -3.371 | 29.4% | 13.3% | 0.44 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 25 | -0.572 | 44.0% | 26.7% | 0.79 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | -3.995 | 52.4% | 32.4% | 0.32 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 31 | -2.013 | 35.5% | 21.1% | 0.33 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 28 | -0.754 | 53.6% | 35.8% | 0.72 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 60 | -0.793 | 36.7% | 25.6% | 0.59 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `EUR_JPY` | 34 | -1.800 | 47.1% | 31.5% | 0.60 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 18 | -0.622 | 66.7% | 43.7% | 0.84 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 46 | -0.189 | 54.3% | 40.2% | 0.95 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 8 | 5 | 3 | -0.150 | 62.5% | 30.6%-86.3% | 0.94 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 17 | 5 | 12 | -3.371 | 29.4% | 13.3%-53.1% | 0.44 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 25 | 11 | 14 | -0.572 | 44.0% | 26.7%-62.9% | 0.79 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | 11 | 10 | -3.995 | 52.4% | 32.4%-71.7% | 0.32 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 31 | 11 | 20 | -2.013 | 35.5% | 21.1%-53.1% | 0.33 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 28 | 15 | 13 | -0.754 | 53.6% | 35.8%-70.5% | 0.72 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 60 | 22 | 38 | -0.793 | 36.7% | 25.6%-49.3% | 0.59 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 46 | 25 | 21 | -0.189 | 54.3% | 40.2%-67.8% | 0.95 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 25 | 18 | 7 | +3.120 | 72.0% | 52.4%-85.7% | 2.60 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
