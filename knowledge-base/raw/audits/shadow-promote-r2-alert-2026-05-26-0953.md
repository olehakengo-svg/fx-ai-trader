# SHADOW_PROMOTE R2 Alert - 2026-05-26T09:53:30.401494+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_rsi_reversion` | `EUR_USD` | 10 | -1.000 | 30.0% | 10.8% | 0.53 |
| **WARN** | `bb_rsi_reversion` | `GBP_USD` | 10 | -0.670 | 40.0% | 16.8% | 0.79 |
| **WARN** | `bb_rsi_reversion` | `USD_CHF` | 23 | -2.604 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `dt_bb_rsi_mr` | `GBP_USD` | 35 | -0.054 | 40.0% | 25.6% | 0.99 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 10 | -9.200 | 0.0% | 0.0% | 0.00 |
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 23 | -2.317 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 46 | -1.215 | 21.7% | 12.3% | 0.63 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 30 | -0.380 | 26.7% | 14.2% | 0.83 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 15 | -3.753 | 13.3% | 3.7% | 0.26 |
| **WARN** | `engulfing_bb` | `USD_JPY` | 10 | -1.990 | 10.0% | 1.8% | 0.44 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 25 | -3.292 | 24.0% | 11.5% | 0.33 |
| **WARN** | `london_breakout` | `EUR_USD` | 23 | -2.526 | 13.0% | 4.5% | 0.20 |
...
| **WARN** | `orb_trap` | `EUR_USD` | 16 | -2.544 | 6.2% | 1.1% | 0.07 |
...
| **WARN** | `sr_break_retest` | `GBP_JPY` | 23 | -8.326 | 8.7% | 2.4% | 0.24 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 53 | -3.513 | 22.6% | 13.5% | 0.42 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 50 | -1.772 | 26.0% | 15.9% | 0.66 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 54 | -2.043 | 22.2% | 13.2% | 0.48 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 12 | -1.383 | 0.0% | 0.0% | 0.00 |
| **WARN** | `sr_fib_confluence` | `EUR_GBP` | 26 | -0.815 | 23.1% | 11.0% | 0.71 |
| **WARN** | `sr_fib_confluence` | `EUR_JPY` | 13 | -4.785 | 15.4% | 4.3% | 0.64 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 53 | -1.966 | 22.6% | 13.5% | 0.56 |
| **WARN** | `sr_fib_confluence` | `GBP_JPY` | 25 | -8.148 | 12.0% | 4.2% | 0.49 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 43 | -2.037 | 18.6% | 9.7% | 0.53 |
| **WARN** | `vol_momentum_scalp` | `USD_JPY` | 11 | -3.082 | 9.1% | 1.6% | 0.18 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 15 | -2.907 | 20.0% | 7.0% | 0.57 |
| **WARN** | `wick_imbalance_reversion` | `EUR_USD` | 27 | -1.507 | 22.2% | 10.6% | 0.49 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 51 | -4.778 | 23.5% | 14.0% | 0.37 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 34 | -3.562 | 20.6% | 10.3% | 0.52 |
| **WARN** | `xs_momentum` | `USD_JPY` | 24 | -1.525 | 37.5% | 21.2% | 0.81 |
...
| WARN | `bb_rsi_reversion` | `EUR_USD` | 10 | 3 | 7 | -1.000 | 30.0% | 10.8%-60.3% | 0.53 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `bb_rsi_reversion` | `GBP_USD` | 10 | 4 | 6 | -0.670 | 40.0% | 16.8%-68.7% | 0.79 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `bb_rsi_reversion` | `USD_CHF` | 23 | 0 | 23 | -2.604 | 0.0% | 0.0%-14.3% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `USD_JPY` | 16 | 8 | 8 | +0.875 | 50.0% | 28.0%-72.0% | 1.39 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_squeeze_breakout` | `EUR_USD` | 2 | 0 | 2 | -1.800 | 0.0% | 0.0%-65.8% | 0.00 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `confluence_scalp` | `EUR_USD` | 1 | 0 | 1 | -3.300 | 0.0% | 0.0%-79.3% | 0.00 | `CONFLUENCE_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `cpd_divergence` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `CPD_DIVERGENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 5 | 0 | 5 | -19.640 | 0.0% | 0.0%-43.4% | 0.00 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 10 | 3 | 7 | +3.160 | 30.0% | 10.8%-60.3% | 2.50 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema_trend_scalp` | `EUR_USD` | 8 | 1 | 7 | -1.850 | 12.5% | 2.2%-47.1% | 0.25 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `GBP_USD` | 9 | 2 | 7 | +0.156 | 22.2% | 6.3%-54.7% | 1.07 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `ema_trend_scalp` | `USD_CHF` | 23 | 0 | 23 | -2.317 | 0.0% | 0.0%-14.3% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 46 | 10 | 36 | -1.215 | 21.7% | 12.3%-35.6% | 0.63 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 30 | 8 | 22 | -0.380 | 26.7% | 14.2%-44.4% | 0.83 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 15 | 2 | 13 | -3.753 | 13.3% | 3.7%-37.9% | 0.26 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `engulfing_bb` | `USD_CHF` | 6 | 0 | 6 | -1.550 | 0.0% | 0.0%-39.0% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `USD_JPY` | 10 | 1 | 9 | -1.990 | 10.0% | 1.8%-40.4% | 0.44 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `intraday_seasonality` | `GBP_USD` | 1 | 1 | 0 | +22.000 | 100.0% | 20.7%-100.0% | n/a | `ALPHA_INTRADAY_SEASONALITY_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 23 | 3 | 20 | -2.526 | 13.0% | 4.5%-32.1% | 0.20 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `orb_trap` | `EUR_USD` | 16 | 1 | 15 | -2.544 | 6.2% | 1.1%-28.3% | 0.07 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 11 | 6 | 5 | +7.655 | 54.5% | 28.0%-78.7% | 5.39 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_JPY` | 23 | 2 | 21 | -8.326 | 8.7% | 2.4%-26.8% | 0.24 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 53 | 12 | 41 | -3.513 | 22.6% | 13.5%-35.5% | 0.42 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 50 | 13 | 37 | -1.772 | 26.0% | 15.9%-39.6% | 0.66 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `EUR_USD` | 3 | 0 | 3 | -3.400 | 0.0% | 0.0%-56.2% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 54 | 12 | 42 | -2.043 | 22.2% | 13.2%-34.9% | 0.48 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `USD_CHF` | 12 | 0 | 12 | -1.383 | 0.0% | 0.0%-24.3% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_JPY` | 11 | 4 | 7 | +0.573 | 36.4% | 15.2%-64.6% | 1.26 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `EUR_GBP` | 26 | 6 | 20 | -0.815 | 23.1% | 11.0%-42.1% | 0.71 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `EUR_JPY` | 13 | 2 | 11 | -4.785 | 15.4% | 4.3%-42.2% | 0.64 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 53 | 12 | 41 | -1.966 | 22.6% | 13.5%-35.5% | 0.56 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `GBP_JPY` | 25 | 3 | 22 | -8.148 | 12.0% | 4.2%-30.0% | 0.49 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 84 | 15 | 69 | -3.992 | 17.9% | 11.1%-27.4% | 0.43 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `USD_JPY` | 15 | 4 | 11 | +2.960 | 26.7% | 10.9%-52.0% | 1.31 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 4 | 2 | 2 | +5.625 | 50.0% | 15.0%-85.0% | 57.25 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_GBP` | 2 | 0 | 2 | -4.600 | 0.0% | 0.0%-65.8% | 0.00 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_USD` | 18 | 5 | 13 | +0.533 | 27.8% | 12.5%-50.9% | 1.13 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 43 | 8 | 35 | -2.037 | 18.6% | 9.7%-32.6% | 0.53 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_momentum_scalp` | `USD_JPY` | 11 | 1 | 10 | -3.082 | 9.1% | 1.6%-37.7% | 0.18 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 9 | 2 | 7 | -1.756 | 22.2% | 6.3%-54.7% | 0.45 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 15 | 3 | 12 | -2.907 | 20.0% | 7.0%-45.2% | 0.57 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 51 | 12 | 39 | -4.778 | 23.5% | 14.0%-36.8% | 0.37 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 34 | 7 | 27 | -3.562 | 20.6% | 10.3%-36.8% | 0.52 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 24 | 9 | 15 | -1.525 | 37.5% | 21.2%-57.3% | 0.81 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
