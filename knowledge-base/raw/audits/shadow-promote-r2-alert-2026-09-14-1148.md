# SHADOW_PROMOTE R2 Alert - 2026-09-14T11:48:42.475783+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | -3.970 | 55.6% | 37.3% | 0.32 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 26 | -1.577 | 42.3% | 25.5% | 0.43 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 28 | -0.682 | 60.7% | 42.4% | 0.78 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 38 | -1.171 | 50.0% | 34.8% | 0.73 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 48 | -0.496 | 62.5% | 48.4% | 0.86 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 21 | -3.476 | 28.6% | 13.8% | 0.16 |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | 15 | 12 | -3.970 | 55.6% | 37.3%-72.4% | 0.32 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 26 | 11 | 15 | -1.577 | 42.3% | 25.5%-61.1% | 0.43 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 28 | 17 | 11 | -0.682 | 60.7% | 42.4%-76.4% | 0.78 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 38 | 19 | 19 | -1.171 | 50.0% | 34.8%-65.2% | 0.73 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 48 | 30 | 18 | -0.496 | 62.5% | 48.4%-74.8% | 0.86 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 21 | 6 | 15 | -3.476 | 28.6% | 13.8%-50.0% | 0.16 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
