# SHADOW_PROMOTE R2 Alert - 2026-07-20T19:41:22.908387+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 19 | -1.221 | 68.4% | 46.0% | 0.57 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 87 | -0.724 | 44.8% | 34.8% | 0.64 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 29 | -1.407 | 44.8% | 28.4% | 0.43 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 21 | -1.700 | 47.6% | 28.3% | 0.42 |
| **WARN** | `london_breakout` | `EUR_USD` | 13 | -1.546 | 38.5% | 17.7% | 0.36 |
| **WARN** | `london_breakout` | `GBP_USD` | 18 | -2.906 | 38.9% | 20.3% | 0.21 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 74 | -1.419 | 37.8% | 27.6% | 0.40 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 32 | -0.847 | 59.4% | 42.3% | 0.71 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 33 | -3.373 | 42.4% | 27.2% | 0.25 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 62 | -1.153 | 40.3% | 29.0% | 0.52 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 20 | -1.130 | 65.0% | 43.3% | 0.69 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 15 | -3.593 | 40.0% | 19.8% | 0.12 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 38 | -2.582 | 55.3% | 39.7% | 0.34 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 40 | -1.545 | 57.5% | 42.2% | 0.71 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 10 | 8 | 2 | +1.080 | 80.0% | 49.0%-94.3% | 1.25 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `AUD_USD` | 9 | 3 | 6 | -7.311 | 33.3% | 12.1%-64.6% | 0.21 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 19 | 13 | 6 | -1.221 | 68.4% | 46.0%-84.6% | 0.57 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 87 | 39 | 48 | -0.724 | 44.8% | 34.8%-55.3% | 0.64 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 29 | 13 | 16 | -1.407 | 44.8% | 28.4%-62.5% | 0.43 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 21 | 10 | 11 | -1.700 | 47.6% | 28.3%-67.6% | 0.42 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 74 | 28 | 46 | -1.419 | 37.8% | 27.6%-49.2% | 0.40 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 32 | 19 | 13 | -0.847 | 59.4% | 42.3%-74.5% | 0.71 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 33 | 14 | 19 | -3.373 | 42.4% | 27.2%-59.2% | 0.25 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 62 | 25 | 37 | -1.153 | 40.3% | 29.0%-52.7% | 0.52 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 20 | 13 | 7 | -1.130 | 65.0% | 43.3%-81.9% | 0.69 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `EUR_USD` | 8 | 7 | 1 | +3.038 | 87.5% | 52.9%-97.8% | 3.56 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 23 | 18 | 5 | +0.843 | 78.3% | 58.1%-90.3% | 1.27 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 38 | 21 | 17 | -2.582 | 55.3% | 39.7%-69.9% | 0.34 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 40 | 23 | 17 | -1.545 | 57.5% | 42.2%-71.5% | 0.71 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
