# SHADOW_PROMOTE R2 Alert - 2026-06-23T03:24:41.036500+00:00
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 10 | -3.430 | 50.0% | 23.7% | 0.37 |
...
| OK | `ema200_trend_reversal` | `USD_JPY` | 10 | 8 | 2 | +1.180 | 80.0% | 49.0%-94.3% | 2.84 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_cross` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_ribbon_ride` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_RIBBON_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `ema_trend_scalp` | `USD_CHF` | 17 | 1 | 16 | -3.047 | 5.9% | 1.0%-27.0% | 0.03 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 70 | 26 | 44 | -0.914 | 37.1% | 26.8%-48.9% | 0.55 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 39 | 13 | 26 | -2.215 | 33.3% | 20.6%-49.0% | 0.26 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 46 | 19 | 27 | -0.709 | 41.3% | 28.3%-55.7% | 0.53 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 37 | 24 | 13 | -1.873 | 64.9% | 48.8%-78.2% | 0.50 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 41 | 28 | 13 | -1.876 | 68.3% | 53.0%-80.4% | 0.59 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 33 | 15 | 18 | -2.715 | 45.5% | 29.8%-62.0% | 0.35 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 10 | 5 | 5 | -3.430 | 50.0% | 23.7%-76.3% | 0.37 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
