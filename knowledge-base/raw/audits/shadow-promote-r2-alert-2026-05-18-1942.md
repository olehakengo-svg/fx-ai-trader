# SHADOW_PROMOTE R2 Alert - 2026-05-18T19:42:59.340741+00:00
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 19 | -1.732 | 26.3% | 11.8% | 0.77 |
...
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 41 | -2.578 | 19.5% | 10.2% | 0.40 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 40 | -1.540 | 20.0% | 10.5% | 0.63 |
...
| OK | `bb_rsi_reversion` | `USD_CHF` | 5 | 0 | 5 | -2.720 | 0.0% | 0.0%-43.4% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 19 | 5 | 14 | -1.732 | 26.3% | 11.8%-48.8% | 0.77 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 41 | 8 | 33 | -2.578 | 19.5% | 10.2%-34.0% | 0.40 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_CHF` | 2 | 0 | 2 | -1.150 | 0.0% | 0.0%-65.8% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 40 | 8 | 32 | -1.540 | 20.0% | 10.5%-34.8% | 0.63 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
