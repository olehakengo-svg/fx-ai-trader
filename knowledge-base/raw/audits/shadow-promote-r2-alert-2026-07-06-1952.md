# SHADOW_PROMOTE R2 Alert - 2026-07-06T19:52:55.804612+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_USD` | 32 | -0.191 | 65.6% | 48.3% | 0.86 |
...
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 42 | -0.210 | 50.0% | 35.5% | 0.89 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -3.967 | 33.3% | 13.8% | 0.18 |
| **WARN** | `london_breakout` | `USD_CHF` | 24 | -1.567 | 29.2% | 14.9% | 0.28 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 70 | -1.646 | 34.3% | 24.2% | 0.31 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 38 | -1.150 | 73.7% | 58.0% | 0.69 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 44 | -0.139 | 68.2% | 53.4% | 0.95 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 33 | -3.415 | 27.3% | 15.1% | 0.20 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 4 | 4 | 0 | +8.100 | 100.0% | 51.0%-100.0% | n/a | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_USD` | 32 | 21 | 11 | -0.191 | 65.6% | 48.3%-79.6% | 0.86 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `GBP_USD` | 42 | 21 | 21 | -0.210 | 50.0% | 35.5%-64.5% | 0.89 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 70 | 24 | 46 | -1.646 | 34.3% | 24.2%-46.0% | 0.31 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 38 | 28 | 10 | -1.150 | 73.7% | 58.0%-85.0% | 0.69 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 44 | 30 | 14 | -0.139 | 68.2% | 53.4%-80.0% | 0.95 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 33 | 9 | 24 | -3.415 | 27.3% | 15.1%-44.2% | 0.20 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `GBP_USD` | 6 | 2 | 4 | -1.967 | 33.3% | 9.7%-70.0% | 0.36 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
