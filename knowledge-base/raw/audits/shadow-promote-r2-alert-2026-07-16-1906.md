# SHADOW_PROMOTE R2 Alert - 2026-07-16T19:06:24.438740+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 19 | -1.979 | 63.2% | 41.0% | 0.44 |
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_USD` | 33 | -1.373 | 45.5% | 29.8% | 0.37 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 30 | -1.927 | 46.7% | 30.2% | 0.45 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 35 | -0.543 | 65.7% | 49.2% | 0.80 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 36 | -2.800 | 55.6% | 39.6% | 0.31 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 38 | -1.216 | 63.2% | 47.3% | 0.77 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 31 | -3.187 | 51.6% | 34.8% | 0.25 |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 7 | 3 | 4 | -10.257 | 42.9% | 15.8%-75.0% | 0.20 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 19 | 12 | 7 | -1.979 | 63.2% | 41.0%-80.9% | 0.44 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `EUR_USD` | 33 | 15 | 18 | -1.373 | 45.5% | 29.8%-62.0% | 0.37 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_JPY` | 13 | 9 | 4 | +1.508 | 69.2% | 42.4%-87.3% | 1.68 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 30 | 14 | 16 | -1.927 | 46.7% | 30.2%-63.9% | 0.45 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 3 | 3 | 0 | +1.800 | 100.0% | 43.8%-100.0% | n/a | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 35 | 23 | 12 | -0.543 | 65.7% | 49.2%-79.2% | 0.80 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `GBP_USD` | 39 | 21 | 18 | +0.646 | 53.8% | 38.6%-68.4% | 1.25 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 36 | 20 | 16 | -2.800 | 55.6% | 39.6%-70.5% | 0.31 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 38 | 24 | 14 | -1.216 | 63.2% | 47.3%-76.6% | 0.77 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 31 | 16 | 15 | -3.187 | 51.6% | 34.8%-68.0% | 0.25 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
