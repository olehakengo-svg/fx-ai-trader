# SHADOW_PROMOTE R2 Alert - 2026-05-22T19:42:17.841471+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_rsi_reversion` | `EUR_USD` | 15 | -0.933 | 33.3% | 15.2% | 0.57 |
...
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 65 | -1.632 | 16.9% | 9.7% | 0.51 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 50 | -2.896 | 26.0% | 15.9% | 0.51 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 74 | -2.907 | 23.0% | 14.9% | 0.58 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 33 | -3.345 | 24.2% | 12.8% | 0.57 |
...
| WARN | `bb_rsi_reversion` | `EUR_USD` | 15 | 5 | 10 | -0.933 | 33.3% | 15.2%-58.3% | 0.57 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 65 | 11 | 54 | -1.632 | 16.9% | 9.7%-27.8% | 0.51 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_JPY` | 15 | 3 | 12 | +1.467 | 20.0% | 7.0%-45.2% | 1.51 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 50 | 13 | 37 | -2.896 | 26.0% | 15.9%-39.6% | 0.51 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 44 | 14 | 30 | -0.593 | 31.8% | 20.0%-46.6% | 0.87 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `EUR_USD` | 8 | 2 | 6 | -0.163 | 25.0% | 7.1%-59.1% | 0.93 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 74 | 17 | 57 | -2.907 | 23.0% | 14.9%-33.7% | 0.58 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 33 | 8 | 25 | -3.345 | 24.2% | 12.8%-41.0% | 0.57 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
