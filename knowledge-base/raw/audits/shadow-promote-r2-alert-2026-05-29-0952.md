# SHADOW_PROMOTE R2 Alert - 2026-05-29T09:52:02.469470+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 40 | -0.625 | 27.5% | 16.1% | 0.73 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 28 | -1.371 | 25.0% | 12.7% | 0.43 |
| **WARN** | `orb_trap` | `EUR_USD` | 18 | -3.161 | 5.6% | 1.0% | 0.05 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `EUR_USD` | 31 | -11.965 | 3.2% | 0.6% | 0.01 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 60 | -1.412 | 23.3% | 14.4% | 0.69 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 72 | -4.001 | 15.3% | 8.8% | 0.39 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 39 | -1.951 | 17.9% | 9.0% | 0.53 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 17 | -4.547 | 17.6% | 6.2% | 0.40 |
| **CRITICAL** | `wick_imbalance_reversion` | `EUR_USD` | 35 | -1.014 | 22.9% | 12.1% | 0.64 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 56 | -5.123 | 19.6% | 11.3% | 0.31 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 38 | -1.168 | 26.3% | 15.0% | 0.82 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 9 | 0 | 9 | -17.356 | 0.0% | 0.0%-29.9% | 0.00 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_JPY` | 10 | 7 | 3 | +19.270 | 70.0% | 39.7%-89.2% | 4.04 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `NZD_USD` | 9 | 5 | 4 | +13.011 | 55.6% | 26.7%-81.1% | 4.39 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 40 | 11 | 29 | -0.625 | 27.5% | 16.1%-42.8% | 0.73 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 28 | 7 | 21 | -1.371 | 25.0% | 12.7%-43.4% | 0.43 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `EUR_USD` | 26 | 8 | 18 | +0.050 | 30.8% | 16.5%-50.0% | 1.01 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_anti_hunt_bounce` | `EUR_USD` | 31 | 1 | 30 | -11.965 | 3.2% | 0.6%-16.2% | 0.01 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_anti_hunt_bounce` | `GBP_JPY` | 11 | 2 | 9 | -2.036 | 18.2% | 5.1%-47.7% | 0.49 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 3 | 2 | 1 | +5.367 | 66.7% | 20.8%-93.9% | 3.82 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 60 | 14 | 46 | -1.412 | 23.3% | 14.4%-35.4% | 0.69 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 69 | 24 | 45 | +0.439 | 34.8% | 24.6%-46.6% | 1.13 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 72 | 11 | 61 | -4.001 | 15.3% | 8.8%-25.3% | 0.39 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 39 | 7 | 32 | -1.951 | 17.9% | 9.0%-32.7% | 0.53 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 9 | 2 | 7 | -1.611 | 22.2% | 6.3%-54.7% | 0.47 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `EUR_USD` | 35 | 8 | 27 | -1.014 | 22.9% | 12.1%-39.0% | 0.64 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 28 | 10 | 18 | +2.164 | 35.7% | 20.7%-54.2% | 1.56 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 38 | 10 | 28 | -1.168 | 26.3% | 15.0%-42.0% | 0.82 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
