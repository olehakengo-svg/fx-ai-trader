# SHADOW_PROMOTE R2 Alert - 2026-09-12T20:11:09.811082+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 30 | -0.823 | 60.0% | 42.3% | 0.73 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 43 | -0.381 | 55.8% | 41.1% | 0.92 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 40 | -0.918 | 52.5% | 37.5% | 0.76 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 54 | -0.544 | 61.1% | 47.8% | 0.85 |
...
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 30 | 18 | 12 | -0.823 | 60.0% | 42.3%-75.4% | 0.73 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 43 | 24 | 19 | -0.381 | 55.8% | 41.1%-69.6% | 0.92 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 40 | 21 | 19 | -0.918 | 52.5% | 37.5%-67.1% | 0.76 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 54 | 33 | 21 | -0.544 | 61.1% | 47.8%-73.0% | 0.85 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
