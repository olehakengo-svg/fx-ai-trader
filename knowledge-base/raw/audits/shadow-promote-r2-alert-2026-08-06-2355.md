# SHADOW_PROMOTE R2 Alert - 2026-08-06T23:55:56.936194+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 11 | -1.027 | 63.6% | 35.4% | 0.61 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 31 | -2.926 | 58.1% | 40.8% | 0.43 |
...
| **CRITICAL** | `london_breakout` | `GBP_USD` | 52 | -2.262 | 30.8% | 19.9% | 0.27 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 35 | -1.437 | 54.3% | 38.2% | 0.59 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 13 | -2.615 | 61.5% | 35.5% | 0.55 |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 7 | 5 | 2 | +3.671 | 71.4% | 35.9%-91.8% | 2.65 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 11 | 7 | 4 | -1.027 | 63.6% | 35.4%-84.8% | 0.61 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 31 | 18 | 13 | -2.926 | 58.1% | 40.8%-73.6% | 0.43 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `GBP_USD` | 52 | 16 | 36 | -2.262 | 30.8% | 19.9%-44.3% | 0.27 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `EUR_USD` | 8 | 2 | 6 | -3.712 | 25.0% | 7.1%-59.1% | 0.33 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 35 | 19 | 16 | -1.437 | 54.3% | 38.2%-69.5% | 0.59 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 13 | 8 | 5 | -2.615 | 61.5% | 35.5%-82.3% | 0.55 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
