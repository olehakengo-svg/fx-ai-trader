# SHADOW_PROMOTE R2 Alert - 2026-07-28T19:19:48.121930+00:00
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 41 | -1.405 | 56.1% | 41.0% | 0.57 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 69 | -1.338 | 36.2% | 25.9% | 0.40 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 24 | 12 | 12 | -0.421 | 50.0% | 31.4%-68.6% | 0.81 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 17 | 9 | 8 | -2.747 | 52.9% | 31.0%-73.8% | 0.26 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 18 | 8 | 10 | -1.278 | 44.4% | 24.6%-66.3% | 0.46 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema200_trend_reversal` | `USD_JPY` | 21 | 12 | 9 | -0.367 | 57.1% | 36.5%-75.5% | 0.87 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `GBP_USD` | 30 | 12 | 18 | -1.250 | 40.0% | 24.6%-57.7% | 0.53 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 41 | 23 | 18 | -1.405 | 56.1% | 41.0%-70.1% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 69 | 25 | 44 | -1.338 | 36.2% | 25.9%-48.0% | 0.40 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
