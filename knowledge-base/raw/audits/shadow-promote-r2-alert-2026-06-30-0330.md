# SHADOW_PROMOTE R2 Alert - 2026-06-30T03:30:30.278116+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 40 | -2.772 | 55.0% | 39.8% | 0.50 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 81 | -1.025 | 39.5% | 29.6% | 0.51 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 41 | -0.427 | 46.3% | 32.1% | 0.80 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 14 | -4.164 | 35.7% | 16.3% | 0.13 |
| **WARN** | `london_breakout` | `USD_CHF` | 23 | -2.504 | 26.1% | 12.5% | 0.17 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 57 | -1.275 | 36.8% | 25.5% | 0.34 |
| **WARN** | `ob_retest` | `GBP_USD` | 10 | -5.260 | 50.0% | 23.7% | 0.16 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 17 | -2.559 | 41.2% | 21.6% | 0.19 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 13 | -0.431 | 69.2% | 42.4% | 0.81 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 35 | -1.251 | 71.4% | 54.9% | 0.63 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 39 | -2.715 | 64.1% | 48.4% | 0.50 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 44 | -3.166 | 27.3% | 16.3% | 0.17 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -1.559 | 41.2% | 21.6% | 0.31 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 11 | -2.500 | 27.3% | 9.7% | 0.17 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 11 | -3.200 | 45.5% | 21.3% | 0.38 |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 40 | 22 | 18 | -2.772 | 55.0% | 39.8%-69.3% | 0.50 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 81 | 32 | 49 | -1.025 | 39.5% | 29.6%-50.4% | 0.51 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 41 | 19 | 22 | -0.427 | 46.3% | 32.1%-61.3% | 0.80 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `USD_CHF` | 23 | 6 | 17 | -2.504 | 26.1% | 12.5%-46.5% | 0.17 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 57 | 21 | 36 | -1.275 | 36.8% | 25.5%-49.8% | 0.34 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 17 | 7 | 10 | -2.559 | 41.2% | 21.6%-64.0% | 0.19 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 8 | 5 | 3 | -3.112 | 62.5% | 30.6%-86.3% | 0.39 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 39 | 25 | 14 | -2.715 | 64.1% | 48.4%-77.3% | 0.50 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_channel_reversal` | `GBP_USD` | 29 | 18 | 11 | +0.024 | 62.1% | 44.0%-77.3% | 1.01 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 44 | 12 | 32 | -3.166 | 27.3% | 16.3%-41.8% | 0.17 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 11 | 5 | 6 | -3.200 | 45.5% | 21.3%-72.0% | 0.38 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
