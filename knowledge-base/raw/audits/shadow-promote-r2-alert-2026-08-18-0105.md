# SHADOW_PROMOTE R2 Alert - 2026-08-18T01:05:22.899320+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 17 | -2.541 | 17.6% | 6.2% | 0.12 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 36 | -1.244 | 47.2% | 32.0% | 0.66 |
...
| **WARN** | `sr_break_retest` | `GBP_USD` | 18 | -1.644 | 55.6% | 33.7% | 0.51 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 46 | -1.902 | 30.4% | 19.1% | 0.54 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 21 | -1.410 | 23.8% | 10.6% | 0.35 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 19 | -2.974 | 36.8% | 19.1% | 0.32 |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 6 | 2 | 4 | -6.867 | 33.3% | 9.7%-70.0% | 0.34 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 4 | 3 | 1 | +2.775 | 75.0% | 30.1%-95.4% | 2.34 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 14 | 10 | 4 | +0.900 | 71.4% | 45.4%-88.3% | 1.47 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 17 | 3 | 14 | -2.541 | 17.6% | 6.2%-41.0% | 0.12 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 23 | 8 | 15 | -2.609 | 34.8% | 18.8%-55.1% | 0.53 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 29 | 14 | 15 | +0.093 | 48.3% | 31.4%-65.6% | 1.04 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 36 | 17 | 19 | -1.244 | 47.2% | 32.0%-63.0% | 0.66 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_USD` | 18 | 10 | 8 | -1.644 | 55.6% | 33.7%-75.4% | 0.51 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 8 | 5 | 3 | +1.025 | 62.5% | 30.6%-86.3% | 1.66 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 46 | 14 | 32 | -1.902 | 30.4% | 19.1%-44.8% | 0.54 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 21 | 5 | 16 | -1.410 | 23.8% | 10.6%-45.1% | 0.35 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `GBP_USD` | 8 | 1 | 7 | -3.025 | 12.5% | 2.2%-47.1% | 0.08 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 19 | 7 | 12 | -2.974 | 36.8% | 19.1%-59.0% | 0.32 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
