# SHADOW_PROMOTE R2 Alert - 2026-09-20T03:25:51.379181+00:00
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 26 | -3.015 | 42.3% | 25.5% | 0.38 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 51 | -1.427 | 54.9% | 41.4% | 0.69 |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 6 | 5 | 1 | +2.567 | 83.3% | 43.6%-97.0% | 2.39 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 26 | 11 | 15 | -3.015 | 42.3% | 25.5%-61.1% | 0.38 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 51 | 28 | 23 | -1.427 | 54.9% | 41.4%-67.7% | 0.69 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
