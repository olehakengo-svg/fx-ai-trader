# SHADOW_PROMOTE R2 Alert - 2026-09-22T20:53:30.557175+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 15 | -1.660 | 13.3% | 3.7% | 0.16 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 46 | -4.576 | 39.1% | 26.4% | 0.22 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 42 | -0.890 | 54.8% | 39.9% | 0.81 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 29 | -3.814 | 37.9% | 22.7% | 0.24 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 51 | -1.751 | 52.9% | 39.5% | 0.62 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 13 | -1.677 | 61.5% | 35.5% | 0.72 |
...
| WARN | `bb_squeeze_breakout` | `EUR_USD` | 15 | 2 | 13 | -1.660 | 13.3% | 3.7%-37.9% | 0.16 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 46 | 18 | 28 | -4.576 | 39.1% | 26.4%-53.5% | 0.22 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 42 | 23 | 19 | -0.890 | 54.8% | 39.9%-68.8% | 0.81 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 29 | 11 | 18 | -3.814 | 37.9% | 22.7%-56.0% | 0.24 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 51 | 27 | 24 | -1.751 | 52.9% | 39.5%-65.9% | 0.62 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 13 | 8 | 5 | -1.677 | 61.5% | 35.5%-82.3% | 0.72 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
