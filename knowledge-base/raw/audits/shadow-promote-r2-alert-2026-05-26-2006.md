# SHADOW_PROMOTE R2 Alert - 2026-05-26T20:06:47.505676+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 44 | -1.484 | 20.5% | 11.2% | 0.56 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 32 | -0.594 | 25.0% | 13.3% | 0.74 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 16 | -3.775 | 12.5% | 3.5% | 0.24 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 21 | -2.957 | 23.8% | 10.6% | 0.31 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 57 | -3.372 | 24.6% | 15.2% | 0.43 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 57 | -1.647 | 22.8% | 13.8% | 0.65 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 49 | -1.710 | 24.5% | 14.6% | 0.55 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 14 | -1.243 | 0.0% | 0.0% | 0.00 |
| **WARN** | `sr_fib_confluence` | `EUR_GBP` | 26 | -0.815 | 23.1% | 11.0% | 0.71 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 55 | -2.149 | 21.8% | 12.9% | 0.52 |
| **WARN** | `sr_fib_confluence` | `GBP_JPY` | 11 | -16.127 | 0.0% | 0.0% | 0.00 |
...
| OK | `bb_rsi_reversion` | `EUR_USD` | 7 | 2 | 5 | -1.157 | 28.6% | 8.2%-64.1% | 0.47 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `GBP_USD` | 9 | 4 | 5 | +0.033 | 44.4% | 18.9%-73.3% | 1.01 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `bb_rsi_reversion` | `USD_CHF` | 29 | 0 | 29 | -2.534 | 0.0% | 0.0%-11.7% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `USD_JPY` | 11 | 7 | 4 | +2.000 | 63.6% | 35.4%-84.8% | 2.31 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 44 | 9 | 35 | -1.484 | 20.5% | 11.2%-34.5% | 0.56 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_JPY` | 9 | 1 | 8 | -1.822 | 11.1% | 2.0%-43.5% | 0.49 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 21 | 5 | 16 | -2.957 | 23.8% | 10.6%-45.1% | 0.31 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 57 | 14 | 43 | -3.372 | 24.6% | 15.2%-37.1% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 57 | 13 | 44 | -1.647 | 22.8% | 13.8%-35.2% | 0.65 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `EUR_USD` | 2 | 0 | 2 | -2.400 | 0.0% | 0.0%-65.8% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 49 | 12 | 37 | -1.710 | 24.5% | 14.6%-38.1% | 0.55 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 55 | 12 | 43 | -2.149 | 21.8% | 12.9%-34.4% | 0.52 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `GBP_JPY` | 11 | 0 | 11 | -16.127 | 0.0% | 0.0%-25.9% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 84 | 15 | 69 | -3.992 | 17.9% | 11.1%-27.4% | 0.43 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `USD_JPY` | 6 | 0 | 6 | -16.400 | 0.0% | 0.0%-39.0% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
