# SHADOW_PROMOTE R2 Alert - 2026-09-20T10:37:54.039551+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 13 | -2.823 | 30.8% | 12.7% | 0.27 |
...
| **CRITICAL** | `london_breakout` | `EUR_USD` | 34 | -1.035 | 41.2% | 26.4% | 0.43 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 11 | -4.091 | 54.5% | 28.0% | 0.30 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 39 | -0.205 | 56.4% | 41.0% | 0.95 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 24 | -3.596 | 37.5% | 21.2% | 0.32 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -2.882 | 11.8% | 3.3% | 0.03 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 50 | -1.670 | 54.0% | 40.4% | 0.64 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 7 | 7 | 0 | +7.171 | 100.0% | 64.6%-100.0% | n/a | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `AUD_USD` | 9 | 4 | 5 | -5.244 | 44.4% | 18.9%-73.3% | 0.10 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 4 | 0 | 4 | -12.600 | 0.0% | 0.0%-49.0% | 0.00 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 13 | 4 | 9 | -2.823 | 30.8% | 12.7%-57.6% | 0.27 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 34 | 14 | 20 | -1.035 | 41.2% | 26.4%-57.8% | 0.43 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 5 | 4 | 1 | +2.360 | 80.0% | 37.6%-96.4% | 2.06 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 39 | 22 | 17 | -0.205 | 56.4% | 41.0%-70.7% | 0.95 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 24 | 9 | 15 | -3.596 | 37.5% | 21.2%-57.3% | 0.32 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 17 | 2 | 15 | -2.882 | 11.8% | 3.3%-34.3% | 0.03 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 50 | 27 | 23 | -1.670 | 54.0% | 40.4%-67.0% | 0.64 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
