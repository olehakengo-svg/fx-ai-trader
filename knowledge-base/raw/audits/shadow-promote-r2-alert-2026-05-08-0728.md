# SHADOW_PROMOTE R2 Alert - 2026-05-08T07:28:06.557271+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 98 | -0.939 | 20.4% | 13.6% | 0.71 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 225 | -1.552 | 21.3% | 16.5% | 0.58 |
...
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 88 | -1.419 | 21.6% | 14.3% | 0.48 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_JPY` | 39 | -13.054 | 5.1% | 1.4% | 0.18 |
| **WARN** | `sr_fib_confluence` | `EUR_USD` | 29 | -1.748 | 24.1% | 12.2% | 0.61 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_JPY` | 67 | -8.676 | 14.9% | 8.3% | 0.45 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 45 | -0.296 | 28.9% | 17.7% | 0.95 |
| **CRITICAL** | `sr_fib_confluence` | `USD_JPY` | 33 | -5.594 | 15.2% | 6.7% | 0.54 |
| **WARN** | `stoch_trend_pullback` | `USD_JPY` | 20 | -4.190 | 15.0% | 5.2% | 0.34 |
...
| OK | `dt_sr_channel_reversal` | `EUR_JPY` | 13 | 7 | 6 | +9.400 | 53.8% | 29.1%-76.8% | 2.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 98 | 20 | 78 | -0.939 | 20.4% | 13.6%-29.4% | 0.71 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 225 | 48 | 177 | -1.552 | 21.3% | 16.5%-27.1% | 0.58 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `GBP_USD` | 4 | 1 | 3 | -2.350 | 25.0% | 4.6%-69.9% | 0.24 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `GBP_USD` | 12 | 7 | 5 | +5.542 | 58.3% | 32.0%-80.7% | 3.01 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 88 | 19 | 69 | -1.419 | 21.6% | 14.3%-31.3% | 0.48 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_GBP` | 4 | 2 | 2 | +3.250 | 50.0% | 15.0%-85.0% | 2.41 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 67 | 10 | 57 | -8.676 | 14.9% | 8.3%-25.3% | 0.45 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 45 | 13 | 32 | -0.296 | 28.9% | 17.7%-43.4% | 0.95 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `stoch_trend_pullback` | `GBP_USD` | 4 | 0 | 4 | -4.500 | 0.0% | 0.0%-49.0% | 0.00 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `stoch_trend_pullback` | `USD_JPY` | 20 | 3 | 17 | -4.190 | 15.0% | 5.2%-36.0% | 0.34 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
