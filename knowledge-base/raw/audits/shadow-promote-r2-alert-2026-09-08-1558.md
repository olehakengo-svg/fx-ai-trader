# SHADOW_PROMOTE R2 Alert - 2026-09-08T15:58:56.644244+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 15 | -2.133 | 13.3% | 3.7% | 0.24 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 18 | -4.294 | 27.8% | 12.5% | 0.37 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 25 | -0.572 | 44.0% | 26.7% | 0.79 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 24 | -4.275 | 50.0% | 31.4% | 0.29 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 31 | -2.013 | 35.5% | 21.1% | 0.33 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 32 | -1.803 | 50.0% | 33.6% | 0.49 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 61 | -0.767 | 37.7% | 26.6% | 0.60 |
...
| **WARN** | `trend_rebound` | `EUR_USD` | 11 | -0.191 | 36.4% | 15.2% | 0.85 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 15 | 2 | 13 | -2.133 | 13.3% | 3.7%-37.9% | 0.24 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 18 | 5 | 13 | -4.294 | 27.8% | 12.5%-50.9% | 0.37 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 25 | 11 | 14 | -0.572 | 44.0% | 26.7%-62.9% | 0.79 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 24 | 12 | 12 | -4.275 | 50.0% | 31.4%-68.6% | 0.29 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 31 | 11 | 20 | -2.013 | 35.5% | 21.1%-53.1% | 0.33 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 32 | 16 | 16 | -1.803 | 50.0% | 33.6%-66.4% | 0.49 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 61 | 23 | 38 | -0.767 | 37.7% | 26.6%-50.3% | 0.60 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `EUR_USD` | 11 | 4 | 7 | -0.191 | 36.4% | 15.2%-64.6% | 0.85 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 26 | 19 | 7 | +3.004 | 73.1% | 53.9%-86.3% | 2.60 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
