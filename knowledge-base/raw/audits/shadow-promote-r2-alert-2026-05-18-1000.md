# SHADOW_PROMOTE R2 Alert - 2026-05-18T10:00:20.496510+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 62 | -0.919 | 19.4% | 11.4% | 0.72 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 176 | -2.025 | 19.3% | 14.2% | 0.48 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 24 | -1.450 | 16.7% | 6.7% | 0.45 |
...
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 42 | -1.938 | 19.0% | 10.0% | 0.42 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 39 | -1.864 | 17.9% | 9.0% | 0.55 |
| **WARN** | `vol_momentum_scalp` | `USD_JPY` | 11 | -2.864 | 9.1% | 1.6% | 0.19 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 22 | -2.750 | 22.7% | 10.1% | 0.56 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 37 | -0.322 | 35.1% | 21.8% | 0.94 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 36 | -0.981 | 30.6% | 18.0% | 0.87 |
...
| OK | `bb_rsi_reversion` | `USD_JPY` | 61 | 29 | 32 | +0.367 | 47.5% | 35.5%-59.8% | 1.13 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 62 | 12 | 50 | -0.919 | 19.4% | 11.4%-30.9% | 0.72 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 176 | 34 | 142 | -2.025 | 19.3% | 14.2%-25.8% | 0.48 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `EUR_USD` | 24 | 4 | 20 | -1.450 | 16.7% | 6.7%-35.9% | 0.45 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 14 | 2 | 12 | -3.386 | 14.3% | 4.0%-39.9% | 0.29 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `engulfing_bb` | `USD_JPY` | 22 | 6 | 16 | +1.186 | 27.3% | 13.2%-48.2% | 1.41 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 42 | 8 | 34 | -1.938 | 19.0% | 10.0%-33.3% | 0.42 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 39 | 7 | 32 | -1.864 | 17.9% | 9.0%-32.7% | 0.55 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_momentum_scalp` | `USD_JPY` | 11 | 1 | 10 | -2.864 | 9.1% | 1.6%-37.7% | 0.19 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 36 | 11 | 25 | -0.981 | 30.6% | 18.0%-46.9% | 0.87 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
