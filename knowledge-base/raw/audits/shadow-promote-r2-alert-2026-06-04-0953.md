# SHADOW_PROMOTE R2 Alert - 2026-06-04T09:53:48.007064+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `USD_CHF` | 31 | -1.961 | 0.0% | 0.0% | 0.00 |
| **WARN** | `donchian_momentum_breakout` | `AUD_JPY` | 14 | -11.214 | 7.1% | 1.3% | 0.18 |
| **WARN** | `donchian_momentum_breakout` | `USD_CAD` | 10 | -7.560 | 30.0% | 10.8% | 0.28 |
...
| **WARN** | `london_breakout` | `EUR_USD` | 28 | -2.207 | 14.3% | 5.7% | 0.24 |
| **WARN** | `london_breakout` | `GBP_USD` | 15 | -1.987 | 20.0% | 7.0% | 0.37 |
| **WARN** | `london_breakout` | `USD_CHF` | 14 | -2.464 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 41 | -1.422 | 24.4% | 13.8% | 0.34 |
| **WARN** | `ob_retest` | `EUR_USD` | 23 | -3.517 | 4.3% | 0.8% | 0.02 |
| **WARN** | `ob_retest` | `GBP_USD` | 10 | -2.210 | 40.0% | 16.8% | 0.60 |
| **WARN** | `ob_retest` | `USD_JPY` | 11 | -2.373 | 45.5% | 21.3% | 0.21 |
...
| **CRITICAL** | `sr_anti_hunt_bounce` | `USD_JPY` | 37 | -1.897 | 0.0% | 0.0% | 0.00 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 26 | -4.638 | 19.2% | 8.5% | 0.37 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 37 | -7.014 | 16.2% | 7.7% | 0.14 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 67 | -2.297 | 28.4% | 19.0% | 0.52 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 41 | -2.876 | 24.4% | 13.8% | 0.27 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 46 | -0.750 | 30.4% | 19.1% | 0.70 |
| **CRITICAL** | `sr_channel_reversal` | `USD_CHF` | 39 | -1.951 | 5.1% | 1.4% | 0.14 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 78 | -1.013 | 32.1% | 22.7% | 0.72 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 72 | -5.199 | 9.7% | 4.8% | 0.19 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 28 | -16.400 | 10.7% | 3.7% | 0.02 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 23 | -4.848 | 0.0% | 0.0% | 0.00 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 12 | -7.675 | 16.7% | 4.7% | 0.13 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 55 | -6.409 | 16.4% | 8.9% | 0.09 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 43 | -1.053 | 41.9% | 28.4% | 0.78 |
...
| CRITICAL | `bb_rsi_reversion` | `USD_CHF` | 31 | 0 | 31 | -1.961 | 0.0% | 0.0%-11.0% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `EUR_AUD` | 5 | 1 | 4 | -14.100 | 20.0% | 3.6%-62.4% | 0.37 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `donchian_momentum_breakout` | `USD_CAD` | 10 | 3 | 7 | -7.560 | 30.0% | 10.8%-60.3% | 0.28 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 26 | 20 | 6 | +5.404 | 76.9% | 57.9%-89.0% | 5.49 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 4 | 3 | 1 | +8.150 | 75.0% | 30.1%-95.4% | 327.00 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_GBP` | 5 | 2 | 3 | +0.560 | 40.0% | 11.8%-76.9% | 1.25 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 6 | 4 | 2 | +4.800 | 66.7% | 30.0%-90.3% | 2.48 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 28 | 4 | 24 | -2.207 | 14.3% | 5.7%-31.5% | 0.24 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `GBP_USD` | 15 | 3 | 12 | -1.987 | 20.0% | 7.0%-45.2% | 0.37 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 41 | 10 | 31 | -1.422 | 24.4% | 13.8%-39.3% | 0.34 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `USD_JPY` | 11 | 5 | 6 | -2.373 | 45.5% | 21.3%-72.0% | 0.21 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_anti_hunt_bounce` | `USD_JPY` | 37 | 0 | 37 | -1.897 | 0.0% | 0.0%-9.4% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 26 | 5 | 21 | -4.638 | 19.2% | 8.5%-37.9% | 0.37 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 37 | 6 | 31 | -7.014 | 16.2% | 7.7%-31.1% | 0.14 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 67 | 19 | 48 | -2.297 | 28.4% | 19.0%-40.1% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 41 | 10 | 31 | -2.876 | 24.4% | 13.8%-39.3% | 0.27 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 46 | 14 | 32 | -0.750 | 30.4% | 19.1%-44.8% | 0.70 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_CHF` | 39 | 2 | 37 | -1.951 | 5.1% | 1.4%-16.9% | 0.14 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 72 | 7 | 65 | -5.199 | 9.7% | 4.8%-18.7% | 0.19 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 28 | 3 | 25 | -16.400 | 10.7% | 3.7%-27.2% | 0.02 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 23 | 0 | 23 | -4.848 | 0.0% | 0.0%-14.3% | 0.00 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_CHF` | 9 | 0 | 9 | -2.200 | 0.0% | 0.0%-29.9% | 0.00 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 58 | 30 | 28 | +4.459 | 51.7% | 39.2%-64.1% | 4.12 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 55 | 9 | 46 | -6.409 | 16.4% | 8.9%-28.3% | 0.09 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 43 | 18 | 25 | -1.053 | 41.9% | 28.4%-56.7% | 0.78 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
