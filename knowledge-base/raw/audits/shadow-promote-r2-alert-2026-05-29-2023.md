# SHADOW_PROMOTE R2 Alert - 2026-05-29T20:23:19.369398+00:00
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 51 | -1.720 | 19.6% | 11.0% | 0.62 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 38 | -0.834 | 28.9% | 17.0% | 0.76 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 41 | -1.624 | 24.4% | 13.8% | 0.76 |
...
| OK | `donchian_momentum_breakout` | `NZD_JPY` | 13 | 10 | 3 | +22.708 | 76.9% | 49.7%-91.8% | 5.66 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `GBP_USD` | 22 | 11 | 11 | +0.618 | 50.0% | 30.7%-69.3% | 1.11 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 51 | 10 | 41 | -1.720 | 19.6% | 11.0%-32.5% | 0.62 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 38 | 11 | 27 | -0.834 | 28.9% | 17.0%-44.8% | 0.76 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 41 | 10 | 31 | -1.624 | 24.4% | 13.8%-39.3% | 0.76 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
