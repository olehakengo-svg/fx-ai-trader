# SHADOW_PROMOTE R2 Alert - 2026-06-29T19:54:35.526489+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `EUR_USD` | 15 | -0.840 | 40.0% | 19.8% | 0.77 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 11 | -2.745 | 18.2% | 5.1% | 0.07 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 54 | -1.320 | 35.2% | 23.8% | 0.33 |
| **WARN** | `ob_retest` | `GBP_USD` | 10 | -5.260 | 50.0% | 23.7% | 0.16 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 16 | -2.763 | 37.5% | 18.5% | 0.18 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 13 | -0.431 | 69.2% | 42.4% | 0.81 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 37 | -1.403 | 70.3% | 54.2% | 0.60 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 38 | -2.318 | 65.8% | 49.9% | 0.55 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 46 | -1.530 | 56.5% | 42.2% | 0.58 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 23 | -0.222 | 60.9% | 40.8% | 0.91 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 31 | -0.190 | 58.1% | 40.8% | 0.90 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 14 | -1.929 | 57.1% | 32.6% | 0.35 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 15 | -1.573 | 46.7% | 24.8% | 0.34 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 14 | -5.464 | 50.0% | 26.8% | 0.27 |
| **WARN** | `xs_momentum` | `EUR_USD` | 27 | -2.285 | 51.9% | 34.0% | 0.47 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 32 | -3.394 | 62.5% | 45.3% | 0.32 |
...
| WARN | `dt_bb_rsi_mr` | `EUR_USD` | 15 | 6 | 9 | -0.840 | 40.0% | 19.8%-64.3% | 0.77 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 11 | 2 | 9 | -2.745 | 18.2% | 5.1%-47.7% | 0.07 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 54 | 19 | 35 | -1.320 | 35.2% | 23.8%-48.5% | 0.33 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 16 | 6 | 10 | -2.763 | 37.5% | 18.5%-61.4% | 0.18 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 37 | 26 | 11 | -1.403 | 70.3% | 54.2%-82.5% | 0.60 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 38 | 25 | 13 | -2.318 | 65.8% | 49.9%-78.8% | 0.55 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 46 | 26 | 20 | -1.530 | 56.5% | 42.2%-69.8% | 0.58 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 23 | 14 | 9 | -0.222 | 60.9% | 40.8%-77.8% | 0.91 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 31 | 18 | 13 | -0.190 | 58.1% | 40.8%-73.6% | 0.90 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_CHF` | 11 | 3 | 8 | +0.264 | 27.3% | 9.7%-56.6% | 1.17 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 14 | 8 | 6 | -1.929 | 57.1% | 32.6%-78.6% | 0.35 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 15 | 7 | 8 | -1.573 | 46.7% | 24.8%-69.9% | 0.34 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 14 | 7 | 7 | -5.464 | 50.0% | 26.8%-73.2% | 0.27 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 32 | 20 | 12 | -3.394 | 62.5% | 45.3%-77.1% | 0.32 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
