# SHADOW_PROMOTE R2 Alert - 2026-07-17T19:04:14.174754+00:00
...
| **WARN** | `sr_break_retest` | `AUD_JPY` | 15 | -2.453 | 53.3% | 30.1% | 0.34 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 36 | -2.953 | 55.6% | 39.6% | 0.27 |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 15 | 14 | 1 | +2.487 | 93.3% | 70.2%-98.8% | 7.43 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 15 | 8 | 7 | -2.453 | 53.3% | 30.1%-75.2% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 36 | 20 | 16 | -2.953 | 55.6% | 39.6%-70.5% | 0.27 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
