# SHADOW_PROMOTE R2 Alert - 2026-06-22T20:45:04.261090+00:00
...
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 19 | -2.995 | 5.3% | 0.9% | 0.03 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 70 | -0.914 | 37.1% | 26.8% | 0.55 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 37 | -2.216 | 35.1% | 21.8% | 0.27 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 32 | -2.841 | 43.8% | 28.2% | 0.34 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 16 | -0.975 | 50.0% | 28.0% | 0.39 |
...
| WARN | `ema_trend_scalp` | `USD_CHF` | 19 | 1 | 18 | -2.995 | 5.3% | 0.9%-24.6% | 0.03 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 70 | 26 | 44 | -0.914 | 37.1% | 26.8%-48.9% | 0.55 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 37 | 13 | 24 | -2.216 | 35.1% | 21.8%-51.2% | 0.27 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 32 | 14 | 18 | -2.841 | 43.8% | 28.2%-60.7% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 16 | 8 | 8 | -0.975 | 50.0% | 28.0%-72.0% | 0.39 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
