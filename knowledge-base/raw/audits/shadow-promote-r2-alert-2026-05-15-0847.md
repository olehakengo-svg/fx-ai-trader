# SHADOW_PROMOTE R2 Alert - 2026-05-15T08:47:22.747466+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `EUR_USD` | 34 | -0.200 | 38.2% | 23.9% | 0.89 |
| **CRITICAL** | `bb_rsi_reversion` | `GBP_USD` | 31 | -2.294 | 19.4% | 9.2% | 0.33 |
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 18 | -7.178 | 11.1% | 3.1% | 0.12 |
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 52 | -1.113 | 17.3% | 9.4% | 0.57 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 63 | -0.984 | 19.0% | 11.2% | 0.70 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 187 | -2.078 | 18.7% | 13.8% | 0.48 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 13 | -1.538 | 23.1% | 8.2% | 0.39 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 13 | -1.015 | 0.0% | 0.0% | 0.00 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 21 | -7.162 | 9.5% | 2.7% | 0.35 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 31 | -1.113 | 38.7% | 23.7% | 0.82 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 21 | -2.062 | 14.3% | 5.0% | 0.38 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 38 | -2.418 | 21.1% | 11.1% | 0.44 |
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 44 | -1.925 | 20.5% | 11.2% | 0.43 |
| **WARN** | `sr_fib_confluence` | `EUR_GBP` | 19 | -0.263 | 21.1% | 8.5% | 0.90 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_JPY` | 34 | -13.776 | 5.9% | 1.6% | 0.19 |
| **WARN** | `sr_fib_confluence` | `EUR_USD` | 29 | -0.103 | 27.6% | 14.7% | 0.97 |
...
| **WARN** | `stoch_trend_pullback` | `USD_JPY` | 11 | -5.355 | 18.2% | 5.1% | 0.36 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 36 | -2.153 | 13.9% | 6.1% | 0.48 |
...
| CRITICAL | `bb_rsi_reversion` | `EUR_USD` | 34 | 13 | 21 | -0.200 | 38.2% | 23.9%-55.0% | 0.89 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `EUR_JPY` | 18 | 7 | 11 | +4.300 | 38.9% | 20.3%-61.4% | 1.58 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 52 | 9 | 43 | -1.113 | 17.3% | 9.4%-29.7% | 0.57 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 63 | 12 | 51 | -0.984 | 19.0% | 11.2%-30.4% | 0.70 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 187 | 35 | 152 | -2.078 | 18.7% | 13.8%-24.9% | 0.48 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_JPY` | 26 | 6 | 20 | +0.069 | 23.1% | 11.0%-42.1% | 1.02 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `gold_pips_hunter` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `GOLD_PIPS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `gold_trend_momentum` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `GOLD_TREND_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `gold_vol_break` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `GOLD_VOL_BREAK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `htf_false_breakout` | `EUR_JPY` | 6 | 1 | 5 | -15.550 | 16.7% | 3.0%-56.4% | 0.01 | `HTF_FALSE_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 13 | 3 | 10 | -1.538 | 23.1% | 8.2%-50.3% | 0.39 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `GBP_USD` | 12 | 7 | 5 | +2.692 | 58.3% | 32.0%-80.7% | 1.47 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `post_news_vol` | `EUR_USD` | 4 | 0 | 4 | -17.575 | 0.0% | 0.0%-49.0% | 0.00 | `POST_NEWS_VOL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `EUR_JPY` | 15 | 5 | 10 | +0.173 | 33.3% | 15.2%-58.3% | 1.02 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 21 | 2 | 19 | -7.162 | 9.5% | 2.7%-28.9% | 0.35 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_channel_reversal` | `EUR_USD` | 21 | 3 | 18 | -2.062 | 14.3% | 5.0%-34.6% | 0.38 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 38 | 8 | 30 | -2.418 | 21.1% | 11.1%-36.3% | 0.44 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 44 | 9 | 35 | -1.925 | 20.5% | 11.2%-34.5% | 0.43 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_fib_confluence` | `EUR_USD` | 29 | 8 | 21 | -0.103 | 27.6% | 14.7%-45.7% | 0.97 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `stoch_trend_pullback` | `EUR_USD` | 5 | 0 | 5 | -3.360 | 0.0% | 0.0%-43.4% | 0.00 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `stoch_trend_pullback` | `GBP_USD` | 2 | 0 | 2 | -3.900 | 0.0% | 0.0%-65.8% | 0.00 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `stoch_trend_pullback` | `USD_JPY` | 11 | 2 | 9 | -5.355 | 18.2% | 5.1%-47.7% | 0.36 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 36 | 5 | 31 | -2.153 | 13.9% | 6.1%-28.7% | 0.48 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `xs_momentum` | `EUR_USD` | 36 | 13 | 23 | +0.236 | 36.1% | 22.5%-52.4% | 1.04 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 43 | 15 | 28 | +1.765 | 34.9% | 22.4%-49.8% | 1.26 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 17 | 9 | 8 | +2.776 | 52.9% | 31.0%-73.8% | 1.47 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
