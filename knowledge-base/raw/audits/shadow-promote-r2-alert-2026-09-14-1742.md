# SHADOW_PROMOTE R2 Alert - 2026-09-14T17:42:07.262779+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 13 | -0.585 | 46.2% | 23.2% | 0.87 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | -4.140 | 40.0% | 23.4% | 0.29 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 28 | -4.214 | 53.6% | 35.8% | 0.30 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 26 | -1.577 | 42.3% | 25.5% | 0.43 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 29 | -0.379 | 62.1% | 44.0% | 0.87 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 10 | -0.280 | 50.0% | 23.7% | 0.89 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 48 | -1.048 | 39.6% | 27.0% | 0.50 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 15 | -3.340 | 46.7% | 24.8% | 0.45 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 42 | -0.124 | 57.1% | 42.2% | 0.97 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 39 | -1.126 | 51.3% | 36.2% | 0.73 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 24 | -1.058 | 45.8% | 27.9% | 0.55 |
| **WARN** | `trend_rebound` | `EUR_USD` | 15 | -0.393 | 33.3% | 15.2% | 0.74 |
| **WARN** | `trend_rebound` | `USD_JPY` | 11 | -1.900 | 27.3% | 9.7% | 0.25 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 26 | -3.081 | 53.8% | 35.5% | 0.27 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 23 | -1.613 | 13.0% | 4.5% | 0.27 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 49 | -0.678 | 61.2% | 47.2% | 0.82 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 16 | -2.775 | 50.0% | 28.0% | 0.54 |
| **WARN** | `wick_imbalance_reversion` | `EUR_USD` | 10 | -4.040 | 30.0% | 10.8% | 0.32 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 18 | -1.367 | 66.7% | 43.7% | 0.74 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 22 | -3.200 | 31.8% | 16.4% | 0.19 |
...
| OK | `bb_squeeze_breakout` | `EUR_USD` | 3 | 0 | 3 | -3.000 | 0.0% | 0.0%-56.2% | 0.00 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_squeeze_breakout` | `GBP_USD` | 2 | 0 | 2 | -4.400 | 0.0% | 0.0%-65.8% | 0.00 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 8 | 6 | 2 | -3.012 | 75.0% | 40.9%-92.9% | 0.49 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 13 | 6 | 7 | -0.585 | 46.2% | 23.2%-70.9% | 0.87 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_GBP` | 9 | 1 | 8 | -2.778 | 11.1% | 2.0%-43.5% | 0.25 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | 10 | 15 | -4.140 | 40.0% | 23.4%-59.3% | 0.29 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 14 | 7 | 7 | +0.064 | 50.0% | 26.8%-73.2% | 1.02 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 28 | 15 | 13 | -4.214 | 53.6% | 35.8%-70.5% | 0.30 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 26 | 11 | 15 | -1.577 | 42.3% | 25.5%-61.1% | 0.43 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 29 | 18 | 11 | -0.379 | 62.1% | 44.0%-77.3% | 0.87 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `mtf_counter_trend_scalp` | `EUR_USD` | 7 | 1 | 6 | -1.886 | 14.3% | 2.6%-51.3% | 0.06 | `MTF_COUNTER_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 15 | 7 | 8 | -3.340 | 46.7% | 24.8%-69.9% | 0.45 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 7 | 4 | 3 | -7.057 | 57.1% | 25.0%-84.2% | 0.06 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 6 | 4 | 2 | -2.033 | 66.7% | 30.0%-90.3% | 0.61 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 5 | 1 | 4 | -1.200 | 20.0% | 3.6%-62.4% | 0.69 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 2 | 2 | 0 | +4.350 | 100.0% | 34.2%-100.0% | n/a | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 42 | 24 | 18 | -0.124 | 57.1% | 42.2%-70.9% | 0.97 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 39 | 20 | 19 | -1.126 | 51.3% | 36.2%-66.1% | 0.73 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 24 | 11 | 13 | -1.058 | 45.8% | 27.9%-64.9% | 0.55 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 11 | 3 | 8 | -1.900 | 27.3% | 9.7%-56.6% | 0.25 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_GBP` | 8 | 1 | 7 | -4.500 | 12.5% | 2.2%-47.1% | 0.04 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_USD` | 7 | 4 | 3 | +1.171 | 57.1% | 25.0%-84.2% | 1.26 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 26 | 14 | 12 | -3.081 | 53.8% | 35.5%-71.2% | 0.27 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `GBP_USD` | 9 | 4 | 5 | -0.522 | 44.4% | 18.9%-73.3% | 0.74 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 49 | 30 | 19 | -0.678 | 61.2% | 47.2%-73.6% | 0.82 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_USD` | 10 | 3 | 7 | -4.040 | 30.0% | 10.8%-60.3% | 0.32 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 22 | 7 | 15 | -3.200 | 31.8% | 16.4%-52.7% | 0.19 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
