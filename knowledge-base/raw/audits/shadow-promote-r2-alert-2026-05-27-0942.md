# SHADOW_PROMOTE R2 Alert - 2026-05-27T09:42:30.873259+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 35 | -2.383 | 0.0% | 0.0% | 0.00 |
| **WARN** | `ema_trend_scalp` | `USD_JPY` | 24 | -0.154 | 25.0% | 12.0% | 0.94 |
...
| **CRITICAL** | `london_breakout` | `GBP_USD` | 36 | -3.394 | 8.3% | 2.9% | 0.17 |
| **WARN** | `london_breakout` | `USD_CHF` | 11 | -2.673 | 0.0% | 0.0% | 0.00 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 30 | -1.790 | 26.7% | 14.2% | 0.72 |
...
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 15 | -1.167 | 0.0% | 0.0% | 0.00 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_USD` | 29 | -0.555 | 27.6% | 14.7% | 0.80 |
...
| OK | `bb_rsi_reversion` | `USD_JPY` | 8 | 5 | 3 | +1.087 | 62.5% | 30.6%-86.3% | 1.56 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `EUR_AUD` | 7 | 4 | 3 | +16.643 | 57.1% | 25.0%-84.2% | 2.33 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 24 | 13 | 11 | +2.300 | 54.2% | 35.1%-72.1% | 1.86 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema_trend_scalp` | `GBP_USD` | 4 | 0 | 4 | -3.925 | 0.0% | 0.0%-49.0% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 35 | 0 | 35 | -2.383 | 0.0% | 0.0%-9.9% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `ema_trend_scalp` | `USD_JPY` | 24 | 6 | 18 | -0.154 | 25.0% | 12.0%-44.9% | 0.94 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_JPY` | 7 | 1 | 6 | -1.143 | 14.3% | 2.6%-51.3% | 0.66 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `GBP_USD` | 36 | 3 | 33 | -3.394 | 8.3% | 2.9%-21.8% | 0.17 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 11 | 0 | 11 | -2.673 | 0.0% | 0.0%-25.9% | 0.00 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 17 | 13 | 4 | +17.535 | 76.5% | 52.7%-90.4% | 18.13 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 30 | 8 | 22 | -1.790 | 26.7% | 14.2%-44.4% | 0.72 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_channel_reversal` | `USD_CHF` | 15 | 0 | 15 | -1.167 | 0.0% | 0.0%-20.4% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_JPY` | 6 | 2 | 4 | +0.533 | 33.3% | 9.7%-70.0% | 1.20 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `USD_JPY` | 4 | 0 | 4 | -14.450 | 0.0% | 0.0%-49.0% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_USD` | 29 | 8 | 21 | -0.555 | 27.6% | 14.7%-45.7% | 0.80 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
