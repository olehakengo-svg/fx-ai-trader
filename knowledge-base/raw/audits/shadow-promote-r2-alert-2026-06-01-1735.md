# SHADOW_PROMOTE R2 Alert - 2026-06-01T17:35:38.048185+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 35 | -0.754 | 25.7% | 14.2% | 0.67 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 12 | -2.300 | 16.7% | 4.7% | 0.39 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 73 | -2.564 | 26.0% | 17.3% | 0.52 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 45 | -1.780 | 17.8% | 9.3% | 0.60 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 36 | -0.567 | 27.8% | 15.8% | 0.80 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 27 | -1.626 | 3.7% | 0.7% | 0.20 |
| **WARN** | `sr_fib_confluence` | `EUR_GBP` | 12 | -4.275 | 16.7% | 4.7% | 0.11 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 83 | -0.984 | 26.5% | 18.2% | 0.75 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 96 | -4.400 | 14.6% | 8.9% | 0.35 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 21 | -0.533 | 23.8% | 10.6% | 0.88 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 23 | -17.535 | 4.3% | 0.8% | 0.01 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 33 | -1.952 | 18.2% | 8.6% | 0.53 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 15 | -3.567 | 20.0% | 7.0% | 0.49 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 52 | -4.987 | 21.2% | 12.2% | 0.32 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 43 | -0.512 | 27.9% | 16.7% | 0.92 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 44 | -1.957 | 22.7% | 12.8% | 0.64 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 35 | 9 | 26 | -0.754 | 25.7% | 14.2%-42.1% | 0.67 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 12 | 2 | 10 | -2.300 | 16.7% | 4.7%-44.8% | 0.39 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 73 | 19 | 54 | -2.564 | 26.0% | 17.3%-37.1% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 45 | 8 | 37 | -1.780 | 17.8% | 9.3%-31.3% | 0.60 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 36 | 10 | 26 | -0.567 | 27.8% | 15.8%-44.0% | 0.80 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `USD_CHF` | 27 | 1 | 26 | -1.626 | 3.7% | 0.7%-18.3% | 0.20 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `EUR_GBP` | 12 | 2 | 10 | -4.275 | 16.7% | 4.7%-44.8% | 0.11 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 83 | 22 | 61 | -0.984 | 26.5% | 18.2%-36.9% | 0.75 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 96 | 14 | 82 | -4.400 | 14.6% | 8.9%-23.0% | 0.35 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 33 | 6 | 27 | -1.952 | 18.2% | 8.6%-34.4% | 0.53 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 7 | 2 | 5 | -0.600 | 28.6% | 8.2%-64.1% | 0.77 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 7 | 1 | 6 | -4.900 | 14.3% | 2.6%-51.3% | 0.01 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `EUR_USD` | 52 | 11 | 41 | -4.987 | 21.2% | 12.2%-34.0% | 0.32 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 43 | 12 | 31 | -0.512 | 27.9% | 16.7%-42.7% | 0.92 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 44 | 10 | 34 | -1.957 | 22.7% | 12.8%-37.0% | 0.64 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
