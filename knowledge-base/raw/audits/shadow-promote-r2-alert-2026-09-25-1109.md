# SHADOW_PROMOTE R2 Alert - 2026-09-25T11:09:07.080131+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 20 | -1.685 | 15.0% | 5.2% | 0.14 |
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 15 | -1.447 | 40.0% | 19.8% | 0.54 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 48 | -4.502 | 39.6% | 27.0% | 0.24 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 27 | -1.596 | 37.0% | 21.5% | 0.45 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 42 | -3.212 | 54.8% | 39.9% | 0.31 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 38 | -0.837 | 44.7% | 30.1% | 0.54 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 13 | -2.454 | 53.8% | 29.1% | 0.51 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 46 | -1.017 | 54.3% | 40.2% | 0.79 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 55 | -2.555 | 49.1% | 36.4% | 0.51 |
...
| WARN | `bb_squeeze_breakout` | `EUR_USD` | 20 | 3 | 17 | -1.685 | 15.0% | 5.2%-36.0% | 0.14 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 15 | 6 | 9 | -1.447 | 40.0% | 19.8%-64.3% | 0.54 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 48 | 19 | 29 | -4.502 | 39.6% | 27.0%-53.7% | 0.24 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 27 | 10 | 17 | -1.596 | 37.0% | 21.5%-55.8% | 0.45 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 42 | 23 | 19 | -3.212 | 54.8% | 39.9%-68.8% | 0.31 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 46 | 25 | 21 | -1.017 | 54.3% | 40.2%-67.8% | 0.79 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 55 | 27 | 28 | -2.555 | 49.1% | 36.4%-61.9% | 0.51 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
