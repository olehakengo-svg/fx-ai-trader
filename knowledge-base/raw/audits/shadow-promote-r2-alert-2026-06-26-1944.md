# SHADOW_PROMOTE R2 Alert - 2026-06-26T19:44:11.416190+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 86 | -1.007 | 39.5% | 29.9% | 0.51 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 43 | -2.540 | 48.8% | 34.6% | 0.41 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 41 | -0.661 | 51.2% | 36.5% | 0.73 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 31 | -4.455 | 54.8% | 37.8% | 0.26 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 86 | 34 | 52 | -1.007 | 39.5% | 29.9%-50.1% | 0.51 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 43 | 21 | 22 | -2.540 | 48.8% | 34.6%-63.2% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `USD_JPY` | 19 | 12 | 7 | +0.058 | 63.2% | 41.0%-80.9% | 1.02 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 41 | 21 | 20 | -0.661 | 51.2% | 36.5%-65.7% | 0.73 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 31 | 17 | 14 | -4.455 | 54.8% | 37.8%-70.8% | 0.26 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
