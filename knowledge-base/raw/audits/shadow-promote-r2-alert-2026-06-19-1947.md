# SHADOW_PROMOTE R2 Alert - 2026-06-19T19:47:42.502698+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 58 | -0.840 | 39.7% | 28.1% | 0.58 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -2.361 | 32.3% | 18.6% | 0.24 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 11 | -4.591 | 36.4% | 15.2% | 0.12 |
| **WARN** | `london_breakout` | `USD_CHF` | 16 | -1.869 | 43.8% | 23.1% | 0.31 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 46 | -0.961 | 34.8% | 22.7% | 0.41 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 16 | -2.600 | 37.5% | 18.5% | 0.28 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 34 | -1.482 | 67.6% | 50.8% | 0.54 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 41 | -2.102 | 68.3% | 53.0% | 0.56 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 32 | -2.894 | 43.8% | 28.2% | 0.34 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 17 | -0.312 | 64.7% | 41.3% | 0.87 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 78 | -0.442 | 51.3% | 40.4% | 0.80 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 23 | -0.248 | 30.4% | 15.6% | 0.84 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 15 | -1.953 | 60.0% | 35.7% | 0.36 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 39 | -2.126 | 33.3% | 20.6% | 0.31 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 30 | -1.730 | 53.3% | 36.1% | 0.62 |
| **WARN** | `xs_momentum` | `GBP_USD` | 29 | -1.338 | 65.5% | 47.3% | 0.63 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 9 | 3 | 6 | -2.956 | 33.3% | 12.1%-64.6% | 0.30 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 21 | 14 | 7 | +1.181 | 66.7% | 45.4%-82.8% | 1.52 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 9 | 4 | 5 | -0.678 | 44.4% | 18.9%-73.3% | 0.73 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 58 | 23 | 35 | -0.840 | 39.7% | 28.1%-52.5% | 0.58 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 10 | 21 | -2.361 | 32.3% | 18.6%-49.9% | 0.24 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `EUR_USD` | 41 | 22 | 19 | +0.934 | 53.7% | 38.7%-67.9% | 1.61 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `london_breakout` | `GBP_USD` | 30 | 20 | 10 | +1.623 | 66.7% | 48.8%-80.8% | 2.03 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 16 | 7 | 9 | -1.869 | 43.8% | 23.1%-66.8% | 0.31 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 46 | 16 | 30 | -0.961 | 34.8% | 22.7%-49.2% | 0.41 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `pullback_to_liquidity_v1` | `EUR_USD` | 1 | 0 | 1 | -7.500 | 0.0% | 0.0%-79.3% | 0.00 | `PULLBACK_TO_LIQUIDITY_V1_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 2 | 0 | 2 | -28.150 | 0.0% | 0.0%-65.8% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 3 | 3 | 0 | +1.433 | 100.0% | 43.8%-100.0% | n/a | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 34 | 23 | 11 | -1.482 | 67.6% | 50.8%-80.9% | 0.54 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 41 | 28 | 13 | -2.102 | 68.3% | 53.0%-80.4% | 0.56 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 32 | 14 | 18 | -2.894 | 43.8% | 28.2%-60.7% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 17 | 11 | 6 | -0.312 | 64.7% | 41.3%-82.7% | 0.87 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 78 | 40 | 38 | -0.442 | 51.3% | 40.4%-62.1% | 0.80 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_USD` | 7 | 5 | 2 | +1.529 | 71.4% | 35.9%-91.8% | 1.55 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `GBP_USD` | 8 | 4 | 4 | -6.037 | 50.0% | 21.5%-78.5% | 0.12 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 39 | 13 | 26 | -2.126 | 33.3% | 20.6%-49.0% | 0.31 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 7 | 5 | 2 | -0.014 | 71.4% | 35.9%-91.8% | 0.98 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vwap_mean_reversion` | `GBP_JPY` | 2 | 2 | 0 | +11.700 | 100.0% | 34.2%-100.0% | n/a | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 9 | 5 | 4 | +0.178 | 55.6% | 26.7%-81.1% | 1.11 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 30 | 16 | 14 | -1.730 | 53.3% | 36.1%-69.8% | 0.62 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `GBP_USD` | 29 | 19 | 10 | -1.338 | 65.5% | 47.3%-80.1% | 0.63 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
