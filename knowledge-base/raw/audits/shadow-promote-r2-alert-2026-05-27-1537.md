# SHADOW_PROMOTE R2 Alert - 2026-05-27T15:37:37.749642+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 34 | -0.300 | 26.5% | 14.6% | 0.86 |
...
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 47 | -1.668 | 25.5% | 15.3% | 0.56 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 78 | -3.635 | 19.2% | 12.0% | 0.47 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 42 | -0.631 | 31.0% | 19.1% | 0.90 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 37 | -1.024 | 32.4% | 19.6% | 0.82 |
...
| OK | `bb_rsi_reversion` | `USD_JPY` | 7 | 5 | 2 | +2.457 | 71.4% | 35.9%-91.8% | 3.49 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_JPY` | 6 | 4 | 2 | +17.583 | 66.7% | 30.0%-90.3% | 3.59 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 29 | 18 | 11 | +3.728 | 62.1% | 44.0%-77.3% | 2.69 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema_trend_scalp` | `USD_JPY` | 18 | 6 | 12 | +0.711 | 33.3% | 16.3%-56.3% | 1.30 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 34 | 9 | 25 | -0.300 | 26.5% | 14.6%-43.1% | 0.86 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 47 | 12 | 35 | -1.668 | 25.5% | 15.3%-39.5% | 0.56 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 78 | 15 | 63 | -3.635 | 19.2% | 12.0%-29.3% | 0.47 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 42 | 13 | 29 | -0.631 | 31.0% | 19.1%-46.0% | 0.90 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 37 | 12 | 25 | -1.024 | 32.4% | 19.6%-48.5% | 0.82 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
