# SHADOW_PROMOTE R2 Alert - 2026-08-26T06:43:19.900879+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 39 | -1.810 | 23.1% | 12.6% | 0.20 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 16 | -1.075 | 25.0% | 10.2% | 0.65 |
...
| **WARN** | `trendline_sweep` | `GBP_USD` | 22 | -4.768 | 50.0% | 30.7% | 0.12 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 16 | -3.881 | 43.8% | 23.1% | 0.31 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 39 | -0.162 | 51.3% | 36.2% | 0.95 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 14 | -2.964 | 50.0% | 26.8% | 0.36 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 39 | 9 | 30 | -1.810 | 23.1% | 12.6%-38.3% | 0.20 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 16 | 4 | 12 | -1.075 | 25.0% | 10.2%-49.5% | 0.65 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 22 | 11 | 11 | -4.768 | 50.0% | 30.7%-69.3% | 0.12 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 16 | 7 | 9 | -3.881 | 43.8% | 23.1%-66.8% | 0.31 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 39 | 20 | 19 | -0.162 | 51.3% | 36.2%-66.1% | 0.95 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 14 | 7 | 7 | -2.964 | 50.0% | 26.8%-73.2% | 0.36 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
