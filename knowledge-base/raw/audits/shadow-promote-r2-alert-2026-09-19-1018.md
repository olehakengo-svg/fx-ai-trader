# SHADOW_PROMOTE R2 Alert - 2026-09-19T10:18:47.932215+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 11 | -1.773 | 27.3% | 9.7% | 0.36 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 37 | -2.430 | 56.8% | 40.9% | 0.41 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 40 | -1.268 | 40.0% | 26.3% | 0.36 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 12 | -3.592 | 58.3% | 32.0% | 0.33 |
...
| **WARN** | `three_bar_reversal` | `USD_JPY` | 25 | -0.216 | 40.0% | 23.4% | 0.91 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 13 | -3.308 | 53.8% | 29.1% | 0.55 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 7 | 2 | 5 | -7.214 | 28.6% | 8.2%-64.1% | 0.20 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 11 | 3 | 8 | -1.773 | 27.3% | 9.7%-56.6% | 0.36 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 37 | 21 | 16 | -2.430 | 56.8% | 40.9%-71.3% | 0.41 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 40 | 16 | 24 | -1.268 | 40.0% | 26.3%-55.4% | 0.36 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 12 | 7 | 5 | -3.592 | 58.3% | 32.0%-80.7% | 0.33 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 25 | 10 | 15 | -0.216 | 40.0% | 23.4%-59.3% | 0.91 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 13 | 7 | 6 | -3.308 | 53.8% | 29.1%-76.8% | 0.55 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
