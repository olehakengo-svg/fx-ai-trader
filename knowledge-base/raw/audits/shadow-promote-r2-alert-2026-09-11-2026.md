# SHADOW_PROMOTE R2 Alert - 2026-09-11T20:26:22.498045+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 30 | -1.633 | 40.0% | 24.6% | 0.40 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 31 | -0.555 | 61.3% | 43.8% | 0.81 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 45 | -1.160 | 51.1% | 37.0% | 0.70 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 24 | -0.592 | 45.8% | 27.9% | 0.69 |
...
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 18 | 10 | 8 | +0.517 | 55.6% | 33.7%-75.4% | 1.22 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 26 | 15 | 11 | -3.527 | 57.7% | 38.9%-74.5% | 0.36 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 30 | 12 | 18 | -1.633 | 40.0% | 24.6%-57.7% | 0.40 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 31 | 19 | 12 | -0.555 | 61.3% | 43.8%-76.3% | 0.81 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 45 | 23 | 22 | -1.160 | 51.1% | 37.0%-65.0% | 0.70 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 24 | 11 | 13 | -0.592 | 45.8% | 27.9%-64.9% | 0.69 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
