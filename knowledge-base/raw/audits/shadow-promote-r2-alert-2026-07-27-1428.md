# SHADOW_PROMOTE R2 Alert - 2026-07-27T14:28:31.625792+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 16 | -2.425 | 56.2% | 33.2% | 0.39 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 21 | -1.143 | 47.6% | 28.3% | 0.48 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | -1.590 | 61.9% | 40.9% | 0.55 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 87 | -1.015 | 37.9% | 28.5% | 0.48 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 58 | -1.107 | 36.2% | 25.1% | 0.46 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 79 | -1.014 | 43.0% | 32.7% | 0.54 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 22 | -1.568 | 27.3% | 13.2% | 0.28 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 36 | -2.369 | 52.8% | 37.0% | 0.36 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 16 | 9 | 7 | -2.425 | 56.2% | 33.2%-76.9% | 0.39 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 21 | 10 | 11 | -1.143 | 47.6% | 28.3%-67.6% | 0.48 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | 13 | 8 | -1.590 | 61.9% | 40.9%-79.2% | 0.55 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 87 | 33 | 54 | -1.015 | 37.9% | 28.5%-48.4% | 0.48 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 58 | 21 | 37 | -1.107 | 36.2% | 25.1%-49.1% | 0.46 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_USD` | 14 | 7 | 7 | -2.786 | 50.0% | 26.8%-73.2% | 0.24 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_JPY` | 29 | 18 | 11 | -4.914 | 62.1% | 44.0%-77.3% | 0.27 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 36 | 18 | 18 | -2.053 | 50.0% | 34.5%-65.5% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 27 | 13 | 14 | -2.796 | 48.1% | 30.7%-66.0% | 0.33 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 16 | 5 | 11 | -1.250 | 31.2% | 14.2%-55.6% | 0.31 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 79 | 34 | 45 | -1.014 | 43.0% | 32.7%-54.0% | 0.54 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 22 | 6 | 16 | -1.568 | 27.3% | 13.2%-48.2% | 0.28 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 36 | 19 | 17 | -2.369 | 52.8% | 37.0%-68.0% | 0.36 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 46 | 32 | 14 | +0.967 | 69.6% | 55.2%-80.9% | 1.29 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
