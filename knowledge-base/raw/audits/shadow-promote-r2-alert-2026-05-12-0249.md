# SHADOW_PROMOTE R2 Alert - 2026-05-12T02:49:27.622903+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `EUR_USD` | 39 | -0.203 | 38.5% | 24.9% | 0.90 |
| **CRITICAL** | `bb_rsi_reversion` | `GBP_USD` | 43 | -2.221 | 18.6% | 9.7% | 0.38 |
| **CRITICAL** | `bb_rsi_reversion` | `USD_JPY` | 86 | -0.113 | 41.9% | 32.0% | 0.96 |
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 12 | -0.192 | 8.3% | 1.5% | 0.93 |
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 71 | -0.869 | 19.7% | 12.1% | 0.66 |
...
| **WARN** | `engulfing_bb` | `GBP_USD` | 11 | -5.100 | 9.1% | 1.6% | 0.04 |
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 15 | -0.273 | 46.7% | 24.8% | 0.94 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 28 | -2.443 | 14.3% | 5.7% | 0.32 |
| **WARN** | `sr_channel_reversal` | `GBP_USD` | 26 | -2.315 | 19.2% | 8.5% | 0.43 |
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 61 | -1.677 | 21.3% | 12.9% | 0.47 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 30 | -2.203 | 13.3% | 5.3% | 0.47 |
...
| CRITICAL | `bb_rsi_reversion` | `EUR_USD` | 39 | 15 | 24 | -0.203 | 38.5% | 24.9%-54.1% | 0.90 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `GBP_USD` | 43 | 8 | 35 | -2.221 | 18.6% | 9.7%-32.6% | 0.38 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 71 | 14 | 57 | -0.869 | 19.7% | 12.1%-30.4% | 0.66 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `GBP_USD` | 11 | 1 | 10 | -5.100 | 9.1% | 1.6%-37.7% | 0.04 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 15 | 7 | 8 | -0.273 | 46.7% | 24.8%-69.9% | 0.94 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `EUR_USD` | 28 | 4 | 24 | -2.443 | 14.3% | 5.7%-31.5% | 0.32 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `GBP_USD` | 26 | 5 | 21 | -2.315 | 19.2% | 8.5%-37.9% | 0.43 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 61 | 13 | 48 | -1.677 | 21.3% | 12.9%-33.1% | 0.47 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 30 | 4 | 26 | -2.203 | 13.3% | 5.3%-29.7% | 0.47 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 9 | 1 | 8 | -1.033 | 11.1% | 2.0%-43.5% | 0.81 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 2 | 0 | 2 | -20.450 | 0.0% | 0.0%-65.8% | 0.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
