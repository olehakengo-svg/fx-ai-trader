# SHADOW_PROMOTE R2 Alert - 2026-07-13T19:20:40.835221+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 32 | -1.447 | 56.2% | 39.3% | 0.51 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 21 | -1.043 | 42.9% | 24.5% | 0.73 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 89 | -0.422 | 46.1% | 36.1% | 0.75 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 33 | -1.176 | 45.5% | 29.8% | 0.50 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 13 | -2.415 | 46.2% | 23.2% | 0.41 |
| **WARN** | `london_breakout` | `EUR_USD` | 10 | -1.870 | 30.0% | 10.8% | 0.32 |
| **WARN** | `london_breakout` | `GBP_USD` | 20 | -2.825 | 40.0% | 21.9% | 0.28 |
| **WARN** | `london_breakout` | `USD_CHF` | 14 | -1.786 | 21.4% | 7.6% | 0.21 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 81 | -1.772 | 32.1% | 22.9% | 0.29 |
| **WARN** | `ob_retest` | `EUR_USD` | 14 | -0.207 | 71.4% | 45.4% | 0.93 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 13 | -3.400 | 53.8% | 29.1% | 0.23 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 17 | -9.612 | 41.2% | 21.6% | 0.12 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 26 | -2.258 | 61.5% | 42.5% | 0.46 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 36 | -3.328 | 69.4% | 53.1% | 0.37 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 40 | -0.652 | 67.5% | 52.0% | 0.77 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 33 | -2.385 | 51.5% | 35.2% | 0.38 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 33 | -1.958 | 39.4% | 24.7% | 0.45 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 37 | -0.514 | 45.9% | 31.0% | 0.78 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 29 | -3.110 | 51.7% | 34.4% | 0.35 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 30 | -4.867 | 56.7% | 39.2% | 0.26 |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 32 | 18 | 14 | -1.447 | 56.2% | 39.3%-71.8% | 0.51 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 89 | 41 | 48 | -0.422 | 46.1% | 36.1%-56.4% | 0.75 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 33 | 15 | 18 | -1.176 | 45.5% | 29.8%-62.0% | 0.50 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 13 | 6 | 7 | -2.415 | 46.2% | 23.2%-70.9% | 0.41 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `EUR_USD` | 10 | 3 | 7 | -1.870 | 30.0% | 10.8%-60.3% | 0.32 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `GBP_USD` | 20 | 8 | 12 | -2.825 | 40.0% | 21.9%-61.3% | 0.28 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 14 | 3 | 11 | -1.786 | 21.4% | 7.6%-47.6% | 0.21 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `EUR_USD` | 14 | 10 | 4 | -0.207 | 71.4% | 45.4%-88.3% | 0.93 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `AUD_JPY` | 2 | 2 | 0 | +2.150 | 100.0% | 34.2%-100.0% | n/a | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 26 | 16 | 10 | -2.258 | 61.5% | 42.5%-77.6% | 0.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 33 | 17 | 16 | -2.385 | 51.5% | 35.2%-67.5% | 0.38 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 33 | 13 | 20 | -1.958 | 39.4% | 24.7%-56.3% | 0.45 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 37 | 17 | 20 | -0.514 | 45.9% | 31.0%-61.6% | 0.78 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 29 | 15 | 14 | -3.110 | 51.7% | 34.4%-68.6% | 0.35 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 30 | 17 | 13 | -4.867 | 56.7% | 39.2%-72.6% | 0.26 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
