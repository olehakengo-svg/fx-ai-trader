# SHADOW_PROMOTE R2 Alert - 2026-06-17T03:57:44.591264+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 54 | -0.950 | 37.0% | 25.4% | 0.53 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 30 | -3.153 | 23.3% | 11.8% | 0.12 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 52 | -0.837 | 36.5% | 24.8% | 0.48 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 10 | -3.070 | 30.0% | 10.8% | 0.25 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 27 | -2.119 | 63.0% | 44.2% | 0.41 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 40 | -4.720 | 52.5% | 37.5% | 0.34 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 32 | -4.753 | 31.2% | 18.0% | 0.17 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 16 | -0.975 | 68.8% | 44.4% | 0.56 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 90 | -0.499 | 50.0% | 39.9% | 0.78 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 28 | -0.507 | 25.0% | 12.7% | 0.68 |
| **WARN** | `sr_fib_confluence` | `GBP_USD` | 21 | -1.519 | 47.6% | 28.3% | 0.55 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 6 | 1 | 5 | -10.183 | 16.7% | 3.0%-56.4% | 0.02 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 54 | 20 | 34 | -0.950 | 37.0% | 25.4%-50.4% | 0.53 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 30 | 7 | 23 | -3.153 | 23.3% | 11.8%-40.9% | 0.12 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 52 | 19 | 33 | -0.837 | 36.5% | 24.8%-50.1% | 0.48 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `mtf_counter_trend_scalp` | `USD_JPY` | 2 | 0 | 2 | -1.700 | 0.0% | 0.0%-65.8% | 0.00 | `MTF_COUNTER_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 10 | 3 | 7 | -3.070 | 30.0% | 10.8%-60.3% | 0.25 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `squeeze_release_momentum` | `GBP_USD` | 5 | 5 | 0 | +3.360 | 100.0% | 56.6%-100.0% | n/a | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 40 | 21 | 19 | -4.720 | 52.5% | 37.5%-67.1% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 90 | 45 | 45 | -0.499 | 50.0% | 39.9%-60.1% | 0.78 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_fib_confluence` | `GBP_USD` | 21 | 10 | 11 | -1.519 | 47.6% | 28.3%-67.6% | 0.55 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `GBP_USD` | 6 | 1 | 5 | -2.600 | 16.7% | 3.0%-56.4% | 0.07 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
