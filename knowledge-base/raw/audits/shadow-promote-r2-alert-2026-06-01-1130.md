# SHADOW_PROMOTE R2 Alert - 2026-06-01T11:30:05.365536+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 35 | -1.023 | 25.7% | 14.2% | 0.60 |
...
| **WARN** | `london_breakout` | `USD_CHF` | 13 | -2.285 | 0.0% | 0.0% | 0.00 |
| **WARN** | `ma_regime_switch` | `USD_JPY` | 26 | -1.408 | 23.1% | 11.0% | 0.43 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 37 | -3.646 | 21.6% | 11.4% | 0.50 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 32 | -6.625 | 9.4% | 3.2% | 0.26 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 69 | -2.604 | 24.6% | 16.0% | 0.53 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 45 | -1.780 | 17.8% | 9.3% | 0.60 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 40 | -0.885 | 27.5% | 16.1% | 0.72 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 21 | -0.776 | 4.8% | 0.8% | 0.40 |
| **WARN** | `sr_fib_confluence` | `EUR_GBP` | 14 | -4.150 | 14.3% | 4.0% | 0.10 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 85 | -0.629 | 28.2% | 19.8% | 0.83 |
...
| **WARN** | `turtle_soup` | `GBP_USD` | 12 | -7.375 | 25.0% | 8.9% | 0.08 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 37 | -2.424 | 16.2% | 7.7% | 0.45 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 14 | -3.200 | 21.4% | 7.6% | 0.54 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 55 | -5.904 | 16.4% | 8.9% | 0.23 |
...
| OK | `dt_sr_channel_reversal` | `EUR_JPY` | 6 | 2 | 4 | -1.617 | 33.3% | 9.7%-70.0% | 0.71 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 35 | 9 | 26 | -1.023 | 25.7% | 14.2%-42.1% | 0.60 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `USD_CHF` | 13 | 0 | 13 | -2.285 | 0.0% | 0.0%-22.8% | 0.00 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 26 | 6 | 20 | -1.408 | 23.1% | 11.0%-42.1% | 0.43 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `USD_JPY` | 17 | 9 | 8 | +9.500 | 52.9% | 31.0%-73.8% | 3.84 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ofi_mr` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `OFI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `orb_trap` | `EUR_USD` | 17 | 0 | 17 | -3.524 | 0.0% | 0.0%-18.4% | 0.00 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `orb_trap` | `GBP_USD` | 17 | 12 | 5 | +7.094 | 70.6% | 46.9%-86.7% | 7.97 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `GBP_USD` | 6 | 1 | 5 | -2.550 | 16.7% | 3.0%-56.4% | 0.51 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 37 | 8 | 29 | -3.646 | 21.6% | 11.4%-37.2% | 0.50 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 32 | 3 | 29 | -6.625 | 9.4% | 3.2%-24.2% | 0.26 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 40 | 11 | 29 | -0.885 | 27.5% | 16.1%-42.8% | 0.72 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `USD_CHF` | 21 | 1 | 20 | -0.776 | 4.8% | 0.8%-22.7% | 0.40 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `EUR_GBP` | 14 | 2 | 12 | -4.150 | 14.3% | 4.0%-39.9% | 0.10 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 85 | 24 | 61 | -0.629 | 28.2% | 19.8%-38.6% | 0.83 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_GBP` | 5 | 0 | 5 | -4.700 | 0.0% | 0.0%-43.4% | 0.00 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `turtle_soup` | `GBP_USD` | 12 | 3 | 9 | -7.375 | 25.0% | 8.9%-53.2% | 0.08 | `TURTLE_SOUP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 37 | 6 | 31 | -2.424 | 16.2% | 7.7%-31.1% | 0.45 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `EUR_USD` | 7 | 1 | 6 | -2.386 | 14.3% | 2.6%-51.3% | 0.33 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 49 | 24 | 25 | +4.849 | 49.0% | 35.6%-62.5% | 3.97 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 55 | 9 | 46 | -5.904 | 16.4% | 8.9%-28.3% | 0.23 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
