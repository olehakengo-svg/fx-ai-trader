# SHADOW_PROMOTE R2 Alert - 2026-07-24T13:40:01.684722+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 17 | -0.294 | 47.1% | 26.2% | 0.88 |
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 22 | -0.950 | 45.5% | 26.9% | 0.72 |
...
| **WARN** | `sr_break_retest` | `AUD_JPY` | 20 | -2.075 | 60.0% | 38.7% | 0.40 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 39 | -2.274 | 51.3% | 36.2% | 0.49 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 34 | -4.900 | 61.8% | 45.0% | 0.26 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 38 | -1.553 | 52.6% | 37.3% | 0.55 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 28 | -3.071 | 46.4% | 29.5% | 0.30 |
| **WARN** | `trend_rebound` | `USD_JPY` | 17 | -1.671 | 23.5% | 9.6% | 0.22 |
| **CRITICAL** | `trendline_sweep` | `EUR_GBP` | 30 | -2.063 | 46.7% | 30.2% | 0.30 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 17 | -0.106 | 76.5% | 52.7% | 0.96 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 13 | -1.792 | 69.2% | 42.4% | 0.40 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 75 | -0.961 | 44.0% | 33.3% | 0.56 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 17 | 8 | 9 | -0.294 | 47.1% | 26.2%-69.0% | 0.88 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 22 | 10 | 12 | -0.950 | 45.5% | 26.9%-65.3% | 0.72 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 20 | 12 | 8 | -2.075 | 60.0% | 38.7%-78.1% | 0.40 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 38 | 20 | 18 | -1.553 | 52.6% | 37.3%-67.5% | 0.55 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 28 | 13 | 15 | -3.071 | 46.4% | 29.5%-64.2% | 0.30 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 17 | 4 | 13 | -1.671 | 23.5% | 9.6%-47.3% | 0.22 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `trendline_sweep` | `EUR_GBP` | 30 | 14 | 16 | -2.063 | 46.7% | 30.2%-63.9% | 0.30 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `GBP_USD` | 53 | 31 | 22 | +0.623 | 58.5% | 45.1%-70.7% | 1.28 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 75 | 33 | 42 | -0.961 | 44.0% | 33.3%-55.3% | 0.56 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
