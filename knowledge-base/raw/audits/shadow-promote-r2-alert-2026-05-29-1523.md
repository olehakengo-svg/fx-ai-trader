# SHADOW_PROMOTE R2 Alert - 2026-05-29T15:23:42.206659+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 38 | -0.489 | 28.9% | 17.0% | 0.79 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 13 | -1.454 | 23.1% | 8.2% | 0.60 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 25 | -1.108 | 28.0% | 14.3% | 0.52 |
| **WARN** | `ob_retest` | `EUR_USD` | 28 | -0.568 | 28.6% | 15.3% | 0.87 |
| **WARN** | `ob_retest` | `GBP_USD` | 24 | -0.683 | 45.8% | 27.9% | 0.89 |
| **WARN** | `orb_trap` | `EUR_USD` | 18 | -3.161 | 5.6% | 1.0% | 0.05 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 21 | -17.548 | 4.8% | 0.8% | 0.01 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `USD_JPY` | 40 | -1.935 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 35 | -2.897 | 25.7% | 14.2% | 0.58 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 31 | -7.300 | 6.5% | 1.8% | 0.21 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 69 | -2.604 | 24.6% | 16.0% | 0.53 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 53 | -1.840 | 18.9% | 10.6% | 0.59 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 40 | -1.157 | 27.5% | 16.1% | 0.68 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 20 | -1.360 | 0.0% | 0.0% | 0.00 |
| **WARN** | `sr_fib_confluence` | `EUR_GBP` | 14 | -4.150 | 14.3% | 4.0% | 0.10 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 75 | -0.253 | 32.0% | 22.5% | 0.93 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 85 | -3.764 | 16.5% | 10.1% | 0.41 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 36 | -2.433 | 16.7% | 7.9% | 0.45 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 14 | -3.200 | 21.4% | 7.6% | 0.54 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 55 | -5.067 | 20.0% | 11.6% | 0.31 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 39 | -0.979 | 25.6% | 14.6% | 0.84 |
...
| OK | `donchian_momentum_breakout` | `NZD_JPY` | 12 | 9 | 3 | +21.908 | 75.0% | 46.8%-91.1% | 5.15 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `NZD_USD` | 14 | 10 | 4 | +17.464 | 71.4% | 45.4%-88.3% | 8.09 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 39 | 20 | 19 | +2.369 | 51.3% | 36.2%-66.1% | 1.96 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 38 | 11 | 27 | -0.489 | 28.9% | 17.0%-44.8% | 0.79 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 13 | 3 | 10 | -1.454 | 23.1% | 8.2%-50.3% | 0.60 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_session_breakout` | `GBP_USD` | 4 | 0 | 4 | -2.575 | 0.0% | 0.0%-49.0% | 0.00 | `LONDON_SESSION_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `london_shrapnel` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `LONDON_SHRAPNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ma_mr_hybrid` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `MA_MR_HYBRID_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `ma_regime_switch` | `USD_JPY` | 25 | 7 | 18 | -1.108 | 28.0% | 14.3%-47.6% | 0.52 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `GBP_USD` | 24 | 11 | 13 | -0.683 | 45.8% | 27.9%-64.9% | 0.89 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_USD` | 21 | 1 | 20 | -17.548 | 4.8% | 0.8%-22.7% | 0.01 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 35 | 9 | 26 | -2.897 | 25.7% | 14.2%-42.1% | 0.58 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 53 | 10 | 43 | -1.840 | 18.9% | 10.6%-31.4% | 0.59 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 40 | 11 | 29 | -1.157 | 27.5% | 16.1%-42.8% | 0.68 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 75 | 24 | 51 | -0.253 | 32.0% | 22.5%-43.2% | 0.93 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 85 | 14 | 71 | -3.764 | 16.5% | 10.1%-25.8% | 0.41 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_GBP` | 3 | 0 | 3 | -4.800 | 0.0% | 0.0%-56.2% | 0.00 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 36 | 6 | 30 | -2.433 | 16.7% | 7.9%-31.9% | 0.45 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `GBP_USD` | 6 | 4 | 2 | +6.717 | 66.7% | 30.0%-90.3% | 10.60 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `USD_CHF` | 3 | 0 | 3 | -2.267 | 0.0% | 0.0%-56.2% | 0.00 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 55 | 11 | 44 | -5.067 | 20.0% | 11.6%-32.4% | 0.31 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 39 | 10 | 29 | -0.979 | 25.6% | 14.6%-41.1% | 0.84 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
