# SHADOW_PROMOTE R2 Alert - 2026-06-19T04:07:57.406298+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | -2.180 | 20.0% | 5.7% | 0.14 |
...
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 22 | -2.614 | 4.5% | 0.8% | 0.03 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 58 | -0.840 | 39.7% | 28.1% | 0.58 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -2.361 | 32.3% | 18.6% | 0.24 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 10 | -4.290 | 40.0% | 16.8% | 0.14 |
| **WARN** | `london_breakout` | `USD_CHF` | 17 | -2.176 | 41.2% | 21.6% | 0.27 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 51 | -0.959 | 35.3% | 23.6% | 0.42 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 16 | -2.600 | 37.5% | 18.5% | 0.28 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 34 | -1.482 | 67.6% | 50.8% | 0.54 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 43 | -2.747 | 65.1% | 50.2% | 0.46 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 31 | -2.719 | 45.2% | 29.2% | 0.36 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 14 | -2.293 | 57.1% | 32.6% | 0.24 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | 2 | 8 | -2.180 | 20.0% | 5.7%-51.0% | 0.14 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema_trend_scalp` | `USD_CHF` | 22 | 1 | 21 | -2.614 | 4.5% | 0.8%-21.8% | 0.03 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 10 | 4 | 6 | -4.290 | 40.0% | 16.8%-68.7% | 0.14 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 51 | 18 | 33 | -0.959 | 35.3% | 23.6%-49.0% | 0.42 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 43 | 28 | 15 | -2.747 | 65.1% | 50.2%-77.6% | 0.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 31 | 14 | 17 | -2.719 | 45.2% | 29.2%-62.2% | 0.36 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 14 | 8 | 6 | -2.293 | 57.1% | 32.6%-78.6% | 0.24 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 9 | 4 | 5 | -7.533 | 44.4% | 18.9%-73.3% | 0.22 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
