# SHADOW_PROMOTE R2 Alert - 2026-07-06T10:15:50.413772+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_USD` | 30 | -0.043 | 66.7% | 48.8% | 0.97 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | -1.524 | 62.1% | 44.0% | 0.68 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 77 | -0.675 | 44.2% | 33.6% | 0.66 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 66 | -1.532 | 36.4% | 25.8% | 0.34 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 31 | -1.287 | 71.0% | 53.4% | 0.62 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 37 | -0.876 | 75.7% | 59.9% | 0.75 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 46 | -0.198 | 67.4% | 53.0% | 0.93 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 29 | -0.328 | 62.1% | 44.0% | 0.89 |
| **WARN** | `trend_rebound` | `USD_JPY` | 11 | -1.600 | 36.4% | 15.2% | 0.24 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 17 | -1.459 | 52.9% | 31.0% | 0.41 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 15 | -1.180 | 73.3% | 48.0% | 0.49 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 35 | -3.283 | 28.6% | 16.3% | 0.21 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 21 | -2.362 | 28.6% | 13.8% | 0.19 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 14 | -0.171 | 57.1% | 32.6% | 0.91 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 2 | 2 | 0 | +5.750 | 100.0% | 34.2%-100.0% | n/a | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 5 | 2 | 3 | -7.680 | 40.0% | 11.8%-76.9% | 0.04 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_USD` | 30 | 20 | 10 | -0.043 | 66.7% | 48.8%-80.8% | 0.97 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | 18 | 11 | -1.524 | 62.1% | 44.0%-77.3% | 0.68 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 77 | 34 | 43 | -0.675 | 44.2% | 33.6%-55.3% | 0.66 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 66 | 24 | 42 | -1.532 | 36.4% | 25.8%-48.4% | 0.34 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 31 | 22 | 9 | -1.287 | 71.0% | 53.4%-83.9% | 0.62 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 37 | 28 | 9 | -0.876 | 75.7% | 59.9%-86.6% | 0.75 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 2 | 2 | 0 | +1.200 | 100.0% | 34.2%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `GBP_USD` | 1 | 1 | 0 | +22.100 | 100.0% | 20.7%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 11 | 4 | 7 | -1.600 | 36.4% | 15.2%-64.6% | 0.24 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_GBP` | 17 | 9 | 8 | -1.459 | 52.9% | 31.0%-73.8% | 0.41 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_USD` | 12 | 8 | 4 | +0.050 | 66.7% | 39.1%-86.2% | 1.02 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 15 | 11 | 4 | -1.180 | 73.3% | 48.0%-89.1% | 0.49 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 35 | 10 | 25 | -3.283 | 28.6% | 16.3%-45.1% | 0.21 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_momentum_scalp` | `USD_JPY` | 14 | 8 | 6 | +0.250 | 57.1% | 32.6%-78.6% | 1.12 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 14 | 8 | 6 | -0.171 | 57.1% | 32.6%-78.6% | 0.91 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 9 | 2 | 7 | -6.611 | 22.2% | 6.3%-54.7% | 0.05 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
