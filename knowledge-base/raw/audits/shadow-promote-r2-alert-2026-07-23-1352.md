# SHADOW_PROMOTE R2 Alert - 2026-07-23T13:52:09.082333+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 13 | -0.977 | 38.5% | 17.7% | 0.67 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 17 | -1.494 | 64.7% | 41.3% | 0.53 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 25 | -1.428 | 44.0% | 26.7% | 0.39 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 20 | -0.165 | 70.0% | 48.1% | 0.94 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 26 | -0.485 | 53.8% | 35.5% | 0.83 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 13 | -0.208 | 46.2% | 23.2% | 0.95 |
| **WARN** | `ema200_trend_reversal` | `USD_JPY` | 20 | -1.080 | 55.0% | 34.2% | 0.64 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 86 | -0.859 | 40.7% | 30.9% | 0.56 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -1.216 | 41.9% | 26.4% | 0.51 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 20 | -2.040 | 45.0% | 25.8% | 0.33 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 60 | -1.465 | 35.0% | 24.2% | 0.37 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 37 | -2.116 | 51.4% | 35.9% | 0.51 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 29 | -3.724 | 65.5% | 47.3% | 0.34 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 33 | -1.224 | 54.5% | 38.0% | 0.62 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 30 | -2.783 | 50.0% | 33.2% | 0.32 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 11 | -1.173 | 45.5% | 21.3% | 0.41 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 73 | -0.940 | 43.8% | 33.0% | 0.57 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 16 | -1.212 | 62.5% | 38.6% | 0.67 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 11 | -5.664 | 27.3% | 9.7% | 0.06 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 37 | -2.597 | 51.4% | 35.9% | 0.33 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 44 | -0.195 | 63.6% | 48.9% | 0.96 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 13 | 5 | 8 | -0.977 | 38.5% | 17.7%-64.5% | 0.67 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 17 | 11 | 6 | -1.494 | 64.7% | 41.3%-82.7% | 0.53 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 25 | 11 | 14 | -1.428 | 44.0% | 26.7%-62.9% | 0.39 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 20 | 14 | 6 | -0.165 | 70.0% | 48.1%-85.5% | 0.94 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 26 | 14 | 12 | -0.485 | 53.8% | 35.5%-71.2% | 0.83 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 13 | 6 | 7 | -0.208 | 46.2% | 23.2%-70.9% | 0.95 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 86 | 35 | 51 | -0.859 | 40.7% | 30.9%-51.3% | 0.56 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 13 | 18 | -1.216 | 41.9% | 26.4%-59.2% | 0.51 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 20 | 9 | 11 | -2.040 | 45.0% | 25.8%-65.8% | 0.33 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `USD_CHF` | 3 | 1 | 2 | -0.367 | 33.3% | 6.1%-79.2% | 0.69 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 60 | 21 | 39 | -1.465 | 35.0% | 24.2%-47.6% | 0.37 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 37 | 19 | 18 | -2.116 | 51.4% | 35.9%-66.6% | 0.51 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 29 | 19 | 10 | -3.724 | 65.5% | 47.3%-80.1% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 33 | 18 | 15 | -1.224 | 54.5% | 38.0%-70.2% | 0.62 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `EUR_USD` | 11 | 5 | 6 | -1.173 | 45.5% | 21.3%-72.0% | 0.41 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `GBP_USD` | 46 | 26 | 20 | +0.696 | 56.5% | 42.2%-69.8% | 1.29 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 73 | 32 | 41 | -0.940 | 43.8% | 33.0%-55.2% | 0.57 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `AUD_JPY` | 3 | 0 | 3 | -6.500 | 0.0% | 0.0%-56.2% | 0.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 16 | 10 | 6 | -1.212 | 62.5% | 38.6%-81.5% | 0.67 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 6 | 2 | 4 | -6.783 | 33.3% | 9.7%-70.0% | 0.06 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 37 | 19 | 18 | -2.597 | 51.4% | 35.9%-66.6% | 0.33 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 44 | 28 | 16 | -0.195 | 63.6% | 48.9%-76.2% | 0.96 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 35 | 23 | 12 | +0.294 | 65.7% | 49.2%-79.2% | 1.09 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
