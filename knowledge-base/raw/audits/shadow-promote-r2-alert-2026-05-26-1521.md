# SHADOW_PROMOTE R2 Alert - 2026-05-26T15:21:48.344824+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 45 | -1.520 | 20.0% | 10.9% | 0.55 |
...
| **WARN** | `lin_reg_channel` | `EUR_USD` | 24 | -3.950 | 20.8% | 9.2% | 0.23 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 58 | -3.514 | 24.1% | 15.0% | 0.41 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 51 | -1.820 | 25.5% | 15.5% | 0.65 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 48 | -1.662 | 25.0% | 14.9% | 0.56 |
...
| **WARN** | `sr_fib_confluence` | `GBP_JPY` | 12 | -16.483 | 0.0% | 0.0% | 0.00 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 42 | -1.914 | 19.0% | 10.0% | 0.55 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 40 | -0.615 | 32.5% | 20.1% | 0.90 |
| **WARN** | `xs_momentum` | `USD_JPY` | 25 | -1.160 | 40.0% | 23.4% | 0.85 |
...
| OK | `bb_rsi_reversion` | `EUR_USD` | 9 | 3 | 6 | -0.444 | 33.3% | 12.1%-64.6% | 0.74 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `bb_rsi_reversion` | `USD_JPY` | 14 | 8 | 6 | +2.307 | 57.1% | 32.6%-78.6% | 2.81 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema_trend_scalp` | `EUR_USD` | 7 | 1 | 6 | -1.443 | 14.3% | 2.6%-51.3% | 0.33 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `GBP_USD` | 7 | 0 | 7 | -2.829 | 0.0% | 0.0%-35.4% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `ema_trend_scalp` | `USD_CHF` | 23 | 0 | 23 | -2.317 | 0.0% | 0.0%-14.3% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 45 | 9 | 36 | -1.520 | 20.0% | 10.9%-33.8% | 0.55 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_CHF` | 9 | 0 | 9 | -1.467 | 0.0% | 0.0%-29.9% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 24 | 5 | 19 | -3.950 | 20.8% | 9.2%-40.5% | 0.23 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `post_news_vol` | `EUR_USD` | 2 | 0 | 2 | -15.150 | 0.0% | 0.0%-65.8% | 0.00 | `POST_NEWS_VOL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 58 | 14 | 44 | -3.514 | 24.1% | 15.0%-36.5% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 51 | 13 | 38 | -1.820 | 25.5% | 15.5%-38.9% | 0.65 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `EUR_USD` | 2 | 0 | 2 | -2.400 | 0.0% | 0.0%-65.8% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 48 | 12 | 36 | -1.662 | 25.0% | 14.9%-38.8% | 0.56 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_JPY` | 2 | 0 | 2 | -19.150 | 0.0% | 0.0%-65.8% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 53 | 12 | 41 | -1.966 | 22.6% | 13.5%-35.5% | 0.56 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `GBP_JPY` | 12 | 0 | 12 | -16.483 | 0.0% | 0.0%-24.3% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 84 | 15 | 69 | -3.992 | 17.9% | 11.1%-27.4% | 0.43 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `USD_JPY` | 9 | 0 | 9 | -13.611 | 0.0% | 0.0%-29.9% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 42 | 8 | 34 | -1.914 | 19.0% | 10.0%-33.3% | 0.55 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_momentum_scalp` | `USD_JPY` | 9 | 0 | 9 | -3.256 | 0.0% | 0.0%-29.9% | 0.00 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 40 | 13 | 27 | -0.615 | 32.5% | 20.1%-48.0% | 0.90 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 25 | 10 | 15 | -1.160 | 40.0% | 23.4%-59.3% | 0.85 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
