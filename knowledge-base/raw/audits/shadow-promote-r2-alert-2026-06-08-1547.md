# SHADOW_PROMOTE R2 Alert - 2026-06-08T15:47:58.031514+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 85 | -1.575 | 9.4% | 4.8% | 0.27 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 33 | -1.282 | 27.3% | 15.1% | 0.46 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 20 | -2.640 | 15.0% | 5.2% | 0.28 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 37 | -0.735 | 29.7% | 17.5% | 0.64 |
| **WARN** | `london_breakout` | `GBP_USD` | 20 | -0.535 | 35.0% | 18.1% | 0.75 |
| **WARN** | `london_breakout` | `USD_CHF` | 15 | -2.153 | 13.3% | 3.7% | 0.11 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 41 | -1.132 | 29.3% | 17.6% | 0.42 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 59 | -2.132 | 30.5% | 20.3% | 0.57 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 38 | -1.997 | 31.6% | 19.1% | 0.31 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 55 | -0.924 | 36.4% | 24.9% | 0.63 |
| **CRITICAL** | `sr_channel_reversal` | `USD_CHF` | 35 | -2.149 | 5.7% | 1.6% | 0.15 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 61 | -4.169 | 14.8% | 8.0% | 0.28 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 12 | -3.092 | 33.3% | 13.8% | 0.16 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 15 | -6.960 | 33.3% | 15.2% | 0.11 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 24 | -2.792 | 20.8% | 9.2% | 0.26 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 15 | -2.593 | 20.0% | 7.0% | 0.22 |
| **WARN** | `vol_surge_detector` | `USD_CHF` | 10 | -3.950 | 0.0% | 0.0% | 0.00 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 10 | -2.630 | 50.0% | 23.7% | 0.44 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 18 | 13 | 5 | +0.889 | 72.2% | 49.1%-87.5% | 1.42 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `EUR_JPY` | 12 | 7 | 5 | +1.533 | 58.3% | 32.0%-80.7% | 1.40 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 6 | 4 | 2 | +2.750 | 66.7% | 30.0%-90.3% | 2.32 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 85 | 8 | 77 | -1.575 | 9.4% | 4.8%-17.5% | 0.27 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 33 | 9 | 24 | -1.282 | 27.3% | 15.1%-44.2% | 0.46 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 20 | 3 | 17 | -2.640 | 15.0% | 5.2%-36.0% | 0.28 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `inducement_ob` | `GBP_USD` | 1 | 0 | 1 | -2.600 | 0.0% | 0.0%-79.3% | 0.00 | `INDUCEMENT_OB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 37 | 11 | 26 | -0.735 | 29.7% | 17.5%-45.8% | 0.64 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `GBP_USD` | 20 | 7 | 13 | -0.535 | 35.0% | 18.1%-56.7% | 0.75 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 15 | 2 | 13 | -2.153 | 13.3% | 3.7%-37.9% | 0.11 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 41 | 12 | 29 | -1.132 | 29.3% | 17.6%-44.5% | 0.42 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `GBP_USD` | 1 | 1 | 0 | +16.200 | 100.0% | 20.7%-100.0% | n/a | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 59 | 18 | 41 | -2.132 | 30.5% | 20.3%-43.1% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 38 | 12 | 26 | -1.997 | 31.6% | 19.1%-47.5% | 0.31 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 55 | 20 | 35 | -0.924 | 36.4% | 24.9%-49.6% | 0.63 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 79 | 35 | 44 | +0.690 | 44.3% | 33.9%-55.3% | 1.26 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 61 | 9 | 52 | -4.169 | 14.8% | 8.0%-25.7% | 0.28 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 12 | 4 | 8 | -3.092 | 33.3% | 13.8%-60.9% | 0.16 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_USD` | 10 | 6 | 4 | +4.270 | 60.0% | 31.3%-83.2% | 2.65 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 15 | 5 | 10 | -6.960 | 33.3% | 15.2%-58.3% | 0.11 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `turtle_soup` | `GBP_USD` | 8 | 4 | 4 | -4.525 | 50.0% | 21.5%-78.5% | 0.20 | `TURTLE_SOUP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 24 | 5 | 19 | -2.792 | 20.8% | 9.2%-40.5% | 0.26 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 10 | 5 | 5 | -2.630 | 50.0% | 23.7%-76.3% | 0.44 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
