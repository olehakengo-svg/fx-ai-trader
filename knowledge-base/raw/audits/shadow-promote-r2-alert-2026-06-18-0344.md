# SHADOW_PROMOTE R2 Alert - 2026-06-18T03:44:55.475268+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 54 | -0.811 | 38.9% | 27.0% | 0.59 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 27 | -3.067 | 25.9% | 13.2% | 0.14 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 29 | -2.338 | 62.1% | 44.0% | 0.38 |
...
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 25 | -0.368 | 28.0% | 14.3% | 0.77 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 15 | -1.953 | 60.0% | 35.7% | 0.36 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 36 | -1.758 | 36.1% | 22.5% | 0.37 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 16 | -1.456 | 43.8% | 23.1% | 0.26 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 54 | 21 | 33 | -0.811 | 38.9% | 27.0%-52.2% | 0.59 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 27 | 7 | 20 | -3.067 | 25.9% | 13.2%-44.7% | 0.14 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 29 | 18 | 11 | -2.338 | 62.1% | 44.0%-77.3% | 0.38 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_channel_reversal` | `USD_CHF` | 25 | 7 | 18 | -0.368 | 28.0% | 14.3%-47.6% | 0.77 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 16 | 7 | 9 | -1.456 | 43.8% | 23.1%-66.8% | 0.26 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
