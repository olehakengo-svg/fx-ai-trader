# SHADOW_PROMOTE R2 Alert - 2026-09-06T19:59:27.652363+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `donchian_momentum_breakout` | `AUD_USD` | 10 | -4.760 | 40.0% | 16.8% | 0.21 |
...
| WARN | `donchian_momentum_breakout` | `AUD_USD` | 10 | 4 | 6 | -4.760 | 40.0% | 16.8%-68.7% | 0.21 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 28 | 10 | 18 | -2.111 | 35.7% | 20.7%-54.2% | 0.33 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 47 | 18 | 29 | -0.613 | 38.3% | 25.8%-52.6% | 0.68 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 44 | 24 | 20 | -0.375 | 54.5% | 40.1%-68.3% | 0.91 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `USD_JPY` | 49 | 24 | 25 | +0.045 | 49.0% | 35.6%-62.5% | 1.02 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `EUR_USD` | 8 | 2 | 6 | -0.663 | 25.0% | 7.1%-59.1% | 0.50 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 7 | 3 | 4 | -0.900 | 42.9% | 15.8%-75.0% | 0.69 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `xs_momentum` | `USD_JPY` | 1 | 0 | 1 | -25.900 | 0.0% | 0.0%-79.3% | 0.00 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
