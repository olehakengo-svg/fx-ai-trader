# SHADOW_PROMOTE R2 Alert - 2026-08-21T12:41:03.957395+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `donchian_momentum_breakout` | `AUD_USD` | 10 | -5.040 | 30.0% | 10.8% | 0.27 |
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 23 | -0.004 | 43.5% | 25.6% | 1.00 |
...
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 19 | -1.068 | 63.2% | 41.0% | 0.71 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 35 | -2.929 | 40.0% | 25.6% | 0.44 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 13 | -3.015 | 61.5% | 35.5% | 0.57 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 13 | -7.746 | 38.5% | 17.7% | 0.22 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 59 | -2.151 | 49.2% | 36.8% | 0.56 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 20 | -4.485 | 55.0% | 34.2% | 0.14 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 37 | -0.622 | 48.6% | 33.4% | 0.83 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 11 | 9 | 2 | +3.409 | 81.8% | 52.3%-94.9% | 1.88 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `donchian_momentum_breakout` | `AUD_USD` | 10 | 3 | 7 | -5.040 | 30.0% | 10.8%-60.3% | 0.27 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 15 | 11 | 4 | +1.660 | 73.3% | 48.0%-89.1% | 1.37 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 23 | 10 | 13 | -0.004 | 43.5% | 25.6%-63.2% | 1.00 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 20 | 10 | 10 | -4.475 | 50.0% | 29.9%-70.1% | 0.36 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 25 | 13 | 12 | +0.660 | 52.0% | 33.5%-70.0% | 1.24 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `USD_JPY` | 7 | 1 | 6 | -7.314 | 14.3% | 2.6%-51.3% | 0.14 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `GBP_JPY` | 19 | 12 | 7 | -1.068 | 63.2% | 41.0%-80.9% | 0.71 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 35 | 14 | 21 | -2.929 | 40.0% | 25.6%-56.4% | 0.44 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 13 | 8 | 5 | -3.015 | 61.5% | 35.5%-82.3% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 59 | 29 | 30 | -2.151 | 49.2% | 36.8%-61.6% | 0.56 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 20 | 11 | 9 | -4.485 | 55.0% | 34.2%-74.2% | 0.14 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 37 | 18 | 19 | -0.622 | 48.6% | 33.4%-64.1% | 0.83 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
