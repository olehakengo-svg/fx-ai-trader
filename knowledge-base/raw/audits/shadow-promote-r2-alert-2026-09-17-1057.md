# SHADOW_PROMOTE R2 Alert - 2026-09-17T10:57:53.754157+00:00
...
| **WARN** | `donchian_momentum_breakout` | `USD_JPY` | 10 | -1.280 | 80.0% | 49.0% | 0.78 |
...
| **WARN** | `three_bar_reversal` | `USD_JPY` | 27 | -0.744 | 44.4% | 27.6% | 0.67 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 58 | -0.959 | 56.9% | 44.1% | 0.77 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 17 | -1.612 | 64.7% | 41.3% | 0.71 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 23 | -3.035 | 30.4% | 15.6% | 0.19 |
...
| OK | `bb_squeeze_breakout` | `USD_JPY` | 8 | 3 | 5 | -0.425 | 37.5% | 13.7%-69.4% | 0.83 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `donchian_momentum_breakout` | `USD_JPY` | 10 | 8 | 2 | -1.280 | 80.0% | 49.0%-94.3% | 0.78 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `EUR_USD` | 2 | 1 | 1 | -3.500 | 50.0% | 9.5%-90.5% | 0.10 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 27 | 12 | 15 | -0.744 | 44.4% | 27.6%-62.7% | 0.67 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 58 | 33 | 25 | -0.959 | 56.9% | 44.1%-68.8% | 0.77 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 17 | 11 | 6 | -1.612 | 64.7% | 41.3%-82.7% | 0.71 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 23 | 7 | 16 | -3.035 | 30.4% | 15.6%-50.9% | 0.19 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
