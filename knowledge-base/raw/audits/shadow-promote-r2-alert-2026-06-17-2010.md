# SHADOW_PROMOTE R2 Alert - 2026-06-17T20:10:08.979591+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | -6.248 | 40.7% | 24.5% | 0.24 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 11 | -2.755 | 45.5% | 21.3% | 0.23 |
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 25 | -2.572 | 8.0% | 2.2% | 0.06 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 55 | -0.782 | 40.0% | 28.1% | 0.60 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 29 | -2.710 | 31.0% | 17.3% | 0.18 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 51 | -0.757 | 39.2% | 27.0% | 0.50 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 13 | -3.000 | 30.8% | 12.7% | 0.24 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 29 | -1.683 | 65.5% | 47.3% | 0.50 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 39 | -4.087 | 56.4% | 41.0% | 0.34 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 33 | -4.479 | 33.3% | 19.8% | 0.18 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 16 | -1.887 | 62.5% | 38.6% | 0.29 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 84 | -0.430 | 52.4% | 41.8% | 0.80 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 26 | -0.450 | 26.9% | 13.7% | 0.72 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 15 | -1.953 | 60.0% | 35.7% | 0.36 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 36 | -1.758 | 36.1% | 22.5% | 0.37 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -1.265 | 47.1% | 26.2% | 0.32 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 16 | -1.100 | 43.8% | 23.1% | 0.52 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 10 | -3.030 | 60.0% | 31.3% | 0.32 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 34 | -1.050 | 55.9% | 39.5% | 0.72 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 34 | -1.259 | 64.7% | 47.9% | 0.63 |
...
| OK | `dt_sr_channel_reversal` | `EUR_JPY` | 9 | 5 | 4 | -4.211 | 55.6% | 26.7%-81.1% | 0.22 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 20 | 13 | 7 | +1.160 | 65.0% | 43.3%-81.9% | 1.49 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | 11 | 16 | -6.248 | 40.7% | 24.5%-59.3% | 0.24 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 55 | 22 | 33 | -0.782 | 40.0% | 28.1%-53.2% | 0.60 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 29 | 9 | 20 | -2.710 | 31.0% | 17.3%-49.2% | 0.18 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `USD_JPY` | 2 | 0 | 2 | -0.300 | 0.0% | 0.0%-65.8% | 0.00 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 51 | 20 | 31 | -0.757 | 39.2% | 27.0%-52.9% | 0.50 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `orb_trap` | `EUR_USD` | 3 | 1 | 2 | -4.100 | 33.3% | 6.1%-79.2% | 0.13 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 29 | 19 | 10 | -1.683 | 65.5% | 47.3%-80.1% | 0.50 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 39 | 22 | 17 | -4.087 | 56.4% | 41.0%-70.7% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 33 | 11 | 22 | -4.479 | 33.3% | 19.8%-50.4% | 0.18 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 16 | 10 | 6 | -1.887 | 62.5% | 38.6%-81.5% | 0.29 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 84 | 44 | 40 | -0.430 | 52.4% | 41.8%-62.7% | 0.80 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `USD_CHF` | 26 | 7 | 19 | -0.450 | 26.9% | 13.7%-46.1% | 0.72 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_GBP` | 4 | 2 | 2 | -0.500 | 50.0% | 15.0%-85.0% | 0.67 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_USD` | 22 | 16 | 6 | +2.086 | 72.7% | 51.8%-86.8% | 2.12 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `GBP_USD` | 23 | 15 | 8 | +0.978 | 65.2% | 44.9%-81.2% | 1.49 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `GBP_USD` | 6 | 3 | 3 | -1.883 | 50.0% | 18.8%-81.2% | 0.32 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_USD` | 8 | 7 | 1 | +4.700 | 87.5% | 52.9%-97.8% | 4.27 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `GBP_USD` | 9 | 4 | 5 | -5.967 | 44.4% | 18.9%-73.3% | 0.13 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 36 | 13 | 23 | -1.758 | 36.1% | 22.5%-52.4% | 0.37 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 17 | 8 | 9 | -1.265 | 47.1% | 26.2%-69.0% | 0.32 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `GBP_USD` | 9 | 2 | 7 | -3.111 | 22.2% | 6.3%-54.7% | 0.11 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `USD_CHF` | 5 | 1 | 4 | -5.320 | 20.0% | 3.6%-62.4% | 0.07 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 16 | 7 | 9 | -1.100 | 43.8% | 23.1%-66.8% | 0.52 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 34 | 22 | 12 | -1.259 | 64.7% | 47.9%-78.5% | 0.63 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
