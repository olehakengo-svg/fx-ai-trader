# SHADOW_PROMOTE R2 Alert - 2026-05-11T19:44:17.027261+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `EUR_USD` | 41 | -0.507 | 36.6% | 23.6% | 0.77 |
| **CRITICAL** | `bb_rsi_reversion` | `GBP_USD` | 44 | -2.293 | 18.2% | 9.5% | 0.37 |
| **CRITICAL** | `bb_rsi_reversion` | `USD_JPY` | 88 | -0.160 | 40.9% | 31.2% | 0.94 |
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 12 | -0.192 | 8.3% | 1.5% | 0.93 |
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 73 | -0.900 | 19.2% | 11.8% | 0.64 |
...
| **WARN** | `engulfing_bb` | `GBP_USD` | 10 | -4.970 | 10.0% | 1.8% | 0.04 |
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 12 | -4.042 | 33.3% | 13.8% | 0.24 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 28 | -2.443 | 14.3% | 5.7% | 0.32 |
| **WARN** | `sr_channel_reversal` | `GBP_USD` | 26 | -2.315 | 19.2% | 8.5% | 0.43 |
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 62 | -1.703 | 21.0% | 12.7% | 0.46 |
...
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 29 | -2.276 | 13.8% | 5.5% | 0.47 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 12 | -3.950 | 0.0% | 0.0% | 0.00 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 19 | -3.595 | 15.8% | 5.5% | 0.48 |
...
| CRITICAL | `bb_rsi_reversion` | `EUR_USD` | 41 | 15 | 26 | -0.507 | 36.6% | 23.6%-51.9% | 0.77 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `GBP_USD` | 44 | 8 | 36 | -2.293 | 18.2% | 9.5%-32.0% | 0.37 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `USD_JPY` | 88 | 36 | 52 | -0.160 | 40.9% | 31.2%-51.4% | 0.94 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 73 | 14 | 59 | -0.900 | 19.2% | 11.8%-29.7% | 0.64 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `GBP_USD` | 10 | 1 | 9 | -4.970 | 10.0% | 1.8%-40.4% | 0.04 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ma_regime_switch` | `USD_JPY` | 6 | 1 | 5 | -2.133 | 16.7% | 3.0%-56.4% | 0.28 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 7 | 1 | 6 | -7.543 | 14.3% | 2.6%-51.3% | 0.45 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 12 | 4 | 8 | -4.042 | 33.3% | 13.8%-60.9% | 0.24 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 62 | 13 | 49 | -1.703 | 21.0% | 12.7%-32.6% | 0.46 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 29 | 4 | 25 | -2.276 | 13.8% | 5.5%-30.6% | 0.47 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 19 | 3 | 16 | -3.595 | 15.8% | 5.5%-37.6% | 0.48 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
