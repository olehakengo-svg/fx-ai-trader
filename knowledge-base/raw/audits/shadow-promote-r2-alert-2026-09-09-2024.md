# SHADOW_PROMOTE R2 Alert - 2026-09-09T20:24:58.342511+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 10 | -0.270 | 60.0% | 31.3% | 0.87 |
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 13 | -2.546 | 38.5% | 17.7% | 0.49 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 12 | -2.642 | 8.3% | 1.5% | 0.21 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | -5.327 | 26.7% | 10.9% | 0.21 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 23 | -0.461 | 43.5% | 25.6% | 0.83 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | -2.771 | 57.1% | 36.5% | 0.42 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 31 | -2.013 | 35.5% | 21.1% | 0.33 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 31 | -0.732 | 54.8% | 37.8% | 0.76 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 58 | -0.684 | 39.7% | 28.1% | 0.63 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `EUR_JPY` | 34 | -2.579 | 44.1% | 28.9% | 0.46 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 18 | -0.622 | 66.7% | 43.7% | 0.84 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 45 | -0.664 | 53.3% | 39.1% | 0.86 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 25 | -0.768 | 44.0% | 26.7% | 0.62 |
| **WARN** | `trend_rebound` | `EUR_USD` | 13 | -0.054 | 38.5% | 17.7% | 0.96 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 20 | -3.100 | 45.0% | 25.8% | 0.45 |
| **WARN** | `wick_imbalance_reversion` | `EUR_USD` | 10 | -3.190 | 40.0% | 16.8% | 0.48 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 18 | -0.344 | 66.7% | 43.7% | 0.93 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 26 | -2.915 | 34.6% | 19.4% | 0.29 |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 7 | 4 | 3 | +1.257 | 57.1% | 25.0%-84.2% | 1.45 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 10 | 6 | 4 | -0.270 | 60.0% | 31.3%-83.2% | 0.87 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | 4 | 11 | -5.327 | 26.7% | 10.9%-52.0% | 0.21 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 23 | 10 | 13 | -0.461 | 43.5% | 25.6%-63.2% | 0.83 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | 12 | 9 | -2.771 | 57.1% | 36.5%-75.5% | 0.42 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 31 | 11 | 20 | -2.013 | 35.5% | 21.1%-53.1% | 0.33 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 31 | 17 | 14 | -0.732 | 54.8% | 37.8%-70.8% | 0.76 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_anti_hunt_bounce` | `EUR_JPY` | 34 | 15 | 19 | -2.579 | 44.1% | 28.9%-60.5% | 0.46 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 45 | 24 | 21 | -0.664 | 53.3% | 39.1%-67.1% | 0.86 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `USD_JPY` | 44 | 22 | 22 | +0.095 | 50.0% | 35.8%-64.2% | 1.03 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `EUR_USD` | 13 | 5 | 8 | -0.054 | 38.5% | 17.7%-64.5% | 0.96 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 9 | 4 | 5 | -1.856 | 44.4% | 18.9%-73.3% | 0.45 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 20 | 9 | 11 | -3.100 | 45.0% | 25.8%-65.8% | 0.45 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_USD` | 10 | 4 | 6 | -3.190 | 40.0% | 16.8%-68.7% | 0.48 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 26 | 9 | 17 | -2.915 | 34.6% | 19.4%-53.8% | 0.29 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
