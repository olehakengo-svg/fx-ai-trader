# SHADOW_PROMOTE R2 Alert - 2026-05-20T09:30:30.453870+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_rsi_reversion` | `EUR_USD` | 26 | -0.350 | 38.5% | 22.4% | 0.83 |
...
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 32 | -0.688 | 21.9% | 11.0% | 0.72 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 55 | -0.744 | 20.0% | 11.6% | 0.77 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 121 | -1.379 | 19.8% | 13.7% | 0.59 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 24 | -2.208 | 29.2% | 14.9% | 0.69 |
...
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 51 | -2.000 | 23.5% | 14.0% | 0.50 |
...
| **WARN** | `sr_fib_confluence` | `EUR_JPY` | 25 | -11.972 | 8.0% | 2.2% | 0.27 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 32 | -0.428 | 28.1% | 15.6% | 0.89 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_JPY` | 51 | -11.437 | 9.8% | 4.3% | 0.33 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 65 | -2.820 | 23.1% | 14.5% | 0.60 |
| **WARN** | `sr_fib_confluence` | `USD_JPY` | 27 | -3.122 | 18.5% | 8.2% | 0.72 |
...
| WARN | `bb_rsi_reversion` | `EUR_USD` | 26 | 10 | 16 | -0.350 | 38.5% | 22.4%-57.5% | 0.83 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `bb_rsi_reversion` | `USD_JPY` | 44 | 20 | 24 | +0.225 | 45.5% | 31.7%-59.9% | 1.08 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `USD_CAD` | 2 | 0 | 2 | -24.850 | 0.0% | 0.0%-65.8% | 0.00 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema_cross` | `EUR_USD` | 1 | 1 | 0 | +17.800 | 100.0% | 20.7%-100.0% | n/a | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 32 | 7 | 25 | -0.688 | 21.9% | 11.0%-38.8% | 0.72 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 55 | 11 | 44 | -0.744 | 20.0% | 11.6%-32.4% | 0.77 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 121 | 24 | 97 | -1.379 | 19.8% | 13.7%-27.8% | 0.59 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_CHF` | 4 | 0 | 4 | -1.725 | 0.0% | 0.0%-49.0% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 24 | 7 | 17 | -2.208 | 29.2% | 14.9%-49.2% | 0.69 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 51 | 12 | 39 | -2.000 | 23.5% | 14.0%-36.8% | 0.50 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_fib_confluence` | `EUR_JPY` | 25 | 2 | 23 | -11.972 | 8.0% | 2.2%-25.0% | 0.27 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 32 | 9 | 23 | -0.428 | 28.1% | 15.6%-45.4% | 0.89 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 51 | 5 | 46 | -11.437 | 9.8% | 4.3%-21.0% | 0.33 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 65 | 15 | 50 | -2.820 | 23.1% | 14.5%-34.6% | 0.60 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `USD_JPY` | 27 | 5 | 22 | -3.122 | 18.5% | 8.2%-36.7% | 0.72 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `stoch_trend_pullback` | `USD_JPY` | 4 | 0 | 4 | -3.750 | 0.0% | 0.0%-49.0% | 0.00 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_USD` | 9 | 6 | 3 | +10.700 | 66.7% | 35.4%-87.9% | 10.53 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
