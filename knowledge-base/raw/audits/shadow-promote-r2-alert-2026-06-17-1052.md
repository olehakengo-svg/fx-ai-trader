# SHADOW_PROMOTE R2 Alert - 2026-06-17T10:52:24.290014+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 23 | -7.352 | 34.8% | 18.8% | 0.19 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 11 | -2.755 | 45.5% | 21.3% | 0.23 |
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 25 | -2.572 | 8.0% | 2.2% | 0.06 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 53 | -0.864 | 39.6% | 27.6% | 0.56 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 29 | -3.124 | 24.1% | 12.2% | 0.13 |
| **WARN** | `london_breakout` | `EUR_USD` | 28 | -0.264 | 46.4% | 29.5% | 0.84 |
| **WARN** | `london_breakout` | `GBP_USD` | 18 | -1.267 | 44.4% | 24.6% | 0.50 |
| **WARN** | `london_breakout` | `USD_CHF` | 13 | -2.854 | 30.8% | 12.7% | 0.18 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 53 | -0.842 | 37.7% | 25.9% | 0.47 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 13 | -3.000 | 30.8% | 12.7% | 0.24 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 27 | -2.119 | 63.0% | 44.2% | 0.41 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 39 | -5.310 | 51.3% | 36.2% | 0.27 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 32 | -4.753 | 31.2% | 18.0% | 0.17 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 17 | -1.306 | 64.7% | 41.3% | 0.48 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 86 | -0.323 | 52.3% | 41.9% | 0.85 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 28 | -0.507 | 25.0% | 12.7% | 0.68 |
| **WARN** | `sr_fib_confluence` | `GBP_USD` | 23 | -0.743 | 56.5% | 36.8% | 0.73 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 14 | -2.000 | 64.3% | 38.8% | 0.37 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 34 | -1.962 | 32.4% | 19.1% | 0.34 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -1.282 | 41.2% | 21.6% | 0.27 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 17 | -1.435 | 41.2% | 21.6% | 0.42 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 10 | -3.030 | 60.0% | 31.3% | 0.32 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 35 | -1.169 | 54.3% | 38.2% | 0.69 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 31 | -1.239 | 64.5% | 46.9% | 0.64 |
| **WARN** | `xs_momentum` | `USD_JPY` | 15 | -4.287 | 40.0% | 19.8% | 0.10 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 5 | 1 | 4 | -12.200 | 20.0% | 3.6%-62.4% | 0.02 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 12 | 8 | 4 | +2.750 | 66.7% | 39.1%-86.2% | 2.71 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 23 | 8 | 15 | -7.352 | 34.8% | 18.8%-55.1% | 0.19 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 53 | 21 | 32 | -0.864 | 39.6% | 27.6%-53.1% | 0.56 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 29 | 7 | 22 | -3.124 | 24.1% | 12.2%-42.1% | 0.13 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `htf_false_breakout` | `EUR_JPY` | 2 | 0 | 2 | -12.750 | 0.0% | 0.0%-65.8% | 0.00 | `HTF_FALSE_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 28 | 13 | 15 | -0.264 | 46.4% | 29.5%-64.2% | 0.84 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 53 | 20 | 33 | -0.842 | 37.7% | 25.9%-51.2% | 0.47 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 27 | 17 | 10 | -2.119 | 63.0% | 44.2%-78.5% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 39 | 20 | 19 | -5.310 | 51.3% | 36.2%-66.1% | 0.27 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 32 | 10 | 22 | -4.753 | 31.2% | 18.0%-48.6% | 0.17 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 17 | 11 | 6 | -1.306 | 64.7% | 41.3%-82.7% | 0.48 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 86 | 45 | 41 | -0.323 | 52.3% | 41.9%-62.6% | 0.85 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 20 | 13 | 7 | +1.715 | 65.0% | 43.3%-81.9% | 1.82 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `GBP_USD` | 23 | 13 | 10 | -0.743 | 56.5% | 36.8%-74.4% | 0.73 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_liquidity_grab` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `SR_LIQUIDITY_GRAB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `stoch_trend_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `EUR_USD` | 4 | 1 | 3 | -2.100 | 25.0% | 4.6%-69.9% | 0.09 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `GBP_USD` | 9 | 3 | 6 | -6.911 | 33.3% | 12.1%-64.6% | 0.10 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 34 | 11 | 23 | -1.962 | 32.4% | 19.1%-49.2% | 0.34 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 17 | 7 | 10 | -1.282 | 41.2% | 21.6%-64.0% | 0.27 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 6 | 4 | 2 | -0.317 | 66.7% | 30.0%-90.3% | 0.76 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 17 | 7 | 10 | -1.435 | 41.2% | 21.6%-64.0% | 0.42 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 31 | 20 | 11 | -1.239 | 64.5% | 46.9%-78.9% | 0.64 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 15 | 6 | 9 | -4.287 | 40.0% | 19.8%-64.3% | 0.10 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
