# SHADOW_PROMOTE R2 Alert - 2026-08-03T02:36:41.460102+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `AUD_JPY` | 35 | -3.197 | 42.9% | 28.0% | 0.36 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 71 | -2.073 | 23.9% | 15.5% | 0.21 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 26 | -0.869 | 34.6% | 19.4% | 0.68 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 45 | -0.849 | 46.7% | 32.9% | 0.65 |
| **WARN** | `ob_retest` | `USD_JPY` | 17 | -2.700 | 47.1% | 26.2% | 0.65 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 14 | -1.886 | 42.9% | 21.4% | 0.51 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 18 | -2.344 | 50.0% | 29.0% | 0.44 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 15 | -1.207 | 60.0% | 35.7% | 0.62 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 26 | -2.623 | 50.0% | 32.1% | 0.43 |
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 29 | -4.993 | 41.4% | 25.5% | 0.27 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 10 | -1.930 | 60.0% | 31.3% | 0.59 |
...
| CRITICAL | `dt_sr_channel_reversal` | `AUD_JPY` | 35 | 15 | 20 | -3.197 | 42.9% | 28.0%-59.1% | 0.36 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 16 | 12 | 4 | +4.844 | 75.0% | 50.5%-89.8% | 5.97 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 71 | 17 | 54 | -2.073 | 23.9% | 15.5%-35.0% | 0.21 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 26 | 9 | 17 | -0.869 | 34.6% | 19.4%-53.8% | 0.68 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 45 | 21 | 24 | -0.849 | 46.7% | 32.9%-60.9% | 0.65 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `AUD_JPY` | 9 | 5 | 4 | +4.711 | 55.6% | 26.7%-81.1% | 2.43 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 14 | 6 | 8 | -1.886 | 42.9% | 21.4%-67.4% | 0.51 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 26 | 13 | 13 | -2.623 | 50.0% | 32.1%-67.9% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 29 | 12 | 17 | -4.993 | 41.4% | 25.5%-59.3% | 0.27 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 10 | 6 | 4 | -1.930 | 60.0% | 31.3%-83.2% | 0.59 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 9 | 7 | 2 | +0.100 | 77.8% | 45.3%-93.7% | 1.03 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
