# SHADOW_PROMOTE R2 Alert - 2026-05-18T15:29:00.692995+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 60 | -0.985 | 18.3% | 10.6% | 0.70 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 172 | -1.926 | 19.8% | 14.5% | 0.50 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 28 | -1.046 | 21.4% | 10.2% | 0.58 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 18 | -1.228 | 27.8% | 12.5% | 0.49 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 18 | -5.278 | 5.6% | 1.0% | 0.04 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 18 | -1.822 | 27.8% | 12.5% | 0.77 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 21 | -6.805 | 9.5% | 2.7% | 0.37 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 31 | -1.113 | 38.7% | 23.7% | 0.82 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 14 | -0.507 | 21.4% | 7.6% | 0.79 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 40 | -2.595 | 20.0% | 10.5% | 0.41 |
...
| OK | `bb_rsi_reversion` | `USD_CHF` | 2 | 0 | 2 | -3.800 | 0.0% | 0.0%-65.8% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `USD_JPY` | 58 | 28 | 30 | +0.371 | 48.3% | 35.9%-60.8% | 1.13 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 3 | 0 | 3 | -5.200 | 0.0% | 0.0%-56.2% | 0.00 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 8 | 0 | 8 | -9.062 | 0.0% | 0.0%-32.4% | 0.00 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 60 | 11 | 49 | -0.985 | 18.3% | 10.6%-29.9% | 0.70 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 172 | 34 | 138 | -1.926 | 19.8% | 14.5%-26.4% | 0.50 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `EUR_USD` | 28 | 6 | 22 | -1.046 | 21.4% | 10.2%-39.5% | 0.58 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_JPY` | 21 | 5 | 16 | +0.843 | 23.8% | 10.6%-45.1% | 1.28 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 18 | 5 | 13 | -1.228 | 27.8% | 12.5%-50.9% | 0.49 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 3 | 0 | 3 | -4.567 | 0.0% | 0.0%-56.2% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 18 | 5 | 13 | -1.822 | 27.8% | 12.5%-50.9% | 0.77 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 21 | 2 | 19 | -6.805 | 9.5% | 2.7%-28.9% | 0.37 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 40 | 8 | 32 | -2.595 | 20.0% | 10.5%-34.8% | 0.41 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_CHF` | 1 | 0 | 1 | -0.300 | 0.0% | 0.0%-79.3% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 63 | 8 | 55 | -10.310 | 12.7% | 6.6%-23.1% | 0.39 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `stoch_trend_pullback` | `USD_JPY` | 8 | 1 | 7 | -8.325 | 12.5% | 2.2%-47.1% | 0.14 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `EUR_USD` | 5 | 0 | 5 | -4.980 | 0.0% | 0.0%-43.4% | 0.00 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 10 | 4 | 6 | +1.980 | 40.0% | 16.8%-68.7% | 2.08 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 39 | 8 | 31 | -1.403 | 20.5% | 10.8%-35.5% | 0.66 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 11 | 8 | 3 | +11.164 | 72.7% | 43.4%-90.3% | 12.58 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 36 | 12 | 24 | -0.381 | 33.3% | 20.2%-49.7% | 0.94 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 34 | 9 | 25 | -2.944 | 26.5% | 14.6%-43.1% | 0.63 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
