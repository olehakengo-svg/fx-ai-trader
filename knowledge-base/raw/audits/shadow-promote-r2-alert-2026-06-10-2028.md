# SHADOW_PROMOTE R2 Alert - 2026-06-10T20:28:06.244119+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | -0.400 | 40.0% | 16.8% | 0.81 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 13 | -0.600 | 53.8% | 29.1% | 0.86 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 11 | -7.018 | 27.3% | 9.7% | 0.33 |
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 37 | -2.319 | 5.4% | 1.5% | 0.04 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 42 | -0.750 | 35.7% | 23.0% | 0.63 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 32 | -2.038 | 37.5% | 22.9% | 0.57 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 14 | -0.979 | 64.3% | 38.8% | 0.55 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 76 | -0.675 | 40.8% | 30.4% | 0.73 |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 14 | 7 | 7 | +1.836 | 50.0% | 26.8%-73.2% | 1.96 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | 4 | 6 | -0.400 | 40.0% | 16.8%-68.7% | 0.81 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 37 | 2 | 35 | -2.319 | 5.4% | 1.5%-17.7% | 0.04 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 42 | 15 | 27 | -0.750 | 35.7% | 23.0%-50.8% | 0.63 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `GBP_USD` | 14 | 6 | 8 | +0.479 | 42.9% | 21.4%-67.4% | 1.28 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 32 | 12 | 20 | -2.038 | 37.5% | 22.9%-54.7% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 14 | 9 | 5 | -0.979 | 64.3% | 38.8%-83.7% | 0.55 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 76 | 31 | 45 | -0.675 | 40.8% | 30.4%-52.0% | 0.73 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_JPY` | 9 | 5 | 4 | -2.456 | 55.6% | 26.7%-81.1% | 0.48 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `EUR_USD` | 17 | 11 | 6 | +7.035 | 64.7% | 41.3%-82.7% | 9.99 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
