# SHADOW_PROMOTE R2 Alert - 2026-07-24T08:24:14.898056+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `AUD_JPY` | 20 | -0.040 | 60.0% | 38.7% | 0.98 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 15 | -0.800 | 40.0% | 19.8% | 0.71 |
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 24 | -0.700 | 50.0% | 31.4% | 0.78 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 11 | -2.609 | 36.4% | 15.2% | 0.43 |
| **WARN** | `ema200_trend_reversal` | `USD_JPY` | 20 | -1.080 | 55.0% | 34.2% | 0.64 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 86 | -0.999 | 38.4% | 28.8% | 0.48 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -0.939 | 41.9% | 26.4% | 0.62 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 24 | -1.767 | 50.0% | 31.4% | 0.36 |
| **WARN** | `london_breakout` | `EUR_USD` | 18 | -2.306 | 27.8% | 12.5% | 0.13 |
| **WARN** | `london_breakout` | `GBP_USD` | 28 | -2.789 | 32.1% | 17.9% | 0.19 |
| **WARN** | `london_breakout` | `USD_JPY` | 13 | -2.538 | 30.8% | 12.7% | 0.14 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 61 | -1.370 | 34.4% | 23.7% | 0.39 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 20 | -1.845 | 55.0% | 34.2% | 0.49 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 16 | -3.175 | 50.0% | 28.0% | 0.20 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 19 | -2.289 | 57.9% | 36.3% | 0.37 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 39 | -2.274 | 51.3% | 36.2% | 0.49 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 34 | -4.900 | 61.8% | 45.0% | 0.26 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 36 | -1.194 | 55.6% | 39.6% | 0.63 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 29 | -2.921 | 48.3% | 31.4% | 0.31 |
| **WARN** | `trend_rebound` | `USD_JPY` | 16 | -1.681 | 25.0% | 10.2% | 0.23 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 76 | -0.997 | 43.4% | 32.9% | 0.55 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 21 | -1.633 | 28.6% | 13.8% | 0.22 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 36 | -2.650 | 50.0% | 34.5% | 0.32 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 40 | -0.070 | 65.0% | 49.5% | 0.98 |
...
| WARN | `dt_sr_channel_reversal` | `AUD_JPY` | 20 | 12 | 8 | -0.040 | 60.0% | 38.7%-78.1% | 0.98 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 15 | 6 | 9 | -0.800 | 40.0% | 19.8%-64.3% | 0.71 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 24 | 12 | 12 | -0.700 | 50.0% | 31.4%-68.6% | 0.78 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 86 | 33 | 53 | -0.999 | 38.4% | 28.8%-48.9% | 0.48 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 13 | 18 | -0.939 | 41.9% | 26.4%-59.2% | 0.62 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 18 | 5 | 13 | -2.306 | 27.8% | 12.5%-50.9% | 0.13 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `GBP_USD` | 28 | 9 | 19 | -2.789 | 32.1% | 17.9%-50.7% | 0.19 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 61 | 21 | 40 | -1.370 | 34.4% | 23.7%-47.0% | 0.39 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `EUR_USD` | 9 | 5 | 4 | -2.256 | 55.6% | 26.7%-81.1% | 0.51 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `EUR_USD` | 18 | 12 | 6 | +0.361 | 66.7% | 43.7%-83.7% | 1.21 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 7 | 6 | 1 | +1.714 | 85.7% | 48.7%-97.4% | 3.31 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `AUD_JPY` | 19 | 11 | 8 | -2.289 | 57.9% | 36.3%-76.9% | 0.37 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 39 | 20 | 19 | -2.274 | 51.3% | 36.2%-66.1% | 0.49 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 34 | 21 | 13 | -4.900 | 61.8% | 45.0%-76.1% | 0.26 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 36 | 20 | 16 | -1.194 | 55.6% | 39.6%-70.5% | 0.63 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 29 | 14 | 15 | -2.921 | 48.3% | 31.4%-65.6% | 0.31 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 16 | 4 | 12 | -1.681 | 25.0% | 10.2%-49.5% | 0.23 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `GBP_USD` | 51 | 30 | 21 | +0.716 | 58.8% | 45.2%-71.2% | 1.32 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 76 | 33 | 43 | -0.997 | 43.4% | 32.9%-54.6% | 0.55 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 21 | 6 | 15 | -1.633 | 28.6% | 13.8%-50.0% | 0.22 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 36 | 18 | 18 | -2.650 | 50.0% | 34.5%-65.5% | 0.32 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 44 | 29 | 15 | +0.373 | 65.9% | 51.1%-78.1% | 1.09 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 40 | 26 | 14 | -0.070 | 65.0% | 49.5%-77.9% | 0.98 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
