# SHADOW_PROMOTE R2 Alert - 2026-06-30T19:53:11.123809+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 83 | -0.947 | 39.8% | 29.9% | 0.54 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 41 | -0.546 | 43.9% | 29.9% | 0.75 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 14 | -4.164 | 35.7% | 16.3% | 0.13 |
| **WARN** | `london_breakout` | `USD_CHF` | 21 | -2.248 | 28.6% | 13.8% | 0.20 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 67 | -1.573 | 32.8% | 22.8% | 0.29 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 38 | -2.418 | 65.8% | 49.9% | 0.54 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 45 | -0.884 | 62.2% | 47.6% | 0.73 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 23 | -2.748 | 65.2% | 44.9% | 0.54 |
...
| OK | `donchian_momentum_breakout` | `AUD_USD` | 4 | 2 | 2 | -6.525 | 50.0% | 15.0%-85.0% | 0.28 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 2 | 2 | 0 | +6.850 | 100.0% | 34.2%-100.0% | n/a | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 83 | 33 | 50 | -0.947 | 39.8% | 29.9%-50.5% | 0.54 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 41 | 18 | 23 | -0.546 | 43.9% | 29.9%-59.0% | 0.75 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `htf_false_breakout` | `GBP_USD` | 1 | 1 | 0 | +2.100 | 100.0% | 20.7%-100.0% | n/a | `HTF_FALSE_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 67 | 22 | 45 | -1.573 | 32.8% | 22.8%-44.7% | 0.29 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 38 | 25 | 13 | -2.418 | 65.8% | 49.9%-78.8% | 0.54 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 45 | 28 | 17 | -0.884 | 62.2% | 47.6%-74.9% | 0.73 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 23 | 15 | 8 | -2.748 | 65.2% | 44.9%-81.2% | 0.54 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 10 | 7 | 3 | +1.200 | 70.0% | 39.7%-89.2% | 2.10 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `xs_momentum` | `USD_JPY` | 14 | 10 | 4 | +1.864 | 71.4% | 45.4%-88.3% | 2.79 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
