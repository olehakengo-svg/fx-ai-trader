# SHADOW_PROMOTE R2 Alert - 2026-08-14T13:00:46.110271+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 17 | -0.024 | 64.7% | 41.3% | 0.99 |
| **WARN** | `dt_sr_channel_reversal` | `AUD_JPY` | 18 | -5.894 | 33.3% | 16.3% | 0.17 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 22 | -1.409 | 36.4% | 19.7% | 0.37 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 31 | -0.642 | 54.8% | 37.8% | 0.81 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 50 | -1.930 | 20.0% | 11.2% | 0.17 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 22 | -1.155 | 27.3% | 13.2% | 0.61 |
| **WARN** | `london_breakout` | `EUR_USD` | 25 | -0.492 | 32.0% | 17.2% | 0.65 |
...
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 26 | -1.077 | 50.0% | 32.1% | 0.72 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 26 | -2.992 | 38.5% | 22.4% | 0.42 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 25 | -4.112 | 52.0% | 33.5% | 0.38 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 24 | -6.067 | 45.8% | 27.9% | 0.25 |
| **WARN** | `sr_break_retest` | `GBP_USD` | 21 | -2.076 | 52.4% | 32.4% | 0.43 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 42 | -2.795 | 47.6% | 33.4% | 0.46 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 10 | -1.080 | 30.0% | 10.8% | 0.44 |
| **WARN** | `trend_rebound` | `USD_JPY` | 10 | -0.110 | 50.0% | 23.7% | 0.94 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 19 | -4.484 | 57.9% | 36.3% | 0.13 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 25 | -3.300 | 40.0% | 23.4% | 0.29 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 51 | -1.751 | 33.3% | 22.0% | 0.55 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 19 | -1.442 | 26.3% | 11.8% | 0.37 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -1.217 | 33.3% | 13.8% | 0.64 |
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 23 | -2.517 | 34.8% | 18.8% | 0.48 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 22 | -0.605 | 59.1% | 38.7% | 0.86 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 13 | -0.731 | 69.2% | 42.4% | 0.85 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 19 | -2.353 | 42.1% | 23.1% | 0.41 |
...
| OK | `donchian_momentum_breakout` | `EUR_USD` | 6 | 5 | 1 | +3.067 | 83.3% | 43.6%-97.0% | 2.19 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 6 | 3 | 3 | -3.917 | 50.0% | 18.8%-81.2% | 0.57 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 17 | 11 | 6 | -0.024 | 64.7% | 41.3%-82.7% | 0.99 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `AUD_JPY` | 18 | 6 | 12 | -5.894 | 33.3% | 16.3%-56.3% | 0.17 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 22 | 8 | 14 | -1.409 | 36.4% | 19.7%-57.0% | 0.37 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 31 | 17 | 14 | -0.642 | 54.8% | 37.8%-70.8% | 0.81 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `lin_reg_channel` | `EUR_USD` | 9 | 3 | 6 | -2.256 | 33.3% | 12.1%-64.6% | 0.41 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `EUR_USD` | 25 | 8 | 17 | -0.492 | 32.0% | 17.2%-51.6% | 0.65 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_session_breakout` | `EUR_USD` | 3 | 1 | 2 | +0.233 | 33.3% | 6.1%-79.2% | 1.04 | `LONDON_SESSION_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `london_session_breakout` | `GBP_USD` | 2 | 2 | 0 | +1.200 | 100.0% | 34.2%-100.0% | n/a | `LONDON_SESSION_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 26 | 13 | 13 | -1.077 | 50.0% | 32.1%-67.9% | 0.72 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 4 | 3 | 1 | +3.550 | 75.0% | 30.1%-95.4% | 3.84 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 13 | 9 | 4 | +1.254 | 69.2% | 42.4%-87.3% | 1.65 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 3 | 1 | 2 | -2.867 | 33.3% | 6.1%-79.2% | 0.62 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 6 | 2 | 4 | +1.683 | 33.3% | 9.7%-70.0% | 1.53 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `AUD_JPY` | 26 | 10 | 16 | -2.992 | 38.5% | 22.4%-57.5% | 0.42 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 25 | 13 | 12 | -4.112 | 52.0% | 33.5%-70.0% | 0.38 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 24 | 11 | 13 | -6.067 | 45.8% | 27.9%-64.9% | 0.25 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_USD` | 21 | 11 | 10 | -2.076 | 52.4% | 32.4%-71.7% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 42 | 20 | 22 | -2.795 | 47.6% | 33.4%-62.3% | 0.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `EUR_USD` | 10 | 3 | 7 | -1.080 | 30.0% | 10.8%-60.3% | 0.44 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 10 | 5 | 5 | -0.110 | 50.0% | 23.7%-76.3% | 0.94 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 25 | 10 | 15 | -3.300 | 40.0% | 23.4%-59.3% | 0.29 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 51 | 17 | 34 | -1.751 | 33.3% | 22.0%-47.0% | 0.55 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 19 | 5 | 14 | -1.442 | 26.3% | 11.8%-48.8% | 0.37 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `GBP_USD` | 5 | 1 | 4 | -3.000 | 20.0% | 3.6%-62.4% | 0.12 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 12 | 4 | 8 | -1.217 | 33.3% | 13.8%-60.9% | 0.64 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `AUD_JPY` | 23 | 8 | 15 | -2.517 | 34.8% | 18.8%-55.1% | 0.48 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 22 | 13 | 9 | -0.605 | 59.1% | 38.7%-76.7% | 0.86 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `EUR_USD` | 13 | 8 | 5 | +1.385 | 61.5% | 35.5%-82.3% | 1.49 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 19 | 8 | 11 | -2.353 | 42.1% | 23.1%-63.7% | 0.41 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `USD_JPY` | 18 | 11 | 7 | +0.106 | 61.1% | 38.6%-79.7% | 1.03 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
