# SHADOW_PROMOTE R2 Alert - 2026-07-16T08:08:52.439826+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 18 | -1.106 | 44.4% | 24.6% | 0.72 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 80 | -0.584 | 47.5% | 36.9% | 0.70 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 82 | -1.493 | 35.4% | 25.9% | 0.36 |
...
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 18 | 8 | 10 | -1.106 | 44.4% | 24.6%-66.3% | 0.72 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 80 | 38 | 42 | -0.584 | 47.5% | 36.9%-58.3% | 0.70 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 82 | 29 | 53 | -1.493 | 35.4% | 25.9%-46.2% | 0.36 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 13 | 7 | 6 | -2.362 | 53.8% | 29.1%-76.8% | 0.36 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 39 | 25 | 14 | -0.892 | 64.1% | 48.4%-77.3% | 0.69 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 27 | 14 | 13 | -1.378 | 51.9% | 34.0%-69.3% | 0.42 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
