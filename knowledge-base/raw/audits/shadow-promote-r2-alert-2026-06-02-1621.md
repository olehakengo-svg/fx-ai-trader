# SHADOW_PROMOTE R2 Alert - 2026-06-02T16:21:24.935556+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 64 | -2.219 | 1.6% | 0.3% | 0.09 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 36 | -0.831 | 25.0% | 13.8% | 0.64 |
...
| **WARN** | `london_breakout` | `GBP_USD` | 17 | -2.941 | 11.8% | 3.3% | 0.23 |
| **WARN** | `london_breakout` | `USD_CHF` | 14 | -2.129 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 37 | -1.943 | 16.2% | 7.7% | 0.26 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 34 | -4.062 | 20.6% | 10.3% | 0.45 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 30 | -4.527 | 13.3% | 5.3% | 0.40 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 66 | -0.361 | 31.8% | 21.8% | 0.91 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 41 | -1.295 | 19.5% | 10.2% | 0.70 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 41 | -0.902 | 24.4% | 13.8% | 0.69 |
| **CRITICAL** | `sr_channel_reversal` | `USD_CHF` | 33 | -1.655 | 3.0% | 0.5% | 0.17 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 83 | -0.688 | 32.5% | 23.4% | 0.81 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 88 | -4.685 | 13.6% | 8.0% | 0.32 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 39 | -0.518 | 30.8% | 18.6% | 0.92 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 30 | 16 | 14 | +2.350 | 53.3% | 36.1%-69.8% | 1.76 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 64 | 1 | 63 | -2.219 | 1.6% | 0.3%-8.3% | 0.09 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 36 | 9 | 27 | -0.831 | 25.0% | 13.8%-41.1% | 0.64 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `GBP_USD` | 17 | 2 | 15 | -2.941 | 11.8% | 3.3%-34.3% | 0.23 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 37 | 6 | 31 | -1.943 | 16.2% | 7.7%-31.1% | 0.26 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 34 | 7 | 27 | -4.062 | 20.6% | 10.3%-36.8% | 0.45 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 30 | 4 | 26 | -4.527 | 13.3% | 5.3%-29.7% | 0.40 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 66 | 21 | 45 | -0.361 | 31.8% | 21.8%-43.8% | 0.91 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 41 | 8 | 33 | -1.295 | 19.5% | 10.2%-34.0% | 0.70 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 41 | 10 | 31 | -0.902 | 24.4% | 13.8%-39.3% | 0.69 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 83 | 27 | 56 | -0.688 | 32.5% | 23.4%-43.2% | 0.81 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 88 | 12 | 76 | -4.685 | 13.6% | 8.0%-22.3% | 0.32 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_liquidity_grab` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `SR_LIQUIDITY_GRAB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `stoch_trend_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `EUR_USD` | 5 | 0 | 5 | -2.820 | 0.0% | 0.0%-43.4% | 0.00 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 39 | 12 | 27 | -0.518 | 30.8% | 18.6%-46.4% | 0.92 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
