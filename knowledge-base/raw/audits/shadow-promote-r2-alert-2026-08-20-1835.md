# SHADOW_PROMOTE R2 Alert - 2026-08-20T18:35:13.976586+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 15 | -3.333 | 6.7% | 1.2% | 0.03 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 20 | -1.665 | 40.0% | 21.9% | 0.68 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 26 | -0.019 | 46.2% | 28.8% | 0.99 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | -4.490 | 47.6% | 28.3% | 0.35 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 35 | -0.300 | 51.4% | 35.6% | 0.91 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 42 | -1.921 | 21.4% | 11.7% | 0.18 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 17 | -2.706 | 52.9% | 31.0% | 0.36 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 12 | 8 | 4 | +0.042 | 66.7% | 39.1%-86.2% | 1.02 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 15 | 1 | 14 | -3.333 | 6.7% | 1.2%-29.8% | 0.03 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 20 | 8 | 12 | -1.665 | 40.0% | 21.9%-61.3% | 0.68 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 26 | 12 | 14 | -0.019 | 46.2% | 28.8%-64.5% | 0.99 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 35 | 18 | 17 | -0.300 | 51.4% | 35.6%-67.0% | 0.91 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 42 | 9 | 33 | -1.921 | 21.4% | 11.7%-35.9% | 0.18 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 55 | 27 | 28 | -2.124 | 49.1% | 36.4%-61.9% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 38 | 14 | 24 | -1.732 | 36.8% | 23.4%-52.7% | 0.61 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 35 | 17 | 18 | -0.794 | 48.6% | 33.0%-64.4% | 0.79 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 17 | 9 | 8 | -2.706 | 52.9% | 31.0%-73.8% | 0.36 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
