# SHADOW_PROMOTE R2 Alert - 2026-09-13T11:05:28.970571+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 12 | -0.250 | 50.0% | 25.4% | 0.95 |
...
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 28 | -0.418 | 64.3% | 45.8% | 0.85 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 49 | -0.947 | 40.8% | 28.2% | 0.54 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 15 | -3.340 | 46.7% | 24.8% | 0.45 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 42 | -0.124 | 57.1% | 42.2% | 0.97 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 38 | -1.005 | 50.0% | 34.8% | 0.76 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 22 | -0.495 | 50.0% | 30.7% | 0.74 |
| **WARN** | `trend_rebound` | `EUR_USD` | 14 | -0.207 | 35.7% | 16.3% | 0.85 |
| **WARN** | `trend_rebound` | `USD_JPY` | 11 | -1.900 | 27.3% | 9.7% | 0.25 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 25 | -2.816 | 56.0% | 37.1% | 0.29 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 22 | -1.677 | 13.6% | 4.7% | 0.27 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 53 | -0.357 | 62.3% | 48.8% | 0.90 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 18 | -2.400 | 50.0% | 29.0% | 0.59 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 18 | -1.367 | 66.7% | 43.7% | 0.74 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 20 | -3.505 | 30.0% | 14.5% | 0.16 |
...
| OK | `bb_squeeze_breakout` | `EUR_USD` | 2 | 0 | 2 | -3.000 | 0.0% | 0.0%-65.8% | 0.00 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_squeeze_breakout` | `GBP_USD` | 1 | 0 | 1 | -4.500 | 0.0% | 0.0%-79.3% | 0.00 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 12 | 6 | 6 | -0.250 | 50.0% | 25.4%-74.6% | 0.95 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 28 | 18 | 10 | -0.418 | 64.3% | 45.8%-79.3% | 0.85 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 49 | 20 | 29 | -0.947 | 40.8% | 28.2%-54.8% | 0.54 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `orb_trap` | `USD_JPY` | 3 | 2 | 1 | -3.600 | 66.7% | 20.8%-93.9% | 0.45 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 8 | 5 | 3 | -3.000 | 62.5% | 30.6%-86.3% | 0.47 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 38 | 19 | 19 | -1.005 | 50.0% | 34.8%-65.2% | 0.76 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 22 | 11 | 11 | -0.495 | 50.0% | 30.7%-69.3% | 0.74 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `EUR_USD` | 14 | 5 | 9 | -0.207 | 35.7% | 16.3%-61.2% | 0.85 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 25 | 14 | 11 | -2.816 | 56.0% | 37.1%-73.3% | 0.29 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 22 | 3 | 19 | -1.677 | 13.6% | 4.7%-33.3% | 0.27 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 53 | 33 | 20 | -0.357 | 62.3% | 48.8%-74.1% | 0.90 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 18 | 9 | 9 | -2.400 | 50.0% | 29.0%-71.0% | 0.59 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `EUR_USD` | 9 | 2 | 7 | -5.544 | 22.2% | 6.3%-54.7% | 0.16 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 20 | 6 | 14 | -3.505 | 30.0% | 14.5%-51.9% | 0.16 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
