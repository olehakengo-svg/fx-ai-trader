# SHADOW_PROMOTE R2 Alert - 2026-09-06T10:15:50.868864+00:00
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 23 | -1.400 | 52.2% | 33.0% | 0.72 |
...
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 29 | 11 | 18 | -1.686 | 37.9% | 22.7%-56.0% | 0.44 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 49 | 18 | 31 | -0.620 | 36.7% | 24.7%-50.7% | 0.66 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 47 | 24 | 23 | -0.683 | 51.1% | 37.2%-64.7% | 0.84 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 8 | 3 | 5 | -1.262 | 37.5% | 13.7%-69.4% | 0.59 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 23 | 12 | 11 | -1.400 | 52.2% | 33.0%-70.8% | 0.72 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
