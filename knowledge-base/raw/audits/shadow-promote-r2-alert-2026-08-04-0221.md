# SHADOW_PROMOTE R2 Alert - 2026-08-04T02:21:26.605660+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 27 | -1.174 | 40.7% | 24.5% | 0.56 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | -2.653 | 53.3% | 30.1% | 0.39 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | -2.000 | 66.7% | 45.4% | 0.51 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 74 | -1.841 | 21.6% | 13.8% | 0.18 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 52 | -0.288 | 50.0% | 36.9% | 0.88 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 37 | -3.243 | 54.1% | 38.4% | 0.42 |
...
| **WARN** | `three_bar_reversal` | `EUR_USD` | 14 | -0.850 | 42.9% | 21.4% | 0.48 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 74 | -1.439 | 39.2% | 28.9% | 0.52 |
...
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 12 | -6.767 | 33.3% | 13.8% | 0.06 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 40 | -1.435 | 60.0% | 44.6% | 0.54 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 27 | 11 | 16 | -1.174 | 40.7% | 24.5%-59.3% | 0.56 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | 8 | 7 | -2.653 | 53.3% | 30.1%-75.2% | 0.39 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 15 | 8 | 7 | +0.507 | 53.3% | 30.1%-75.2% | 1.22 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | 14 | 7 | -2.000 | 66.7% | 45.4%-82.8% | 0.51 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 15 | 13 | 2 | +5.627 | 86.7% | 62.1%-96.3% | 10.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 13 | 8 | 5 | +0.254 | 61.5% | 35.5%-82.3% | 1.09 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 74 | 16 | 58 | -1.841 | 21.6% | 13.8%-32.3% | 0.18 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 52 | 26 | 26 | -0.288 | 50.0% | 36.9%-63.1% | 0.88 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 37 | 20 | 17 | -3.243 | 54.1% | 38.4%-69.0% | 0.42 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `EUR_USD` | 14 | 6 | 8 | -0.850 | 42.9% | 21.4%-67.4% | 0.48 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `GBP_USD` | 7 | 1 | 6 | -4.186 | 14.3% | 2.6%-51.3% | 0.07 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `USD_JPY` | 9 | 6 | 3 | +2.089 | 66.7% | 35.4%-87.9% | 2.68 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 74 | 29 | 45 | -1.439 | 39.2% | 28.9%-50.6% | 0.52 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `USD_JPY` | 12 | 4 | 8 | -6.767 | 33.3% | 13.8%-60.9% | 0.06 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `EUR_USD` | 40 | 24 | 16 | -1.435 | 60.0% | 44.6%-73.7% | 0.54 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 59 | 44 | 15 | +1.008 | 74.6% | 62.2%-83.9% | 1.40 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 52 | 31 | 21 | +0.042 | 59.6% | 46.1%-71.8% | 1.01 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
