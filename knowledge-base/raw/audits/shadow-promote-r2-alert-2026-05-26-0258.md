# SHADOW_PROMOTE R2 Alert - 2026-05-26T02:58:06.808508+00:00
...
| **WARN** | `bb_rsi_reversion` | `USD_CHF` | 17 | -2.794 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `dt_bb_rsi_mr` | `GBP_USD` | 35 | -0.054 | 40.0% | 25.6% | 0.99 |
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 21 | -2.490 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 50 | -1.426 | 20.0% | 11.2% | 0.57 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 30 | -0.380 | 26.7% | 14.2% | 0.83 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 15 | -3.427 | 13.3% | 3.7% | 0.27 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 25 | -3.292 | 24.0% | 11.5% | 0.33 |
| **WARN** | `london_breakout` | `EUR_USD` | 18 | -2.144 | 16.7% | 5.8% | 0.28 |
...
| **WARN** | `orb_trap` | `EUR_USD` | 13 | -1.669 | 7.7% | 1.4% | 0.12 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 41 | -1.905 | 19.5% | 10.2% | 0.56 |
| **WARN** | `vol_momentum_scalp` | `USD_JPY` | 12 | -3.158 | 8.3% | 1.5% | 0.16 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 15 | -2.907 | 20.0% | 7.0% | 0.57 |
| **WARN** | `wick_imbalance_reversion` | `EUR_USD` | 24 | -1.683 | 20.8% | 9.2% | 0.49 |
...
| WARN | `bb_rsi_reversion` | `USD_CHF` | 17 | 0 | 17 | -2.794 | 0.0% | 0.0%-18.4% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `USD_JPY` | 17 | 8 | 9 | +0.200 | 47.1% | 26.2%-69.0% | 1.07 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_squeeze_breakout` | `EUR_USD` | 3 | 0 | 3 | -2.600 | 0.0% | 0.0%-56.2% | 0.00 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 9 | 0 | 9 | -9.467 | 0.0% | 0.0%-29.9% | 0.00 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema_trend_scalp` | `USD_CHF` | 21 | 0 | 21 | -2.490 | 0.0% | 0.0%-15.5% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 50 | 10 | 40 | -1.426 | 20.0% | 11.2%-33.0% | 0.57 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 30 | 8 | 22 | -0.380 | 26.7% | 14.2%-44.4% | 0.83 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 15 | 2 | 13 | -3.427 | 13.3% | 3.7%-37.9% | 0.27 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `engulfing_bb` | `USD_CHF` | 6 | 0 | 6 | -1.550 | 0.0% | 0.0%-39.0% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `engulfing_bb` | `USD_JPY` | 11 | 2 | 9 | +2.391 | 18.2% | 5.1%-47.7% | 1.74 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `gold_pips_hunter` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `GOLD_PIPS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `gold_trend_momentum` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `GOLD_TREND_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `gold_vol_break` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `GOLD_VOL_BREAK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `htf_false_breakout` | `EUR_JPY` | 1 | 1 | 0 | +1.300 | 100.0% | 20.7%-100.0% | n/a | `HTF_FALSE_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 18 | 3 | 15 | -2.144 | 16.7% | 5.8%-39.2% | 0.28 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `orb_trap` | `EUR_USD` | 13 | 1 | 12 | -1.669 | 7.7% | 1.4%-33.3% | 0.12 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `post_news_vol` | `USD_JPY` | 1 | 1 | 0 | +14.800 | 100.0% | 20.7%-100.0% | n/a | `POST_NEWS_VOL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 9 | 6 | 3 | +9.556 | 66.7% | 35.4%-87.9% | 5.94 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_channel_reversal` | `USD_JPY` | 12 | 4 | 8 | +0.225 | 33.3% | 13.8%-60.9% | 1.10 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `USD_JPY` | 16 | 4 | 12 | +2.013 | 25.0% | 10.2%-49.5% | 1.21 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 41 | 8 | 33 | -1.905 | 19.5% | 10.2%-34.0% | 0.56 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `GBP_USD` | 10 | 5 | 5 | +3.830 | 50.0% | 23.7%-76.3% | 3.18 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_USD` | 24 | 5 | 19 | -1.683 | 20.8% | 9.2%-40.5% | 0.49 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
