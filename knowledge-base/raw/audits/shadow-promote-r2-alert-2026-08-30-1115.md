# SHADOW_PROMOTE R2 Alert - 2026-08-30T11:15:39.914257+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 30 | -0.797 | 43.3% | 27.4% | 0.74 |
...
| **WARN** | `ob_retest` | `USD_JPY` | 14 | -4.436 | 50.0% | 26.8% | 0.45 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 57 | -1.770 | 49.1% | 36.6% | 0.63 |
| **WARN** | `trend_rebound` | `USD_JPY` | 10 | -0.230 | 40.0% | 16.8% | 0.90 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 22 | -3.595 | 45.5% | 26.9% | 0.14 |
| **WARN** | `vol_momentum_scalp` | `USD_JPY` | 21 | -3.919 | 28.6% | 13.8% | 0.31 |
...
| **WARN** | `xs_momentum` | `GBP_USD` | 16 | -3.475 | 50.0% | 28.0% | 0.27 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 36 | -4.461 | 50.0% | 34.5% | 0.40 |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 30 | 13 | 17 | -0.797 | 43.3% | 27.4%-60.8% | 0.74 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `AUD_JPY` | 5 | 5 | 0 | +15.880 | 100.0% | 56.6%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `USD_JPY` | 14 | 7 | 7 | -4.436 | 50.0% | 26.8%-73.2% | 0.45 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `GBP_JPY` | 8 | 4 | 4 | -6.350 | 50.0% | 21.5%-78.5% | 0.33 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `GBP_USD` | 4 | 2 | 2 | -1.400 | 50.0% | 15.0%-85.0% | 0.59 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 57 | 28 | 29 | -1.770 | 49.1% | 36.6%-61.7% | 0.63 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `EUR_USD` | 9 | 4 | 5 | +0.622 | 44.4% | 18.9%-73.3% | 1.47 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 22 | 10 | 12 | -3.595 | 45.5% | 26.9%-65.3% | 0.14 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `GBP_USD` | 7 | 2 | 5 | -4.671 | 28.6% | 8.2%-64.1% | 0.06 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_momentum_scalp` | `USD_JPY` | 21 | 6 | 15 | -3.919 | 28.6% | 13.8%-50.0% | 0.31 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vwap_mean_reversion` | `EUR_USD` | 5 | 2 | 3 | -4.060 | 40.0% | 11.8%-76.9% | 0.30 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `GBP_USD` | 16 | 8 | 8 | -3.475 | 50.0% | 28.0%-72.0% | 0.27 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 36 | 18 | 18 | -4.461 | 50.0% | 34.5%-65.5% | 0.40 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
