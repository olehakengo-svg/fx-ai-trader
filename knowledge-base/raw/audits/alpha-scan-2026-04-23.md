...
| BUY | GBP_USD | 12 | 41.7% | -2.36 | -28.3 | 0.39 |
| SELL | EUR_USD | 19 | 15.8% | -2.50 | -47.5 | 0.19 |
| SELL | GBP_USD | 17 | 11.8% | -6.05 | -102.9 | 0.06 |

### direction x regime
| direction | regime | N | WR% | EV(pip) | PnL(pip) | PF |
|---|---|---|---|---|---|---|
| BUY | RANGE | 57 | 54.4% | +0.72 | +41.3 | 1.25 |
...
| SELL | TREND_BEAR | 48 | 35.4% | -1.75 | -84.0 | 0.45 |
...
- **SELL x GBP_USD** — EV=-6.05 pip, N=17, WR=11.8%
