# SHADOW_PROMOTE R2 Alert - 2026-05-19T19:50:27.419579+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 36 | -0.631 | 22.2% | 11.7% | 0.75 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 57 | -0.818 | 19.3% | 11.1% | 0.74 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 135 | -1.412 | 21.5% | 15.4% | 0.61 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 22 | -1.795 | 22.7% | 10.1% | 0.35 |
...
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 49 | -2.463 | 20.4% | 11.5% | 0.41 |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 36 | 8 | 28 | -0.631 | 22.2% | 11.7%-38.1% | 0.75 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 57 | 11 | 46 | -0.818 | 19.3% | 11.1%-31.3% | 0.74 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 135 | 29 | 106 | -1.412 | 21.5% | 15.4%-29.1% | 0.61 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 22 | 5 | 17 | -1.795 | 22.7% | 10.1%-43.4% | 0.35 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 49 | 10 | 39 | -2.463 | 20.4% | 11.5%-33.6% | 0.41 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
