# SHADOW_PROMOTE R2 Alert - 2026-08-17T12:38:33.675416+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 18 | -0.356 | 61.1% | 38.6% | 0.87 |
| **WARN** | `dt_sr_channel_reversal` | `AUD_JPY` | 18 | -5.894 | 33.3% | 16.3% | 0.17 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 19 | -2.105 | 26.3% | 11.8% | 0.18 |
...
| **WARN** | `lin_reg_channel` | `EUR_USD` | 11 | -3.064 | 27.3% | 9.7% | 0.30 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 48 | -2.910 | 47.9% | 34.5% | 0.42 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 10 | -1.080 | 30.0% | 10.8% | 0.44 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 20 | -4.190 | 60.0% | 38.7% | 0.14 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 20 | -2.190 | 45.0% | 25.8% | 0.42 |
...
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 18 | 11 | 7 | -0.356 | 61.1% | 38.6%-79.7% | 0.87 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 19 | 5 | 14 | -2.105 | 26.3% | 11.8%-48.8% | 0.18 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 11 | 3 | 8 | -3.064 | 27.3% | 9.7%-56.6% | 0.30 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 48 | 23 | 25 | -2.910 | 47.9% | 34.5%-61.7% | 0.42 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 20 | 12 | 8 | -4.190 | 60.0% | 38.7%-78.1% | 0.14 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 20 | 9 | 11 | -2.190 | 45.0% | 25.8%-65.8% | 0.42 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
