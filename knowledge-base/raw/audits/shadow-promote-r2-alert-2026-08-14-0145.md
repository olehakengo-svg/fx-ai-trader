# SHADOW_PROMOTE R2 Alert - 2026-08-14T01:45:46.451761+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 23 | -1.022 | 39.1% | 22.2% | 0.53 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 27 | -4.196 | 51.9% | 34.0% | 0.36 |
...
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 28 | -2.721 | 46.4% | 29.5% | 0.34 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 22 | -2.736 | 54.5% | 34.7% | 0.34 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 42 | -1.169 | 64.3% | 49.2% | 0.67 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 57 | -2.942 | 54.4% | 41.6% | 0.57 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 23 | 9 | 14 | -1.022 | 39.1% | 22.2%-59.2% | 0.53 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 27 | 14 | 13 | -4.196 | 51.9% | 34.0%-69.3% | 0.36 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 28 | 13 | 15 | -2.721 | 46.4% | 29.5%-64.2% | 0.34 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 22 | 12 | 10 | -2.736 | 54.5% | 34.7%-73.1% | 0.34 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 42 | 27 | 15 | -1.169 | 64.3% | 49.2%-77.0% | 0.67 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 57 | 31 | 26 | -2.942 | 54.4% | 41.6%-66.6% | 0.57 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
