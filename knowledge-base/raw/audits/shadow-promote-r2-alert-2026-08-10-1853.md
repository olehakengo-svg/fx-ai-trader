# SHADOW_PROMOTE R2 Alert - 2026-08-10T18:53:50.067326+00:00
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 32 | -3.503 | 50.0% | 33.6% | 0.43 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 9 | 5 | 4 | -5.356 | 55.6% | 26.7%-81.1% | 0.41 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 20 | 4 | 16 | -1.885 | 20.0% | 8.1%-41.6% | 0.11 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 48 | 21 | 27 | -0.985 | 43.8% | 30.7%-57.7% | 0.67 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 10 | 6 | 4 | -0.250 | 60.0% | 31.3%-83.2% | 0.94 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 32 | 16 | 16 | -3.503 | 50.0% | 33.6%-66.4% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
