# SHADOW_PROMOTE R2 Alert - 2026-07-02T19:21:29.175216+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 90 | -0.784 | 43.3% | 33.6% | 0.61 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 42 | -0.671 | 45.2% | 31.2% | 0.71 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 13 | -4.315 | 30.8% | 12.7% | 0.16 |
| **WARN** | `london_breakout` | `USD_CHF` | 26 | -1.485 | 30.8% | 16.5% | 0.30 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 64 | -1.373 | 37.5% | 26.7% | 0.37 |
| **WARN** | `ob_retest` | `GBP_USD` | 10 | -5.260 | 50.0% | 23.7% | 0.16 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 16 | -2.031 | 43.8% | 23.1% | 0.36 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 46 | -0.904 | 63.0% | 48.6% | 0.71 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 26 | -0.623 | 57.7% | 38.9% | 0.80 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 42 | -3.079 | 28.6% | 17.2% | 0.21 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 19 | -2.416 | 31.6% | 15.4% | 0.19 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 18 | -1.144 | 66.7% | 43.7% | 0.70 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 25 | -2.316 | 68.0% | 48.4% | 0.58 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 90 | 39 | 51 | -0.784 | 43.3% | 33.6%-53.6% | 0.61 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 42 | 19 | 23 | -0.671 | 45.2% | 31.2%-60.1% | 0.71 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `engulfing_bb` | `USD_CHF` | 2 | 1 | 1 | -0.400 | 50.0% | 9.5%-90.5% | 0.67 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 64 | 24 | 40 | -1.373 | 37.5% | 26.7%-49.7% | 0.37 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 16 | 7 | 9 | -2.031 | 43.8% | 23.1%-66.8% | 0.36 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `GBP_JPY` | 32 | 25 | 7 | +0.059 | 78.1% | 61.2%-89.0% | 1.02 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 46 | 29 | 17 | -0.904 | 63.0% | 48.6%-75.5% | 0.71 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 26 | 15 | 11 | -0.623 | 57.7% | 38.9%-74.5% | 0.80 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 4 | 4 | 0 | +3.350 | 100.0% | 51.0%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 42 | 12 | 30 | -3.079 | 28.6% | 17.2%-43.6% | 0.21 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 19 | 6 | 13 | -2.416 | 31.6% | 15.4%-54.0% | 0.19 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 25 | 17 | 8 | -2.316 | 68.0% | 48.4%-82.8% | 0.58 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
