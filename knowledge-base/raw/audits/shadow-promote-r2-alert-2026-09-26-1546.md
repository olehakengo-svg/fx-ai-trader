# SHADOW_PROMOTE R2 Alert - 2026-09-26T15:46:48.409634+00:00
...
| **WARN** | `bb_squeeze_breakout` | `USD_JPY` | 11 | -0.382 | 36.4% | 15.2% | 0.83 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 46 | -4.828 | 37.0% | 24.5% | 0.22 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 25 | -1.384 | 40.0% | 23.4% | 0.51 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 48 | -1.473 | 52.1% | 38.3% | 0.70 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 34 | -3.918 | 35.3% | 21.5% | 0.25 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 14 | -1.464 | 35.7% | 16.3% | 0.44 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 27 | -1.711 | 25.9% | 13.2% | 0.46 |
| **WARN** | `trend_rebound` | `USD_JPY` | 10 | -0.830 | 50.0% | 23.7% | 0.55 |
| **CRITICAL** | `trendline_sweep` | `GBP_USD` | 30 | -1.807 | 66.7% | 48.8% | 0.44 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 25 | -2.496 | 12.0% | 4.2% | 0.04 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 47 | -2.768 | 46.8% | 33.3% | 0.48 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 12 | -3.442 | 58.3% | 32.0% | 0.57 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 21 | -3.095 | 33.3% | 17.2% | 0.21 |
...
| OK | `bb_squeeze_breakout` | `GBP_USD` | 7 | 1 | 6 | -3.400 | 14.3% | 2.6%-51.3% | 0.04 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_squeeze_breakout` | `USD_CHF` | 2 | 0 | 2 | -2.350 | 0.0% | 0.0%-65.8% | 0.00 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `bb_squeeze_breakout` | `USD_JPY` | 11 | 4 | 7 | -0.382 | 36.4% | 15.2%-64.6% | 0.83 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 46 | 17 | 29 | -4.828 | 37.0% | 24.5%-51.4% | 0.22 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 25 | 10 | 15 | -1.384 | 40.0% | 23.4%-59.3% | 0.51 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 48 | 25 | 23 | -1.473 | 52.1% | 38.3%-65.5% | 0.70 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `EUR_USD` | 14 | 5 | 9 | -1.464 | 35.7% | 16.3%-61.2% | 0.44 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `GBP_USD` | 7 | 3 | 4 | -1.029 | 42.9% | 15.8%-75.0% | 0.57 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `three_bar_reversal` | `USD_JPY` | 27 | 7 | 20 | -1.711 | 25.9% | 13.2%-44.7% | 0.46 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_USD` | 9 | 4 | 5 | -2.844 | 44.4% | 18.9%-73.3% | 0.43 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `trendline_sweep` | `GBP_USD` | 30 | 20 | 10 | -1.807 | 66.7% | 48.8%-80.8% | 0.44 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 25 | 3 | 22 | -2.496 | 12.0% | 4.2%-30.0% | 0.04 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vwap_mean_reversion` | `EUR_GBP` | 7 | 1 | 6 | -2.286 | 14.3% | 2.6%-51.3% | 0.17 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `EUR_JPY` | 3 | 2 | 1 | +1.733 | 66.7% | 20.8%-93.9% | 1.57 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `EUR_USD` | 1 | 0 | 1 | -5.300 | 0.0% | 0.0%-79.3% | 0.00 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 47 | 22 | 25 | -2.768 | 46.8% | 33.3%-60.8% | 0.48 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 12 | 7 | 5 | -3.442 | 58.3% | 32.0%-80.7% | 0.57 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 21 | 7 | 14 | -3.095 | 33.3% | 17.2%-54.6% | 0.21 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `USD_JPY` | 19 | 15 | 4 | +3.089 | 78.9% | 56.7%-91.5% | 2.87 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
