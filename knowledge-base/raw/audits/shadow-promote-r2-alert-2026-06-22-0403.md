# SHADOW_PROMOTE R2 Alert - 2026-06-22T04:03:07.582794+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 59 | -0.827 | 39.0% | 27.6% | 0.58 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 32 | -2.444 | 31.2% | 18.0% | 0.23 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 11 | -4.591 | 36.4% | 15.2% | 0.12 |
| **WARN** | `london_breakout` | `USD_CHF` | 16 | -1.869 | 43.8% | 23.1% | 0.31 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 47 | -0.902 | 36.2% | 24.0% | 0.44 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 16 | -2.600 | 37.5% | 18.5% | 0.28 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 35 | -1.831 | 65.7% | 49.2% | 0.48 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 41 | -2.102 | 68.3% | 53.0% | 0.56 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 32 | -2.894 | 43.8% | 28.2% | 0.34 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 18 | -0.194 | 66.7% | 43.7% | 0.92 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 76 | -0.443 | 51.3% | 40.3% | 0.80 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 59 | 23 | 36 | -0.827 | 39.0% | 27.6%-51.7% | 0.58 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 32 | 10 | 22 | -2.444 | 31.2% | 18.0%-48.6% | 0.23 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `EUR_USD` | 36 | 19 | 17 | +0.811 | 52.8% | 37.0%-68.0% | 1.49 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `london_breakout` | `GBP_USD` | 27 | 20 | 7 | +2.015 | 74.1% | 55.3%-86.8% | 2.31 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 47 | 17 | 30 | -0.902 | 36.2% | 24.0%-50.5% | 0.44 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 35 | 23 | 12 | -1.831 | 65.7% | 49.2%-79.2% | 0.48 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 18 | 12 | 6 | -0.194 | 66.7% | 43.7%-83.7% | 0.92 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 76 | 39 | 37 | -0.443 | 51.3% | 40.3%-62.2% | 0.80 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
