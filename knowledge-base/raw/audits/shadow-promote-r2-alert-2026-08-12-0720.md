# SHADOW_PROMOTE R2 Alert - 2026-08-12T07:20:38.384872+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 28 | -0.046 | 60.7% | 42.4% | 0.99 |
...
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 18 | -3.361 | 27.8% | 12.5% | 0.34 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 20 | -1.195 | 60.0% | 38.7% | 0.75 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 11 | -0.827 | 72.7% | 43.4% | 0.81 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 17 | -3.494 | 35.3% | 17.3% | 0.20 |
...
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 28 | 17 | 11 | -0.046 | 60.7% | 42.4%-76.4% | 0.99 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 7 | 6 | 1 | +3.386 | 85.7% | 48.7%-97.4% | 20.75 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 2 | 0 | 2 | -11.450 | 0.0% | 0.0%-65.8% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 5 | 2 | 3 | +2.960 | 40.0% | 11.8%-76.9% | 2.05 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `AUD_JPY` | 18 | 5 | 13 | -3.361 | 27.8% | 12.5%-50.9% | 0.34 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 20 | 12 | 8 | -1.195 | 60.0% | 38.7%-78.1% | 0.75 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 17 | 6 | 11 | -3.494 | 35.3% | 17.3%-58.7% | 0.20 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
