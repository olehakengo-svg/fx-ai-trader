# SHADOW_PROMOTE R2 Alert - 2026-06-30T14:14:34.376841+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 36 | -2.461 | 55.6% | 39.6% | 0.55 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 82 | -1.088 | 39.0% | 29.2% | 0.48 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 41 | -0.563 | 43.9% | 29.9% | 0.75 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 14 | -4.164 | 35.7% | 16.3% | 0.13 |
| **WARN** | `london_breakout` | `USD_CHF` | 21 | -2.248 | 28.6% | 13.8% | 0.20 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 64 | -1.488 | 34.4% | 23.9% | 0.31 |
| **WARN** | `ob_retest` | `GBP_USD` | 10 | -5.260 | 50.0% | 23.7% | 0.16 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 16 | -2.994 | 37.5% | 18.5% | 0.15 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 12 | -1.233 | 66.7% | 39.1% | 0.51 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 12 | -2.467 | 66.7% | 39.1% | 0.46 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 38 | -0.992 | 73.7% | 58.0% | 0.68 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 38 | -2.411 | 65.8% | 49.9% | 0.54 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 45 | -1.398 | 57.8% | 43.3% | 0.61 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 26 | -0.758 | 57.7% | 38.9% | 0.77 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 15 | -1.807 | 53.3% | 30.1% | 0.35 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 15 | -0.380 | 66.7% | 41.7% | 0.87 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 13 | -1.715 | 69.2% | 42.4% | 0.38 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 44 | -3.159 | 27.3% | 16.3% | 0.17 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 16 | -1.756 | 37.5% | 18.5% | 0.27 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 11 | -2.500 | 27.3% | 9.7% | 0.17 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 16 | -2.406 | 56.2% | 33.2% | 0.45 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 20 | -4.380 | 60.0% | 38.7% | 0.36 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 10 | -3.780 | 30.0% | 10.8% | 0.09 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 30 | -2.510 | 50.0% | 33.2% | 0.43 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 35 | -3.851 | 60.0% | 43.6% | 0.29 |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 36 | 20 | 16 | -2.461 | 55.6% | 39.6%-70.5% | 0.55 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 82 | 32 | 50 | -1.088 | 39.0% | 29.2%-49.8% | 0.48 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 41 | 18 | 23 | -0.563 | 43.9% | 29.9%-59.0% | 0.75 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 64 | 22 | 42 | -1.488 | 34.4% | 23.9%-46.6% | 0.31 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 16 | 6 | 10 | -2.994 | 37.5% | 18.5%-61.4% | 0.15 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 6 | 3 | 3 | -5.167 | 50.0% | 18.8%-81.2% | 0.19 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 8 | 6 | 2 | -2.462 | 75.0% | 40.9%-92.9% | 0.58 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_anti_hunt_bounce` | `GBP_JPY` | 12 | 8 | 4 | -2.467 | 66.7% | 39.1%-86.2% | 0.46 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 38 | 28 | 10 | -0.992 | 73.7% | 58.0%-85.0% | 0.68 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 38 | 25 | 13 | -2.411 | 65.8% | 49.9%-78.8% | 0.54 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 45 | 26 | 19 | -1.398 | 57.8% | 43.3%-71.0% | 0.61 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 26 | 15 | 11 | -0.758 | 57.7% | 38.9%-74.5% | 0.77 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `GBP_USD` | 22 | 13 | 9 | +0.027 | 59.1% | 38.7%-76.7% | 1.01 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 9 | 2 | 7 | -1.833 | 22.2% | 6.3%-54.7% | 0.15 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 13 | 9 | 4 | -1.715 | 69.2% | 42.4%-87.3% | 0.38 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 44 | 12 | 32 | -3.159 | 27.3% | 16.3%-41.8% | 0.17 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_momentum_scalp` | `USD_JPY` | 2 | 1 | 1 | +4.300 | 50.0% | 9.5%-90.5% | 15.33 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 16 | 6 | 10 | -1.756 | 37.5% | 18.5%-61.4% | 0.27 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 16 | 9 | 7 | -2.406 | 56.2% | 33.2%-76.9% | 0.45 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 20 | 12 | 8 | -4.380 | 60.0% | 38.7%-78.1% | 0.36 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 8 | 6 | 2 | +1.438 | 75.0% | 40.9%-92.9% | 2.07 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `EUR_USD` | 30 | 15 | 15 | -2.510 | 50.0% | 33.2%-66.8% | 0.43 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 35 | 21 | 14 | -3.851 | 60.0% | 43.6%-74.4% | 0.29 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 9 | 6 | 3 | +1.344 | 66.7% | 35.4%-87.9% | 1.84 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
