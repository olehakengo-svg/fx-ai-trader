# SHADOW_PROMOTE R2 Alert - 2026-08-18T06:38:41.873010+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 16 | -2.562 | 18.8% | 6.6% | 0.12 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 23 | -2.609 | 34.8% | 18.8% | 0.53 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 26 | -4.331 | 50.0% | 32.1% | 0.33 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 32 | -0.816 | 53.1% | 36.4% | 0.76 |
...
| **WARN** | `sr_break_retest` | `GBP_USD` | 17 | -1.188 | 58.8% | 36.0% | 0.60 |
...
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 29 | -1.755 | 41.4% | 25.5% | 0.59 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 16 | 3 | 13 | -2.562 | 18.8% | 6.6%-43.0% | 0.12 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 26 | 15 | 11 | +1.654 | 57.7% | 38.9%-74.5% | 1.82 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 32 | 17 | 15 | -0.816 | 53.1% | 36.4%-69.1% | 0.76 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_USD` | 17 | 10 | 7 | -1.188 | 58.8% | 36.0%-78.4% | 0.60 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `AUD_JPY` | 29 | 12 | 17 | -1.755 | 41.4% | 25.5%-59.3% | 0.59 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
