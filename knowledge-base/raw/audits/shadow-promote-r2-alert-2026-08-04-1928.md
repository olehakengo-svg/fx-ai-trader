# SHADOW_PROMOTE R2 Alert - 2026-08-04T19:28:16.021113+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 77 | -1.865 | 19.5% | 12.2% | 0.16 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 27 | -0.893 | 33.3% | 18.6% | 0.68 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 54 | -0.743 | 46.3% | 33.7% | 0.73 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 36 | -3.219 | 55.6% | 39.6% | 0.42 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 30 | -7.063 | 43.3% | 27.4% | 0.20 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 37 | -1.568 | 54.1% | 38.4% | 0.56 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 27 | -4.015 | 48.1% | 30.7% | 0.42 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 76 | -1.278 | 39.5% | 29.2% | 0.58 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 53 | -0.270 | 69.8% | 56.5% | 0.91 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 77 | 15 | 62 | -1.865 | 19.5% | 12.2%-29.7% | 0.16 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 27 | 9 | 18 | -0.893 | 33.3% | 18.6%-52.2% | 0.68 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 54 | 25 | 29 | -0.743 | 46.3% | 33.7%-59.4% | 0.73 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 36 | 20 | 16 | -3.219 | 55.6% | 39.6%-70.5% | 0.42 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 30 | 13 | 17 | -7.063 | 43.3% | 27.4%-60.8% | 0.20 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 37 | 20 | 17 | -1.568 | 54.1% | 38.4%-69.0% | 0.56 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 27 | 13 | 14 | -4.015 | 48.1% | 30.7%-66.0% | 0.42 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `v_reversal` | `USD_JPY` | 2 | 1 | 1 | +0.750 | 50.0% | 9.5%-90.5% | 1.31 | `V_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 76 | 30 | 46 | -1.278 | 39.5% | 29.2%-50.7% | 0.58 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 9 | 7 | 2 | +3.378 | 77.8% | 45.3%-93.7% | 2.85 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 53 | 37 | 16 | -0.270 | 69.8% | 56.5%-80.5% | 0.91 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
