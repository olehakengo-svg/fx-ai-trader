# SHADOW_PROMOTE R2 Alert - 2026-08-16T12:34:10.998635+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 21 | -1.571 | 33.3% | 17.2% | 0.33 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 32 | -0.619 | 56.2% | 39.3% | 0.81 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 50 | -1.930 | 20.0% | 11.2% | 0.17 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 22 | -1.155 | 27.3% | 13.2% | 0.61 |
| **WARN** | `london_breakout` | `EUR_USD` | 21 | -0.576 | 23.8% | 10.6% | 0.61 |
| **CRITICAL** | `london_breakout` | `GBP_USD` | 37 | -2.076 | 32.4% | 19.6% | 0.32 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 43 | -2.874 | 46.5% | 32.5% | 0.45 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 10 | -1.080 | 30.0% | 10.8% | 0.44 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 19 | -4.484 | 57.9% | 36.3% | 0.13 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 24 | -3.533 | 37.5% | 21.2% | 0.27 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 49 | -1.782 | 32.7% | 21.2% | 0.55 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 18 | -1.511 | 27.8% | 12.5% | 0.37 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -1.217 | 33.3% | 13.8% | 0.64 |
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 26 | -1.827 | 38.5% | 22.4% | 0.60 |
...
| OK | `donchian_momentum_breakout` | `AUD_USD` | 7 | 2 | 5 | -5.529 | 28.6% | 8.2%-64.1% | 0.20 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 21 | 7 | 14 | -1.571 | 33.3% | 17.2%-54.6% | 0.33 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 32 | 18 | 14 | -0.619 | 56.2% | 39.3%-71.8% | 0.81 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 21 | 5 | 16 | -0.576 | 23.8% | 10.6%-45.1% | 0.61 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `london_breakout` | `GBP_USD` | 37 | 12 | 25 | -2.076 | 32.4% | 19.6%-48.5% | 0.32 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 43 | 20 | 23 | -2.874 | 46.5% | 32.5%-61.1% | 0.45 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 9 | 5 | 4 | +0.244 | 55.6% | 26.7%-81.1% | 1.16 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 24 | 9 | 15 | -3.533 | 37.5% | 21.2%-57.3% | 0.27 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 49 | 16 | 33 | -1.782 | 32.7% | 21.2%-46.6% | 0.55 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 18 | 5 | 13 | -1.511 | 27.8% | 12.5%-50.9% | 0.37 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `AUD_JPY` | 26 | 10 | 16 | -1.827 | 38.5% | 22.4%-57.5% | 0.60 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
