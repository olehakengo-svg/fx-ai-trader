# SHADOW_PROMOTE R2 Alert - 2026-07-09T02:48:35.979447+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 20 | -0.065 | 50.0% | 29.9% | 0.98 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 91 | -0.530 | 44.0% | 34.2% | 0.71 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 79 | -1.490 | 36.7% | 26.9% | 0.34 |
| **WARN** | `ob_retest` | `EUR_USD` | 12 | -1.242 | 66.7% | 39.1% | 0.64 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 12 | -0.342 | 58.3% | 32.0% | 0.86 |
...
| **WARN** | `trendline_sweep` | `EUR_GBP` | 25 | -1.476 | 56.0% | 37.1% | 0.41 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 17 | -2.276 | 70.6% | 46.9% | 0.27 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 26 | -2.365 | 23.1% | 11.0% | 0.16 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 14 | -0.329 | 50.0% | 26.8% | 0.87 |
...
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 2 | 1 | 1 | -3.400 | 50.0% | 9.5%-90.5% | 0.17 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 20 | 10 | 10 | -0.065 | 50.0% | 29.9%-70.1% | 0.98 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 91 | 40 | 51 | -0.530 | 44.0% | 34.2%-54.2% | 0.71 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 79 | 29 | 50 | -1.490 | 36.7% | 26.9%-47.7% | 0.34 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 12 | 7 | 5 | -0.342 | 58.3% | 32.0%-80.7% | 0.86 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 5 | 3 | 2 | -2.240 | 60.0% | 23.1%-88.2% | 0.33 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 25 | 14 | 11 | -1.476 | 56.0% | 37.1%-73.3% | 0.41 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_USD` | 17 | 12 | 5 | -2.276 | 70.6% | 46.9%-86.7% | 0.27 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 26 | 6 | 20 | -2.365 | 23.1% | 11.0%-42.1% | 0.16 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 14 | 7 | 7 | -0.329 | 50.0% | 26.8%-73.2% | 0.87 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
