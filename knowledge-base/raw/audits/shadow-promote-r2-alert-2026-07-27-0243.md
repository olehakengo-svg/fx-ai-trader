# SHADOW_PROMOTE R2 Alert - 2026-07-27T02:43:34.904983+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 23 | -1.739 | 43.5% | 25.6% | 0.26 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 18 | -1.489 | 61.1% | 38.6% | 0.57 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 20 | -0.400 | 50.0% | 29.9% | 0.87 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 13 | -2.738 | 38.5% | 17.7% | 0.38 |
| **WARN** | `ema200_trend_reversal` | `USD_JPY` | 21 | -1.348 | 52.4% | 32.4% | 0.58 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 86 | -0.987 | 38.4% | 28.8% | 0.49 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -1.032 | 41.9% | 26.4% | 0.59 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 61 | -1.187 | 36.1% | 25.2% | 0.44 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 35 | -1.989 | 51.4% | 35.6% | 0.45 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 79 | -0.963 | 44.3% | 33.9% | 0.56 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 23 | 10 | 13 | -1.739 | 43.5% | 25.6%-63.2% | 0.26 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 18 | 11 | 7 | -1.489 | 61.1% | 38.6%-79.7% | 0.57 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 20 | 10 | 10 | -0.400 | 50.0% | 29.9%-70.1% | 0.87 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 13 | 5 | 8 | -2.738 | 38.5% | 17.7%-64.5% | 0.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 13 | 18 | -1.032 | 41.9% | 26.4%-59.2% | 0.59 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 61 | 22 | 39 | -1.187 | 36.1% | 25.2%-48.6% | 0.44 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 35 | 18 | 17 | -1.989 | 51.4% | 35.6%-67.0% | 0.45 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 79 | 35 | 44 | -0.963 | 44.3% | 33.9%-55.3% | 0.56 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
