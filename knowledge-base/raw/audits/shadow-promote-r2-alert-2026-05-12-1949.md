# SHADOW_PROMOTE R2 Alert - 2026-05-12T19:49:32.641844+00:00
...
| **WARN** | `engulfing_bb` | `EUR_USD` | 19 | -1.174 | 21.1% | 8.5% | 0.58 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 10 | -1.900 | 20.0% | 5.7% | 0.27 |
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 26 | -2.050 | 34.6% | 19.4% | 0.60 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 25 | -2.536 | 12.0% | 4.2% | 0.29 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 35 | -2.417 | 20.0% | 10.0% | 0.45 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 27 | -1.644 | 25.9% | 13.2% | 0.73 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 33 | -0.370 | 33.3% | 19.8% | 0.95 |
| **WARN** | `xs_momentum` | `USD_JPY` | 13 | -4.831 | 30.8% | 12.7% | 0.42 |
...
| WARN | `engulfing_bb` | `EUR_USD` | 19 | 4 | 15 | -1.174 | 21.1% | 8.5%-43.3% | 0.58 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 10 | 2 | 8 | -1.900 | 20.0% | 5.7%-51.0% | 0.27 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `orb_trap` | `EUR_USD` | 1 | 1 | 0 | +3.000 | 100.0% | 20.7%-100.0% | n/a | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `orb_trap` | `GBP_USD` | 3 | 3 | 0 | +21.033 | 100.0% | 43.8%-100.0% | n/a | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 26 | 9 | 17 | -2.050 | 34.6% | 19.4%-53.8% | 0.60 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `EUR_USD` | 25 | 3 | 22 | -2.536 | 12.0% | 4.2%-30.0% | 0.29 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 35 | 7 | 28 | -2.417 | 20.0% | 10.0%-35.9% | 0.45 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 27 | 7 | 20 | -1.644 | 25.9% | 13.2%-44.7% | 0.73 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 33 | 11 | 22 | -0.370 | 33.3% | 19.8%-50.4% | 0.95 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 13 | 4 | 9 | -4.831 | 30.8% | 12.7%-57.6% | 0.42 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
