# SHADOW_PROMOTE R2 Alert - 2026-08-31T22:26:54.547307+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | -4.328 | 48.3% | 31.4% | 0.32 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 28 | -2.321 | 35.7% | 20.7% | 0.35 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 52 | -0.488 | 53.8% | 40.5% | 0.87 |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | 14 | 15 | -4.328 | 48.3% | 31.4%-65.6% | 0.32 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 28 | 10 | 18 | -2.321 | 35.7% | 20.7%-54.2% | 0.35 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `USD_JPY` | 26 | 13 | 13 | +0.504 | 50.0% | 32.1%-67.9% | 1.24 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `EUR_USD` | 8 | 4 | 4 | +1.350 | 50.0% | 21.5%-78.5% | 2.64 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 52 | 28 | 24 | -0.488 | 53.8% | 40.5%-66.7% | 0.87 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
