# SHADOW_PROMOTE R2 Alert - 2026-09-18T20:24:22.476478+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 27 | -1.393 | 40.7% | 24.5% | 0.49 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 38 | -2.003 | 57.9% | 42.2% | 0.50 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 48 | -1.048 | 39.6% | 27.0% | 0.50 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 13 | -2.092 | 61.5% | 35.5% | 0.58 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 43 | -0.360 | 55.8% | 41.1% | 0.92 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 33 | -3.136 | 39.4% | 24.7% | 0.38 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 12 | -1.225 | 33.3% | 13.8% | 0.51 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 27 | -0.144 | 44.4% | 27.6% | 0.93 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 54 | -1.291 | 55.6% | 42.4% | 0.71 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 14 | -2.307 | 50.0% | 26.8% | 0.57 |
| **WARN** | `wick_imbalance_reversion` | `EUR_USD` | 13 | -3.023 | 30.8% | 12.7% | 0.34 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 14 | -2.886 | 57.1% | 32.6% | 0.58 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 25 | -3.060 | 32.0% | 17.2% | 0.19 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 9 | 4 | 5 | -3.356 | 44.4% | 18.9%-73.3% | 0.52 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 27 | 11 | 16 | -1.393 | 40.7% | 24.5%-59.3% | 0.49 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 38 | 22 | 16 | -2.003 | 57.9% | 42.2%-72.1% | 0.50 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `mtf_counter_trend_scalp` | `EUR_USD` | 7 | 2 | 5 | -1.371 | 28.6% | 8.2%-64.1% | 0.13 | `MTF_COUNTER_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 13 | 8 | 5 | -2.092 | 61.5% | 35.5%-82.3% | 0.58 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 43 | 24 | 19 | -0.360 | 55.8% | 41.1%-69.6% | 0.92 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `GBP_USD` | 6 | 2 | 4 | -1.500 | 33.3% | 9.7%-70.0% | 0.48 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `three_bar_reversal` | `USD_JPY` | 27 | 12 | 15 | -0.144 | 44.4% | 27.6%-62.7% | 0.93 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 54 | 30 | 24 | -1.291 | 55.6% | 42.4%-68.0% | 0.71 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 14 | 7 | 7 | -2.307 | 50.0% | 26.8%-73.2% | 0.57 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 14 | 8 | 6 | -2.886 | 57.1% | 32.6%-78.6% | 0.58 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 25 | 8 | 17 | -3.060 | 32.0% | 17.2%-51.6% | 0.19 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `USD_JPY` | 20 | 15 | 5 | +3.180 | 75.0% | 53.1%-88.8% | 2.68 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
