# SHADOW_PROMOTE R2 Alert - 2026-08-13T07:23:01.300861+00:00
...
| **WARN** | `sr_break_retest` | `GBP_USD` | 26 | -1.619 | 57.7% | 38.9% | 0.52 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 37 | -2.865 | 45.9% | 31.0% | 0.48 |
...
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 18 | -2.511 | 33.3% | 16.3% | 0.47 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 21 | -1.581 | 57.1% | 36.5% | 0.68 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 13 | -0.931 | 69.2% | 42.4% | 0.82 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 9 | 6 | 3 | -3.122 | 66.7% | 35.4%-87.9% | 0.55 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 24 | 13 | 11 | +1.679 | 54.2% | 35.1%-72.1% | 1.77 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_USD` | 26 | 15 | 11 | -1.619 | 57.7% | 38.9%-74.5% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 37 | 17 | 20 | -2.865 | 45.9% | 31.0%-61.6% | 0.48 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `AUD_JPY` | 18 | 6 | 12 | -2.511 | 33.3% | 16.3%-56.3% | 0.47 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 13 | 9 | 4 | -0.931 | 69.2% | 42.4%-87.3% | 0.82 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
