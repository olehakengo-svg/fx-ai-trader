# SHADOW_PROMOTE R2 Alert - 2026-09-09T03:06:19.719028+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 17 | -4.029 | 29.4% | 13.3% | 0.40 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 25 | -0.572 | 44.0% | 26.7% | 0.79 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 23 | -3.757 | 52.2% | 33.0% | 0.33 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 31 | -2.013 | 35.5% | 21.1% | 0.33 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 31 | -1.494 | 51.6% | 34.8% | 0.55 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 47 | -0.640 | 53.2% | 39.2% | 0.86 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 26 | -1.423 | 19.2% | 8.5% | 0.30 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 12 | 11 | 1 | +6.567 | 91.7% | 64.6%-98.5% | 5.69 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 17 | 5 | 12 | -4.029 | 29.4% | 13.3%-53.1% | 0.40 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 25 | 11 | 14 | -0.572 | 44.0% | 26.7%-62.9% | 0.79 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 23 | 12 | 11 | -3.757 | 52.2% | 33.0%-70.8% | 0.33 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 31 | 11 | 20 | -2.013 | 35.5% | 21.1%-53.1% | 0.33 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 31 | 16 | 15 | -1.494 | 51.6% | 34.8%-68.0% | 0.55 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 47 | 25 | 22 | -0.640 | 53.2% | 39.2%-66.7% | 0.86 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `USD_JPY` | 49 | 25 | 24 | +0.469 | 51.0% | 37.5%-64.4% | 1.18 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 26 | 5 | 21 | -1.423 | 19.2% | 8.5%-37.9% | 0.30 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
