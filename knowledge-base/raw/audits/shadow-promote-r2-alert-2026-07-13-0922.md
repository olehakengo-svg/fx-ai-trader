# SHADOW_PROMOTE R2 Alert - 2026-07-13T09:22:08.347615+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 79 | -0.453 | 45.6% | 35.0% | 0.74 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -1.103 | 41.9% | 26.4% | 0.56 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 13 | -2.623 | 38.5% | 17.7% | 0.37 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 80 | -1.603 | 33.8% | 24.3% | 0.33 |
| **WARN** | `ob_retest` | `EUR_USD` | 13 | -0.362 | 69.2% | 42.4% | 0.89 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 14 | -3.014 | 57.1% | 32.6% | 0.27 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 17 | -9.612 | 41.2% | 21.6% | 0.12 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 28 | -1.950 | 64.3% | 45.8% | 0.49 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 37 | -3.157 | 70.3% | 54.2% | 0.38 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 42 | -1.012 | 64.3% | 49.2% | 0.67 |
...
| **WARN** | `trendline_sweep` | `GBP_USD` | 14 | -2.907 | 64.3% | 38.8% | 0.26 |
...
| **WARN** | `vol_surge_detector` | `GBP_USD` | 10 | -0.350 | 40.0% | 16.8% | 0.84 |
...
| **WARN** | `xs_momentum` | `GBP_USD` | 28 | -5.332 | 53.6% | 35.8% | 0.24 |
...
| OK | `ema200_trend_reversal` | `USD_JPY` | 12 | 6 | 6 | +0.267 | 50.0% | 25.4%-74.6% | 1.08 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_cross` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_ribbon_ride` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_RIBBON_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 79 | 36 | 43 | -0.453 | 45.6% | 35.0%-56.5% | 0.74 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 13 | 18 | -1.103 | 41.9% | 26.4%-59.2% | 0.56 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 13 | 5 | 8 | -2.623 | 38.5% | 17.7%-64.5% | 0.37 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 80 | 27 | 53 | -1.603 | 33.8% | 24.3%-44.6% | 0.33 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `GBP_USD` | 14 | 8 | 6 | -3.014 | 57.1% | 32.6%-78.6% | 0.27 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 28 | 18 | 10 | -1.950 | 64.3% | 45.8%-79.3% | 0.49 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 37 | 26 | 11 | -3.157 | 70.3% | 54.2%-82.5% | 0.38 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 42 | 27 | 15 | -1.012 | 64.3% | 49.2%-77.0% | 0.67 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 14 | 9 | 5 | -2.907 | 64.3% | 38.8%-83.7% | 0.26 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `GBP_USD` | 10 | 4 | 6 | -0.350 | 40.0% | 16.8%-68.7% | 0.84 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `GBP_USD` | 28 | 15 | 13 | -5.332 | 53.6% | 35.8%-70.5% | 0.24 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
