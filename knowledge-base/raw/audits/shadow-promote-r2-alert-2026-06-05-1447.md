# SHADOW_PROMOTE R2 Alert - 2026-06-05T14:47:26.243108+00:00
...
| **CRITICAL** | `london_breakout` | `EUR_USD` | 39 | -0.946 | 28.2% | 16.5% | 0.56 |
| **WARN** | `london_breakout` | `GBP_USD` | 22 | -1.091 | 31.8% | 16.4% | 0.58 |
| **WARN** | `london_breakout` | `USD_CHF` | 17 | -1.935 | 11.8% | 3.3% | 0.11 |
...
| **WARN** | `ob_retest` | `USD_JPY` | 21 | -1.614 | 61.9% | 40.9% | 0.35 |
...
| **CRITICAL** | `sr_anti_hunt_bounce` | `USD_JPY` | 31 | -1.532 | 6.5% | 1.8% | 0.07 |
...
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 27 | -3.352 | 14.8% | 5.9% | 0.19 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 14 | -2.536 | 21.4% | 7.6% | 0.23 |
...
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 15 | -3.267 | 60.0% | 35.7% | 0.16 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 63 | -4.744 | 28.6% | 18.9% | 0.23 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 45 | -0.762 | 44.4% | 30.9% | 0.83 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 60 | -3.602 | 30.0% | 19.9% | 0.33 |
...
| OK | `dt_sr_channel_reversal` | `GBP_JPY` | 6 | 3 | 3 | +0.683 | 50.0% | 18.8%-81.2% | 1.12 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 39 | 11 | 28 | -0.946 | 28.2% | 16.5%-43.8% | 0.56 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `GBP_USD` | 22 | 7 | 15 | -1.091 | 31.8% | 16.4%-52.7% | 0.58 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 17 | 2 | 15 | -1.935 | 11.8% | 3.3%-34.3% | 0.11 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `USD_JPY` | 21 | 13 | 8 | -1.614 | 61.9% | 40.9%-79.2% | 0.35 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_anti_hunt_bounce` | `USD_JPY` | 31 | 2 | 29 | -1.532 | 6.5% | 1.8%-20.7% | 0.07 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 88 | 36 | 52 | +0.087 | 40.9% | 31.2%-51.4% | 1.03 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_GBP` | 8 | 1 | 7 | -2.938 | 12.5% | 2.2%-47.1% | 0.07 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_USD` | 14 | 6 | 8 | +0.221 | 42.9% | 21.4%-67.4% | 1.05 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 27 | 4 | 23 | -3.352 | 14.8% | 5.9%-32.5% | 0.19 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 14 | 3 | 11 | -2.536 | 21.4% | 7.6%-47.6% | 0.23 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `USD_JPY` | 15 | 9 | 6 | -3.267 | 60.0% | 35.7%-80.2% | 0.16 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `EUR_USD` | 63 | 18 | 45 | -4.744 | 28.6% | 18.9%-40.7% | 0.23 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 45 | 20 | 25 | -0.762 | 44.4% | 30.9%-58.8% | 0.83 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 60 | 18 | 42 | -3.602 | 30.0% | 19.9%-42.5% | 0.33 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
