# SHADOW_PROMOTE R2 Alert - 2026-05-21T09:38:05.647543+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 88 | -1.108 | 19.3% | 12.4% | 0.65 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 25 | -2.196 | 28.0% | 14.3% | 0.69 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 28 | -4.475 | 14.3% | 5.7% | 0.53 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_JPY` | 42 | -9.481 | 11.9% | 5.2% | 0.41 |
...
| OK | `bb_squeeze_breakout` | `GBP_USD` | 3 | 2 | 1 | +4.133 | 66.7% | 20.8%-93.9% | 4.02 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 88 | 17 | 71 | -1.108 | 19.3% | 12.4%-28.8% | 0.65 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `EUR_USD` | 5 | 1 | 4 | -2.840 | 20.0% | 3.6%-62.4% | 0.13 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `USD_JPY` | 29 | 9 | 20 | +2.024 | 31.0% | 17.3%-49.2% | 1.37 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 25 | 7 | 18 | -2.196 | 28.0% | 14.3%-47.6% | 0.69 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 28 | 4 | 24 | -4.475 | 14.3% | 5.7%-31.5% | 0.53 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 44 | 12 | 32 | -3.041 | 27.3% | 16.3%-41.8% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `USD_JPY` | 37 | 13 | 24 | +0.357 | 35.1% | 21.8%-51.2% | 1.08 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 42 | 5 | 37 | -9.481 | 11.9% | 5.2%-25.0% | 0.41 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `GBP_USD` | 9 | 1 | 8 | -14.878 | 11.1% | 2.0%-43.5% | 0.02 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_JPY` | 11 | 3 | 8 | +0.664 | 27.3% | 9.7%-56.6% | 1.15 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
