# SHADOW_PROMOTE R2 Alert - 2026-06-23T14:44:31.853072+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 34 | -4.541 | 50.0% | 34.1% | 0.36 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 15 | -2.527 | 53.3% | 30.1% | 0.28 |
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 14 | -3.336 | 7.1% | 1.3% | 0.04 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 79 | -0.871 | 38.0% | 28.1% | 0.57 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 41 | -1.646 | 36.6% | 23.6% | 0.42 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -4.375 | 33.3% | 13.8% | 0.11 |
| **WARN** | `london_breakout` | `USD_CHF` | 16 | -2.700 | 31.2% | 14.2% | 0.18 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 47 | -1.013 | 38.3% | 25.8% | 0.42 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 16 | -2.600 | 37.5% | 18.5% | 0.28 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 37 | -1.249 | 70.3% | 54.2% | 0.62 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 42 | -1.776 | 69.0% | 54.0% | 0.60 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 35 | -2.451 | 48.6% | 33.0% | 0.38 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 74 | -0.409 | 51.4% | 40.2% | 0.82 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 23 | -0.248 | 30.4% | 15.6% | 0.84 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 13 | -1.777 | 69.2% | 42.4% | 0.42 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 38 | -2.658 | 31.6% | 19.1% | 0.21 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 15 | -1.453 | 40.0% | 19.8% | 0.26 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 12 | -3.450 | 50.0% | 25.4% | 0.36 |
| **WARN** | `xs_momentum` | `EUR_USD` | 29 | -2.424 | 51.7% | 34.4% | 0.51 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 32 | -2.106 | 65.6% | 48.3% | 0.48 |
| **WARN** | `xs_momentum` | `USD_JPY` | 12 | -0.333 | 66.7% | 39.1% | 0.88 |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 34 | 17 | 17 | -4.541 | 50.0% | 34.1%-65.9% | 0.36 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 79 | 30 | 49 | -0.871 | 38.0% | 28.1%-49.0% | 0.57 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `EUR_USD` | 37 | 19 | 18 | +0.651 | 51.4% | 35.9%-66.6% | 1.36 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `london_breakout` | `GBP_USD` | 38 | 24 | 14 | +0.413 | 63.2% | 47.3%-76.6% | 1.20 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 16 | 5 | 11 | -2.700 | 31.2% | 14.2%-55.6% | 0.18 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `USD_JPY` | 8 | 5 | 3 | +1.050 | 62.5% | 30.6%-86.3% | 1.48 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 37 | 26 | 11 | -1.249 | 70.3% | 54.2%-82.5% | 0.62 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 42 | 29 | 13 | -1.776 | 69.0% | 54.0%-80.9% | 0.60 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 35 | 17 | 18 | -2.451 | 48.6% | 33.0%-64.4% | 0.38 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 7 | 3 | 4 | -0.829 | 42.9% | 15.8%-75.0% | 0.45 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_GBP` | 13 | 9 | 4 | -1.777 | 69.2% | 42.4%-87.3% | 0.42 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 38 | 12 | 26 | -2.658 | 31.6% | 19.1%-47.5% | 0.21 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 15 | 6 | 9 | -1.453 | 40.0% | 19.8%-64.3% | 0.26 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 7 | 5 | 2 | +0.671 | 71.4% | 35.9%-91.8% | 2.00 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 10 | 7 | 3 | +0.420 | 70.0% | 39.7%-89.2% | 1.17 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `EUR_USD` | 29 | 15 | 14 | -2.424 | 51.7% | 34.4%-68.6% | 0.51 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 32 | 21 | 11 | -2.106 | 65.6% | 48.3%-79.6% | 0.48 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 12 | 8 | 4 | -0.333 | 66.7% | 39.1%-86.2% | 0.88 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
