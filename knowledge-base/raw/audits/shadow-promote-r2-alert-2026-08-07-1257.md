# SHADOW_PROMOTE R2 Alert - 2026-08-07T12:57:54.236767+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | -2.571 | 41.7% | 24.5% | 0.45 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 17 | -0.112 | 52.9% | 31.0% | 0.96 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 26 | -2.612 | 57.7% | 38.9% | 0.47 |
...
| **WARN** | `london_breakout` | `EUR_USD` | 21 | -1.824 | 23.8% | 10.6% | 0.14 |
...
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 14 | -4.679 | 35.7% | 16.3% | 0.14 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 10 | -1.620 | 60.0% | 31.3% | 0.61 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 15 | -1.647 | 53.3% | 30.1% | 0.53 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 23 | -2.113 | 47.8% | 29.2% | 0.54 |
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 26 | -4.642 | 53.8% | 35.5% | 0.34 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -0.994 | 29.4% | 13.3% | 0.52 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 11 | -3.291 | 9.1% | 1.6% | 0.05 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 14 | -1.171 | 28.6% | 11.7% | 0.59 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 13 | -0.146 | 76.9% | 49.7% | 0.96 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 33 | -2.506 | 51.5% | 35.2% | 0.35 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 51 | -0.592 | 66.7% | 53.0% | 0.82 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 65 | -0.262 | 61.5% | 49.4% | 0.95 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | 10 | 14 | -2.571 | 41.7% | 24.5%-61.2% | 0.45 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 17 | 9 | 8 | -0.112 | 52.9% | 31.0%-73.8% | 0.96 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 26 | 15 | 11 | -2.612 | 57.7% | 38.9%-74.5% | 0.47 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 21 | 5 | 16 | -1.824 | 23.8% | 10.6%-45.1% | 0.14 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `GBP_USD` | 14 | 5 | 9 | -4.679 | 35.7% | 16.3%-61.2% | 0.14 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 10 | 6 | 4 | -1.620 | 60.0% | 31.3%-83.2% | 0.61 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 23 | 11 | 12 | -2.113 | 47.8% | 29.2%-67.0% | 0.54 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 26 | 14 | 12 | -4.642 | 53.8% | 35.5%-71.2% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 17 | 5 | 12 | -0.994 | 29.4% | 13.3%-53.1% | 0.52 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `GBP_USD` | 11 | 1 | 10 | -3.291 | 9.1% | 1.6%-37.7% | 0.05 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 14 | 4 | 10 | -1.171 | 28.6% | 11.7%-54.6% | 0.59 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 13 | 10 | 3 | -0.146 | 76.9% | 49.7%-91.8% | 0.96 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 33 | 17 | 16 | -2.506 | 51.5% | 35.2%-67.5% | 0.35 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 51 | 34 | 17 | -0.592 | 66.7% | 53.0%-78.0% | 0.82 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 65 | 40 | 25 | -0.262 | 61.5% | 49.4%-72.4% | 0.95 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
