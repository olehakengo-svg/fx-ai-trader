# SHADOW_PROMOTE R2 Alert - 2026-08-11T12:58:43.185307+00:00
...
| **WARN** | `xs_momentum` | `EUR_USD` | 26 | -3.235 | 50.0% | 32.1% | 0.28 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 48 | -1.050 | 66.7% | 52.5% | 0.69 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 66 | -1.571 | 57.6% | 45.6% | 0.74 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 22 | 11 | 11 | -0.200 | 50.0% | 30.7%-69.3% | 0.92 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 62 | 12 | 50 | -1.848 | 19.4% | 11.4%-30.9% | 0.17 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `orb_trap` | `GBP_USD` | 5 | 2 | 3 | -5.400 | 40.0% | 11.8%-76.9% | 0.12 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 8 | 4 | 4 | +0.438 | 50.0% | 21.5%-78.5% | 1.28 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 26 | 13 | 13 | -3.235 | 50.0% | 32.1%-67.9% | 0.28 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 48 | 32 | 16 | -1.050 | 66.7% | 52.5%-78.3% | 0.69 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 66 | 38 | 28 | -1.571 | 57.6% | 45.6%-68.8% | 0.74 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
