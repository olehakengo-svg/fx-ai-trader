# SHADOW_PROMOTE R2 Alert - 2026-07-13T02:36:03.598916+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 85 | -0.519 | 44.7% | 34.6% | 0.71 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 32 | -1.009 | 43.8% | 28.2% | 0.59 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -2.242 | 41.7% | 19.3% | 0.43 |
| **WARN** | `london_breakout` | `EUR_USD` | 14 | -1.757 | 42.9% | 21.4% | 0.33 |
| **WARN** | `london_breakout` | `GBP_USD` | 21 | -1.829 | 47.6% | 28.3% | 0.47 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 85 | 38 | 47 | -0.519 | 44.7% | 34.6%-55.3% | 0.71 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 12 | 5 | 7 | -2.242 | 41.7% | 19.3%-68.0% | 0.43 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `EUR_USD` | 14 | 6 | 8 | -1.757 | 42.9% | 21.4%-67.4% | 0.33 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `GBP_USD` | 21 | 10 | 11 | -1.829 | 47.6% | 28.3%-67.6% | 0.47 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
