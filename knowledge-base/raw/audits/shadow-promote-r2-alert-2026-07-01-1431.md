# SHADOW_PROMOTE R2 Alert - 2026-07-01T14:31:13.146395+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `EUR_USD` | 12 | -0.833 | 41.7% | 19.3% | 0.77 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 26 | -4.315 | 50.0% | 32.1% | 0.20 |
...
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 10 | -1.690 | 40.0% | 16.8% | 0.47 |
| **WARN** | `ema200_trend_reversal` | `USD_JPY` | 11 | -0.091 | 63.6% | 35.4% | 0.96 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 85 | -1.013 | 38.8% | 29.2% | 0.52 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 41 | -0.544 | 43.9% | 29.9% | 0.76 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 14 | -3.879 | 35.7% | 16.3% | 0.19 |
| **WARN** | `london_breakout` | `USD_CHF` | 25 | -2.008 | 28.0% | 14.3% | 0.22 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 69 | -1.487 | 33.3% | 23.4% | 0.33 |
| **WARN** | `ob_retest` | `GBP_USD` | 10 | -5.260 | 50.0% | 23.7% | 0.16 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 17 | -1.776 | 47.1% | 26.2% | 0.40 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 12 | -1.233 | 66.7% | 39.1% | 0.51 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 12 | -4.908 | 50.0% | 25.4% | 0.24 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 35 | -0.897 | 74.3% | 57.9% | 0.70 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 35 | -1.940 | 68.6% | 52.0% | 0.58 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 46 | -1.215 | 60.9% | 46.5% | 0.64 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 27 | -0.852 | 55.6% | 37.3% | 0.74 |
| **WARN** | `trend_rebound` | `USD_JPY` | 10 | -1.030 | 40.0% | 16.8% | 0.35 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 42 | -3.186 | 26.2% | 15.3% | 0.17 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 11 | -4.527 | 27.3% | 9.7% | 0.07 |
...
| WARN | `dt_bb_rsi_mr` | `EUR_USD` | 12 | 5 | 7 | -0.833 | 41.7% | 19.3%-68.0% | 0.77 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 12 | 7 | 5 | +0.667 | 58.3% | 32.0%-80.7% | 1.31 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 3 | 0 | 3 | -7.800 | 0.0% | 0.0%-56.2% | 0.00 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 26 | 13 | 13 | -4.315 | 50.0% | 32.1%-67.9% | 0.20 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 10 | 4 | 6 | -1.690 | 40.0% | 16.8%-68.7% | 0.47 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 85 | 33 | 52 | -1.013 | 38.8% | 29.2%-49.5% | 0.52 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `EUR_USD` | 46 | 23 | 23 | +0.217 | 50.0% | 36.1%-63.9% | 1.11 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `london_breakout` | `GBP_USD` | 52 | 32 | 20 | +0.175 | 61.5% | 48.0%-73.5% | 1.08 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 25 | 7 | 18 | -2.008 | 28.0% | 14.3%-47.6% | 0.22 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 69 | 23 | 46 | -1.487 | 33.3% | 23.4%-45.1% | 0.33 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 17 | 8 | 9 | -1.776 | 47.1% | 26.2%-69.0% | 0.40 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `GBP_JPY` | 12 | 6 | 6 | -4.908 | 50.0% | 25.4%-74.6% | 0.24 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 35 | 26 | 9 | -0.897 | 74.3% | 57.9%-85.8% | 0.70 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 35 | 24 | 11 | -1.940 | 68.6% | 52.0%-81.4% | 0.58 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 46 | 28 | 18 | -1.215 | 60.9% | 46.5%-73.6% | 0.64 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 27 | 15 | 12 | -0.852 | 55.6% | 37.3%-72.4% | 0.74 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 10 | 4 | 6 | -1.030 | 40.0% | 16.8%-68.7% | 0.35 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 42 | 11 | 31 | -3.186 | 26.2% | 15.3%-41.1% | 0.17 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 11 | 3 | 8 | -4.527 | 27.3% | 9.7%-56.6% | 0.07 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
