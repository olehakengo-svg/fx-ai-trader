# SHADOW_PROMOTE R2 Alert - 2026-09-16T16:08:01.651513+00:00
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 33 | -1.976 | 45.5% | 29.8% | 0.58 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 58 | -1.424 | 55.2% | 42.5% | 0.67 |
...
| OK | `lin_reg_channel` | `EUR_USD` | 9 | 5 | 4 | +0.422 | 55.6% | 26.7%-81.1% | 1.20 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 4 | 1 | 3 | +0.500 | 25.0% | 4.6%-69.9% | 1.18 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 33 | 15 | 18 | -1.976 | 45.5% | 29.8%-62.0% | 0.58 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_GBP` | 8 | 2 | 6 | -3.550 | 25.0% | 7.1%-59.1% | 0.12 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 58 | 32 | 26 | -1.424 | 55.2% | 42.5%-67.3% | 0.67 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
