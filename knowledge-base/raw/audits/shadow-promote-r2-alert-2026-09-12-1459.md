# SHADOW_PROMOTE R2 Alert - 2026-09-12T14:59:03.992972+00:00
...
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 21 | -1.229 | 57.1% | 36.5% | 0.73 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 14 | -2.914 | 57.1% | 32.6% | 0.41 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 43 | -0.381 | 55.8% | 41.1% | 0.92 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 42 | -0.998 | 52.4% | 37.7% | 0.74 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 55 | -0.318 | 61.8% | 48.6% | 0.91 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 18 | -2.400 | 50.0% | 29.0% | 0.59 |
| **WARN** | `wick_imbalance_reversion` | `EUR_USD` | 10 | -6.460 | 20.0% | 5.7% | 0.13 |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 21 | 12 | 9 | -1.229 | 57.1% | 36.5%-75.5% | 0.73 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 42 | 22 | 20 | -0.998 | 52.4% | 37.7%-66.6% | 0.74 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 55 | 34 | 21 | -0.318 | 61.8% | 48.6%-73.5% | 0.91 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_USD` | 10 | 2 | 8 | -6.460 | 20.0% | 5.7%-51.0% | 0.13 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
