# SHADOW_PROMOTE R2 Alert - 2026-07-20T08:54:19.254558+00:00
...
| **WARN** | `lin_reg_channel` | `EUR_USD` | 18 | -1.444 | 50.0% | 29.0% | 0.49 |
| **WARN** | `london_breakout` | `EUR_USD` | 13 | -1.546 | 38.5% | 17.7% | 0.36 |
| **WARN** | `london_breakout` | `GBP_USD` | 18 | -2.906 | 38.9% | 20.3% | 0.21 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 79 | -1.454 | 36.7% | 26.9% | 0.38 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 32 | -2.206 | 75.0% | 57.9% | 0.49 |
...
| **WARN** | `trendline_sweep` | `EUR_GBP` | 28 | -1.575 | 50.0% | 32.6% | 0.38 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 25 | -2.540 | 20.0% | 8.9% | 0.08 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 14 | -1.386 | 35.7% | 16.3% | 0.52 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 13 | -0.254 | 46.2% | 23.2% | 0.90 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 22 | -0.786 | 68.2% | 47.3% | 0.76 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 21 | -1.348 | 71.4% | 50.0% | 0.73 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 15 | -3.593 | 40.0% | 19.8% | 0.12 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 35 | -2.914 | 54.3% | 38.2% | 0.28 |
...
| OK | `ema200_trend_reversal` | `USD_JPY` | 21 | 12 | 9 | +0.029 | 57.1% | 36.5%-75.5% | 1.01 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 18 | 9 | 9 | -1.444 | 50.0% | 29.0%-71.0% | 0.49 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 79 | 29 | 50 | -1.454 | 36.7% | 26.9%-47.7% | 0.38 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 32 | 24 | 8 | -2.206 | 75.0% | 57.9%-86.7% | 0.49 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 28 | 14 | 14 | -1.575 | 50.0% | 32.6%-67.4% | 0.38 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 25 | 5 | 20 | -2.540 | 20.0% | 8.9%-39.1% | 0.08 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `GBP_USD` | 14 | 5 | 9 | -1.386 | 35.7% | 16.3%-61.2% | 0.52 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `USD_CHF` | 1 | 1 | 0 | +2.000 | 100.0% | 20.7%-100.0% | n/a | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 13 | 6 | 7 | -0.254 | 46.2% | 23.2%-70.9% | 0.90 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 21 | 15 | 6 | -1.348 | 71.4% | 50.0%-86.2% | 0.73 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 35 | 19 | 16 | -2.914 | 54.3% | 38.2%-69.5% | 0.28 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
