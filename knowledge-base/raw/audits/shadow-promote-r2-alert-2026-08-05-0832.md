# SHADOW_PROMOTE R2 Alert - 2026-08-05T08:32:05.174823+00:00
...
| **WARN** | `engulfing_bb` | `GBP_USD` | 29 | -0.786 | 31.0% | 17.3% | 0.72 |
...
| **WARN** | `trendline_sweep` | `EUR_GBP` | 14 | -3.864 | 28.6% | 11.7% | 0.11 |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 19 | 12 | 7 | +0.184 | 63.2% | 41.0%-80.9% | 1.06 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `GBP_USD` | 29 | 9 | 20 | -0.786 | 31.0% | 17.3%-49.2% | 0.72 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 11 | 4 | 7 | -3.055 | 36.4% | 15.2%-64.6% | 0.33 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 19 | 11 | 8 | -1.279 | 57.9% | 36.3%-76.9% | 0.71 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 14 | 4 | 10 | -3.864 | 28.6% | 11.7%-54.6% | 0.11 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 9 | 3 | 6 | -0.678 | 33.3% | 12.1%-64.6% | 0.73 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
