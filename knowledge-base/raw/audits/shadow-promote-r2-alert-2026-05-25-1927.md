# SHADOW_PROMOTE R2 Alert - 2026-05-25T19:27:57.355119+00:00
...
| **WARN** | `bb_rsi_reversion` | `USD_JPY` | 19 | -0.358 | 42.1% | 23.1% | 0.88 |
| **CRITICAL** | `dt_bb_rsi_mr` | `GBP_USD` | 35 | -0.054 | 40.0% | 25.6% | 0.99 |
| **WARN** | `ema_trend_scalp` | `GBP_USD` | 13 | -0.108 | 23.1% | 8.2% | 0.96 |
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 20 | -2.090 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 53 | -1.513 | 18.9% | 10.6% | 0.54 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 85 | -3.947 | 17.6% | 11.0% | 0.43 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 52 | -4.737 | 23.1% | 13.7% | 0.37 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 34 | -3.562 | 20.6% | 10.3% | 0.52 |
| **WARN** | `xs_momentum` | `USD_JPY` | 25 | -1.488 | 36.0% | 20.2% | 0.80 |
...
| WARN | `bb_rsi_reversion` | `USD_JPY` | 19 | 8 | 11 | -0.358 | 42.1% | 23.1%-63.7% | 0.88 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `AUD_USD` | 2 | 0 | 2 | -11.200 | 0.0% | 0.0%-65.8% | 0.00 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema_trend_scalp` | `GBP_USD` | 13 | 3 | 10 | -0.108 | 23.1% | 8.2%-50.3% | 0.96 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `ema_trend_scalp` | `USD_CHF` | 20 | 0 | 20 | -2.090 | 0.0% | 0.0%-16.1% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 53 | 10 | 43 | -1.513 | 18.9% | 10.6%-31.4% | 0.54 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_JPY` | 12 | 3 | 9 | +2.458 | 25.0% | 8.9%-53.2% | 1.83 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `orb_trap` | `EUR_USD` | 11 | 1 | 10 | -1.900 | 9.1% | 1.6%-37.7% | 0.13 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `post_news_vol` | `USD_JPY` | 2 | 1 | 1 | +6.250 | 50.0% | 9.5%-90.5% | 6.43 | `POST_NEWS_VOL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 10 | 7 | 3 | +9.670 | 70.0% | 39.7%-89.2% | 6.56 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_anti_hunt_bounce` | `USD_JPY` | 31 | 0 | 31 | -1.542 | 0.0% | 0.0%-11.0% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 26 | 7 | 19 | -2.992 | 26.9% | 13.7%-46.1% | 0.61 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 25 | 2 | 23 | -7.684 | 8.0% | 2.2%-25.0% | 0.24 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 54 | 13 | 41 | -3.191 | 24.1% | 14.6%-36.9% | 0.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 46 | 14 | 32 | -0.622 | 30.4% | 19.1%-44.8% | 0.86 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_channel_reversal` | `USD_JPY` | 15 | 4 | 11 | -0.347 | 26.7% | 10.9%-52.0% | 0.85 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 85 | 15 | 70 | -3.947 | 17.6% | 11.0%-27.1% | 0.43 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 4 | 2 | 2 | +4.425 | 50.0% | 15.0%-85.0% | 4.40 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 52 | 12 | 40 | -4.737 | 23.1% | 13.7%-36.1% | 0.37 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 34 | 7 | 27 | -3.562 | 20.6% | 10.3%-36.8% | 0.52 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 25 | 9 | 16 | -1.488 | 36.0% | 20.2%-55.5% | 0.80 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
