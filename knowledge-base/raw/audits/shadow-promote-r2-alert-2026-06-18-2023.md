# SHADOW_PROMOTE R2 Alert - 2026-06-18T20:23:46.681148+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 57 | -0.714 | 40.4% | 28.6% | 0.63 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 33 | -3.839 | 36.4% | 22.2% | 0.26 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 13 | -2.608 | 53.8% | 29.1% | 0.20 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 31 | -1.742 | 51.6% | 34.8% | 0.61 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 31 | -1.558 | 61.3% | 43.8% | 0.58 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 57 | 23 | 34 | -0.714 | 40.4% | 28.6%-53.3% | 0.63 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `EUR_USD` | 1 | 0 | 1 | -2.100 | 0.0% | 0.0%-79.3% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ob_retest` | `GBP_JPY` | 1 | 1 | 0 | +2.000 | 100.0% | 20.7%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ob_retest` | `GBP_USD` | 2 | 2 | 0 | +2.050 | 100.0% | 34.2%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 3 | 2 | 1 | +2.233 | 66.7% | 20.8%-93.9% | 3.68 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 33 | 12 | 21 | -3.839 | 36.4% | 22.2%-53.4% | 0.26 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 13 | 7 | 6 | -2.608 | 53.8% | 29.1%-76.8% | 0.20 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 8 | 4 | 4 | -5.162 | 50.0% | 21.5%-78.5% | 0.32 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 31 | 16 | 15 | -1.742 | 51.6% | 34.8%-68.0% | 0.61 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 31 | 19 | 12 | -1.558 | 61.3% | 43.8%-76.3% | 0.58 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
