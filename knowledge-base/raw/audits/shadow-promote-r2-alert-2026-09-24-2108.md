# SHADOW_PROMOTE R2 Alert - 2026-09-24T21:08:38.874046+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 19 | -1.616 | 15.8% | 5.5% | 0.15 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_JPY` | 54 | -3.550 | 40.7% | 28.7% | 0.39 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 14 | -1.136 | 42.9% | 21.4% | 0.62 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 51 | -4.614 | 39.2% | 27.0% | 0.23 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 47 | -1.209 | 53.2% | 39.2% | 0.75 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 36 | -3.581 | 36.1% | 22.5% | 0.30 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 15 | -1.433 | 33.3% | 15.2% | 0.43 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 28 | -1.429 | 28.6% | 15.3% | 0.53 |
| **WARN** | `trend_rebound` | `USD_JPY` | 11 | -1.073 | 45.5% | 21.3% | 0.46 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 11 | -0.373 | 54.5% | 28.0% | 0.91 |
| **CRITICAL** | `trendline_sweep` | `GBP_USD` | 33 | -2.094 | 60.6% | 43.7% | 0.38 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 23 | -2.583 | 13.0% | 4.5% | 0.04 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 57 | -2.428 | 49.1% | 36.6% | 0.53 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 15 | -3.687 | 53.3% | 30.1% | 0.51 |
...
| WARN | `bb_squeeze_breakout` | `EUR_USD` | 19 | 3 | 16 | -1.616 | 15.8% | 5.5%-37.6% | 0.15 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_JPY` | 54 | 22 | 32 | -3.550 | 40.7% | 28.7%-54.0% | 0.39 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 14 | 6 | 8 | -1.136 | 42.9% | 21.4%-67.4% | 0.62 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 51 | 20 | 31 | -4.614 | 39.2% | 27.0%-52.9% | 0.23 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `mtf_reversal_confluence` | `USD_CHF` | 3 | 0 | 3 | -2.033 | 0.0% | 0.0%-56.2% | 0.00 | `MTF_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 47 | 25 | 22 | -1.209 | 53.2% | 39.2%-66.7% | 0.75 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 36 | 13 | 23 | -3.581 | 36.1% | 22.5%-52.4% | 0.30 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 11 | 5 | 6 | -1.073 | 45.5% | 21.3%-72.0% | 0.46 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_GBP` | 7 | 1 | 6 | -4.286 | 14.3% | 2.6%-51.3% | 0.07 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_USD` | 11 | 6 | 5 | -0.373 | 54.5% | 28.0%-78.7% | 0.91 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `trendline_sweep` | `GBP_USD` | 33 | 20 | 13 | -2.094 | 60.6% | 43.7%-75.3% | 0.38 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 23 | 3 | 20 | -2.583 | 13.0% | 4.5%-32.1% | 0.04 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `GBP_USD` | 7 | 4 | 3 | +0.800 | 57.1% | 25.0%-84.2% | 1.65 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 57 | 28 | 29 | -2.428 | 49.1% | 36.6%-61.7% | 0.53 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 15 | 8 | 7 | -3.687 | 53.3% | 30.1%-75.2% | 0.51 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
