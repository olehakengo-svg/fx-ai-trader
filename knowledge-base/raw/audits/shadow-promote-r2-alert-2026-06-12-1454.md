# SHADOW_PROMOTE R2 Alert - 2026-06-12T14:54:53.126226+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 12 | -0.842 | 50.0% | 25.4% | 0.70 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 33 | -2.718 | 39.4% | 24.7% | 0.44 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 13 | -0.631 | 76.9% | 49.7% | 0.69 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 86 | -0.710 | 44.2% | 34.2% | 0.70 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 27 | -0.652 | 22.2% | 10.6% | 0.68 |
| **WARN** | `sr_fib_confluence` | `GBP_USD` | 20 | -3.395 | 35.0% | 18.1% | 0.35 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 35 | -1.863 | 60.0% | 43.6% | 0.58 |
| **WARN** | `xs_momentum` | `USD_JPY` | 23 | -2.630 | 43.5% | 25.6% | 0.39 |
...
| OK | `donchian_momentum_breakout` | `NZD_JPY` | 2 | 1 | 1 | +11.950 | 50.0% | 9.5%-90.5% | 3.85 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `NZD_USD` | 3 | 2 | 1 | +6.200 | 66.7% | 20.8%-93.9% | 4.21 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 12 | 6 | 6 | -0.842 | 50.0% | 25.4%-74.6% | 0.70 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 9 | 5 | 4 | +0.233 | 55.6% | 26.7%-81.1% | 1.10 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 33 | 13 | 20 | -2.718 | 39.4% | 24.7%-56.3% | 0.44 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 13 | 10 | 3 | -0.631 | 76.9% | 49.7%-91.8% | 0.69 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_fib_confluence` | `GBP_USD` | 20 | 7 | 13 | -3.395 | 35.0% | 18.1%-56.7% | 0.35 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_USD` | 6 | 6 | 0 | +7.850 | 100.0% | 61.0%-100.0% | n/a | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 15 | 8 | 7 | +1.887 | 53.3% | 30.1%-75.2% | 1.93 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 35 | 21 | 14 | -1.863 | 60.0% | 43.6%-74.4% | 0.58 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 23 | 10 | 13 | -2.630 | 43.5% | 25.6%-63.2% | 0.39 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
