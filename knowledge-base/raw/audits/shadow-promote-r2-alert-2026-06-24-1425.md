# SHADOW_PROMOTE R2 Alert - 2026-06-24T14:25:28.270170+00:00
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 33 | -2.327 | 63.6% | 46.6% | 0.43 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 86 | 34 | 52 | -0.916 | 39.5% | 29.9%-50.1% | 0.55 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 43 | 18 | 25 | -1.188 | 41.9% | 28.4%-56.7% | 0.55 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `USD_CHF` | 19 | 6 | 13 | -2.474 | 31.6% | 15.4%-54.0% | 0.20 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 41 | 30 | 11 | -0.924 | 73.2% | 58.1%-84.3% | 0.69 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 67 | 34 | 33 | -0.470 | 50.7% | 39.1%-62.3% | 0.79 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 12 | 7 | 5 | -3.258 | 58.3% | 32.0%-80.7% | 0.25 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 37 | 11 | 26 | -2.846 | 29.7% | 17.5%-45.8% | 0.19 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_CHF` | 3 | 3 | 0 | +2.033 | 100.0% | 43.8%-100.0% | n/a | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 33 | 21 | 12 | -2.327 | 63.6% | 46.6%-77.8% | 0.43 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
