# SHADOW_PROMOTE R2 Alert - 2026-07-24T02:30:09.325662+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 14 | -1.000 | 35.7% | 16.3% | 0.66 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 32 | -5.334 | 59.4% | 42.3% | 0.24 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 20 | -1.705 | 30.0% | 14.5% | 0.22 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 38 | -2.426 | 52.6% | 37.3% | 0.34 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 14 | 5 | 9 | -1.000 | 35.7% | 16.3%-61.2% | 0.66 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 32 | 19 | 13 | -5.334 | 59.4% | 42.3%-74.5% | 0.24 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 20 | 6 | 14 | -1.705 | 30.0% | 14.5%-51.9% | 0.22 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 38 | 20 | 18 | -2.426 | 52.6% | 37.3%-67.5% | 0.34 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 46 | 30 | 16 | +0.022 | 65.2% | 50.8%-77.3% | 1.01 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
