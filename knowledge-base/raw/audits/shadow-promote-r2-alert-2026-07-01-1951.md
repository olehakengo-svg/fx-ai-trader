# SHADOW_PROMOTE R2 Alert - 2026-07-01T19:51:48.386217+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `EUR_USD` | 10 | -2.420 | 30.0% | 10.8% | 0.44 |
...
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 13 | -1.154 | 46.2% | 23.2% | 0.64 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 89 | -1.064 | 38.2% | 28.8% | 0.50 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 72 | -1.431 | 34.7% | 24.8% | 0.34 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 37 | -1.697 | 70.3% | 54.2% | 0.62 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 48 | -1.075 | 62.5% | 48.4% | 0.67 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 26 | -0.954 | 53.8% | 35.5% | 0.72 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 16 | -2.006 | 50.0% | 28.0% | 0.31 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 15 | -0.433 | 66.7% | 41.7% | 0.85 |
...
| WARN | `dt_bb_rsi_mr` | `EUR_USD` | 10 | 3 | 7 | -2.420 | 30.0% | 10.8%-60.3% | 0.44 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 11 | 7 | 4 | +1.827 | 63.6% | 35.4%-84.8% | 2.50 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 13 | 6 | 7 | -1.154 | 46.2% | 23.2%-70.9% | 0.64 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 89 | 34 | 55 | -1.064 | 38.2% | 28.8%-48.6% | 0.50 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 72 | 25 | 47 | -1.431 | 34.7% | 24.8%-46.2% | 0.34 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 37 | 26 | 11 | -1.697 | 70.3% | 54.2%-82.5% | 0.62 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 48 | 30 | 18 | -1.075 | 62.5% | 48.4%-74.8% | 0.67 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 26 | 14 | 12 | -0.954 | 53.8% | 35.5%-71.2% | 0.72 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_USD` | 15 | 10 | 5 | -0.433 | 66.7% | 41.7%-84.8% | 0.85 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
