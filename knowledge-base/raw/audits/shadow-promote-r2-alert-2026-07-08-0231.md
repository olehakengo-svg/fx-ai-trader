# SHADOW_PROMOTE R2 Alert - 2026-07-08T02:31:05.383710+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 86 | -0.592 | 44.2% | 34.2% | 0.70 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 28 | -1.221 | 71.4% | 52.9% | 0.64 |
...
| **WARN** | `trendline_sweep` | `GBP_USD` | 13 | -1.615 | 69.2% | 42.4% | 0.40 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 31 | -3.365 | 25.8% | 13.7% | 0.21 |
| **WARN** | `vol_momentum_scalp` | `USD_JPY` | 22 | -0.518 | 50.0% | 30.7% | 0.79 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 22 | -2.173 | 27.3% | 13.2% | 0.19 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 17 | -0.429 | 52.9% | 31.0% | 0.79 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 27 | -2.752 | 66.7% | 47.8% | 0.53 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 13 | -1.431 | 53.8% | 29.1% | 0.55 |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 5 | 1 | 4 | -12.500 | 20.0% | 3.6%-62.4% | 0.01 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 86 | 38 | 48 | -0.592 | 44.2% | 34.2%-54.7% | 0.70 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 28 | 20 | 8 | -1.221 | 71.4% | 52.9%-84.7% | 0.64 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 13 | 9 | 4 | -1.615 | 69.2% | 42.4%-87.3% | 0.40 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `USD_JPY` | 22 | 11 | 11 | -0.518 | 50.0% | 30.7%-69.3% | 0.79 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 17 | 9 | 8 | -0.429 | 52.9% | 31.0%-73.8% | 0.79 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `USD_JPY` | 13 | 7 | 6 | -1.431 | 53.8% | 29.1%-76.8% | 0.55 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
