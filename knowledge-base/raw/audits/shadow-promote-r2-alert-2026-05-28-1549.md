# SHADOW_PROMOTE R2 Alert - 2026-05-28T15:49:02.800153+00:00
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 31 | -1.087 | 25.8% | 13.7% | 0.51 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 32 | -7.709 | 6.2% | 1.7% | 0.19 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 64 | -3.759 | 20.3% | 12.3% | 0.37 |
...
| **WARN** | `sr_fib_confluence` | `EUR_GBP` | 22 | -1.555 | 18.2% | 7.3% | 0.46 |
...
| **WARN** | `vol_surge_detector` | `USD_JPY` | 11 | -2.200 | 18.2% | 5.1% | 0.35 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 18 | -4.317 | 16.7% | 5.8% | 0.40 |
| **CRITICAL** | `wick_imbalance_reversion` | `EUR_USD` | 31 | -1.042 | 25.8% | 13.7% | 0.66 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 58 | -4.914 | 20.7% | 12.3% | 0.34 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 44 | -1.298 | 29.5% | 18.2% | 0.80 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 40 | -1.325 | 30.0% | 18.1% | 0.77 |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 34 | 18 | 16 | +2.447 | 52.9% | 36.7%-68.5% | 1.94 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 31 | 8 | 23 | -1.087 | 25.8% | 13.7%-43.2% | 0.51 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 32 | 2 | 30 | -7.709 | 6.2% | 1.7%-20.1% | 0.19 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 64 | 13 | 51 | -3.759 | 20.3% | 12.3%-31.7% | 0.37 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_fib_confluence` | `EUR_GBP` | 22 | 4 | 18 | -1.555 | 18.2% | 7.3%-38.5% | 0.46 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 11 | 2 | 9 | -2.200 | 18.2% | 5.1%-47.7% | 0.35 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 18 | 3 | 15 | -4.317 | 16.7% | 5.8%-39.2% | 0.40 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 58 | 12 | 46 | -4.914 | 20.7% | 12.3%-32.8% | 0.34 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 44 | 13 | 31 | -1.298 | 29.5% | 18.2%-44.2% | 0.80 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 40 | 12 | 28 | -1.325 | 30.0% | 18.1%-45.4% | 0.77 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
