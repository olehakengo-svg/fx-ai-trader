# SHADOW_PROMOTE R2 Alert - 2026-09-03T02:57:42.879319+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | -2.129 | 33.3% | 18.0% | 0.54 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 25 | -0.632 | 44.0% | 26.7% | 0.77 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 31 | -3.829 | 51.6% | 34.8% | 0.35 |
...
| **WARN** | `three_bar_reversal` | `USD_JPY` | 27 | -0.289 | 44.4% | 27.6% | 0.88 |
| **WARN** | `trend_rebound` | `USD_JPY` | 13 | -0.623 | 38.5% | 17.7% | 0.72 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 28 | -3.550 | 46.4% | 29.5% | 0.22 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 24 | -2.592 | 45.8% | 27.9% | 0.55 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | 8 | 16 | -2.129 | 33.3% | 18.0%-53.3% | 0.54 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 25 | 11 | 14 | -0.632 | 44.0% | 26.7%-62.9% | 0.77 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 31 | 16 | 15 | -3.829 | 51.6% | 34.8%-68.0% | 0.35 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 32 | 10 | 22 | -2.509 | 31.2% | 18.0%-48.6% | 0.28 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 30 | 17 | 13 | +0.057 | 56.7% | 39.2%-72.6% | 1.02 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `htf_false_breakout` | `EUR_JPY` | 3 | 2 | 1 | -0.933 | 66.7% | 20.8%-93.9% | 0.79 | `HTF_FALSE_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ma_regime_switch` | `USD_JPY` | 4 | 0 | 4 | -7.000 | 0.0% | 0.0%-49.0% | 0.00 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `EUR_JPY` | 6 | 5 | 1 | +2.317 | 83.3% | 43.6%-97.0% | 2.05 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 27 | 12 | 15 | -0.289 | 44.4% | 27.6%-62.7% | 0.88 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `EUR_USD` | 8 | 4 | 4 | +1.112 | 50.0% | 21.5%-78.5% | 2.35 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 28 | 13 | 15 | -3.550 | 46.4% | 29.5%-64.2% | 0.22 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 24 | 11 | 13 | -2.592 | 45.8% | 27.9%-64.9% | 0.55 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 24 | 18 | 6 | +4.858 | 75.0% | 55.1%-88.0% | 4.23 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
