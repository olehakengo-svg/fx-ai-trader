# SHADOW_PROMOTE R2 Alert - 2026-08-21T18:32:47.922915+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `donchian_momentum_breakout` | `AUD_USD` | 11 | -4.455 | 36.4% | 15.2% | 0.29 |
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 10 | -0.050 | 60.0% | 31.3% | 0.98 |
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 18 | -1.300 | 55.6% | 33.7% | 0.62 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 12 | 10 | 2 | +3.742 | 83.3% | 55.2%-95.3% | 2.05 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `donchian_momentum_breakout` | `AUD_USD` | 11 | 4 | 7 | -4.455 | 36.4% | 15.2%-64.6% | 0.29 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 18 | 10 | 8 | -1.300 | 55.6% | 33.7%-75.4% | 0.62 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
