# SHADOW_PROMOTE R2 Alert - 2026-06-11T10:20:30.094100+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 11 | -0.691 | 36.4% | 15.2% | 0.70 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 13 | -0.600 | 53.8% | 29.1% | 0.86 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 14 | -8.807 | 21.4% | 7.6% | 0.24 |
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 33 | -2.470 | 6.1% | 1.7% | 0.04 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 41 | -1.005 | 34.1% | 21.6% | 0.51 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 22 | -4.295 | 50.0% | 30.7% | 0.21 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 30 | -4.660 | 46.7% | 30.2% | 0.34 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 33 | -2.270 | 36.4% | 22.2% | 0.53 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 13 | -0.669 | 69.2% | 42.4% | 0.66 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 81 | -0.789 | 39.5% | 29.6% | 0.68 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 28 | -0.564 | 21.4% | 10.2% | 0.70 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 30 | -3.337 | 26.7% | 14.2% | 0.35 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 15 | -2.393 | 46.7% | 24.8% | 0.26 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 10 | -8.150 | 30.0% | 10.8% | 0.07 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 22 | -2.073 | 27.3% | 13.2% | 0.35 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -1.418 | 29.4% | 13.3% | 0.36 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 37 | -0.824 | 51.4% | 35.9% | 0.76 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 32 | -2.444 | 53.1% | 36.4% | 0.49 |
| **WARN** | `xs_momentum` | `USD_JPY` | 27 | -2.996 | 37.0% | 21.5% | 0.32 |
...
| OK | `donchian_momentum_breakout` | `EUR_AUD` | 2 | 0 | 2 | -27.800 | 0.0% | 0.0%-65.8% | 0.00 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_JPY` | 6 | 4 | 2 | +18.117 | 66.7% | 30.0%-90.3% | 4.51 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `NZD_USD` | 8 | 5 | 3 | +13.813 | 62.5% | 30.6%-86.3% | 6.21 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 12 | 4 | 8 | +0.417 | 33.3% | 13.8%-60.9% | 1.18 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 11 | 4 | 7 | -0.691 | 36.4% | 15.2%-64.6% | 0.70 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 14 | 3 | 11 | -8.807 | 21.4% | 7.6%-47.6% | 0.24 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 33 | 2 | 31 | -2.470 | 6.1% | 1.7%-19.6% | 0.04 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 41 | 14 | 27 | -1.005 | 34.1% | 21.6%-49.5% | 0.51 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `lin_reg_channel` | `EUR_USD` | 7 | 1 | 6 | -5.114 | 14.3% | 2.6%-51.3% | 0.14 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `USD_CHF` | 9 | 2 | 7 | -2.333 | 22.2% | 6.3%-54.7% | 0.16 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 22 | 11 | 11 | -4.295 | 50.0% | 30.7%-69.3% | 0.21 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 30 | 14 | 16 | -4.660 | 46.7% | 30.2%-63.9% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 33 | 12 | 21 | -2.270 | 36.4% | 22.2%-53.4% | 0.53 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 13 | 9 | 4 | -0.669 | 69.2% | 42.4%-87.3% | 0.66 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 81 | 32 | 49 | -0.789 | 39.5% | 29.6%-50.4% | 0.68 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `USD_CHF` | 28 | 6 | 22 | -0.564 | 21.4% | 10.2%-39.5% | 0.70 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 4 | 1 | 3 | -3.125 | 25.0% | 4.6%-69.9% | 0.12 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 10 | 3 | 7 | -8.150 | 30.0% | 10.8%-60.3% | 0.07 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 22 | 6 | 16 | -2.073 | 27.3% | 13.2%-48.2% | 0.35 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 17 | 5 | 12 | -1.418 | 29.4% | 13.3%-53.1% | 0.36 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vwap_mean_reversion` | `EUR_JPY` | 1 | 0 | 1 | -20.300 | 0.0% | 0.0%-79.3% | 0.00 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 21 | 9 | 12 | +0.400 | 42.9% | 24.5%-63.5% | 1.13 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 37 | 19 | 18 | -0.824 | 51.4% | 35.9%-66.6% | 0.76 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 32 | 17 | 15 | -2.444 | 53.1% | 36.4%-69.1% | 0.49 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 27 | 10 | 17 | -2.996 | 37.0% | 21.5%-55.8% | 0.32 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
