...
| BUY | USD_JPY | 75 | 42.7% | -0.07 | -5.6 | 0.97 |
| SELL | USD_JPY | 105 | 40.0% | -0.44 | -46.6 | 0.81 |
| SELL | EUR_USD | 19 | 15.8% | -2.50 | -47.5 | 0.19 |
| BUY | GBP_USD | 7 | 42.9% | -3.47 | -24.3 | 0.26 |
| SELL | GBP_USD | 16 | 6.2% | -6.51 | -104.1 | 0.05 |

### direction x regime
| direction | regime | N | WR% | EV(pip) | PnL(pip) | PF |
|---|---|---|---|---|---|---|
| BUY | RANGE | 54 | 55.6% | +1.11 | +60.1 | 1.43 |
...
| SELL | TREND_BEAR | 46 | 34.8% | -1.63 | -75.1 | 0.47 |
...
- **SELL x GBP_USD** — EV=-6.51 pip, N=16, WR=6.2%
- **11 x EUR_USD** — EV=-5.23 pip, N=6, WR=33.3%
- **BUY x GBP_USD** — EV=-3.47 pip, N=7, WR=42.9%
