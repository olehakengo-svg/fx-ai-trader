# SHADOW_PROMOTE R2 Alert - 2026-06-08T03:52:00.784495+00:00
...
| **WARN** | `engulfing_bb` | `EUR_USD` | 28 | -1.079 | 28.6% | 15.3% | 0.51 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 17 | -2.518 | 11.8% | 3.3% | 0.21 |
...
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 16 | -15.500 | 25.0% | 10.2% | 0.12 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `USD_JPY` | 30 | -1.520 | 10.0% | 3.5% | 0.10 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 24 | -6.171 | 16.7% | 6.7% | 0.14 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 33 | -6.500 | 21.2% | 10.7% | 0.18 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 63 | -2.168 | 30.2% | 20.2% | 0.55 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 38 | -2.379 | 28.9% | 17.0% | 0.26 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 42 | -0.843 | 31.0% | 19.1% | 0.64 |
...
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 25 | -3.100 | 16.0% | 6.4% | 0.22 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 10 | -3.790 | 40.0% | 16.8% | 0.32 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 19 | -2.789 | 63.2% | 41.0% | 0.27 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 66 | -4.026 | 34.8% | 24.5% | 0.31 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 51 | -0.410 | 49.0% | 35.9% | 0.90 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 56 | -3.629 | 30.4% | 19.9% | 0.28 |
...
| WARN | `engulfing_bb` | `EUR_USD` | 28 | 8 | 20 | -1.079 | 28.6% | 15.3%-47.1% | 0.51 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 17 | 2 | 15 | -2.518 | 11.8% | 3.3%-34.3% | 0.21 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_USD` | 16 | 4 | 12 | -15.500 | 25.0% | 10.2%-49.5% | 0.12 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 3 | 0 | 3 | -0.400 | 0.0% | 0.0%-56.2% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_anti_hunt_bounce` | `USD_JPY` | 30 | 3 | 27 | -1.520 | 10.0% | 3.5%-25.6% | 0.10 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 24 | 4 | 20 | -6.171 | 16.7% | 6.7%-35.9% | 0.14 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 33 | 7 | 26 | -6.500 | 21.2% | 10.7%-37.8% | 0.18 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 63 | 19 | 44 | -2.168 | 30.2% | 20.2%-42.4% | 0.55 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 38 | 11 | 27 | -2.379 | 28.9% | 17.0%-44.8% | 0.26 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 42 | 13 | 29 | -0.843 | 31.0% | 19.1%-46.0% | 0.64 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 25 | 4 | 21 | -3.100 | 16.0% | 6.4%-34.7% | 0.22 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 10 | 4 | 6 | -3.790 | 40.0% | 16.8%-68.7% | 0.32 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 40 | 14 | 26 | +0.290 | 35.0% | 22.1%-50.5% | 1.09 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 66 | 23 | 43 | -4.026 | 34.8% | 24.5%-46.9% | 0.31 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 51 | 25 | 26 | -0.410 | 49.0% | 35.9%-62.3% | 0.90 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 56 | 17 | 39 | -3.629 | 30.4% | 19.9%-43.3% | 0.28 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
