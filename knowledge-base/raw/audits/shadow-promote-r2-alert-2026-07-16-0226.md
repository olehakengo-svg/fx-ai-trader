# SHADOW_PROMOTE R2 Alert - 2026-07-16T02:26:06.941749+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 81 | -0.583 | 46.9% | 36.4% | 0.70 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 32 | -2.050 | 75.0% | 57.9% | 0.52 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 40 | -1.155 | 62.5% | 47.0% | 0.63 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 40 | -3.098 | 45.0% | 30.7% | 0.31 |
...
| OK | `dt_sr_channel_reversal` | `AUD_JPY` | 5 | 4 | 1 | +0.200 | 80.0% | 37.6%-96.4% | 1.16 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 81 | 38 | 43 | -0.583 | 46.9% | 36.4%-57.7% | 0.70 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 32 | 24 | 8 | -2.050 | 75.0% | 57.9%-86.7% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 40 | 25 | 15 | -1.155 | 62.5% | 47.0%-75.8% | 0.63 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 40 | 18 | 22 | -3.098 | 45.0% | 30.7%-60.2% | 0.31 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
