# SHADOW_PROMOTE R2 Alert - 2026-07-14T08:00:14.241440+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_USD` | 39 | -0.826 | 56.4% | 41.0% | 0.55 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 82 | -0.187 | 47.6% | 37.1% | 0.88 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 30 | -3.420 | 50.0% | 33.2% | 0.31 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 37 | -3.054 | 70.3% | 54.2% | 0.40 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 43 | -0.800 | 65.1% | 50.2% | 0.72 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 37 | -2.768 | 48.6% | 33.4% | 0.33 |
| **WARN** | `trend_rebound` | `USD_JPY` | 12 | -1.125 | 33.3% | 13.8% | 0.38 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 29 | -0.990 | 58.6% | 40.7% | 0.53 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 15 | -1.127 | 73.3% | 48.0% | 0.65 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 11 | -4.882 | 45.5% | 21.3% | 0.13 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 32 | -1.747 | 40.6% | 25.5% | 0.48 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 40 | -0.800 | 42.5% | 28.5% | 0.67 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 28 | -1.668 | 67.9% | 49.3% | 0.65 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 11 | -8.473 | 9.1% | 1.6% | 0.01 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 14 | -3.314 | 42.9% | 21.4% | 0.13 |
| **WARN** | `xs_momentum` | `EUR_USD` | 27 | -3.522 | 48.1% | 30.7% | 0.27 |
| **WARN** | `xs_momentum` | `GBP_USD` | 27 | -4.996 | 55.6% | 37.3% | 0.24 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 13 | 10 | 3 | +0.300 | 76.9% | 49.7%-91.8% | 1.08 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 8 | 2 | 6 | -3.650 | 25.0% | 7.1%-59.1% | 0.29 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_USD` | 39 | 22 | 17 | -0.826 | 56.4% | 41.0%-70.7% | 0.55 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 82 | 39 | 43 | -0.187 | 47.6% | 37.1%-58.2% | 0.88 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `EUR_USD` | 17 | 10 | 7 | +0.006 | 58.8% | 36.0%-78.4% | 1.00 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `AUD_JPY` | 6 | 4 | 2 | -2.267 | 66.7% | 30.0%-90.3% | 0.36 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 30 | 15 | 15 | -3.420 | 50.0% | 33.2%-66.8% | 0.31 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 37 | 26 | 11 | -3.054 | 70.3% | 54.2%-82.5% | 0.40 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 43 | 28 | 15 | -0.800 | 65.1% | 50.2%-77.6% | 0.72 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 37 | 18 | 19 | -2.768 | 48.6% | 33.4%-64.1% | 0.33 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 29 | 17 | 12 | -0.990 | 58.6% | 40.7%-74.5% | 0.53 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_USD` | 15 | 11 | 4 | -1.127 | 73.3% | 48.0%-89.1% | 0.65 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 11 | 5 | 6 | -4.882 | 45.5% | 21.3%-72.0% | 0.13 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 40 | 17 | 23 | -0.800 | 42.5% | 28.5%-57.8% | 0.67 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 28 | 19 | 9 | -1.668 | 67.9% | 49.3%-82.1% | 0.65 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 27 | 13 | 14 | -3.522 | 48.1% | 30.7%-66.0% | 0.27 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `GBP_USD` | 27 | 15 | 12 | -4.996 | 55.6% | 37.3%-72.4% | 0.24 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
