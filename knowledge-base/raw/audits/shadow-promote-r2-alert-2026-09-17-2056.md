# SHADOW_PROMOTE R2 Alert - 2026-09-17T20:56:56.247843+00:00
...
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 13 | -3.800 | 53.8% | 29.1% | 0.42 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 48 | -0.773 | 54.2% | 40.3% | 0.83 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 34 | -2.588 | 41.2% | 26.4% | 0.46 |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 13 | 7 | 6 | -3.800 | 53.8% | 29.1%-76.8% | 0.42 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 34 | 14 | 20 | -2.588 | 41.2% | 26.4%-57.8% | 0.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
