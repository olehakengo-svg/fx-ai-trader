# SHADOW_PROMOTE R2 Alert - 2026-06-16T20:48:30.105353+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 53 | -0.949 | 37.7% | 25.9% | 0.53 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 29 | -3.131 | 24.1% | 12.2% | 0.13 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 51 | -0.722 | 37.3% | 25.3% | 0.52 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 26 | -2.031 | 65.4% | 46.2% | 0.43 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 41 | -4.871 | 51.2% | 36.5% | 0.33 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 32 | -4.753 | 31.2% | 18.0% | 0.17 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 16 | -0.975 | 68.8% | 44.4% | 0.56 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 92 | -0.447 | 50.0% | 40.0% | 0.80 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 53 | 20 | 33 | -0.949 | 37.7% | 25.9%-51.2% | 0.53 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 29 | 7 | 22 | -3.131 | 24.1% | 12.2%-42.1% | 0.13 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 51 | 19 | 32 | -0.722 | 37.3% | 25.3%-51.0% | 0.52 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 41 | 21 | 20 | -4.871 | 51.2% | 36.5%-65.7% | 0.33 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 92 | 46 | 46 | -0.447 | 50.0% | 40.0%-60.0% | 0.80 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
