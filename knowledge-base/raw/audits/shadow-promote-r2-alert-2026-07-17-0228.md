# SHADOW_PROMOTE R2 Alert - 2026-07-17T02:28:56.696666+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_USD` | 31 | -1.348 | 45.2% | 29.2% | 0.38 |
...
| **WARN** | `lin_reg_channel` | `EUR_USD` | 19 | -1.489 | 52.6% | 31.7% | 0.49 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 32 | -1.766 | 53.1% | 36.4% | 0.56 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 33 | -1.885 | 75.8% | 59.0% | 0.55 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 36 | -0.467 | 66.7% | 50.3% | 0.82 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 36 | -2.622 | 58.3% | 42.2% | 0.33 |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_USD` | 31 | 14 | 17 | -1.348 | 45.2% | 29.2%-62.2% | 0.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 19 | 10 | 9 | -1.489 | 52.6% | 31.7%-72.7% | 0.49 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 10 | 9 | 1 | +1.670 | 90.0% | 59.6%-98.2% | 3.88 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 32 | 17 | 15 | -1.766 | 53.1% | 36.4%-69.1% | 0.56 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 33 | 25 | 8 | -1.885 | 75.8% | 59.0%-87.2% | 0.55 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 36 | 24 | 12 | -0.467 | 66.7% | 50.3%-79.8% | 0.82 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 36 | 21 | 15 | -2.622 | 58.3% | 42.2%-72.9% | 0.33 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
