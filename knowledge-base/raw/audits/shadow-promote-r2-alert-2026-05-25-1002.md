# SHADOW_PROMOTE R2 Alert - 2026-05-25T10:02:29.001963+00:00
...
| **WARN** | `bb_rsi_reversion` | `USD_JPY` | 23 | -0.622 | 39.1% | 22.2% | 0.79 |
| **CRITICAL** | `dt_bb_rsi_mr` | `GBP_USD` | 35 | -0.054 | 40.0% | 25.6% | 0.99 |
| **WARN** | `ema_trend_scalp` | `EUR_USD` | 11 | -1.836 | 9.1% | 1.6% | 0.20 |
| **WARN** | `ema_trend_scalp` | `GBP_USD` | 16 | -0.806 | 18.8% | 6.6% | 0.70 |
| **WARN** | `ema_trend_scalp` | `USD_CHF` | 19 | -2.100 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 54 | -1.552 | 18.5% | 10.4% | 0.53 |
...
| **WARN** | `sr_anti_hunt_bounce` | `USD_JPY` | 21 | -1.743 | 0.0% | 0.0% | 0.00 |
...
| **WARN** | `sr_channel_reversal` | `USD_JPY` | 21 | -1.405 | 19.0% | 7.7% | 0.51 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 49 | -4.631 | 24.5% | 14.6% | 0.39 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 34 | -2.953 | 23.5% | 12.4% | 0.59 |
...
| WARN | `bb_rsi_reversion` | `USD_JPY` | 23 | 9 | 14 | -0.622 | 39.1% | 22.2%-59.2% | 0.79 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `AUD_USD` | 1 | 0 | 1 | -20.300 | 0.0% | 0.0%-79.3% | 0.00 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema_trend_scalp` | `EUR_USD` | 11 | 1 | 10 | -1.836 | 9.1% | 1.6%-37.7% | 0.20 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `ema_trend_scalp` | `GBP_USD` | 16 | 3 | 13 | -0.806 | 18.8% | 6.6%-43.0% | 0.70 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `ema_trend_scalp` | `USD_CHF` | 19 | 0 | 19 | -2.100 | 0.0% | 0.0%-16.8% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 54 | 10 | 44 | -1.552 | 18.5% | 10.4%-30.8% | 0.53 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `USD_JPY` | 21 | 0 | 21 | -1.743 | 0.0% | 0.0%-15.5% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_channel_reversal` | `USD_JPY` | 21 | 4 | 17 | -1.405 | 19.0% | 7.7%-40.0% | 0.51 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 49 | 12 | 37 | -4.631 | 24.5% | 14.6%-38.1% | 0.39 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 34 | 8 | 26 | -2.953 | 23.5% | 12.4%-40.0% | 0.59 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
