# SHADOW_PROMOTE R2 Alert - 2026-05-11T02:57:32.454201+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `EUR_USD` | 47 | -0.600 | 34.0% | 22.2% | 0.71 |
| **CRITICAL** | `bb_rsi_reversion` | `GBP_USD` | 38 | -2.224 | 15.8% | 7.4% | 0.35 |
| **CRITICAL** | `bb_rsi_reversion` | `USD_JPY` | 75 | -0.459 | 36.0% | 26.1% | 0.84 |
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 12 | -0.192 | 8.3% | 1.5% | 0.93 |
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 76 | -0.999 | 18.4% | 11.3% | 0.61 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 89 | -0.857 | 21.3% | 14.1% | 0.74 |
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 10 | -4.510 | 30.0% | 10.8% | 0.25 |
...
| CRITICAL | `bb_rsi_reversion` | `EUR_USD` | 47 | 16 | 31 | -0.600 | 34.0% | 22.2%-48.3% | 0.71 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `GBP_USD` | 38 | 6 | 32 | -2.224 | 15.8% | 7.4%-30.4% | 0.35 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `USD_JPY` | 75 | 27 | 48 | -0.459 | 36.0% | 26.1%-47.3% | 0.84 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 89 | 19 | 70 | -0.857 | 21.3% | 14.1%-31.0% | 0.74 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ma_regime_switch` | `USD_JPY` | 4 | 0 | 4 | -3.550 | 0.0% | 0.0%-49.0% | 0.00 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 10 | 3 | 7 | -4.510 | 30.0% | 10.8%-60.3% | 0.25 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
