# SHADOW_PROMOTE R2 Alert - 2026-09-21T12:00:37.968694+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 13 | -2.192 | 7.7% | 1.4% | 0.03 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | -1.450 | 30.0% | 10.8% | 0.43 |
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_JPY` | 37 | -4.814 | 35.1% | 21.8% | 0.28 |
...
| WARN | `bb_squeeze_breakout` | `EUR_USD` | 13 | 1 | 12 | -2.192 | 7.7% | 1.4%-33.3% | 0.03 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_JPY` | 37 | 13 | 24 | -4.814 | 35.1% | 21.8%-51.2% | 0.28 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 33 | 20 | 13 | -2.609 | 60.6% | 43.7%-75.3% | 0.37 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `mtf_reversal_confluence` | `USD_JPY` | 2 | 2 | 0 | +0.800 | 100.0% | 34.2%-100.0% | n/a | `MTF_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 39 | 22 | 17 | -0.444 | 56.4% | 41.0%-70.7% | 0.90 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 20 | 7 | 13 | -0.265 | 35.0% | 18.1%-56.7% | 0.89 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
