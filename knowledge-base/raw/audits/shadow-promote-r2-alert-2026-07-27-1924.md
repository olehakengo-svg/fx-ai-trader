# SHADOW_PROMOTE R2 Alert - 2026-07-27T19:24:14.149029+00:00
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 55 | -1.167 | 34.5% | 23.4% | 0.44 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 44 | -2.527 | 50.0% | 35.8% | 0.45 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 29 | -5.507 | 58.6% | 40.7% | 0.23 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 41 | -1.685 | 53.7% | 38.7% | 0.51 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 25 | -3.376 | 44.0% | 26.7% | 0.25 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 11 | -0.736 | 54.5% | 28.0% | 0.57 |
| **WARN** | `trend_rebound` | `USD_JPY` | 15 | -1.093 | 33.3% | 15.2% | 0.35 |
| **CRITICAL** | `trendline_sweep` | `EUR_GBP` | 30 | -2.083 | 46.7% | 30.2% | 0.29 |
...
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 10 | -5.420 | 30.0% | 10.8% | 0.07 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 37 | -2.565 | 51.4% | 35.9% | 0.33 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 39 | -0.321 | 61.5% | 45.9% | 0.91 |
...
| OK | `dt_sr_channel_reversal` | `AUD_JPY` | 24 | 15 | 9 | +0.179 | 62.5% | 42.7%-78.8% | 1.08 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 55 | 19 | 36 | -1.167 | 34.5% | 23.4%-47.7% | 0.44 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 44 | 22 | 22 | -2.527 | 50.0% | 35.8%-64.2% | 0.45 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 29 | 17 | 12 | -5.507 | 58.6% | 40.7%-74.5% | 0.23 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 41 | 22 | 19 | -1.685 | 53.7% | 38.7%-67.9% | 0.51 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 25 | 11 | 14 | -3.376 | 44.0% | 26.7%-62.9% | 0.25 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `trendline_sweep` | `EUR_GBP` | 30 | 14 | 16 | -2.083 | 46.7% | 30.2%-63.9% | 0.29 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `USD_JPY` | 10 | 3 | 7 | -5.420 | 30.0% | 10.8%-60.3% | 0.07 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `USD_JPY` | 39 | 24 | 15 | -0.321 | 61.5% | 45.9%-75.1% | 0.91 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
