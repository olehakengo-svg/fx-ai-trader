# SHADOW_PROMOTE R2 Alert - 2026-09-04T20:16:33.349255+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `donchian_momentum_breakout` | `AUD_USD` | 12 | -4.442 | 41.7% | 19.3% | 0.21 |
| **WARN** | `donchian_momentum_breakout` | `NZD_USD` | 15 | -0.547 | 60.0% | 35.7% | 0.89 |
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 18 | -0.678 | 50.0% | 29.0% | 0.83 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 14 | -1.929 | 14.3% | 4.0% | 0.27 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 20 | -1.895 | 30.0% | 14.5% | 0.59 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 28 | -0.936 | 42.9% | 26.5% | 0.67 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | -3.596 | 51.9% | 34.0% | 0.37 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 33 | -2.203 | 33.3% | 19.8% | 0.35 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 26 | -0.973 | 50.0% | 32.1% | 0.70 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 51 | -0.653 | 37.3% | 25.3% | 0.65 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `EUR_JPY` | 36 | -1.831 | 47.2% | 32.0% | 0.59 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 18 | -0.622 | 66.7% | 43.7% | 0.84 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 49 | -1.114 | 49.0% | 35.6% | 0.74 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 22 | -0.573 | 45.5% | 26.9% | 0.75 |
| **WARN** | `trend_rebound` | `USD_JPY` | 13 | -0.623 | 38.5% | 17.7% | 0.72 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 26 | -3.446 | 50.0% | 32.1% | 0.24 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 25 | -1.132 | 24.0% | 11.5% | 0.45 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 10 | -1.820 | 30.0% | 10.8% | 0.44 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 56 | -0.121 | 58.9% | 45.9% | 0.96 |
...
| **WARN** | `xs_momentum` | `USD_JPY` | 14 | -4.814 | 50.0% | 26.8% | 0.46 |
...
| WARN | `donchian_momentum_breakout` | `AUD_USD` | 12 | 5 | 7 | -4.442 | 41.7% | 19.3%-68.0% | 0.21 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 8 | 5 | 3 | +1.175 | 62.5% | 30.6%-86.3% | 1.57 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 18 | 9 | 9 | -0.678 | 50.0% | 29.0%-71.0% | 0.83 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 20 | 6 | 14 | -1.895 | 30.0% | 14.5%-51.9% | 0.59 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 28 | 12 | 16 | -0.936 | 42.9% | 26.5%-60.9% | 0.67 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | 14 | 13 | -3.596 | 51.9% | 34.0%-69.3% | 0.37 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 33 | 11 | 22 | -2.203 | 33.3% | 19.8%-50.4% | 0.35 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 26 | 13 | 13 | -0.973 | 50.0% | 32.1%-67.9% | 0.70 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema200_trend_reversal` | `USD_JPY` | 4 | 2 | 2 | -3.750 | 50.0% | 15.0%-85.0% | 0.43 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_cross` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_ribbon_ride` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_RIBBON_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `engulfing_bb` | `GBP_USD` | 1 | 0 | 1 | -4.300 | 0.0% | 0.0%-79.3% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `london_breakout` | `EUR_USD` | 51 | 19 | 32 | -0.653 | 37.3% | 25.3%-51.0% | 0.65 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `pullback_to_liquidity_v1` | `USD_JPY` | 2 | 1 | 1 | +1.800 | 50.0% | 9.5%-90.5% | 1.54 | `PULLBACK_TO_LIQUIDITY_V1_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 49 | 24 | 25 | -1.114 | 49.0% | 35.6%-62.5% | 0.74 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 26 | 13 | 13 | -3.446 | 50.0% | 32.1%-67.9% | 0.24 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 10 | 3 | 7 | -1.820 | 30.0% | 10.8%-60.3% | 0.44 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `AUD_JPY` | 1 | 0 | 1 | -20.000 | 0.0% | 0.0%-79.3% | 0.00 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `EUR_GBP` | 7 | 1 | 6 | -1.700 | 14.3% | 2.6%-51.3% | 0.41 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 56 | 33 | 23 | -0.121 | 58.9% | 45.9%-70.8% | 0.96 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 9 | 5 | 4 | -1.311 | 55.6% | 26.7%-81.1% | 0.74 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `USD_JPY` | 14 | 7 | 7 | -4.814 | 50.0% | 26.8%-73.2% | 0.46 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
