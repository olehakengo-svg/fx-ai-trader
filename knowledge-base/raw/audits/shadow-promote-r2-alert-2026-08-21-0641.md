# SHADOW_PROMOTE R2 Alert - 2026-08-21T06:41:13.159288+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 11 | -0.164 | 63.6% | 35.4% | 0.93 |
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | -4.490 | 47.6% | 28.3% | 0.35 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 34 | -0.485 | 50.0% | 34.1% | 0.86 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 41 | -1.895 | 22.0% | 12.0% | 0.19 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 29 | -1.345 | 48.3% | 31.4% | 0.68 |
...
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 20 | -0.835 | 65.0% | 43.3% | 0.76 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 34 | -3.347 | 38.2% | 23.9% | 0.38 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 14 | -2.664 | 64.3% | 38.8% | 0.59 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 13 | -7.746 | 38.5% | 17.7% | 0.22 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 59 | -2.041 | 49.2% | 36.8% | 0.58 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 20 | -3.925 | 55.0% | 34.2% | 0.16 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 17 | -3.894 | 41.2% | 21.6% | 0.29 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 36 | -1.686 | 38.9% | 24.8% | 0.63 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 21 | -0.981 | 23.8% | 10.6% | 0.52 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -0.900 | 33.3% | 13.8% | 0.70 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 36 | -0.936 | 47.2% | 32.0% | 0.75 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 27 | -2.174 | 51.9% | 34.0% | 0.60 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 22 | -3.118 | 36.4% | 19.7% | 0.29 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 10 | 8 | 2 | +2.700 | 80.0% | 49.0%-94.3% | 1.63 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 11 | 7 | 4 | -0.164 | 63.6% | 35.4%-84.8% | 0.93 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 17 | 9 | 8 | -1.424 | 52.9% | 31.0%-73.8% | 0.60 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `AUD_JPY` | 9 | 1 | 8 | -8.422 | 11.1% | 2.0%-43.5% | 0.09 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 26 | 12 | 14 | +0.123 | 46.2% | 28.8%-64.5% | 1.04 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 21 | 10 | 11 | -4.490 | 47.6% | 28.3%-67.6% | 0.35 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 26 | 14 | 12 | +0.715 | 53.8% | 35.5%-71.2% | 1.27 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 34 | 17 | 17 | -0.485 | 50.0% | 34.1%-65.9% | 0.86 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 41 | 9 | 32 | -1.895 | 22.0% | 12.0%-36.7% | 0.19 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `lin_reg_channel` | `EUR_USD` | 9 | 3 | 6 | -2.911 | 33.3% | 12.1%-64.6% | 0.34 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 29 | 14 | 15 | -1.345 | 48.3% | 31.4%-65.6% | 0.68 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `GBP_JPY` | 20 | 13 | 7 | -0.835 | 65.0% | 43.3%-81.9% | 0.76 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_JPY` | 13 | 5 | 8 | -7.746 | 38.5% | 17.7%-64.5% | 0.22 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `GBP_USD` | 8 | 3 | 5 | -3.400 | 37.5% | 13.7%-69.4% | 0.25 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 59 | 29 | 30 | -2.041 | 49.2% | 36.8%-61.6% | 0.58 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 20 | 11 | 9 | -3.925 | 55.0% | 34.2%-74.2% | 0.16 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 36 | 14 | 22 | -1.686 | 38.9% | 24.8%-55.1% | 0.63 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vwap_mean_reversion` | `GBP_USD` | 4 | 3 | 1 | -1.900 | 75.0% | 30.1%-95.4% | 0.56 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `USD_JPY` | 1 | 1 | 0 | +0.700 | 100.0% | 20.7%-100.0% | n/a | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 36 | 17 | 19 | -0.936 | 47.2% | 32.0%-63.0% | 0.75 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 27 | 14 | 13 | -2.174 | 51.9% | 34.0%-69.3% | 0.60 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 22 | 8 | 14 | -3.118 | 36.4% | 19.7%-57.0% | 0.29 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
