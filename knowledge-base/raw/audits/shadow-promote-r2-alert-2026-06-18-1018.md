# SHADOW_PROMOTE R2 Alert - 2026-06-18T10:18:14.092065+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 53 | -0.753 | 39.6% | 27.6% | 0.61 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 28 | -2.886 | 28.6% | 15.3% | 0.16 |
| **WARN** | `london_breakout` | `USD_CHF` | 16 | -2.375 | 37.5% | 18.5% | 0.25 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 43 | -3.491 | 60.5% | 45.6% | 0.38 |
...
| OK | `bb_rsi_reversion` | `EUR_USD` | 1 | 0 | 1 | -3.700 | 0.0% | 0.0%-79.3% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 53 | 21 | 32 | -0.753 | 39.6% | 27.6%-53.1% | 0.61 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 28 | 8 | 20 | -2.886 | 28.6% | 15.3%-47.1% | 0.16 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `lin_reg_channel` | `EUR_USD` | 8 | 2 | 6 | -5.763 | 25.0% | 7.1%-59.1% | 0.07 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `london_breakout` | `EUR_USD` | 37 | 18 | 19 | +0.719 | 48.6% | 33.4%-64.1% | 1.43 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `london_breakout` | `GBP_USD` | 31 | 20 | 11 | +1.577 | 64.5% | 46.9%-78.9% | 1.93 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 16 | 6 | 10 | -2.375 | 37.5% | 18.5%-61.4% | 0.25 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `USD_JPY` | 18 | 12 | 6 | +0.200 | 66.7% | 43.7%-83.7% | 1.12 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 43 | 26 | 17 | -3.491 | 60.5% | 45.6%-73.6% | 0.38 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_USD` | 7 | 6 | 1 | +2.943 | 85.7% | 48.7%-97.4% | 2.79 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `GBP_USD` | 6 | 2 | 4 | -8.600 | 33.3% | 9.7%-70.0% | 0.07 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 36 | 13 | 23 | -1.811 | 36.1% | 22.5%-52.4% | 0.36 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_CHF` | 4 | 1 | 3 | -6.375 | 25.0% | 4.6%-69.9% | 0.07 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 15 | 7 | 8 | -1.127 | 46.7% | 24.8%-69.9% | 0.53 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 33 | 21 | 12 | -1.400 | 63.6% | 46.6%-77.8% | 0.60 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
