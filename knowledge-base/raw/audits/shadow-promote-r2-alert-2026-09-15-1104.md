# SHADOW_PROMOTE R2 Alert - 2026-09-15T11:04:51.696554+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 14 | -0.500 | 50.0% | 26.8% | 0.88 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | -2.870 | 10.0% | 1.8% | 0.23 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 29 | -5.359 | 34.5% | 19.9% | 0.21 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 31 | -4.035 | 51.6% | 34.8% | 0.30 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 26 | -1.577 | 42.3% | 25.5% | 0.43 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 32 | -0.828 | 59.4% | 42.3% | 0.74 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 43 | -0.088 | 58.1% | 43.3% | 0.98 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 52 | -0.890 | 59.6% | 46.1% | 0.77 |
...
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 14 | 7 | 7 | -0.500 | 50.0% | 26.8%-73.2% | 0.88 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 29 | 10 | 19 | -5.359 | 34.5% | 19.9%-52.7% | 0.21 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 14 | 7 | 7 | +0.064 | 50.0% | 26.8%-73.2% | 1.02 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 31 | 16 | 15 | -4.035 | 51.6% | 34.8%-68.0% | 0.30 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 26 | 11 | 15 | -1.577 | 42.3% | 25.5%-61.1% | 0.43 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 32 | 19 | 13 | -0.828 | 59.4% | 42.3%-74.5% | 0.74 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 43 | 25 | 18 | -0.088 | 58.1% | 43.3%-71.6% | 0.98 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 52 | 31 | 21 | -0.890 | 59.6% | 46.1%-71.8% | 0.77 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
