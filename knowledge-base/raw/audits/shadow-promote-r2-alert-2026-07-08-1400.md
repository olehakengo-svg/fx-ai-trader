# SHADOW_PROMOTE R2 Alert - 2026-07-08T14:00:11.040780+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 84 | -0.523 | 42.9% | 32.8% | 0.72 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 38 | -0.347 | 47.4% | 32.5% | 0.84 |
...
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 11 | -0.436 | 54.5% | 28.0% | 0.83 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 13 | -3.408 | 53.8% | 29.1% | 0.23 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 15 | -9.033 | 46.7% | 24.8% | 0.14 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 29 | -2.593 | 62.1% | 44.0% | 0.39 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 32 | -2.781 | 68.8% | 51.4% | 0.45 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 47 | -0.791 | 63.8% | 49.5% | 0.74 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 30 | -2.287 | 53.3% | 36.1% | 0.41 |
| **WARN** | `trend_rebound` | `USD_JPY` | 10 | -2.180 | 20.0% | 5.7% | 0.11 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 23 | -1.439 | 56.5% | 36.8% | 0.42 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 18 | -2.600 | 66.7% | 43.7% | 0.23 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 14 | -2.943 | 64.3% | 38.8% | 0.25 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 34 | -2.485 | 32.4% | 19.1% | 0.36 |
| **WARN** | `vol_momentum_scalp` | `USD_JPY` | 24 | -0.325 | 54.2% | 35.1% | 0.86 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 24 | -1.579 | 70.8% | 50.8% | 0.66 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 11 | -3.209 | 45.5% | 21.3% | 0.15 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 36 | -2.689 | 55.6% | 39.6% | 0.39 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 38 | -4.903 | 55.3% | 39.7% | 0.26 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 84 | 36 | 48 | -0.523 | 42.9% | 32.8%-53.5% | 0.72 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 38 | 18 | 20 | -0.347 | 47.4% | 32.5%-62.7% | 0.84 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `inducement_ob` | `GBP_USD` | 4 | 2 | 2 | -4.750 | 50.0% | 15.0%-85.0% | 0.21 | `INDUCEMENT_OB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `GBP_USD` | 5 | 3 | 2 | -4.040 | 60.0% | 23.1%-88.2% | 0.23 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 11 | 6 | 5 | -0.436 | 54.5% | 28.0%-78.7% | 0.83 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 29 | 18 | 11 | -2.593 | 62.1% | 44.0%-77.3% | 0.39 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 32 | 22 | 10 | -2.781 | 68.8% | 51.4%-82.0% | 0.45 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 47 | 30 | 17 | -0.791 | 63.8% | 49.5%-76.0% | 0.74 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 30 | 16 | 14 | -2.287 | 53.3% | 36.1%-69.8% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 23 | 13 | 10 | -1.439 | 56.5% | 36.8%-74.4% | 0.42 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_USD` | 18 | 12 | 6 | -2.600 | 66.7% | 43.7%-83.7% | 0.23 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 14 | 9 | 5 | -2.943 | 64.3% | 38.8%-83.7% | 0.25 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 34 | 11 | 23 | -2.485 | 32.4% | 19.1%-49.2% | 0.36 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_momentum_scalp` | `USD_JPY` | 24 | 13 | 11 | -0.325 | 54.2% | 35.1%-72.1% | 0.86 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vwap_mean_reversion` | `GBP_JPY` | 5 | 5 | 0 | +5.160 | 100.0% | 56.6%-100.0% | n/a | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 24 | 17 | 7 | -1.579 | 70.8% | 50.8%-85.1% | 0.66 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 36 | 20 | 16 | -2.689 | 55.6% | 39.6%-70.5% | 0.39 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 38 | 21 | 17 | -4.903 | 55.3% | 39.7%-69.9% | 0.26 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
