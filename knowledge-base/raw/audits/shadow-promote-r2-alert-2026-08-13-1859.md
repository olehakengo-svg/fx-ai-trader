# SHADOW_PROMOTE R2 Alert - 2026-08-13T18:59:52.645829+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 22 | -1.027 | 40.9% | 23.3% | 0.54 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 52 | -1.919 | 19.2% | 10.8% | 0.16 |
...
| **WARN** | `ob_retest` | `USD_JPY` | 21 | -2.343 | 47.6% | 28.3% | 0.63 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 41 | -2.880 | 46.3% | 32.1% | 0.46 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 11 | -0.836 | 36.4% | 15.2% | 0.52 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 19 | -4.484 | 57.9% | 36.3% | 0.13 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 30 | -2.987 | 43.3% | 27.4% | 0.31 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 52 | -1.817 | 32.7% | 21.5% | 0.54 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 20 | -1.315 | 30.0% | 14.5% | 0.39 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 11 | -0.927 | 36.4% | 15.2% | 0.72 |
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 20 | -2.095 | 35.0% | 18.1% | 0.55 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 21 | -1.633 | 57.1% | 36.5% | 0.67 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 43 | -1.112 | 65.1% | 50.2% | 0.68 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 22 | 9 | 13 | -1.027 | 40.9% | 23.3%-61.3% | 0.54 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 52 | 10 | 42 | -1.919 | 19.2% | 10.8%-31.9% | 0.16 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `USD_JPY` | 21 | 10 | 11 | -2.343 | 47.6% | 28.3%-67.6% | 0.63 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 41 | 19 | 22 | -2.880 | 46.3% | 32.1%-61.3% | 0.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `EUR_USD` | 11 | 4 | 7 | -0.836 | 36.4% | 15.2%-64.6% | 0.52 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 30 | 13 | 17 | -2.987 | 43.3% | 27.4%-60.8% | 0.31 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 52 | 17 | 35 | -1.817 | 32.7% | 21.5%-46.2% | 0.54 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `AUD_JPY` | 20 | 7 | 13 | -2.095 | 35.0% | 18.1%-56.7% | 0.55 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 21 | 12 | 9 | -1.633 | 57.1% | 36.5%-75.5% | 0.67 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 43 | 28 | 15 | -1.112 | 65.1% | 50.2%-77.6% | 0.68 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
