# SHADOW_PROMOTE R2 Alert - 2026-06-11T20:19:35.807972+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 11 | -0.118 | 54.5% | 28.0% | 0.97 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 16 | -8.731 | 31.2% | 14.2% | 0.14 |
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 31 | -2.587 | 6.5% | 1.8% | 0.05 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 38 | -0.518 | 39.5% | 25.6% | 0.71 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 24 | -2.833 | 25.0% | 12.0% | 0.14 |
| **WARN** | `london_breakout` | `USD_CHF` | 10 | -2.570 | 20.0% | 5.7% | 0.13 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 41 | -1.000 | 29.3% | 17.6% | 0.43 |
| **WARN** | `ob_retest` | `EUR_USD` | 13 | -3.169 | 7.7% | 1.4% | 0.04 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 21 | -2.629 | 57.1% | 36.5% | 0.37 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 34 | -4.915 | 47.1% | 31.5% | 0.31 |
...
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 25 | -2.120 | 28.0% | 14.3% | 0.33 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 16 | -1.619 | 31.2% | 14.2% | 0.21 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 37 | -0.789 | 54.1% | 38.4% | 0.78 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 36 | -1.864 | 58.3% | 42.2% | 0.57 |
| **WARN** | `xs_momentum` | `USD_JPY` | 25 | -2.684 | 40.0% | 23.4% | 0.36 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 7 | 6 | 1 | +18.229 | 85.7% | 48.7%-97.4% | 23.00 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 9 | 3 | 6 | +0.411 | 33.3% | 12.1%-64.6% | 1.25 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 11 | 6 | 5 | -0.118 | 54.5% | 28.0%-78.7% | 0.97 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 16 | 5 | 11 | -8.731 | 31.2% | 14.2%-55.6% | 0.14 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 6 | 3 | 3 | -2.467 | 50.0% | 18.8%-81.2% | 0.23 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 31 | 2 | 29 | -2.587 | 6.5% | 1.8%-20.7% | 0.05 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 38 | 15 | 23 | -0.518 | 39.5% | 25.6%-55.3% | 0.71 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 24 | 6 | 18 | -2.833 | 25.0% | 12.0%-44.9% | 0.14 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 41 | 12 | 29 | -1.000 | 29.3% | 17.6%-44.5% | 0.43 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 21 | 12 | 9 | -2.629 | 57.1% | 36.5%-75.5% | 0.37 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 34 | 16 | 18 | -4.915 | 47.1% | 31.5%-63.3% | 0.31 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 35 | 13 | 22 | -2.620 | 37.1% | 23.2%-53.7% | 0.47 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `USD_JPY` | 11 | 9 | 2 | +0.473 | 81.8% | 52.3%-94.9% | 1.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `EUR_USD` | 31 | 16 | 15 | +0.381 | 51.6% | 34.8%-68.0% | 1.14 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 25 | 7 | 18 | -2.120 | 28.0% | 14.3%-47.6% | 0.33 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 37 | 20 | 17 | -0.789 | 54.1% | 38.4%-69.0% | 0.78 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 36 | 21 | 15 | -1.864 | 58.3% | 42.2%-72.9% | 0.57 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 25 | 10 | 15 | -2.684 | 40.0% | 23.4%-59.3% | 0.36 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
