# SHADOW_PROMOTE R2 Alert - 2026-06-30T09:31:30.493876+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | -2.660 | 20.0% | 5.7% | 0.08 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | -4.284 | 52.0% | 33.5% | 0.20 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 39 | -2.472 | 56.4% | 41.0% | 0.54 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 21 | -1.271 | 66.7% | 45.4% | 0.50 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 13 | -0.969 | 46.2% | 23.2% | 0.66 |
| **WARN** | `ema200_trend_reversal` | `USD_JPY` | 11 | -0.091 | 63.6% | 35.4% | 0.96 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 83 | -0.973 | 39.8% | 29.9% | 0.53 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 42 | -0.519 | 45.2% | 31.2% | 0.76 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 14 | -4.164 | 35.7% | 16.3% | 0.13 |
| **WARN** | `london_breakout` | `USD_CHF` | 22 | -2.359 | 27.3% | 13.2% | 0.19 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 60 | -1.350 | 35.0% | 24.2% | 0.32 |
| **WARN** | `ob_retest` | `GBP_USD` | 10 | -5.260 | 50.0% | 23.7% | 0.16 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 15 | -2.633 | 40.0% | 19.8% | 0.18 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 12 | -1.233 | 66.7% | 39.1% | 0.51 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 35 | -1.251 | 71.4% | 54.9% | 0.63 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 40 | -2.592 | 65.0% | 49.5% | 0.51 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 46 | -1.530 | 56.5% | 42.2% | 0.58 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 24 | -1.117 | 58.3% | 38.8% | 0.66 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 15 | -1.807 | 53.3% | 30.1% | 0.35 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 14 | -0.364 | 71.4% | 45.4% | 0.88 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 14 | -1.707 | 64.3% | 38.8% | 0.36 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 46 | -3.224 | 26.1% | 15.6% | 0.16 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -1.559 | 41.2% | 21.6% | 0.31 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 11 | -2.500 | 27.3% | 9.7% | 0.17 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 13 | -2.300 | 53.8% | 29.1% | 0.47 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 17 | -6.000 | 52.9% | 31.0% | 0.25 |
| **WARN** | `xs_momentum` | `EUR_USD` | 27 | -2.285 | 51.9% | 34.0% | 0.47 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 33 | -3.209 | 63.6% | 46.6% | 0.34 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 10 | 2 | 8 | -2.660 | 20.0% | 5.7%-51.0% | 0.08 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | 13 | 12 | -4.284 | 52.0% | 33.5%-70.0% | 0.20 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 31 | 22 | 9 | +0.358 | 71.0% | 53.4%-83.9% | 1.25 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 39 | 22 | 17 | -2.472 | 56.4% | 41.0%-70.7% | 0.54 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 21 | 14 | 7 | -1.271 | 66.7% | 45.4%-82.8% | 0.50 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 83 | 33 | 50 | -0.973 | 39.8% | 29.9%-50.5% | 0.53 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 42 | 19 | 23 | -0.519 | 45.2% | 31.2%-60.1% | 0.76 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `USD_CHF` | 22 | 6 | 16 | -2.359 | 27.3% | 13.2%-48.2% | 0.19 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 60 | 21 | 39 | -1.350 | 35.0% | 24.2%-47.6% | 0.32 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 15 | 6 | 9 | -2.633 | 40.0% | 19.8%-64.3% | 0.18 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 9 | 6 | 3 | -2.378 | 66.7% | 35.4%-87.9% | 0.47 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 35 | 25 | 10 | -1.251 | 71.4% | 54.9%-83.7% | 0.63 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 40 | 26 | 14 | -2.592 | 65.0% | 49.5%-77.9% | 0.51 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 46 | 26 | 20 | -1.530 | 56.5% | 42.2%-69.8% | 0.58 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 24 | 14 | 10 | -1.117 | 58.3% | 38.8%-75.5% | 0.66 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `GBP_USD` | 27 | 17 | 10 | +0.100 | 63.0% | 44.2%-78.5% | 1.06 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_CHF` | 8 | 2 | 6 | -1.300 | 25.0% | 7.1%-59.1% | 0.25 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `GBP_USD` | 4 | 2 | 2 | -2.475 | 50.0% | 15.0%-85.0% | 0.24 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 8 | 2 | 6 | -1.688 | 25.0% | 7.1%-59.1% | 0.18 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_GBP` | 15 | 8 | 7 | -1.807 | 53.3% | 30.1%-75.2% | 0.35 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_USD` | 14 | 10 | 4 | -0.364 | 71.4% | 45.4%-88.3% | 0.88 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 14 | 9 | 5 | -1.707 | 64.3% | 38.8%-83.7% | 0.36 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `turtle_soup` | `GBP_USD` | 3 | 3 | 0 | +1.833 | 100.0% | 43.8%-100.0% | n/a | `TURTLE_SOUP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 46 | 12 | 34 | -3.224 | 26.1% | 15.6%-40.3% | 0.16 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_momentum_scalp` | `USD_JPY` | 4 | 2 | 2 | +1.600 | 50.0% | 15.0%-85.0% | 2.78 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 17 | 7 | 10 | -1.559 | 41.2% | 21.6%-64.0% | 0.31 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `GBP_USD` | 11 | 3 | 8 | -2.500 | 27.3% | 9.7%-56.6% | 0.17 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `USD_CHF` | 3 | 2 | 1 | +0.533 | 66.7% | 20.8%-93.9% | 1.64 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `USD_JPY` | 12 | 7 | 5 | +0.000 | 58.3% | 32.0%-80.7% | 1.00 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `EUR_GBP` | 2 | 1 | 1 | -1.050 | 50.0% | 9.5%-90.5% | 0.43 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `EUR_JPY` | 3 | 2 | 1 | -5.767 | 66.7% | 20.8%-93.9% | 0.18 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 13 | 7 | 6 | -2.300 | 53.8% | 29.1%-76.8% | 0.47 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 17 | 9 | 8 | -6.000 | 52.9% | 31.0%-73.8% | 0.25 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `GBP_USD` | 7 | 2 | 5 | -3.529 | 28.6% | 8.2%-64.1% | 0.09 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `USD_JPY` | 7 | 5 | 2 | +1.486 | 71.4% | 35.9%-91.8% | 1.97 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `EUR_USD` | 27 | 14 | 13 | -2.285 | 51.9% | 34.0%-69.3% | 0.47 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 33 | 21 | 12 | -3.209 | 63.6% | 46.6%-77.8% | 0.34 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 8 | 6 | 2 | +2.112 | 75.0% | 40.9%-92.9% | 2.76 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
