# SHADOW_PROMOTE R2 Alert - 2026-07-31T02:37:38.876391+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `AUD_JPY` | 36 | -2.603 | 47.2% | 32.0% | 0.42 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 49 | -1.549 | 36.7% | 24.7% | 0.46 |
...
| **WARN** | `sr_break_retest` | `AUD_JPY` | 25 | -2.688 | 52.0% | 33.5% | 0.32 |
...
| CRITICAL | `dt_sr_channel_reversal` | `AUD_JPY` | 36 | 17 | 19 | -2.603 | 47.2% | 32.0%-63.0% | 0.42 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 16 | 9 | 7 | +0.994 | 56.2% | 33.2%-76.9% | 1.37 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 49 | 18 | 31 | -1.549 | 36.7% | 24.7%-50.7% | 0.46 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `GBP_JPY` | 2 | 2 | 0 | +2.500 | 100.0% | 34.2%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 25 | 13 | 12 | -2.688 | 52.0% | 33.5%-70.0% | 0.32 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 27 | 12 | 15 | -2.159 | 44.4% | 27.6%-62.7% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 18 | 6 | 12 | -2.850 | 33.3% | 16.3%-56.3% | 0.18 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 71 | 27 | 44 | -0.848 | 38.0% | 27.6%-49.7% | 0.64 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
