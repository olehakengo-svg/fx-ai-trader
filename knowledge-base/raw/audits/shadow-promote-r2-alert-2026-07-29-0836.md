# SHADOW_PROMOTE R2 Alert - 2026-07-29T08:36:56.172823+00:00
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 52 | -1.073 | 34.6% | 23.2% | 0.46 |
...
| **WARN** | `sr_break_retest` | `AUD_JPY` | 22 | -2.018 | 59.1% | 38.7% | 0.43 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 49 | -2.871 | 49.0% | 35.6% | 0.40 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 30 | -4.470 | 60.0% | 42.3% | 0.30 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 40 | -1.473 | 55.0% | 39.8% | 0.56 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 24 | -2.071 | 45.8% | 27.9% | 0.45 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 12 | -0.525 | 58.3% | 32.0% | 0.66 |
| **WARN** | `trend_rebound` | `USD_JPY` | 15 | -1.093 | 33.3% | 15.2% | 0.35 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 24 | -2.337 | 41.7% | 24.5% | 0.25 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 15 | -3.167 | 66.7% | 41.7% | 0.23 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 72 | -1.231 | 36.1% | 26.0% | 0.44 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 22 | 11 | 11 | -0.759 | 50.0% | 30.7%-69.3% | 0.65 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema200_trend_reversal` | `USD_JPY` | 19 | 12 | 7 | +0.379 | 63.2% | 41.0%-80.9% | 1.17 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_cross` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_ribbon_ride` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_RIBBON_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 85 | 27 | 58 | -1.365 | 31.8% | 22.8%-42.3% | 0.35 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 26 | 13 | 13 | -1.765 | 50.0% | 32.1%-67.9% | 0.35 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 52 | 18 | 34 | -1.073 | 34.6% | 23.2%-48.2% | 0.46 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 22 | 13 | 9 | -2.018 | 59.1% | 38.7%-76.7% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 49 | 24 | 25 | -2.871 | 49.0% | 35.6%-62.5% | 0.40 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 24 | 11 | 13 | -2.071 | 45.8% | 27.9%-64.9% | 0.45 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 24 | 10 | 14 | -2.337 | 41.7% | 24.5%-61.2% | 0.25 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_USD` | 14 | 11 | 3 | +0.386 | 78.6% | 52.4%-92.4% | 1.14 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 15 | 10 | 5 | -3.167 | 66.7% | 41.7%-84.8% | 0.23 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 72 | 26 | 46 | -1.231 | 36.1% | 26.0%-47.6% | 0.44 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `xs_momentum` | `USD_JPY` | 34 | 21 | 13 | +0.226 | 61.8% | 45.0%-76.1% | 1.06 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
