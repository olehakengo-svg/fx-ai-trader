# SHADOW_PROMOTE R2 Alert - 2026-05-11T09:37:05.290929+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `EUR_USD` | 48 | -0.548 | 35.4% | 23.4% | 0.75 |
| **CRITICAL** | `bb_rsi_reversion` | `GBP_USD` | 45 | -2.244 | 17.8% | 9.3% | 0.37 |
| **CRITICAL** | `bb_rsi_reversion` | `USD_JPY` | 90 | -0.227 | 40.0% | 30.5% | 0.92 |
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 12 | -0.192 | 8.3% | 1.5% | 0.93 |
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 75 | -0.972 | 18.7% | 11.5% | 0.62 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 87 | -0.783 | 21.8% | 14.5% | 0.76 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 220 | -1.542 | 21.8% | 16.9% | 0.59 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 14 | -2.021 | 14.3% | 4.0% | 0.35 |
| **CRITICAL** | `engulfing_bb` | `USD_JPY` | 40 | -1.750 | 20.0% | 10.5% | 0.60 |
...
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 71 | -1.601 | 19.7% | 12.1% | 0.46 |
...
| CRITICAL | `bb_rsi_reversion` | `EUR_USD` | 48 | 17 | 31 | -0.548 | 35.4% | 23.4%-49.6% | 0.75 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `GBP_USD` | 45 | 8 | 37 | -2.244 | 17.8% | 9.3%-31.3% | 0.37 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `USD_JPY` | 90 | 36 | 54 | -0.227 | 40.0% | 30.5%-50.3% | 0.92 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 75 | 14 | 61 | -0.972 | 18.7% | 11.5%-28.9% | 0.62 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 87 | 19 | 68 | -0.783 | 21.8% | 14.5%-31.6% | 0.76 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 220 | 48 | 172 | -1.542 | 21.8% | 16.9%-27.7% | 0.59 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `USD_JPY` | 40 | 8 | 32 | -1.750 | 20.0% | 10.5%-34.8% | 0.60 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 71 | 14 | 57 | -1.601 | 19.7% | 12.1%-30.4% | 0.46 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
