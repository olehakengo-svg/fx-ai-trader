# SHADOW_PROMOTE R2 Alert - 2026-08-13T01:47:36.112287+00:00
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 41 | -1.056 | 46.3% | 32.1% | 0.68 |
...
| **WARN** | `sr_break_retest` | `AUD_JPY` | 24 | -2.475 | 41.7% | 24.5% | 0.48 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 36 | -2.822 | 47.2% | 32.0% | 0.49 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 55 | -1.775 | 34.5% | 23.4% | 0.53 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 19 | -1.458 | 26.3% | 11.8% | 0.36 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 10 | -1.100 | 30.0% | 10.8% | 0.69 |
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 20 | -2.905 | 30.0% | 14.5% | 0.41 |
...
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 15 | 10 | 5 | +0.427 | 66.7% | 41.7%-84.8% | 1.17 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 26 | 13 | 13 | -0.158 | 50.0% | 32.1%-67.9% | 0.94 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 28 | 14 | 14 | -4.096 | 50.0% | 32.6%-67.4% | 0.34 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 23 | 13 | 10 | +1.739 | 56.5% | 36.8%-74.4% | 1.76 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 57 | 10 | 47 | -2.046 | 17.5% | 9.8%-29.4% | 0.14 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 41 | 19 | 22 | -1.056 | 46.3% | 32.1%-61.3% | 0.68 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `EUR_JPY` | 2 | 1 | 1 | -14.950 | 50.0% | 9.5%-90.5% | 0.31 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 6 | 3 | 3 | -4.633 | 50.0% | 18.8%-81.2% | 0.41 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 24 | 10 | 14 | -2.475 | 41.7% | 24.5%-61.2% | 0.48 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 36 | 17 | 19 | -2.822 | 47.2% | 32.0%-63.0% | 0.49 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 55 | 19 | 36 | -1.775 | 34.5% | 23.4%-47.7% | 0.53 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 19 | 5 | 14 | -1.458 | 26.3% | 11.8%-48.8% | 0.36 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `GBP_USD` | 7 | 1 | 6 | -3.243 | 14.3% | 2.6%-51.3% | 0.08 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `AUD_JPY` | 20 | 6 | 14 | -2.905 | 30.0% | 14.5%-51.9% | 0.41 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
