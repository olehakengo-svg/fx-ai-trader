# SHADOW_PROMOTE R2 Alert - 2026-09-01T11:06:00.146593+00:00
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 41 | -1.851 | 46.3% | 32.1% | 0.58 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 52 | -0.250 | 50.0% | 36.9% | 0.92 |
| **WARN** | `trend_rebound` | `USD_JPY` | 12 | -0.375 | 41.7% | 19.3% | 0.82 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 21 | -4.248 | 38.1% | 20.8% | 0.11 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 53 | -0.474 | 54.7% | 41.5% | 0.87 |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 41 | 19 | 22 | -1.851 | 46.3% | 32.1%-61.3% | 0.58 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 12 | 5 | 7 | -0.375 | 41.7% | 19.3%-68.0% | 0.82 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 21 | 8 | 13 | -4.248 | 38.1% | 20.8%-59.1% | 0.11 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 53 | 29 | 24 | -0.474 | 54.7% | 41.5%-67.3% | 0.87 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
