# SHADOW_PROMOTE R2 Alert - 2026-07-07T09:37:29.641753+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | -1.759 | 59.3% | 40.7% | 0.64 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 78 | -0.665 | 44.9% | 34.3% | 0.67 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 28 | -0.775 | 75.0% | 56.6% | 0.74 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 37 | -2.030 | 70.3% | 54.2% | 0.55 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 46 | -0.243 | 67.4% | 53.0% | 0.91 |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | 16 | 11 | -1.759 | 59.3% | 40.7%-75.5% | 0.64 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema200_trend_reversal` | `USD_JPY` | 9 | 5 | 4 | +1.800 | 55.6% | 26.7%-81.1% | 1.45 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_cross` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_ribbon_ride` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_RIBBON_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 78 | 35 | 43 | -0.665 | 44.9% | 34.3%-55.9% | 0.67 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 28 | 21 | 7 | -0.775 | 75.0% | 56.6%-87.3% | 0.74 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 37 | 26 | 11 | -2.030 | 70.3% | 54.2%-82.5% | 0.55 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 46 | 31 | 15 | -0.243 | 67.4% | 53.0%-79.1% | 0.91 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `GBP_USD` | 4 | 1 | 3 | -3.875 | 25.0% | 4.6%-69.9% | 0.12 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
