# SHADOW_PROMOTE R2 Alert - 2026-09-24T11:07:03.074441+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_JPY` | 51 | -3.641 | 41.2% | 28.8% | 0.39 |
...
| **WARN** | `three_bar_reversal` | `USD_JPY` | 24 | -0.950 | 33.3% | 18.0% | 0.66 |
| **WARN** | `trend_rebound` | `USD_JPY` | 10 | -1.250 | 40.0% | 16.8% | 0.43 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 29 | -1.969 | 58.6% | 40.7% | 0.37 |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 15 | 13 | 2 | +1.833 | 86.7% | 62.1%-96.3% | 1.47 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_JPY` | 51 | 21 | 30 | -3.641 | 41.2% | 28.8%-54.8% | 0.39 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 24 | 8 | 16 | -0.950 | 33.3% | 18.0%-53.3% | 0.66 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 29 | 17 | 12 | -1.969 | 58.6% | 40.7%-74.5% | 0.37 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
