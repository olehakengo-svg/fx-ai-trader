# SHADOW_PROMOTE R2 Alert - 2026-08-07T07:11:31.784064+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | -2.380 | 44.0% | 26.7% | 0.47 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 17 | -0.112 | 52.9% | 31.0% | 0.96 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | -2.110 | 62.1% | 44.0% | 0.52 |
...
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 11 | -3.936 | 18.2% | 5.1% | 0.25 |
...
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 13 | 9 | 4 | +0.362 | 69.2% | 42.4%-87.3% | 1.16 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | 11 | 14 | -2.380 | 44.0% | 26.7%-62.9% | 0.47 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 17 | 9 | 8 | -0.112 | 52.9% | 31.0%-73.8% | 0.96 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | 18 | 11 | -2.110 | 62.1% | 44.0%-77.3% | 0.52 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 11 | 2 | 9 | -3.936 | 18.2% | 5.1%-47.7% | 0.25 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
