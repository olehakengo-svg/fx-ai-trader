# SHADOW_PROMOTE R2 Alert - 2026-06-10T03:34:03.523171+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `USD_CHF` | 33 | -1.748 | 6.1% | 1.7% | 0.07 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 18 | -6.567 | 38.9% | 20.3% | 0.32 |
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 101 | -1.649 | 7.9% | 4.1% | 0.23 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 40 | -0.773 | 32.5% | 20.1% | 0.64 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 23 | -2.909 | 13.0% | 4.5% | 0.24 |
| **WARN** | `engulfing_bb` | `USD_CHF` | 12 | -1.475 | 0.0% | 0.0% | 0.00 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 43 | -1.184 | 27.9% | 16.7% | 0.39 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 24 | -4.054 | 29.2% | 14.9% | 0.28 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 46 | -3.604 | 43.5% | 30.2% | 0.36 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 57 | -1.832 | 35.1% | 24.0% | 0.63 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 31 | -0.255 | 51.6% | 34.8% | 0.85 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 71 | -0.823 | 39.4% | 28.9% | 0.65 |
| **CRITICAL** | `sr_channel_reversal` | `USD_CHF` | 52 | -2.198 | 7.7% | 3.0% | 0.13 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 48 | -4.090 | 20.8% | 11.7% | 0.27 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 15 | -2.880 | 40.0% | 19.8% | 0.20 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 14 | -6.600 | 35.7% | 16.3% | 0.12 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 26 | -2.488 | 23.1% | 11.0% | 0.27 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -2.082 | 23.5% | 9.6% | 0.27 |
| **WARN** | `vol_surge_detector` | `USD_CHF` | 10 | -3.950 | 0.0% | 0.0% | 0.00 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 19 | -2.789 | 63.2% | 41.0% | 0.27 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 52 | -0.213 | 57.7% | 44.2% | 0.95 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 57 | -3.296 | 31.6% | 21.0% | 0.30 |
...
| CRITICAL | `bb_rsi_reversion` | `USD_CHF` | 33 | 2 | 31 | -1.748 | 6.1% | 1.7%-19.6% | 0.07 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 9 | 1 | 8 | -6.533 | 11.1% | 2.0%-43.5% | 0.37 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `EUR_USD` | 3 | 0 | 3 | -11.433 | 0.0% | 0.0%-56.2% | 0.00 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 10 | 6 | 4 | +0.190 | 60.0% | 31.3%-83.2% | 1.08 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 101 | 8 | 93 | -1.649 | 7.9% | 4.1%-14.9% | 0.23 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 40 | 13 | 27 | -0.773 | 32.5% | 20.1%-48.0% | 0.64 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 23 | 3 | 20 | -2.909 | 13.0% | 4.5%-32.1% | 0.24 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `USD_CHF` | 12 | 0 | 12 | -1.475 | 0.0% | 0.0%-24.3% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `lin_reg_channel` | `EUR_USD` | 8 | 1 | 7 | -5.387 | 12.5% | 2.2%-47.1% | 0.12 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 43 | 12 | 31 | -1.184 | 27.9% | 16.7%-42.7% | 0.39 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `orb_trap` | `EUR_USD` | 9 | 2 | 7 | -2.467 | 22.2% | 6.3%-54.7% | 0.45 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 8 | 8 | 0 | +29.788 | 100.0% | 67.6%-100.0% | n/a | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 5 | 3 | 2 | -1.760 | 60.0% | 23.1%-88.2% | 0.37 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 24 | 7 | 17 | -4.054 | 29.2% | 14.9%-49.2% | 0.28 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 46 | 20 | 26 | -3.604 | 43.5% | 30.2%-57.8% | 0.36 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 57 | 20 | 37 | -1.832 | 35.1% | 24.0%-48.1% | 0.63 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 31 | 16 | 15 | -0.255 | 51.6% | 34.8%-68.0% | 0.85 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 71 | 28 | 43 | -0.823 | 39.4% | 28.9%-51.1% | 0.65 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_CHF` | 52 | 4 | 48 | -2.198 | 7.7% | 3.0%-18.2% | 0.13 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_GBP` | 1 | 0 | 1 | -5.700 | 0.0% | 0.0%-79.3% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_USD` | 67 | 36 | 31 | +1.879 | 53.7% | 41.9%-65.1% | 1.99 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 48 | 10 | 38 | -4.090 | 20.8% | 11.7%-34.3% | 0.27 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 15 | 6 | 9 | -2.880 | 40.0% | 19.8%-64.3% | 0.20 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vdr_jpy` | `USD_JPY` | 3 | 3 | 0 | +11.867 | 100.0% | 43.8%-100.0% | n/a | `VDR_JPY_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_momentum_scalp` | `GBP_USD` | 26 | 6 | 20 | -2.488 | 23.1% | 11.0%-42.1% | 0.27 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 17 | 4 | 13 | -2.082 | 23.5% | 9.6%-47.3% | 0.27 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 35 | 24 | 11 | +7.894 | 68.6% | 52.0%-81.4% | 11.55 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `xs_momentum` | `EUR_USD` | 49 | 26 | 23 | +0.169 | 53.1% | 39.4%-66.3% | 1.06 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 52 | 30 | 22 | -0.213 | 57.7% | 44.2%-70.1% | 0.95 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 57 | 18 | 39 | -3.296 | 31.6% | 21.0%-44.5% | 0.30 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
