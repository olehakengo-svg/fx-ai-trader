# SHADOW_PROMOTE R2 Alert - 2026-06-02T10:20:36.613505+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 56 | -2.227 | 1.8% | 0.3% | 0.10 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 30 | -1.727 | 20.0% | 9.5% | 0.32 |
| **WARN** | `ob_retest` | `EUR_USD` | 28 | -0.568 | 28.6% | 15.3% | 0.87 |
| **WARN** | `ob_retest` | `GBP_USD` | 16 | -1.981 | 37.5% | 18.5% | 0.70 |
| **WARN** | `orb_trap` | `EUR_USD` | 11 | -5.391 | 0.0% | 0.0% | 0.00 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 65 | -0.266 | 32.3% | 22.2% | 0.93 |
...
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 88 | -0.834 | 30.7% | 22.0% | 0.77 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 89 | -4.444 | 14.6% | 8.7% | 0.34 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 38 | -0.334 | 31.6% | 19.1% | 0.95 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 34 | 18 | 16 | +2.047 | 52.9% | 36.7%-68.5% | 1.63 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 56 | 1 | 55 | -2.227 | 1.8% | 0.3%-9.4% | 0.10 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 30 | 6 | 24 | -1.727 | 20.0% | 9.5%-37.3% | 0.32 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `orb_trap` | `EUR_USD` | 11 | 0 | 11 | -5.391 | 0.0% | 0.0%-25.9% | 0.00 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 65 | 21 | 44 | -0.266 | 32.3% | 22.2%-44.4% | 0.93 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 88 | 27 | 61 | -0.834 | 30.7% | 22.0%-41.0% | 0.77 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 89 | 13 | 76 | -4.444 | 14.6% | 8.7%-23.4% | 0.34 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 9 | 2 | 7 | -1.222 | 22.2% | 6.3%-54.7% | 0.56 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 38 | 12 | 26 | -0.334 | 31.6% | 19.1%-47.5% | 0.95 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
