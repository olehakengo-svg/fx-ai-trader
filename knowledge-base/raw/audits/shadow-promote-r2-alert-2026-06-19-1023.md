# SHADOW_PROMOTE R2 Alert - 2026-06-19T10:23:16.443445+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 10 | -2.430 | 40.0% | 16.8% | 0.36 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 11 | -2.427 | 18.2% | 5.1% | 0.12 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 12 | -5.767 | 50.0% | 25.4% | 0.16 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | -5.669 | 44.8% | 28.4% | 0.26 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 39 | -2.085 | 33.3% | 20.6% | 0.31 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 15 | -1.320 | 46.7% | 24.8% | 0.29 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 10 | -2.880 | 20.0% | 5.7% | 0.11 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 10 | -0.910 | 60.0% | 31.3% | 0.72 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 10 | -6.480 | 50.0% | 23.7% | 0.26 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 11 | -0.709 | 54.5% | 28.0% | 0.68 |
...
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 10 | 4 | 6 | -2.430 | 40.0% | 16.8%-68.7% | 0.36 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 12 | 6 | 6 | -5.767 | 50.0% | 25.4%-74.6% | 0.16 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 20 | 13 | 7 | +1.160 | 65.0% | 43.3%-81.9% | 1.49 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | 13 | 16 | -5.669 | 44.8% | 28.4%-62.5% | 0.26 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 49 | 17 | 32 | -1.002 | 34.7% | 22.9%-48.7% | 0.40 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `pullback_to_liquidity_v1` | `EUR_USD` | 2 | 0 | 2 | -7.100 | 0.0% | 0.0%-65.8% | 0.00 | `PULLBACK_TO_LIQUIDITY_V1_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 43 | 29 | 14 | -2.212 | 67.4% | 52.5%-79.5% | 0.54 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 39 | 13 | 26 | -2.085 | 33.3% | 20.6%-49.0% | 0.31 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `USD_JPY` | 3 | 2 | 1 | -0.667 | 66.7% | 20.8%-93.9% | 0.57 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 10 | 6 | 4 | -0.910 | 60.0% | 31.3%-83.2% | 0.72 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 10 | 5 | 5 | -6.480 | 50.0% | 23.7%-76.3% | 0.26 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 11 | 6 | 5 | -0.709 | 54.5% | 28.0%-78.7% | 0.68 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
