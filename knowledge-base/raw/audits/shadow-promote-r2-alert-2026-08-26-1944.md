# SHADOW_PROMOTE R2 Alert - 2026-08-26T19:44:03.732750+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 24 | -4.412 | 50.0% | 31.4% | 0.35 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 33 | -0.336 | 51.5% | 35.2% | 0.90 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 31 | -1.616 | 25.8% | 13.7% | 0.25 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 27 | -1.319 | 51.9% | 34.0% | 0.70 |
...
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 48 | -3.071 | 54.2% | 40.3% | 0.59 |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 24 | 12 | 12 | -4.412 | 50.0% | 31.4%-68.6% | 0.35 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 29 | 15 | 14 | +0.183 | 51.7% | 34.4%-68.6% | 1.06 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 31 | 8 | 23 | -1.616 | 25.8% | 13.7%-43.2% | 0.25 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 27 | 14 | 13 | -1.319 | 51.9% | 34.0%-69.3% | 0.70 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 36 | 16 | 20 | -2.175 | 44.4% | 29.5%-60.4% | 0.56 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 61 | 32 | 29 | -1.513 | 52.5% | 40.2%-64.5% | 0.67 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 14 | 6 | 8 | -4.050 | 42.9% | 21.4%-67.4% | 0.31 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 22 | 5 | 17 | -0.941 | 22.7% | 10.1%-43.4% | 0.51 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `AUD_JPY` | 43 | 23 | 20 | +0.023 | 53.5% | 38.9%-67.5% | 1.01 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 21 | 16 | 5 | +0.462 | 76.2% | 54.9%-89.4% | 1.13 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `USD_JPY` | 48 | 26 | 22 | -3.071 | 54.2% | 40.3%-67.4% | 0.59 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
