# SHADOW_PROMOTE R2 Alert - 2026-05-11T14:47:02.719584+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `EUR_USD` | 47 | -0.509 | 36.2% | 24.0% | 0.76 |
| **CRITICAL** | `bb_rsi_reversion` | `GBP_USD` | 45 | -2.244 | 17.8% | 9.3% | 0.37 |
| **CRITICAL** | `bb_rsi_reversion` | `USD_JPY` | 89 | -0.196 | 40.4% | 30.9% | 0.93 |
...
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 219 | -1.534 | 21.9% | 16.9% | 0.59 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 14 | -2.021 | 14.3% | 4.0% | 0.35 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 10 | -4.970 | 10.0% | 1.8% | 0.04 |
| **CRITICAL** | `engulfing_bb` | `USD_JPY` | 39 | -1.715 | 20.5% | 10.8% | 0.61 |
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 11 | -4.427 | 27.3% | 9.7% | 0.24 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 28 | -2.443 | 14.3% | 5.7% | 0.32 |
| **WARN** | `sr_channel_reversal` | `GBP_USD` | 23 | -2.196 | 17.4% | 7.0% | 0.46 |
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 67 | -1.570 | 20.9% | 12.9% | 0.48 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 47 | -0.496 | 29.8% | 18.7% | 0.91 |
| **CRITICAL** | `sr_fib_confluence` | `USD_JPY` | 33 | -5.594 | 15.2% | 6.7% | 0.54 |
| **WARN** | `stoch_trend_pullback` | `USD_JPY` | 18 | -4.267 | 16.7% | 5.8% | 0.36 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 28 | -2.329 | 14.3% | 5.7% | 0.48 |
...
| CRITICAL | `bb_rsi_reversion` | `EUR_USD` | 47 | 17 | 30 | -0.509 | 36.2% | 24.0%-50.5% | 0.76 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `GBP_USD` | 45 | 8 | 37 | -2.244 | 17.8% | 9.3%-31.3% | 0.37 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `USD_JPY` | 89 | 36 | 53 | -0.196 | 40.4% | 30.9%-50.8% | 0.93 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 219 | 48 | 171 | -1.534 | 21.9% | 16.9%-27.9% | 0.59 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `EUR_USD` | 14 | 2 | 12 | -2.021 | 14.3% | 4.0%-39.9% | 0.35 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 10 | 1 | 9 | -4.970 | 10.0% | 1.8%-40.4% | 0.04 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `USD_JPY` | 39 | 8 | 31 | -1.715 | 20.5% | 10.8%-35.5% | 0.61 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ma_regime_switch` | `USD_JPY` | 5 | 1 | 4 | -1.840 | 20.0% | 3.6%-62.4% | 0.35 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 9 | 0 | 9 | -1.378 | 0.0% | 0.0%-29.9% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `EUR_JPY` | 8 | 2 | 6 | -0.975 | 25.0% | 7.1%-59.1% | 0.89 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 11 | 3 | 8 | -4.427 | 27.3% | 9.7%-56.6% | 0.24 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `EUR_USD` | 28 | 4 | 24 | -2.443 | 14.3% | 5.7%-31.5% | 0.32 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `GBP_USD` | 23 | 4 | 19 | -2.196 | 17.4% | 7.0%-37.1% | 0.46 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 67 | 14 | 53 | -1.570 | 20.9% | 12.9%-32.1% | 0.48 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 47 | 14 | 33 | -0.496 | 29.8% | 18.7%-44.0% | 0.91 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `stoch_trend_pullback` | `USD_JPY` | 18 | 3 | 15 | -4.267 | 16.7% | 5.8%-39.2% | 0.36 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 28 | 4 | 24 | -2.329 | 14.3% | 5.7%-31.5% | 0.48 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
