# SHADOW_PROMOTE R2 Alert - 2026-09-21T21:41:56.610315+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_JPY` | 39 | -4.754 | 35.9% | 22.7% | 0.28 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 12 | -1.158 | 41.7% | 19.3% | 0.64 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 38 | -4.926 | 42.1% | 27.9% | 0.24 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 27 | -1.596 | 37.0% | 21.5% | 0.45 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 34 | -2.521 | 61.8% | 45.0% | 0.37 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 33 | -1.091 | 39.4% | 24.7% | 0.42 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 12 | -3.808 | 50.0% | 25.4% | 0.30 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 40 | -0.390 | 57.5% | 42.2% | 0.91 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 26 | -3.904 | 38.5% | 22.4% | 0.25 |
...
| **WARN** | `trendline_sweep` | `GBP_USD` | 26 | -1.900 | 57.7% | 38.9% | 0.38 |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_JPY` | 39 | 14 | 25 | -4.754 | 35.9% | 22.7%-51.6% | 0.28 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 12 | 5 | 7 | -1.158 | 41.7% | 19.3%-68.0% | 0.64 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 38 | 16 | 22 | -4.926 | 42.1% | 27.9%-57.8% | 0.24 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 27 | 10 | 17 | -1.596 | 37.0% | 21.5%-55.8% | 0.45 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 34 | 21 | 13 | -2.521 | 61.8% | 45.0%-76.1% | 0.37 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 12 | 6 | 6 | -3.808 | 50.0% | 25.4%-74.6% | 0.30 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 26 | 10 | 16 | -3.904 | 38.5% | 22.4%-57.5% | 0.25 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 26 | 15 | 11 | -1.900 | 57.7% | 38.9%-74.5% | 0.38 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vdr_jpy` | `USD_JPY` | 3 | 1 | 2 | +3.900 | 33.3% | 6.1%-79.2% | 3.34 | `VDR_JPY_REDESIGN_V2_SHADOW_PROMOTE` |
