# SHADOW_PROMOTE R2 Alert - 2026-07-08T19:22:09.356552+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_USD` | 36 | -0.444 | 61.1% | 44.9% | 0.71 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 22 | -3.564 | 50.0% | 30.7% | 0.40 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 90 | -0.553 | 43.3% | 33.6% | 0.70 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 77 | -1.530 | 36.4% | 26.5% | 0.33 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 33 | -2.630 | 69.7% | 52.7% | 0.46 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 47 | -0.570 | 66.0% | 51.7% | 0.80 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 30 | -2.287 | 53.3% | 36.1% | 0.41 |
| **WARN** | `trend_rebound` | `USD_JPY` | 11 | -2.264 | 18.2% | 5.1% | 0.09 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 24 | -1.308 | 58.3% | 38.8% | 0.45 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 18 | -2.600 | 66.7% | 43.7% | 0.23 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 14 | -2.943 | 64.3% | 38.8% | 0.25 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 31 | -2.261 | 35.5% | 21.1% | 0.40 |
| **WARN** | `vol_momentum_scalp` | `USD_JPY` | 27 | -0.489 | 51.9% | 34.0% | 0.78 |
...
| OK | `dt_sr_channel_reversal` | `EUR_GBP` | 8 | 5 | 3 | +0.225 | 62.5% | 30.6%-86.3% | 1.14 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 23 | 13 | 10 | -2.635 | 56.5% | 36.8%-74.4% | 0.34 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `EUR_USD` | 36 | 22 | 14 | -0.444 | 61.1% | 44.9%-75.2% | 0.71 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 22 | 11 | 11 | -3.564 | 50.0% | 30.7%-69.3% | 0.40 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 90 | 39 | 51 | -0.553 | 43.3% | 33.6%-53.6% | 0.70 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 77 | 28 | 49 | -1.530 | 36.4% | 26.5%-47.5% | 0.33 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 6 | 4 | 2 | -0.233 | 66.7% | 30.0%-90.3% | 0.84 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 29 | 18 | 11 | -2.593 | 62.1% | 44.0%-77.3% | 0.39 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 33 | 23 | 10 | -2.630 | 69.7% | 52.7%-82.6% | 0.46 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 47 | 31 | 16 | -0.570 | 66.0% | 51.7%-77.8% | 0.80 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 24 | 14 | 10 | -1.308 | 58.3% | 38.8%-75.5% | 0.45 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 31 | 11 | 20 | -2.261 | 35.5% | 21.1%-53.1% | 0.40 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_momentum_scalp` | `USD_JPY` | 27 | 14 | 13 | -0.489 | 51.9% | 34.0%-69.3% | 0.78 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
