# SHADOW_PROMOTE R2 Alert - 2026-05-28T02:57:37.032263+00:00
...
| **WARN** | `engulfing_bb` | `GBP_USD` | 15 | -3.740 | 13.3% | 3.7% | 0.26 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 67 | -3.466 | 22.4% | 14.1% | 0.40 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 62 | -1.526 | 24.2% | 15.2% | 0.66 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 47 | -1.619 | 25.5% | 15.3% | 0.57 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 78 | -3.029 | 19.2% | 12.0% | 0.51 |
...
| OK | `bb_rsi_reversion` | `GBP_USD` | 5 | 2 | 3 | -0.640 | 40.0% | 11.8%-76.9% | 0.80 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `USD_CHF` | 30 | 0 | 30 | -2.467 | 0.0% | 0.0%-11.4% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `USD_JPY` | 4 | 3 | 1 | +3.250 | 75.0% | 30.1%-95.4% | 5.06 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 5 | 2 | 3 | +3.400 | 40.0% | 11.8%-76.9% | 1.49 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema_trend_scalp` | `EUR_USD` | 3 | 0 | 3 | -2.600 | 0.0% | 0.0%-56.2% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `GBP_USD` | 15 | 2 | 13 | -3.740 | 13.3% | 3.7%-37.9% | 0.26 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `USD_CHF` | 10 | 0 | 10 | -1.430 | 0.0% | 0.0%-27.8% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `engulfing_bb` | `USD_JPY` | 3 | 0 | 3 | -6.400 | 0.0% | 0.0%-56.2% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 67 | 15 | 52 | -3.466 | 22.4% | 14.1%-33.7% | 0.40 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 47 | 12 | 35 | -1.619 | 25.5% | 15.3%-39.5% | 0.57 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `USD_CHF` | 17 | 0 | 17 | -1.388 | 0.0% | 0.0%-18.4% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_JPY` | 3 | 1 | 2 | +1.067 | 33.3% | 6.1%-79.2% | 1.41 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 78 | 15 | 63 | -3.029 | 19.2% | 12.0%-29.3% | 0.51 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
