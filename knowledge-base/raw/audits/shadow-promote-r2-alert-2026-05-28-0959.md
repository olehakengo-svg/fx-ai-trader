# SHADOW_PROMOTE R2 Alert - 2026-05-28T09:59:14.649819+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `USD_CHF` | 30 | -2.467 | 0.0% | 0.0% | 0.00 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 11 | -7.491 | 9.1% | 1.6% | 0.10 |
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 42 | -2.174 | 0.0% | 0.0% | 0.00 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 35 | -0.329 | 28.6% | 16.3% | 0.85 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 16 | -3.537 | 12.5% | 3.5% | 0.25 |
| **WARN** | `engulfing_bb` | `USD_CHF` | 10 | -1.430 | 0.0% | 0.0% | 0.00 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 16 | -1.100 | 31.2% | 14.2% | 0.62 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 31 | -1.471 | 22.6% | 11.4% | 0.39 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 34 | -2.968 | 23.5% | 12.4% | 0.57 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 33 | -7.945 | 6.1% | 1.7% | 0.19 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 66 | -3.391 | 22.7% | 14.3% | 0.41 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 62 | -1.526 | 24.2% | 15.2% | 0.66 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 48 | -1.704 | 25.0% | 14.9% | 0.55 |
| **WARN** | `sr_channel_reversal` | `USD_CHF` | 17 | -1.388 | 0.0% | 0.0% | 0.00 |
| **WARN** | `sr_fib_confluence` | `EUR_GBP` | 26 | -0.815 | 23.1% | 11.0% | 0.71 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 59 | -1.505 | 27.1% | 17.4% | 0.61 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 79 | -3.090 | 19.0% | 11.9% | 0.50 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 57 | -4.895 | 21.1% | 12.5% | 0.34 |
...
| OK | `bb_rsi_reversion` | `GBP_USD` | 3 | 1 | 2 | -1.467 | 33.3% | 6.1%-79.2% | 0.52 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `USD_CHF` | 30 | 0 | 30 | -2.467 | 0.0% | 0.0%-11.4% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `USD_JPY` | 3 | 3 | 0 | +5.400 | 100.0% | 43.8%-100.0% | n/a | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 6 | 2 | 4 | +2.817 | 33.3% | 9.7%-70.0% | 1.49 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `EUR_JPY` | 6 | 1 | 5 | -5.000 | 16.7% | 3.0%-56.4% | 0.23 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 11 | 1 | 10 | -7.491 | 9.1% | 1.6%-37.7% | 0.10 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema_trend_scalp` | `GBP_USD` | 1 | 0 | 1 | -1.100 | 0.0% | 0.0%-79.3% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 42 | 0 | 42 | -2.174 | 0.0% | 0.0%-8.4% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `USD_JPY` | 14 | 6 | 8 | +1.971 | 42.9% | 21.4%-67.4% | 2.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 35 | 10 | 25 | -0.329 | 28.6% | 16.3%-45.1% | 0.85 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 16 | 2 | 14 | -3.537 | 12.5% | 3.5%-36.0% | 0.25 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `USD_CHF` | 10 | 0 | 10 | -1.430 | 0.0% | 0.0%-27.8% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `engulfing_bb` | `USD_JPY` | 2 | 0 | 2 | -7.300 | 0.0% | 0.0%-65.8% | 0.00 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 16 | 5 | 11 | -1.100 | 31.2% | 14.2%-55.6% | 0.62 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 31 | 7 | 24 | -1.471 | 22.6% | 11.4%-39.8% | 0.39 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `pullback_to_liquidity_v1` | `EUR_JPY` | 3 | 0 | 3 | -10.133 | 0.0% | 0.0%-56.2% | 0.00 | `PULLBACK_TO_LIQUIDITY_V1_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 34 | 8 | 26 | -2.968 | 23.5% | 12.4%-40.0% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 33 | 2 | 31 | -7.945 | 6.1% | 1.7%-19.6% | 0.19 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 66 | 15 | 51 | -3.391 | 22.7% | 14.3%-34.2% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 62 | 15 | 47 | -1.526 | 24.2% | 15.2%-36.2% | 0.66 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 48 | 12 | 36 | -1.704 | 25.0% | 14.9%-38.8% | 0.55 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `USD_CHF` | 17 | 0 | 17 | -1.388 | 0.0% | 0.0%-18.4% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_JPY` | 1 | 1 | 0 | +11.000 | 100.0% | 20.7%-100.0% | n/a | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `EUR_GBP` | 26 | 6 | 20 | -0.815 | 23.1% | 11.0%-42.1% | 0.71 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 59 | 16 | 43 | -1.505 | 27.1% | 17.4%-39.6% | 0.61 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `GBP_JPY` | 7 | 0 | 7 | -20.971 | 0.0% | 0.0%-35.4% | 0.00 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 79 | 15 | 64 | -3.090 | 19.0% | 11.9%-29.0% | 0.50 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 27 | 10 | 17 | +2.267 | 37.0% | 21.5%-55.8% | 1.57 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 57 | 12 | 45 | -4.895 | 21.1% | 12.5%-33.3% | 0.34 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
