# SHADOW_PROMOTE R2 Alert - 2026-09-26T10:49:48.672511+00:00
...
| **CRITICAL** | `trendline_sweep` | `GBP_USD` | 31 | -1.919 | 64.5% | 46.9% | 0.41 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 25 | -2.496 | 12.0% | 4.2% | 0.04 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 49 | -2.586 | 46.9% | 33.7% | 0.51 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 22 | -3.041 | 31.8% | 16.4% | 0.21 |
...
| OK | `mtf_reversal_confluence` | `USD_CHF` | 4 | 1 | 3 | -0.750 | 25.0% | 4.6%-69.9% | 0.36 | `MTF_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 1 | 0 | 1 | -3.000 | 0.0% | 0.0%-79.3% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `trendline_sweep` | `GBP_USD` | 31 | 20 | 11 | -1.919 | 64.5% | 46.9%-78.9% | 0.41 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 49 | 23 | 26 | -2.586 | 46.9% | 33.7%-60.6% | 0.51 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 22 | 7 | 15 | -3.041 | 31.8% | 16.4%-52.7% | 0.21 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
