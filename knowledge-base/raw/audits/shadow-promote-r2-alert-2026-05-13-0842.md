# SHADOW_PROMOTE R2 Alert - 2026-05-13T08:42:13.532165+00:00
...
| **CRITICAL** | `bb_rsi_reversion` | `GBP_USD` | 36 | -1.681 | 22.2% | 11.7% | 0.49 |
| **CRITICAL** | `bb_rsi_reversion` | `USD_JPY` | 81 | -0.093 | 42.0% | 31.8% | 0.97 |
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 12 | -0.192 | 8.3% | 1.5% | 0.93 |
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 66 | -0.632 | 21.2% | 13.1% | 0.74 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 77 | -0.769 | 22.1% | 14.3% | 0.76 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 214 | -1.591 | 21.5% | 16.5% | 0.58 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 21 | -1.395 | 19.0% | 7.7% | 0.51 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 15 | -4.227 | 13.3% | 3.7% | 0.16 |
| **CRITICAL** | `engulfing_bb` | `USD_JPY` | 34 | -2.215 | 17.6% | 8.3% | 0.55 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -7.058 | 8.3% | 1.5% | 0.13 |
| **WARN** | `london_breakout` | `GBP_USD` | 12 | -2.933 | 8.3% | 1.5% | 0.20 |
...
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 38 | -2.721 | 18.4% | 9.2% | 0.40 |
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 55 | -1.565 | 21.8% | 12.9% | 0.50 |
...
| **WARN** | `stoch_trend_pullback` | `USD_JPY` | 16 | -4.225 | 18.8% | 6.6% | 0.39 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 34 | -2.035 | 14.7% | 6.4% | 0.51 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 15 | -2.253 | 13.3% | 3.7% | 0.35 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 22 | -3.191 | 18.2% | 7.3% | 0.50 |
...
| CRITICAL | `bb_rsi_reversion` | `GBP_USD` | 36 | 8 | 28 | -1.681 | 22.2% | 11.7%-38.1% | 0.49 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `USD_JPY` | 81 | 34 | 47 | -0.093 | 42.0% | 31.8%-52.8% | 0.97 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 5 | 0 | 5 | -5.560 | 0.0% | 0.0%-43.4% | 0.00 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 77 | 17 | 60 | -0.769 | 22.1% | 14.3%-32.5% | 0.76 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 214 | 46 | 168 | -1.591 | 21.5% | 16.5%-27.5% | 0.58 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `EUR_USD` | 21 | 4 | 17 | -1.395 | 19.0% | 7.7%-40.0% | 0.51 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 15 | 2 | 13 | -4.227 | 13.3% | 3.7%-37.9% | 0.16 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `USD_JPY` | 34 | 6 | 28 | -2.215 | 17.6% | 8.3%-33.5% | 0.55 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `GBP_USD` | 12 | 1 | 11 | -2.933 | 8.3% | 1.5%-35.4% | 0.20 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `GBP_USD` | 5 | 1 | 4 | -4.680 | 20.0% | 3.6%-62.4% | 0.11 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 38 | 7 | 31 | -2.721 | 18.4% | 9.2%-33.4% | 0.40 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 55 | 12 | 43 | -1.565 | 21.8% | 12.9%-34.4% | 0.50 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_GBP` | 15 | 4 | 11 | +1.627 | 26.7% | 10.9%-52.0% | 2.18 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `stoch_trend_pullback` | `USD_JPY` | 16 | 3 | 13 | -4.225 | 18.8% | 6.6%-43.0% | 0.39 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `v_reversal` | `USD_JPY` | 2 | 1 | 1 | +2.750 | 50.0% | 9.5%-90.5% | 56.00 | `V_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 34 | 5 | 29 | -2.035 | 14.7% | 6.4%-30.1% | 0.51 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 22 | 4 | 18 | -3.191 | 18.2% | 7.3%-38.5% | 0.50 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 3 | 0 | 3 | -3.133 | 0.0% | 0.0%-56.2% | 0.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
