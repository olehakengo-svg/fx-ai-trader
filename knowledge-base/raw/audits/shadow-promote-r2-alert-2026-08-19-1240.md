# SHADOW_PROMOTE R2 Alert - 2026-08-19T12:40:52.546459+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | -2.317 | 37.5% | 21.2% | 0.56 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 25 | -0.268 | 44.0% | 26.7% | 0.90 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 25 | -3.996 | 52.0% | 33.5% | 0.36 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 29 | -0.724 | 51.7% | 34.4% | 0.79 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 48 | -1.977 | 18.8% | 10.2% | 0.16 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 20 | -1.075 | 25.0% | 11.2% | 0.64 |
...
| **WARN** | `sr_break_retest` | `AUD_JPY` | 27 | -3.570 | 33.3% | 18.6% | 0.37 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 22 | -3.586 | 54.5% | 34.7% | 0.43 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 42 | -1.767 | 33.3% | 21.0% | 0.58 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 20 | -1.535 | 20.0% | 8.1% | 0.25 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -0.900 | 33.3% | 13.8% | 0.70 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 32 | -1.419 | 43.8% | 28.2% | 0.66 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 23 | -0.809 | 56.5% | 36.8% | 0.82 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 15 | -0.267 | 73.3% | 48.0% | 0.94 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 21 | -3.310 | 33.3% | 17.2% | 0.28 |
| **WARN** | `xs_momentum` | `EUR_USD` | 19 | -2.832 | 52.6% | 31.7% | 0.34 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 34 | -1.426 | 61.8% | 45.0% | 0.63 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | 9 | 15 | -2.317 | 37.5% | 21.2%-57.3% | 0.56 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 25 | 11 | 14 | -0.268 | 44.0% | 26.7%-62.9% | 0.90 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 25 | 13 | 12 | -3.996 | 52.0% | 33.5%-70.0% | 0.36 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 48 | 9 | 39 | -1.977 | 18.8% | 10.2%-31.9% | 0.16 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 20 | 5 | 15 | -1.075 | 25.0% | 11.2%-46.9% | 0.64 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_USD` | 7 | 3 | 4 | +0.500 | 42.9% | 15.8%-75.0% | 1.10 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `USD_JPY` | 5 | 3 | 2 | +4.680 | 60.0% | 23.1%-88.2% | 2.71 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `AUD_JPY` | 27 | 9 | 18 | -3.570 | 33.3% | 18.6%-52.2% | 0.37 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 22 | 12 | 10 | -3.586 | 54.5% | 34.7%-73.1% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `USD_JPY` | 16 | 8 | 8 | +1.644 | 50.0% | 28.0%-72.0% | 1.83 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 42 | 14 | 28 | -1.767 | 33.3% | 21.0%-48.4% | 0.58 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 20 | 4 | 16 | -1.535 | 20.0% | 8.1%-41.6% | 0.25 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vwap_mean_reversion` | `EUR_GBP` | 5 | 1 | 4 | -0.900 | 20.0% | 3.6%-62.4% | 0.63 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 32 | 14 | 18 | -1.419 | 43.8% | 28.2%-60.7% | 0.66 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 23 | 13 | 10 | -0.809 | 56.5% | 36.8%-74.4% | 0.82 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 15 | 11 | 4 | -0.267 | 73.3% | 48.0%-89.1% | 0.94 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 21 | 13 | 8 | +1.038 | 61.9% | 40.9%-79.2% | 1.32 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `EUR_USD` | 19 | 10 | 9 | -2.832 | 52.6% | 31.7%-72.7% | 0.34 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 34 | 21 | 13 | -1.426 | 61.8% | 45.0%-76.1% | 0.63 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
