# SHADOW_PROMOTE R2 Alert - 2026-05-21T03:32:19.674573+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_rsi_reversion` | `GBP_USD` | 23 | -1.796 | 26.1% | 12.5% | 0.46 |
| **WARN** | `bb_rsi_reversion` | `USD_CHF` | 12 | -3.358 | 0.0% | 0.0% | 0.00 |
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 25 | -2.704 | 24.0% | 11.5% | 0.50 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 10 | -8.290 | 10.0% | 1.8% | 0.10 |
| **WARN** | `ema_trend_scalp` | `EUR_USD` | 22 | -0.418 | 22.7% | 10.1% | 0.80 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 45 | -1.533 | 15.6% | 7.7% | 0.52 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 102 | -1.421 | 18.6% | 12.3% | 0.58 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 34 | -0.803 | 23.5% | 12.4% | 0.67 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 15 | -3.867 | 13.3% | 3.7% | 0.25 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 25 | -3.292 | 24.0% | 11.5% | 0.33 |
| **WARN** | `london_breakout` | `GBP_USD` | 28 | -3.221 | 7.1% | 2.0% | 0.21 |
| **WARN** | `ma_regime_switch` | `USD_JPY` | 24 | -1.929 | 20.8% | 9.2% | 0.31 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 20 | -4.760 | 5.0% | 0.9% | 0.04 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 26 | -2.885 | 26.9% | 13.7% | 0.62 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 29 | -5.014 | 13.8% | 5.5% | 0.49 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 43 | -2.656 | 30.2% | 18.6% | 0.59 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 37 | -0.030 | 35.1% | 21.8% | 0.99 |
...
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 33 | -0.388 | 27.3% | 15.1% | 0.88 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_JPY` | 46 | -10.487 | 10.9% | 4.7% | 0.37 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 61 | -2.777 | 23.0% | 14.2% | 0.60 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 44 | -1.380 | 20.5% | 11.2% | 0.65 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 31 | -0.739 | 32.3% | 18.6% | 0.86 |
...
| WARN | `bb_rsi_reversion` | `GBP_USD` | 23 | 6 | 17 | -1.796 | 26.1% | 12.5%-46.5% | 0.46 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `bb_rsi_reversion` | `USD_CHF` | 12 | 0 | 12 | -3.358 | 0.0% | 0.0%-24.3% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `USD_JPY` | 34 | 16 | 18 | +0.385 | 47.1% | 31.5%-63.3% | 1.15 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 9 | 6 | 3 | +5.067 | 66.7% | 35.4%-87.9% | 3.92 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 25 | 6 | 19 | -2.704 | 24.0% | 11.5%-43.4% | 0.50 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 16 | 8 | 8 | +5.731 | 50.0% | 28.0%-72.0% | 3.67 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_JPY` | 4 | 1 | 3 | -5.325 | 25.0% | 4.6%-69.9% | 0.47 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 9 | 0 | 9 | -9.544 | 0.0% | 0.0%-29.9% | 0.00 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 8 | 4 | 4 | +2.050 | 50.0% | 21.5%-78.5% | 1.49 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema_trend_scalp` | `EUR_USD` | 22 | 5 | 17 | -0.418 | 22.7% | 10.1%-43.4% | 0.80 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 45 | 7 | 38 | -1.533 | 15.6% | 7.7%-28.8% | 0.52 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `USD_CHF` | 1 | 0 | 1 | -0.100 | 0.0% | 0.0%-79.3% | 0.00 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 102 | 19 | 83 | -1.421 | 18.6% | 12.3%-27.3% | 0.58 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 34 | 8 | 26 | -0.803 | 23.5% | 12.4%-40.0% | 0.67 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 15 | 2 | 13 | -3.867 | 13.3% | 3.7%-37.9% | 0.25 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 24 | 5 | 19 | -1.929 | 20.8% | 9.2%-40.5% | 0.31 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 9 | 3 | 6 | -0.244 | 33.3% | 12.1%-64.6% | 0.97 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 26 | 7 | 19 | -2.885 | 26.9% | 13.7%-46.1% | 0.62 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 29 | 4 | 25 | -5.014 | 13.8% | 5.5%-30.6% | 0.49 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 43 | 13 | 30 | -2.656 | 30.2% | 18.6%-45.1% | 0.59 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 37 | 13 | 24 | -0.030 | 35.1% | 21.8%-51.2% | 0.99 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 33 | 9 | 24 | -0.388 | 27.3% | 15.1%-44.2% | 0.88 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 46 | 5 | 41 | -10.487 | 10.9% | 4.7%-23.0% | 0.37 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 61 | 14 | 47 | -2.777 | 23.0% | 14.2%-34.9% | 0.60 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 44 | 9 | 35 | -1.380 | 20.5% | 11.2%-34.5% | 0.65 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 9 | 1 | 8 | -3.444 | 11.1% | 2.0%-43.5% | 0.04 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 15 | 8 | 7 | +6.207 | 53.3% | 30.1%-75.2% | 3.31 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 31 | 10 | 21 | -0.739 | 32.3% | 18.6%-49.9% | 0.86 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 31 | 8 | 23 | -3.555 | 25.8% | 13.7%-43.2% | 0.57 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 18 | 7 | 11 | +0.189 | 38.9% | 20.3%-61.4% | 1.03 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
