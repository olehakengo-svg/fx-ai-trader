# SHADOW_PROMOTE R2 Alert - 2026-06-29T15:42:40.960733+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 41 | -3.185 | 53.7% | 38.7% | 0.46 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 25 | -1.576 | 64.0% | 44.5% | 0.44 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 14 | -0.543 | 50.0% | 26.8% | 0.80 |
| **WARN** | `ema200_trend_reversal` | `USD_JPY` | 11 | -0.091 | 63.6% | 35.4% | 0.96 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 83 | -1.049 | 38.6% | 28.8% | 0.50 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 55 | -1.351 | 34.5% | 23.4% | 0.32 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 37 | -2.468 | 64.9% | 48.8% | 0.53 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 46 | -1.904 | 54.3% | 40.2% | 0.51 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 23 | -0.222 | 60.9% | 40.8% | 0.91 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 32 | -0.309 | 56.2% | 39.3% | 0.84 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 13 | -2.231 | 53.8% | 29.1% | 0.30 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 16 | -1.581 | 43.8% | 23.1% | 0.32 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 26 | -2.392 | 50.0% | 32.1% | 0.47 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 31 | -3.545 | 61.3% | 43.8% | 0.32 |
...
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 29 | 22 | 7 | +0.528 | 75.9% | 57.9%-87.8% | 1.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 41 | 22 | 19 | -3.185 | 53.7% | 38.7%-67.9% | 0.46 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 25 | 16 | 9 | -1.576 | 64.0% | 44.5%-79.8% | 0.44 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 83 | 32 | 51 | -1.049 | 38.6% | 28.8%-49.3% | 0.50 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 55 | 19 | 36 | -1.351 | 34.5% | 23.4%-47.7% | 0.32 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 37 | 24 | 13 | -2.468 | 64.9% | 48.8%-78.2% | 0.53 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 46 | 25 | 21 | -1.904 | 54.3% | 40.2%-67.8% | 0.51 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 23 | 14 | 9 | -0.222 | 60.9% | 40.8%-77.8% | 0.91 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 32 | 18 | 14 | -0.309 | 56.2% | 39.3%-71.8% | 0.84 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_CHF` | 12 | 4 | 8 | +0.558 | 33.3% | 13.8%-60.9% | 1.39 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 13 | 7 | 6 | -2.231 | 53.8% | 29.1%-76.8% | 0.30 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 16 | 7 | 9 | -1.581 | 43.8% | 23.1%-66.8% | 0.32 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 26 | 13 | 13 | -2.392 | 50.0% | 32.1%-67.9% | 0.47 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 31 | 19 | 12 | -3.545 | 61.3% | 43.8%-76.3% | 0.32 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
