# SHADOW_PROMOTE R2 Alert - 2026-08-10T13:02:00.753422+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 27 | -1.233 | 37.0% | 21.5% | 0.52 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | -2.524 | 36.0% | 20.2% | 0.52 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 28 | -3.461 | 53.6% | 35.8% | 0.38 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 25 | -0.392 | 60.0% | 40.7% | 0.89 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 68 | -1.829 | 19.1% | 11.5% | 0.17 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -0.874 | 32.3% | 18.6% | 0.70 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 14 | -1.950 | 42.9% | 21.4% | 0.40 |
| **WARN** | `london_breakout` | `EUR_USD` | 23 | -2.052 | 17.4% | 7.0% | 0.09 |
...
| **WARN** | `sr_break_retest` | `USD_JPY` | 27 | -4.800 | 51.9% | 34.0% | 0.33 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 45 | -2.080 | 48.9% | 35.0% | 0.42 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 63 | -1.454 | 38.1% | 27.1% | 0.57 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 16 | -1.162 | 31.2% | 14.2% | 0.50 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 13 | -0.962 | 30.8% | 12.7% | 0.71 |
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 14 | -3.993 | 21.4% | 7.6% | 0.34 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 18 | -0.511 | 66.7% | 43.7% | 0.90 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 11 | -0.827 | 72.7% | 43.4% | 0.81 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 13 | -3.146 | 38.5% | 17.7% | 0.25 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 16 | -1.625 | 50.0% | 28.0% | 0.70 |
| **WARN** | `xs_momentum` | `EUR_USD` | 28 | -3.129 | 50.0% | 32.6% | 0.27 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 54 | -0.720 | 66.7% | 53.4% | 0.78 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 9 | 5 | 4 | -4.689 | 55.6% | 26.7%-81.1% | 0.48 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `AUD_USD` | 7 | 3 | 4 | -2.386 | 42.9% | 15.8%-75.0% | 0.40 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 9 | 6 | 3 | +1.700 | 66.7% | 35.4%-87.9% | 1.41 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 27 | 10 | 17 | -1.233 | 37.0% | 21.5%-55.8% | 0.52 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 25 | 9 | 16 | -2.524 | 36.0% | 20.2%-55.5% | 0.52 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 19 | 10 | 9 | +0.074 | 52.6% | 31.7%-72.7% | 1.03 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 28 | 15 | 13 | -3.461 | 53.6% | 35.8%-70.5% | 0.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 19 | 13 | 6 | +3.153 | 68.4% | 46.0%-84.6% | 2.83 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 25 | 15 | 10 | -0.392 | 60.0% | 40.7%-76.6% | 0.89 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 68 | 13 | 55 | -1.829 | 19.1% | 11.5%-30.0% | 0.17 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 10 | 21 | -0.874 | 32.3% | 18.6%-49.9% | 0.70 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 23 | 4 | 19 | -2.052 | 17.4% | 7.0%-37.1% | 0.09 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 27 | 14 | 13 | -4.800 | 51.9% | 34.0%-69.3% | 0.33 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 8 | 4 | 4 | -0.175 | 50.0% | 21.5%-78.5% | 0.89 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 45 | 22 | 23 | -2.080 | 48.9% | 35.0%-63.0% | 0.42 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 63 | 24 | 39 | -1.454 | 38.1% | 27.1%-50.4% | 0.57 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 16 | 5 | 11 | -1.162 | 31.2% | 14.2%-55.6% | 0.50 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 18 | 12 | 6 | -0.511 | 66.7% | 43.7%-83.7% | 0.90 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 13 | 5 | 8 | -3.146 | 38.5% | 17.7%-64.5% | 0.25 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 28 | 14 | 14 | -3.129 | 50.0% | 32.6%-67.4% | 0.27 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 54 | 36 | 18 | -0.720 | 66.7% | 53.4%-77.8% | 0.78 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
