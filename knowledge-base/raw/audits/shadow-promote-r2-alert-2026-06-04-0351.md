# SHADOW_PROMOTE R2 Alert - 2026-06-04T03:51:25.473499+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `USD_CHF` | 36 | -2.322 | 0.0% | 0.0% | 0.00 |
...
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 71 | -1.837 | 4.2% | 1.4% | 0.22 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 36 | -1.492 | 22.2% | 11.7% | 0.33 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 27 | -3.581 | 22.2% | 10.6% | 0.49 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 32 | -7.219 | 12.5% | 5.0% | 0.14 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 71 | -2.632 | 26.8% | 17.9% | 0.47 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 41 | -2.876 | 24.4% | 13.8% | 0.27 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 46 | -0.804 | 28.3% | 17.3% | 0.70 |
| **CRITICAL** | `sr_channel_reversal` | `USD_CHF` | 39 | -2.138 | 5.1% | 1.4% | 0.13 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 82 | -0.802 | 32.9% | 23.7% | 0.78 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 87 | -6.221 | 8.0% | 4.0% | 0.14 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 27 | -15.241 | 11.1% | 3.9% | 0.02 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 22 | -4.891 | 0.0% | 0.0% | 0.00 |
| **WARN** | `vol_surge_detector` | `USD_CHF` | 10 | -2.580 | 0.0% | 0.0% | 0.00 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 11 | -8.618 | 9.1% | 1.6% | 0.10 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 57 | -6.063 | 17.5% | 9.8% | 0.13 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 43 | -1.053 | 41.9% | 28.4% | 0.78 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 55 | -2.665 | 27.3% | 17.3% | 0.41 |
...
| CRITICAL | `bb_rsi_reversion` | `USD_CHF` | 36 | 0 | 36 | -2.322 | 0.0% | 0.0%-9.6% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 38 | 18 | 20 | +2.168 | 47.4% | 32.5%-62.7% | 2.00 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 22 | 16 | 6 | +6.014 | 72.7% | 51.8%-86.8% | 5.23 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 71 | 3 | 68 | -1.837 | 4.2% | 1.4%-11.7% | 0.22 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 36 | 8 | 28 | -1.492 | 22.2% | 11.7%-38.1% | 0.33 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `EUR_USD` | 33 | 9 | 24 | +0.342 | 27.3% | 15.1%-44.2% | 1.12 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `pullback_to_liquidity_v1` | `EUR_USD` | 8 | 2 | 6 | -3.375 | 25.0% | 7.1%-59.1% | 0.11 | `PULLBACK_TO_LIQUIDITY_V1_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 27 | 6 | 21 | -3.581 | 22.2% | 10.6%-40.8% | 0.49 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 32 | 4 | 28 | -7.219 | 12.5% | 5.0%-28.1% | 0.14 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 71 | 19 | 52 | -2.632 | 26.8% | 17.9%-38.1% | 0.47 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 41 | 10 | 31 | -2.876 | 24.4% | 13.8%-39.3% | 0.27 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 46 | 13 | 33 | -0.804 | 28.3% | 17.3%-42.5% | 0.70 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_CHF` | 39 | 2 | 37 | -2.138 | 5.1% | 1.4%-16.9% | 0.13 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_GBP` | 8 | 2 | 6 | -2.738 | 25.0% | 7.1%-59.1% | 0.22 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 82 | 27 | 55 | -0.802 | 32.9% | 23.7%-43.7% | 0.78 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 22 | 0 | 22 | -4.891 | 0.0% | 0.0%-14.9% | 0.00 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_USD` | 39 | 12 | 27 | +0.238 | 30.8% | 18.6%-46.4% | 1.06 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 57 | 10 | 47 | -6.063 | 17.5% | 9.8%-29.4% | 0.13 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 43 | 18 | 25 | -1.053 | 41.9% | 28.4%-56.7% | 0.78 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 55 | 15 | 40 | -2.665 | 27.3% | 17.3%-40.2% | 0.41 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
