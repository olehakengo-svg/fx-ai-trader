# SHADOW_PROMOTE R2 Alert - 2026-06-12T03:46:00.168901+00:00
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 43 | -0.981 | 30.2% | 18.6% | 0.43 |
| **WARN** | `ob_retest` | `EUR_USD` | 13 | -3.169 | 7.7% | 1.4% | 0.04 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 23 | -2.991 | 56.5% | 36.8% | 0.33 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 36 | -4.811 | 47.2% | 32.0% | 0.34 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 35 | -2.620 | 37.1% | 23.2% | 0.47 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 12 | -0.833 | 75.0% | 46.8% | 0.62 |
...
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 23 | -1.913 | 30.4% | 15.6% | 0.38 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 16 | -1.619 | 31.2% | 14.2% | 0.21 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 10 | -2.980 | 60.0% | 31.3% | 0.32 |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 6 | 3 | 3 | +0.850 | 50.0% | 18.8%-81.2% | 1.33 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 43 | 13 | 30 | -0.981 | 30.2% | 18.6%-45.1% | 0.43 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 4 | 3 | 1 | +2.300 | 75.0% | 30.1%-95.4% | 12.50 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 23 | 13 | 10 | -2.991 | 56.5% | 36.8%-74.4% | 0.33 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 36 | 17 | 19 | -4.811 | 47.2% | 32.0%-63.0% | 0.34 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 35 | 13 | 22 | -2.620 | 37.1% | 23.2%-53.7% | 0.47 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 12 | 9 | 3 | -0.833 | 75.0% | 46.8%-91.1% | 0.62 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 23 | 7 | 16 | -1.913 | 30.4% | 15.6%-50.9% | 0.38 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `USD_JPY` | 10 | 6 | 4 | -2.980 | 60.0% | 31.3%-83.2% | 0.32 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
