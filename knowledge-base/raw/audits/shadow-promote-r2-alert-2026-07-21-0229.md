# SHADOW_PROMOTE R2 Alert - 2026-07-21T02:29:57.640722+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 16 | -5.350 | 25.0% | 10.2% | 0.08 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 88 | -0.734 | 44.3% | 34.4% | 0.63 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 72 | -1.528 | 37.5% | 27.2% | 0.36 |
| **WARN** | `ob_retest` | `EUR_USD` | 13 | -1.100 | 69.2% | 42.4% | 0.66 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 18 | -1.967 | 55.6% | 33.7% | 0.49 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 63 | -1.163 | 39.7% | 28.5% | 0.52 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 19 | -0.516 | 68.4% | 46.0% | 0.83 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 15 | -3.593 | 40.0% | 19.8% | 0.12 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 39 | -2.626 | 53.8% | 38.6% | 0.33 |
...
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 16 | 4 | 12 | -5.350 | 25.0% | 10.2%-49.5% | 0.08 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 88 | 39 | 49 | -0.734 | 44.3% | 34.4%-54.7% | 0.63 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 72 | 27 | 45 | -1.528 | 37.5% | 27.2%-49.0% | 0.36 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `EUR_USD` | 21 | 13 | 8 | +0.114 | 61.9% | 40.9%-79.2% | 1.05 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `squeeze_release_momentum` | `GBP_USD` | 18 | 10 | 8 | -1.967 | 55.6% | 33.7%-75.4% | 0.49 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 63 | 25 | 38 | -1.163 | 39.7% | 28.5%-52.0% | 0.52 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 19 | 13 | 6 | -0.516 | 68.4% | 46.0%-84.6% | 0.83 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `EUR_USD` | 7 | 6 | 1 | +3.214 | 85.7% | 48.7%-97.4% | 3.37 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 39 | 21 | 18 | -2.626 | 53.8% | 38.6%-68.4% | 0.33 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
