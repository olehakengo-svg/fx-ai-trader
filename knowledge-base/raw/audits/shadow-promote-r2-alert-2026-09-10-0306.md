# SHADOW_PROMOTE R2 Alert - 2026-09-10T03:06:39.229860+00:00
...
| **CRITICAL** | `sr_anti_hunt_bounce` | `EUR_JPY` | 32 | -2.803 | 43.8% | 28.2% | 0.45 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 17 | -1.035 | 64.7% | 41.3% | 0.75 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 19 | -3.195 | 47.4% | 27.3% | 0.46 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 25 | -2.712 | 36.0% | 20.2% | 0.31 |
...
| CRITICAL | `sr_anti_hunt_bounce` | `EUR_JPY` | 32 | 14 | 18 | -2.803 | 43.8% | 28.2%-60.7% | 0.45 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 5 | 3 | 2 | -7.400 | 60.0% | 23.1%-88.2% | 0.06 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_anti_hunt_bounce` | `GBP_JPY` | 17 | 11 | 6 | -1.035 | 64.7% | 41.3%-82.7% | 0.75 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `AUD_JPY` | 55 | 33 | 22 | +0.011 | 60.0% | 46.8%-71.9% | 1.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 19 | 9 | 10 | -3.195 | 47.4% | 27.3%-68.3% | 0.46 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 25 | 9 | 16 | -2.712 | 36.0% | 20.2%-55.5% | 0.31 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `USD_JPY` | 30 | 21 | 9 | +2.517 | 70.0% | 52.1%-83.3% | 2.19 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
