# SHADOW_PROMOTE R2 Alert - 2026-08-11T07:02:50.992159+00:00
...
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 13 | -0.438 | 53.8% | 29.1% | 0.88 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 38 | -2.247 | 47.4% | 32.5% | 0.41 |
...
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 16 | -3.856 | 25.0% | 10.2% | 0.33 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 15 | -3.627 | 33.3% | 15.2% | 0.20 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 16 | -1.625 | 50.0% | 28.0% | 0.70 |
| **WARN** | `xs_momentum` | `EUR_USD` | 27 | -3.085 | 51.9% | 34.0% | 0.28 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 52 | -0.625 | 67.3% | 53.8% | 0.80 |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 8 | 4 | 4 | +0.875 | 50.0% | 21.5%-78.5% | 1.19 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 4 | 3 | 1 | +2.775 | 75.0% | 30.1%-95.4% | 2.34 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 14 | 12 | 2 | +2.750 | 85.7% | 60.1%-96.0% | 3.50 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 21 | 11 | 10 | -0.114 | 52.4% | 32.4%-71.7% | 0.96 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 64 | 12 | 52 | -1.892 | 18.8% | 11.1%-30.0% | 0.16 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 13 | 7 | 6 | -0.438 | 53.8% | 29.1%-76.8% | 0.88 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 38 | 18 | 20 | -2.247 | 47.4% | 32.5%-62.7% | 0.41 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `AUD_JPY` | 16 | 4 | 12 | -3.856 | 25.0% | 10.2%-49.5% | 0.33 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 15 | 5 | 10 | -3.627 | 33.3% | 15.2%-58.3% | 0.20 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 52 | 35 | 17 | -0.625 | 67.3% | 53.8%-78.5% | 0.80 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
