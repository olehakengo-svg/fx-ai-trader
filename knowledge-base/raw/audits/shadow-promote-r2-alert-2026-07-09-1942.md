# SHADOW_PROMOTE R2 Alert - 2026-07-09T19:42:47.874040+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 31 | -1.732 | 58.1% | 40.8% | 0.40 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 21 | -0.329 | 47.6% | 28.3% | 0.90 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 90 | -0.646 | 43.3% | 33.6% | 0.66 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 37 | -0.430 | 45.9% | 31.0% | 0.81 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 80 | -1.460 | 35.0% | 25.5% | 0.36 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 28 | -2.193 | 64.3% | 45.8% | 0.44 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 35 | -2.009 | 74.3% | 57.9% | 0.53 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 23 | -2.543 | 21.7% | 9.7% | 0.14 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 37 | -4.211 | 56.8% | 40.9% | 0.29 |
| **WARN** | `xs_momentum` | `USD_JPY` | 19 | -0.947 | 68.4% | 46.0% | 0.60 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 9 | 8 | 1 | +3.167 | 88.9% | 56.5%-98.0% | 2.76 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 31 | 18 | 13 | -1.732 | 58.1% | 40.8%-73.6% | 0.40 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 90 | 39 | 51 | -0.646 | 43.3% | 33.6%-53.6% | 0.66 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 37 | 17 | 20 | -0.430 | 45.9% | 31.0%-61.6% | 0.81 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 80 | 28 | 52 | -1.460 | 35.0% | 25.5%-45.9% | 0.36 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 28 | 18 | 10 | -2.193 | 64.3% | 45.8%-79.3% | 0.44 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 35 | 26 | 9 | -2.009 | 74.3% | 57.9%-85.8% | 0.53 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 23 | 5 | 18 | -2.543 | 21.7% | 9.7%-41.9% | 0.14 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 37 | 21 | 16 | -4.211 | 56.8% | 40.9%-71.3% | 0.29 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 19 | 13 | 6 | -0.947 | 68.4% | 46.0%-84.6% | 0.60 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
