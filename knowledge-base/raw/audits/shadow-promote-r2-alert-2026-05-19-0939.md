# SHADOW_PROMOTE R2 Alert - 2026-05-19T09:39:51.676686+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 154 | -1.934 | 19.5% | 14.0% | 0.50 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 21 | -2.652 | 23.8% | 10.6% | 0.66 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 23 | -3.617 | 17.4% | 7.0% | 0.63 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 35 | -0.586 | 40.0% | 25.6% | 0.90 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 14 | -0.507 | 21.4% | 7.6% | 0.79 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 43 | -2.705 | 18.6% | 9.7% | 0.38 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_JPY` | 60 | -12.930 | 8.3% | 3.6% | 0.27 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 53 | -0.902 | 28.3% | 18.0% | 0.85 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 34 | -1.574 | 29.4% | 16.8% | 0.75 |
...
| OK | `bb_rsi_reversion` | `USD_CHF` | 7 | 0 | 7 | -2.500 | 0.0% | 0.0%-35.4% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `USD_JPY` | 50 | 25 | 25 | +0.608 | 50.0% | 36.6%-63.4% | 1.23 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 7 | 2 | 5 | -3.329 | 28.6% | 8.2%-64.1% | 0.42 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 154 | 30 | 124 | -1.934 | 19.5% | 14.0%-26.4% | 0.50 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 21 | 5 | 16 | -2.652 | 23.8% | 10.6%-45.1% | 0.66 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 23 | 4 | 19 | -3.617 | 17.4% | 7.0%-37.1% | 0.63 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 35 | 14 | 21 | -0.586 | 40.0% | 25.6%-56.4% | 0.90 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 43 | 8 | 35 | -2.705 | 18.6% | 9.7%-32.6% | 0.38 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `USD_CHF` | 6 | 0 | 6 | -1.467 | 0.0% | 0.0%-39.0% | 0.00 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 60 | 5 | 55 | -12.930 | 8.3% | 3.6%-18.1% | 0.27 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 53 | 15 | 38 | -0.902 | 28.3% | 18.0%-41.6% | 0.85 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `EUR_USD` | 6 | 0 | 6 | -4.800 | 0.0% | 0.0%-39.0% | 0.00 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 34 | 10 | 24 | -1.574 | 29.4% | 16.8%-46.2% | 0.75 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 36 | 9 | 27 | -3.733 | 25.0% | 13.8%-41.1% | 0.56 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 14 | 7 | 7 | +3.286 | 50.0% | 26.8%-73.2% | 1.57 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
