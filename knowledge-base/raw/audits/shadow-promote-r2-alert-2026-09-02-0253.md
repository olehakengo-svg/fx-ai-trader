# SHADOW_PROMOTE R2 Alert - 2026-09-02T02:53:24.001115+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 30 | -2.123 | 36.7% | 21.9% | 0.38 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 33 | -0.652 | 51.5% | 35.2% | 0.81 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 16 | -1.500 | 25.0% | 10.2% | 0.19 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 13 | -0.862 | 38.5% | 17.7% | 0.79 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `EUR_JPY` | 36 | -1.131 | 50.0% | 34.5% | 0.70 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 18 | -0.622 | 66.7% | 43.7% | 0.84 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 44 | -1.814 | 47.7% | 33.8% | 0.59 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 53 | -0.400 | 49.1% | 36.1% | 0.88 |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 30 | 11 | 19 | -2.123 | 36.7% | 21.9%-54.5% | 0.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `EUR_USD` | 16 | 4 | 12 | -1.500 | 25.0% | 10.2%-49.5% | 0.19 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 13 | 5 | 8 | -0.862 | 38.5% | 17.7%-64.5% | 0.79 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `squeeze_release_momentum` | `EUR_USD` | 9 | 2 | 7 | -4.156 | 22.2% | 6.3%-54.7% | 0.04 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 44 | 21 | 23 | -1.814 | 47.7% | 33.8%-62.1% | 0.59 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 53 | 26 | 27 | -0.400 | 49.1% | 36.1%-62.1% | 0.88 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `USD_JPY` | 28 | 14 | 14 | +0.539 | 50.0% | 32.6%-67.4% | 1.26 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
