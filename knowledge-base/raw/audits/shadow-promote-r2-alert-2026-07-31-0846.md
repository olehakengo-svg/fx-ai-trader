# SHADOW_PROMOTE R2 Alert - 2026-07-31T08:46:15.471229+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 16 | -0.206 | 56.2% | 33.2% | 0.93 |
| **CRITICAL** | `dt_sr_channel_reversal` | `AUD_JPY` | 37 | -2.943 | 45.9% | 31.0% | 0.38 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 28 | -1.336 | 39.3% | 23.6% | 0.52 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | -2.367 | 53.3% | 30.1% | 0.29 |
...
| **WARN** | `lin_reg_channel` | `EUR_USD` | 27 | -1.785 | 48.1% | 30.7% | 0.42 |
| **WARN** | `london_breakout` | `EUR_USD` | 19 | -2.032 | 26.3% | 11.8% | 0.14 |
| **CRITICAL** | `london_breakout` | `GBP_USD` | 45 | -2.204 | 33.3% | 21.4% | 0.31 |
| **WARN** | `london_breakout` | `USD_JPY` | 17 | -2.435 | 29.4% | 13.3% | 0.24 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 51 | -1.475 | 39.2% | 27.0% | 0.47 |
...
| **WARN** | `sr_break_retest` | `AUD_JPY` | 26 | -1.785 | 53.8% | 35.5% | 0.53 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 43 | -2.588 | 51.2% | 36.8% | 0.45 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 26 | -5.477 | 50.0% | 32.1% | 0.23 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 38 | -1.689 | 52.6% | 37.3% | 0.52 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 28 | -2.486 | 42.9% | 26.5% | 0.41 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 14 | -0.614 | 50.0% | 26.8% | 0.59 |
| **WARN** | `trend_rebound` | `USD_JPY` | 13 | -1.246 | 38.5% | 17.7% | 0.22 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 19 | -2.963 | 31.6% | 15.4% | 0.16 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 15 | -3.147 | 66.7% | 41.7% | 0.23 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 56 | -0.425 | 53.6% | 40.7% | 0.86 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 72 | -0.697 | 38.9% | 28.5% | 0.70 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -0.906 | 35.3% | 17.3% | 0.47 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 14 | -2.371 | 28.6% | 11.7% | 0.21 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 13 | -2.346 | 53.8% | 29.1% | 0.50 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 12 | -1.683 | 66.7% | 39.1% | 0.65 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 12 | -4.208 | 41.7% | 19.3% | 0.14 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 10 | -4.470 | 40.0% | 16.8% | 0.10 |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 6 | 6 | 0 | +5.033 | 100.0% | 61.0%-100.0% | n/a | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 16 | 9 | 7 | -0.206 | 56.2% | 33.2%-76.9% | 0.93 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 5 | 3 | 2 | +0.660 | 60.0% | 23.1%-88.2% | 1.26 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `AUD_JPY` | 37 | 17 | 20 | -2.943 | 45.9% | 31.0%-61.6% | 0.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 28 | 11 | 17 | -1.336 | 39.3% | 23.6%-57.6% | 0.52 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | 8 | 7 | -2.367 | 53.3% | 30.1%-75.2% | 0.29 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 15 | 9 | 6 | +1.620 | 60.0% | 35.7%-80.2% | 1.69 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `inducement_ob` | `EUR_GBP` | 2 | 1 | 1 | -2.400 | 50.0% | 9.5%-90.5% | 0.24 | `INDUCEMENT_OB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 27 | 13 | 14 | -1.785 | 48.1% | 30.7%-66.0% | 0.42 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `EUR_USD` | 19 | 5 | 14 | -2.032 | 26.3% | 11.8%-48.8% | 0.14 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `london_breakout` | `GBP_USD` | 45 | 15 | 30 | -2.204 | 33.3% | 21.4%-47.9% | 0.31 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 51 | 20 | 31 | -1.475 | 39.2% | 27.0%-52.9% | 0.47 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 14 | 11 | 3 | +1.629 | 78.6% | 52.4%-92.4% | 2.10 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 26 | 14 | 12 | -1.785 | 53.8% | 35.5%-71.2% | 0.53 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 43 | 22 | 21 | -2.588 | 51.2% | 36.8%-65.4% | 0.45 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 26 | 13 | 13 | -5.477 | 50.0% | 32.1%-67.9% | 0.23 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 38 | 20 | 18 | -1.689 | 52.6% | 37.3%-67.5% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 28 | 12 | 16 | -2.486 | 42.9% | 26.5%-60.9% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 19 | 6 | 13 | -2.963 | 31.6% | 15.4%-54.0% | 0.16 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_USD` | 8 | 6 | 2 | +2.550 | 75.0% | 40.9%-92.9% | 2.09 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 15 | 10 | 5 | -3.147 | 66.7% | 41.7%-84.8% | 0.23 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 72 | 28 | 44 | -0.697 | 38.9% | 28.5%-50.4% | 0.70 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 17 | 6 | 11 | -0.906 | 35.3% | 17.3%-58.7% | 0.47 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 7 | 5 | 2 | +2.343 | 71.4% | 35.9%-91.8% | 2.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 12 | 8 | 4 | -1.683 | 66.7% | 39.1%-86.2% | 0.65 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 12 | 5 | 7 | -4.208 | 41.7% | 19.3%-68.0% | 0.14 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `USD_JPY` | 10 | 4 | 6 | -4.470 | 40.0% | 16.8%-68.7% | 0.10 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
