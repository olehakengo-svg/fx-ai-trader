# SHADOW_PROMOTE R2 Alert - 2026-08-14T07:20:43.843772+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `AUD_JPY` | 19 | -5.789 | 31.6% | 15.4% | 0.17 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 23 | -1.448 | 34.8% | 18.8% | 0.35 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 51 | -1.894 | 19.6% | 11.0% | 0.17 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 24 | -0.575 | 33.3% | 18.0% | 0.79 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 13 | -1.685 | 46.2% | 23.2% | 0.45 |
| **WARN** | `london_breakout` | `EUR_USD` | 16 | -1.631 | 25.0% | 10.2% | 0.15 |
...
| **WARN** | `sr_anti_hunt_bounce` | `EUR_JPY` | 26 | -1.808 | 42.3% | 25.5% | 0.59 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 27 | -2.807 | 40.7% | 24.5% | 0.43 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 26 | -3.869 | 53.8% | 35.5% | 0.39 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 25 | -7.132 | 44.0% | 26.7% | 0.21 |
| **WARN** | `sr_break_retest` | `GBP_USD` | 23 | -2.313 | 52.2% | 33.0% | 0.39 |
...
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 27 | -2.900 | 44.4% | 27.6% | 0.32 |
...
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 21 | -2.495 | 33.3% | 17.2% | 0.50 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 20 | -0.725 | 60.0% | 38.7% | 0.83 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 21 | -2.895 | 52.4% | 32.4% | 0.33 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 41 | -1.254 | 63.4% | 48.1% | 0.66 |
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 53 | -3.206 | 52.8% | 39.7% | 0.56 |
...
| WARN | `dt_sr_channel_reversal` | `AUD_JPY` | 19 | 6 | 13 | -5.789 | 31.6% | 15.4%-54.0% | 0.17 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 23 | 8 | 15 | -1.448 | 34.8% | 18.8%-55.1% | 0.35 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 51 | 10 | 41 | -1.894 | 19.6% | 11.0%-32.5% | 0.17 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 24 | 8 | 16 | -0.575 | 33.3% | 18.0%-53.3% | 0.79 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `EUR_USD` | 16 | 4 | 12 | -1.631 | 25.0% | 10.2%-49.5% | 0.15 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `EUR_JPY` | 26 | 11 | 15 | -1.808 | 42.3% | 25.5%-61.1% | 0.59 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `EUR_USD` | 4 | 3 | 1 | +3.550 | 75.0% | 30.1%-95.4% | 3.84 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 10 | 6 | 4 | +0.930 | 60.0% | 31.3%-83.2% | 1.37 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 27 | 11 | 16 | -2.807 | 40.7% | 24.5%-59.3% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 26 | 14 | 12 | -3.869 | 53.8% | 35.5%-71.2% | 0.39 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 25 | 11 | 14 | -7.132 | 44.0% | 26.7%-62.9% | 0.21 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_USD` | 23 | 12 | 11 | -2.313 | 52.2% | 33.0%-70.8% | 0.39 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 27 | 12 | 15 | -2.900 | 44.4% | 27.6%-62.7% | 0.32 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `AUD_JPY` | 21 | 7 | 14 | -2.495 | 33.3% | 17.2%-54.6% | 0.50 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 20 | 12 | 8 | -0.725 | 60.0% | 38.7%-78.1% | 0.83 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 21 | 11 | 10 | -2.895 | 52.4% | 32.4%-71.7% | 0.33 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 41 | 26 | 15 | -1.254 | 63.4% | 48.1%-76.4% | 0.66 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `USD_JPY` | 53 | 28 | 25 | -3.206 | 52.8% | 39.7%-65.6% | 0.56 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
