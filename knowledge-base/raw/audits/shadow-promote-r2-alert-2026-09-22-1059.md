# SHADOW_PROMOTE R2 Alert - 2026-09-22T10:59:00.031986+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 14 | -2.064 | 7.1% | 1.3% | 0.03 |
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_JPY` | 42 | -4.650 | 35.7% | 23.0% | 0.28 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 14 | -1.136 | 42.9% | 21.4% | 0.62 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 44 | -4.768 | 38.6% | 25.7% | 0.22 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 40 | -0.390 | 57.5% | 42.2% | 0.91 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 27 | -3.752 | 40.7% | 24.5% | 0.25 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 12 | -1.225 | 33.3% | 13.8% | 0.51 |
| **WARN** | `three_bar_reversal` | `USD_JPY` | 21 | -0.238 | 38.1% | 20.8% | 0.90 |
| **WARN** | `trend_rebound` | `EUR_USD` | 19 | -0.079 | 36.8% | 19.1% | 0.94 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 27 | -1.778 | 59.3% | 40.7% | 0.40 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 19 | -2.726 | 15.8% | 5.5% | 0.04 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 50 | -1.926 | 52.0% | 38.5% | 0.59 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 12 | -0.825 | 58.3% | 32.0% | 0.83 |
| **WARN** | `wick_imbalance_reversion` | `EUR_USD` | 13 | -3.677 | 30.8% | 12.7% | 0.20 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 12 | -2.067 | 58.3% | 32.0% | 0.68 |
...
| WARN | `bb_squeeze_breakout` | `EUR_USD` | 14 | 1 | 13 | -2.064 | 7.1% | 1.3%-31.5% | 0.03 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_JPY` | 42 | 15 | 27 | -4.650 | 35.7% | 23.0%-50.8% | 0.28 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 14 | 6 | 8 | -1.136 | 42.9% | 21.4%-67.4% | 0.62 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 44 | 17 | 27 | -4.768 | 38.6% | 25.7%-53.4% | 0.22 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_session_breakout` | `EUR_USD` | 2 | 1 | 1 | +2.650 | 50.0% | 9.5%-90.5% | 2.29 | `LONDON_SESSION_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `macdh_reversal` | `USD_JPY` | 3 | 2 | 1 | -0.733 | 66.7% | 20.8%-93.9% | 0.35 | `MACDH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `mtf_reversal_confluence` | `USD_JPY` | 4 | 3 | 1 | +0.800 | 75.0% | 30.1%-95.4% | 1.94 | `MTF_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 40 | 23 | 17 | -0.390 | 57.5% | 42.2%-71.5% | 0.91 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 27 | 11 | 16 | -3.752 | 40.7% | 24.5%-59.3% | 0.25 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 21 | 8 | 13 | -0.238 | 38.1% | 20.8%-59.1% | 0.90 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `EUR_USD` | 19 | 7 | 12 | -0.079 | 36.8% | 19.1%-59.0% | 0.94 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 27 | 16 | 11 | -1.778 | 59.3% | 40.7%-75.5% | 0.40 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 19 | 3 | 16 | -2.726 | 15.8% | 5.5%-37.6% | 0.04 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 50 | 26 | 24 | -1.926 | 52.0% | 38.5%-65.2% | 0.59 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 12 | 7 | 5 | -0.825 | 58.3% | 32.0%-80.7% | 0.83 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_USD` | 13 | 4 | 9 | -3.677 | 30.8% | 12.7%-57.6% | 0.20 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 12 | 7 | 5 | -2.067 | 58.3% | 32.0%-80.7% | 0.68 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
