# SHADOW_PROMOTE R2 Alert - 2026-07-29T14:05:30.425940+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `AUD_JPY` | 31 | -1.526 | 54.8% | 37.8% | 0.56 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 26 | -0.769 | 46.2% | 28.8% | 0.68 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 17 | -2.747 | 52.9% | 31.0% | 0.26 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 23 | -0.978 | 47.8% | 29.2% | 0.58 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 24 | -1.038 | 66.7% | 46.7% | 0.66 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 12 | -1.525 | 50.0% | 25.4% | 0.60 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 83 | -1.572 | 30.1% | 21.3% | 0.28 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -1.371 | 38.7% | 23.7% | 0.50 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 24 | -1.721 | 50.0% | 31.4% | 0.36 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 50 | -1.064 | 34.0% | 22.4% | 0.47 |
...
| **WARN** | `sr_break_retest` | `AUD_JPY` | 23 | -2.261 | 56.5% | 36.8% | 0.39 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 48 | -2.490 | 52.1% | 38.3% | 0.44 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 31 | -4.903 | 54.8% | 37.8% | 0.25 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 43 | -1.891 | 51.2% | 36.8% | 0.48 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 23 | -1.717 | 47.8% | 29.2% | 0.50 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 13 | -0.562 | 53.8% | 29.1% | 0.63 |
| **WARN** | `trend_rebound` | `USD_JPY` | 14 | -1.086 | 35.7% | 16.3% | 0.37 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 23 | -2.296 | 43.5% | 25.6% | 0.26 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 16 | -2.881 | 68.8% | 44.4% | 0.25 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 71 | -1.070 | 38.0% | 27.6% | 0.48 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 20 | -1.410 | 30.0% | 14.5% | 0.33 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 17 | -1.788 | 29.4% | 13.3% | 0.37 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 11 | -0.045 | 45.5% | 21.3% | 0.98 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 39 | -2.103 | 56.4% | 41.0% | 0.39 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 53 | -0.142 | 66.0% | 52.6% | 0.96 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 11 | 9 | 2 | +0.945 | 81.8% | 52.3%-94.9% | 1.31 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `AUD_JPY` | 31 | 17 | 14 | -1.526 | 54.8% | 37.8%-70.8% | 0.56 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 23 | 11 | 12 | -0.978 | 47.8% | 29.2%-67.0% | 0.58 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 24 | 16 | 8 | -1.038 | 66.7% | 46.7%-82.0% | 0.66 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 16 | 8 | 8 | +0.325 | 50.0% | 28.0%-72.0% | 1.10 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 83 | 25 | 58 | -1.572 | 30.1% | 21.3%-40.7% | 0.28 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 12 | 19 | -1.371 | 38.7% | 23.7%-56.2% | 0.50 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `inducement_ob` | `GBP_USD` | 4 | 2 | 2 | -3.425 | 50.0% | 15.0%-85.0% | 0.23 | `INDUCEMENT_OB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 24 | 12 | 12 | -1.721 | 50.0% | 31.4%-68.6% | 0.36 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 50 | 17 | 33 | -1.064 | 34.0% | 22.4%-47.8% | 0.47 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 23 | 13 | 10 | -2.261 | 56.5% | 36.8%-74.4% | 0.39 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 48 | 25 | 23 | -2.490 | 52.1% | 38.3%-65.5% | 0.44 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 31 | 17 | 14 | -4.903 | 54.8% | 37.8%-70.8% | 0.25 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 43 | 22 | 21 | -1.891 | 51.2% | 36.8%-65.4% | 0.48 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 23 | 11 | 12 | -1.717 | 47.8% | 29.2%-67.0% | 0.50 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_channel_reversal` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_liquidity_grab` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `SR_LIQUIDITY_GRAB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `stoch_trend_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `three_bar_reversal` | `EUR_USD` | 13 | 7 | 6 | -0.562 | 53.8% | 29.1%-76.8% | 0.63 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 14 | 5 | 9 | -1.086 | 35.7% | 16.3%-61.2% | 0.37 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_GBP` | 23 | 10 | 13 | -2.296 | 43.5% | 25.6%-63.2% | 0.26 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trendline_sweep` | `EUR_USD` | 12 | 9 | 3 | +0.233 | 75.0% | 46.8%-91.1% | 1.07 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 16 | 11 | 5 | -2.881 | 68.8% | 44.4%-85.8% | 0.25 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `GBP_USD` | 55 | 31 | 24 | +0.469 | 56.4% | 43.3%-68.6% | 1.20 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 71 | 27 | 44 | -1.070 | 38.0% | 27.6%-49.7% | 0.48 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 20 | 6 | 14 | -1.410 | 30.0% | 14.5%-51.9% | 0.33 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `GBP_USD` | 17 | 5 | 12 | -1.788 | 29.4% | 13.3%-53.1% | 0.37 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 11 | 5 | 6 | -0.045 | 45.5% | 21.3%-72.0% | 0.98 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 39 | 22 | 17 | -2.103 | 56.4% | 41.0%-70.7% | 0.39 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 53 | 35 | 18 | -0.142 | 66.0% | 52.6%-77.3% | 0.96 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 35 | 21 | 14 | +0.074 | 60.0% | 43.6%-74.4% | 1.02 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
