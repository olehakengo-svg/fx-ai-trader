# SHADOW_PROMOTE R2 Alert - 2026-07-17T13:23:14.681968+00:00
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 32 | -2.169 | 75.0% | 57.9% | 0.49 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 34 | -0.309 | 64.7% | 47.9% | 0.88 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 35 | -2.891 | 57.1% | 40.9% | 0.28 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 37 | -0.789 | 64.9% | 48.8% | 0.84 |
...
| OK | `intraday_seasonality` | `EUR_GBP` | 1 | 1 | 0 | +9.900 | 100.0% | 20.7%-100.0% | n/a | `ALPHA_INTRADAY_SEASONALITY_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 14 | 13 | 1 | +2.443 | 92.9% | 68.5%-98.7% | 6.90 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 32 | 24 | 8 | -2.169 | 75.0% | 57.9%-86.7% | 0.49 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 34 | 22 | 12 | -0.309 | 64.7% | 47.9%-78.5% | 0.88 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `GBP_USD` | 37 | 20 | 17 | +0.759 | 54.1% | 38.4%-69.0% | 1.30 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 35 | 20 | 15 | -2.891 | 57.1% | 40.9%-72.0% | 0.28 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 37 | 24 | 13 | -0.789 | 64.9% | 48.8%-78.2% | 0.84 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
