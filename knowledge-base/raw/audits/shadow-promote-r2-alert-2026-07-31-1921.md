# SHADOW_PROMOTE R2 Alert - 2026-07-31T19:21:11.558992+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 71 | -2.139 | 22.5% | 14.4% | 0.18 |
...
| **WARN** | `ob_retest` | `USD_JPY` | 19 | -2.316 | 47.4% | 27.3% | 0.66 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 76 | -1.689 | 36.8% | 26.9% | 0.45 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 15 | -1.113 | 33.3% | 15.2% | 0.42 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 13 | -2.715 | 23.1% | 8.2% | 0.16 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 12 | -1.408 | 58.3% | 32.0% | 0.65 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 71 | 16 | 55 | -2.139 | 22.5% | 14.4%-33.5% | 0.18 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `USD_JPY` | 19 | 9 | 10 | -2.316 | 47.4% | 27.3%-68.3% | 0.66 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 76 | 28 | 48 | -1.689 | 36.8% | 26.9%-48.1% | 0.45 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 15 | 5 | 10 | -1.113 | 33.3% | 15.2%-58.3% | 0.42 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 12 | 7 | 5 | -1.408 | 58.3% | 32.0%-80.7% | 0.65 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `xs_momentum` | `USD_JPY` | 53 | 32 | 21 | +0.485 | 60.4% | 46.9%-72.4% | 1.12 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
