# SHADOW_PROMOTE R2 Alert - 2026-08-06T14:02:46.568196+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 10 | -0.640 | 70.0% | 39.7% | 0.74 |
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 22 | -2.914 | 45.5% | 26.9% | 0.41 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | -3.252 | 59.3% | 40.7% | 0.36 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 73 | -1.773 | 20.5% | 12.9% | 0.18 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -0.781 | 32.3% | 18.6% | 0.73 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 17 | -2.635 | 41.2% | 21.6% | 0.30 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 37 | -1.784 | 51.4% | 35.9% | 0.52 |
...
| **WARN** | `vol_surge_detector` | `GBP_USD` | 12 | -3.342 | 8.3% | 1.5% | 0.05 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -0.633 | 33.3% | 13.8% | 0.76 |
...
| **CRITICAL** | `xs_momentum` | `USD_JPY` | 56 | -0.121 | 62.5% | 49.4% | 0.98 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 16 | 13 | 3 | +1.856 | 81.2% | 57.0%-93.4% | 2.13 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 10 | 7 | 3 | -0.640 | 70.0% | 39.7%-89.2% | 0.74 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 22 | 10 | 12 | -2.914 | 45.5% | 26.9%-65.3% | 0.41 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 14 | 8 | 6 | +0.714 | 57.1% | 32.6%-78.6% | 1.31 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | 16 | 11 | -3.252 | 59.3% | 40.7%-75.5% | 0.36 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 17 | 13 | 4 | +4.206 | 76.5% | 52.7%-90.4% | 4.54 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 22 | 15 | 7 | +0.864 | 68.2% | 47.3%-83.6% | 1.33 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 10 | 21 | -0.781 | 32.3% | 18.6%-49.9% | 0.73 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 17 | 7 | 10 | -2.635 | 41.2% | 21.6%-64.0% | 0.30 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `mtf_counter_trend_scalp` | `EUR_USD` | 3 | 1 | 2 | -2.067 | 33.3% | 6.1%-79.2% | 0.10 | `MTF_COUNTER_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 13 | 10 | 3 | +0.631 | 76.9% | 49.7%-91.8% | 1.23 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_USD` | 37 | 19 | 18 | -1.784 | 51.4% | 35.9%-66.6% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `GBP_USD` | 12 | 1 | 11 | -3.342 | 8.3% | 1.5%-35.4% | 0.05 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 12 | 4 | 8 | -0.633 | 33.3% | 13.8%-60.9% | 0.76 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vwap_mean_reversion` | `GBP_USD` | 4 | 2 | 2 | -3.850 | 50.0% | 15.0%-85.0% | 0.37 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `USD_JPY` | 56 | 35 | 21 | -0.121 | 62.5% | 49.4%-74.0% | 0.98 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
