# SHADOW_PROMOTE R2 Alert - 2026-09-18T03:12:56.253423+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_JPY` | 34 | -4.053 | 38.2% | 23.9% | 0.34 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 15 | -1.573 | 40.0% | 19.8% | 0.56 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_JPY` | 38 | -4.284 | 44.7% | 30.1% | 0.27 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 24 | -1.246 | 41.7% | 24.5% | 0.50 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 36 | -1.581 | 58.3% | 42.2% | 0.57 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 34 | -3.235 | 38.2% | 23.9% | 0.37 |
...
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 17 | -3.435 | 47.1% | 26.2% | 0.47 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 7 | 7 | 0 | +8.757 | 100.0% | 64.6%-100.0% | n/a | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 10 | 9 | 1 | +2.010 | 90.0% | 59.6%-98.2% | 1.57 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_JPY` | 34 | 13 | 21 | -4.053 | 38.2% | 23.9%-55.0% | 0.34 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 15 | 6 | 9 | -1.573 | 40.0% | 19.8%-64.3% | 0.56 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_JPY` | 38 | 17 | 21 | -4.284 | 44.7% | 30.1%-60.3% | 0.27 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 24 | 10 | 14 | -1.246 | 41.7% | 24.5%-61.2% | 0.50 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `USD_JPY` | 36 | 21 | 15 | -1.581 | 58.3% | 42.2%-72.9% | 0.57 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `htf_false_breakout` | `USD_JPY` | 3 | 1 | 2 | -8.033 | 33.3% | 6.1%-79.2% | 0.03 | `HTF_FALSE_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 34 | 13 | 21 | -3.235 | 38.2% | 23.9%-55.0% | 0.37 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 17 | 8 | 9 | -3.435 | 47.1% | 26.2%-69.0% | 0.47 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
