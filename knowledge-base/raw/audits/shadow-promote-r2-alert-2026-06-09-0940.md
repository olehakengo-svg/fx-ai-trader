# SHADOW_PROMOTE R2 Alert - 2026-06-09T09:40:07.814037+00:00
...
| **CRITICAL** | `dt_bb_rsi_mr` | `EUR_USD` | 31 | -0.052 | 35.5% | 21.1% | 0.98 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 36 | -0.906 | 30.6% | 18.0% | 0.59 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 42 | -1.257 | 26.2% | 15.3% | 0.37 |
...
| **WARN** | `sr_anti_hunt_bounce` | `USD_JPY` | 24 | -1.763 | 12.5% | 4.3% | 0.11 |
...
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 64 | -0.791 | 39.1% | 28.1% | 0.67 |
...
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 23 | -2.239 | 26.1% | 12.5% | 0.32 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 48 | -0.998 | 43.8% | 30.7% | 0.71 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 47 | -0.423 | 53.2% | 39.2% | 0.91 |
...
- `dt_bb_rsi_mr` x `EUR_USD`: remove `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE`
...
| CRITICAL | `dt_bb_rsi_mr` | `EUR_USD` | 31 | 11 | 20 | -0.052 | 35.5% | 21.1%-53.1% | 0.98 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 36 | 11 | 25 | -0.906 | 30.6% | 18.0%-46.9% | 0.59 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 42 | 11 | 31 | -1.257 | 26.2% | 15.3%-41.1% | 0.37 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `USD_JPY` | 24 | 3 | 21 | -1.763 | 12.5% | 4.3%-31.0% | 0.11 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 64 | 25 | 39 | -0.791 | 39.1% | 28.1%-51.3% | 0.67 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 23 | 6 | 17 | -2.239 | 26.1% | 12.5%-46.5% | 0.32 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 48 | 21 | 27 | -0.998 | 43.8% | 30.7%-57.7% | 0.71 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 47 | 25 | 22 | -0.423 | 53.2% | 39.2%-66.7% | 0.91 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
