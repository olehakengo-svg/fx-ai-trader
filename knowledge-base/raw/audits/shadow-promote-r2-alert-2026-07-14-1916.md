# SHADOW_PROMOTE R2 Alert - 2026-07-14T19:16:16.697292+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_USD` | 40 | -0.870 | 55.0% | 39.8% | 0.53 |
...
| **WARN** | `engulfing_bb` | `GBP_USD` | 28 | -1.489 | 42.9% | 26.5% | 0.41 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 14 | -1.357 | 57.1% | 32.6% | 0.56 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 83 | -1.806 | 31.3% | 22.4% | 0.28 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 36 | -3.200 | 69.4% | 53.1% | 0.39 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 43 | -0.767 | 44.2% | 30.4% | 0.68 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 32 | -3.753 | 46.9% | 30.9% | 0.24 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 32 | -4.669 | 50.0% | 33.6% | 0.36 |
...
| OK | `donchian_momentum_breakout` | `AUD_USD` | 7 | 2 | 5 | -8.629 | 28.6% | 8.2%-64.1% | 0.12 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 6 | 2 | 4 | -2.067 | 33.3% | 9.7%-70.0% | 0.49 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `EUR_GBP` | 8 | 6 | 2 | +1.013 | 75.0% | 40.9%-92.9% | 1.94 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | 13 | 11 | -3.212 | 54.2% | 35.1%-72.1% | 0.29 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `EUR_USD` | 40 | 22 | 18 | -0.870 | 55.0% | 39.8%-69.3% | 0.53 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `GBP_USD` | 28 | 12 | 16 | -1.489 | 42.9% | 26.5%-60.9% | 0.41 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 14 | 8 | 6 | -1.357 | 57.1% | 32.6%-78.6% | 0.56 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 83 | 26 | 57 | -1.806 | 31.3% | 22.4%-41.9% | 0.28 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 36 | 25 | 11 | -3.200 | 69.4% | 53.1%-82.0% | 0.39 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `EUR_USD` | 8 | 3 | 5 | -2.275 | 37.5% | 13.7%-69.4% | 0.18 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 43 | 19 | 24 | -0.767 | 44.2% | 30.4%-58.9% | 0.68 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 32 | 15 | 17 | -3.753 | 46.9% | 30.9%-63.6% | 0.24 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 32 | 16 | 16 | -4.669 | 50.0% | 33.6%-66.4% | 0.36 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
