# SHADOW_PROMOTE R2 Alert - 2026-05-12T08:38:05.299999+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `EUR_USD` | 38 | -0.097 | 39.5% | 25.6% | 0.95 |
| **CRITICAL** | `bb_rsi_reversion` | `GBP_USD` | 37 | -1.641 | 21.6% | 11.4% | 0.49 |
| **CRITICAL** | `bb_rsi_reversion` | `USD_JPY` | 86 | -0.113 | 41.9% | 32.0% | 0.96 |
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 12 | -0.192 | 8.3% | 1.5% | 0.93 |
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 70 | -0.839 | 20.0% | 12.3% | 0.67 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 83 | -0.659 | 22.9% | 15.2% | 0.80 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 218 | -1.527 | 22.0% | 17.0% | 0.59 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 16 | -2.169 | 12.5% | 3.5% | 0.30 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 13 | -5.238 | 7.7% | 1.4% | 0.03 |
| **CRITICAL** | `engulfing_bb` | `USD_JPY` | 37 | -1.651 | 21.6% | 11.4% | 0.63 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -7.058 | 8.3% | 1.5% | 0.13 |
| **WARN** | `london_breakout` | `GBP_USD` | 11 | -2.682 | 9.1% | 1.6% | 0.23 |
| **WARN** | `macdh_reversal` | `USD_JPY` | 13 | -0.223 | 30.8% | 12.7% | 0.91 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 13 | -1.015 | 0.0% | 0.0% | 0.00 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 14 | -4.957 | 14.3% | 4.0% | 0.54 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 17 | -2.112 | 41.2% | 21.6% | 0.62 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 26 | -2.246 | 15.4% | 6.1% | 0.35 |
| **WARN** | `sr_channel_reversal` | `GBP_USD` | 27 | -2.404 | 18.5% | 8.2% | 0.41 |
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 59 | -1.595 | 22.0% | 13.4% | 0.49 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_JPY` | 39 | -13.054 | 5.1% | 1.4% | 0.18 |
| **WARN** | `sr_fib_confluence` | `EUR_USD` | 25 | -0.988 | 28.0% | 14.3% | 0.77 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_JPY` | 65 | -9.395 | 13.8% | 7.5% | 0.42 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 43 | -0.402 | 30.2% | 18.6% | 0.93 |
| **CRITICAL** | `sr_fib_confluence` | `USD_JPY` | 33 | -5.594 | 15.2% | 6.7% | 0.54 |
| **WARN** | `stoch_trend_pullback` | `USD_JPY` | 17 | -4.341 | 17.6% | 6.2% | 0.37 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 31 | -1.732 | 16.1% | 7.1% | 0.57 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 15 | -2.253 | 13.3% | 3.7% | 0.35 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 20 | -3.055 | 20.0% | 8.1% | 0.54 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 10 | -10.690 | 10.0% | 1.8% | 0.13 |
| **WARN** | `xs_momentum` | `EUR_USD` | 21 | -2.200 | 23.8% | 10.6% | 0.66 |
| **WARN** | `xs_momentum` | `USD_JPY` | 13 | -2.623 | 38.5% | 17.7% | 0.62 |
...
| CRITICAL | `bb_rsi_reversion` | `EUR_USD` | 38 | 15 | 23 | -0.097 | 39.5% | 25.6%-55.3% | 0.95 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `GBP_USD` | 37 | 8 | 29 | -1.641 | 21.6% | 11.4%-37.2% | 0.49 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `bb_rsi_reversion` | `USD_JPY` | 86 | 36 | 50 | -0.113 | 41.9% | 32.0%-52.4% | 0.96 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `bb_squeeze_breakout` | `USD_JPY` | 2 | 0 | 2 | -3.500 | 0.0% | 0.0%-65.8% | 0.00 | `SQUEEZE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_fib_reversal` | `EUR_JPY` | 7 | 2 | 5 | -3.686 | 28.6% | 8.2%-64.1% | 0.65 | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `GBP_JPY` | 1 | 0 | 1 | -20.000 | 0.0% | 0.0%-79.3% | 0.00 | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_fib_reversal` | `GBP_USD` | 5 | 2 | 3 | +3.640 | 40.0% | 11.8%-76.9% | 2.58 | `FIB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 8 | 2 | 6 | -4.450 | 25.0% | 7.1%-59.1% | 0.35 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema200_trend_reversal` | `EUR_JPY` | 1 | 1 | 0 | +39.300 | 100.0% | 20.7%-100.0% | n/a | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `EUR_USD` | 70 | 14 | 56 | -0.839 | 20.0% | 12.3%-30.8% | 0.67 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 83 | 19 | 64 | -0.659 | 22.9% | 15.2%-33.0% | 0.80 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 218 | 48 | 170 | -1.527 | 22.0% | 17.0%-28.0% | 0.59 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `EUR_USD` | 16 | 2 | 14 | -2.169 | 12.5% | 3.5%-36.0% | 0.30 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 13 | 1 | 12 | -5.238 | 7.7% | 1.4%-33.3% | 0.03 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `USD_JPY` | 37 | 8 | 29 | -1.651 | 21.6% | 11.4%-37.2% | 0.63 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `london_breakout` | `GBP_USD` | 11 | 1 | 10 | -2.682 | 9.1% | 1.6%-37.7% | 0.23 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ma_regime_switch` | `USD_JPY` | 8 | 1 | 7 | -2.487 | 12.5% | 2.2%-47.1% | 0.20 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ma_trend_perfect` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `MA_TREND_PERFECT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `macdh_reversal` | `EUR_USD` | 3 | 1 | 2 | -1.233 | 33.3% | 6.1%-79.2% | 0.70 | `MACDH_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `macdh_reversal` | `USD_JPY` | 13 | 4 | 9 | -0.223 | 30.8% | 12.7%-57.6% | 0.91 | `MACDH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 8 | 1 | 7 | -7.338 | 12.5% | 2.2%-47.1% | 0.15 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_anti_hunt_bounce` | `EUR_USD` | 13 | 0 | 13 | -1.015 | 0.0% | 0.0%-22.8% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 8 | 1 | 7 | -6.650 | 12.5% | 2.2%-47.1% | 0.45 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `EUR_JPY` | 9 | 2 | 7 | -1.956 | 22.2% | 6.3%-54.7% | 0.77 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 17 | 7 | 10 | -2.112 | 41.2% | 21.6%-64.0% | 0.62 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `EUR_USD` | 26 | 4 | 22 | -2.246 | 15.4% | 6.1%-33.5% | 0.35 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `GBP_USD` | 27 | 5 | 22 | -2.404 | 18.5% | 8.2%-36.7% | 0.41 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 59 | 13 | 46 | -1.595 | 22.0% | 13.4%-34.1% | 0.49 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `EUR_GBP` | 13 | 4 | 9 | +2.400 | 30.8% | 12.7%-57.6% | 3.26 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `EUR_JPY` | 39 | 2 | 37 | -13.054 | 5.1% | 1.4%-16.9% | 0.18 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_fib_confluence` | `EUR_USD` | 25 | 7 | 18 | -0.988 | 28.0% | 14.3%-47.6% | 0.77 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 65 | 9 | 56 | -9.395 | 13.8% | 7.5%-24.3% | 0.42 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 43 | 13 | 30 | -0.402 | 30.2% | 18.6%-45.1% | 0.93 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `stoch_trend_pullback` | `USD_JPY` | 17 | 3 | 14 | -4.341 | 17.6% | 6.2%-41.0% | 0.37 | `STOCH_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 13 | 4 | 9 | +0.115 | 30.8% | 12.7%-57.6% | 1.04 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `v_reversal` | `USD_JPY` | 3 | 2 | 1 | +4.167 | 66.7% | 20.8%-93.9% | 126.00 | `V_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vbp` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `VBP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vdr_jpy` | `EUR_JPY` | 1 | 0 | 1 | -8.400 | 0.0% | 0.0%-79.3% | 0.00 | `VDR_JPY_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 31 | 5 | 26 | -1.732 | 16.1% | 7.1%-32.6% | 0.57 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `GBP_USD` | 15 | 2 | 13 | -2.253 | 13.3% | 3.7%-37.9% | 0.35 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 20 | 4 | 16 | -3.055 | 20.0% | 8.1%-41.6% | 0.54 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `GBP_JPY` | 1 | 0 | 1 | -20.100 | 0.0% | 0.0%-79.3% | 0.00 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 2 | 0 | 2 | -10.650 | 0.0% | 0.0%-65.8% | 0.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 8 | 1 | 7 | +1.125 | 12.5% | 2.2%-47.1% | 1.30 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 4 | 0 | 4 | -13.075 | 0.0% | 0.0%-49.0% | 0.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `EUR_USD` | 21 | 5 | 16 | -2.200 | 23.8% | 10.6%-45.1% | 0.66 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 31 | 11 | 20 | +0.910 | 35.5% | 21.1%-53.1% | 1.13 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 13 | 5 | 8 | -2.623 | 38.5% | 17.7%-64.5% | 0.62 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
