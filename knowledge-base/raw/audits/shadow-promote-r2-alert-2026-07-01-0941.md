# SHADOW_PROMOTE R2 Alert - 2026-07-01T09:41:53.329953+00:00
...
| **WARN** | `london_breakout` | `USD_CHF` | 24 | -1.904 | 29.2% | 14.9% | 0.23 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 66 | -1.574 | 31.8% | 21.8% | 0.30 |
...
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 12 | -3.625 | 58.3% | 32.0% | 0.34 |
...
| OK | `london_breakout` | `EUR_USD` | 45 | 22 | 23 | +0.098 | 48.9% | 35.0%-63.0% | 1.05 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `london_breakout` | `GBP_USD` | 53 | 32 | 21 | +0.047 | 60.4% | 46.9%-72.4% | 1.02 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 24 | 7 | 17 | -1.904 | 29.2% | 14.9%-49.2% | 0.23 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 66 | 21 | 45 | -1.574 | 31.8% | 21.8%-43.8% | 0.30 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `orb_trap` | `GBP_USD` | 3 | 1 | 2 | -4.367 | 33.3% | 6.1%-79.2% | 0.44 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `GBP_JPY` | 12 | 7 | 5 | -3.625 | 58.3% | 32.0%-80.7% | 0.34 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
