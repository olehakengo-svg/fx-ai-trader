# SHADOW_PROMOTE R2 Alert - 2026-07-03T13:59:26.088555+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 28 | -3.332 | 57.1% | 39.1% | 0.25 |
...
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 17 | -0.218 | 47.1% | 26.2% | 0.93 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 78 | -0.724 | 43.6% | 33.1% | 0.63 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 66 | -1.632 | 34.8% | 24.5% | 0.31 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 36 | -3.411 | 25.0% | 13.8% | 0.19 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 28 | 16 | 12 | -3.332 | 57.1% | 39.1%-73.5% | 0.25 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 17 | 8 | 9 | -0.218 | 47.1% | 26.2%-69.0% | 0.93 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 78 | 34 | 44 | -0.724 | 43.6% | 33.1%-54.6% | 0.63 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 66 | 23 | 43 | -1.632 | 34.8% | 24.5%-46.9% | 0.31 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_fib_confluence` | `GBP_USD` | 5 | 5 | 0 | +5.960 | 100.0% | 56.6%-100.0% | n/a | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 9 | 4 | 5 | -1.044 | 44.4% | 18.9%-73.3% | 0.37 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 36 | 9 | 27 | -3.411 | 25.0% | 13.8%-41.1% | 0.19 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
