# SHADOW_PROMOTE R2 Alert - 2026-07-07T14:28:50.075872+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 80 | -0.566 | 46.2% | 35.7% | 0.71 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 40 | -0.323 | 47.5% | 32.9% | 0.85 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -2.600 | 41.7% | 19.3% | 0.28 |
| **CRITICAL** | `london_breakout` | `GBP_USD` | 44 | -0.277 | 61.4% | 46.6% | 0.88 |
| **WARN** | `london_breakout` | `USD_CHF` | 22 | -1.909 | 22.7% | 10.1% | 0.19 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 35 | -2.271 | 68.6% | 52.0% | 0.52 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 47 | -0.211 | 68.1% | 53.8% | 0.92 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 33 | -0.903 | 60.6% | 43.7% | 0.72 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 21 | -1.519 | 57.1% | 36.5% | 0.41 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 13 | -2.377 | 61.5% | 35.5% | 0.25 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 14 | -1.357 | 71.4% | 45.4% | 0.46 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 33 | -3.576 | 24.2% | 12.8% | 0.19 |
...
| OK | `ema200_trend_reversal` | `USD_JPY` | 10 | 6 | 4 | +1.700 | 60.0% | 31.3%-83.2% | 1.48 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_cross` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_ribbon_ride` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_RIBBON_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 80 | 37 | 43 | -0.566 | 46.2% | 35.7%-57.1% | 0.71 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_breakout` | `EUR_USD` | 37 | 20 | 17 | +0.697 | 54.1% | 38.4%-69.0% | 1.37 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `london_breakout` | `GBP_USD` | 44 | 27 | 17 | -0.277 | 61.4% | 46.6%-74.3% | 0.88 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `USD_CHF` | 22 | 5 | 17 | -1.909 | 22.7% | 10.1%-43.4% | 0.19 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 35 | 24 | 11 | -2.271 | 68.6% | 52.0%-81.4% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `GBP_USD` | 3 | 1 | 2 | -2.367 | 33.3% | 6.1%-79.2% | 0.23 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `EUR_GBP` | 21 | 12 | 9 | -1.519 | 57.1% | 36.5%-75.5% | 0.41 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `EUR_USD` | 13 | 8 | 5 | -2.377 | 61.5% | 35.5%-82.3% | 0.25 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 33 | 8 | 25 | -3.576 | 24.2% | 12.8%-41.0% | 0.19 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
