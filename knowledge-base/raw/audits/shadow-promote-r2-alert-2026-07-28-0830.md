# SHADOW_PROMOTE R2 Alert - 2026-07-28T08:30:23.863869+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `donchian_momentum_breakout` | `AUD_JPY` | 12 | -5.508 | 58.3% | 32.0% | 0.32 |
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 22 | -0.641 | 45.5% | 26.9% | 0.74 |
...
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -1.184 | 38.7% | 23.7% | 0.54 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 55 | -1.036 | 36.4% | 24.9% | 0.48 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 30 | -4.993 | 60.0% | 42.3% | 0.27 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 42 | -1.543 | 54.8% | 39.9% | 0.54 |
...
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 72 | -1.242 | 38.9% | 28.5% | 0.44 |
...
| WARN | `donchian_momentum_breakout` | `AUD_JPY` | 12 | 7 | 5 | -5.508 | 58.3% | 32.0%-80.7% | 0.32 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 22 | 10 | 12 | -0.641 | 45.5% | 26.9%-65.3% | 0.74 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 12 | 19 | -1.184 | 38.7% | 23.7%-56.2% | 0.54 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 55 | 20 | 35 | -1.036 | 36.4% | 24.9%-49.6% | 0.48 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 30 | 18 | 12 | -4.993 | 60.0% | 42.3%-75.4% | 0.27 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 42 | 23 | 19 | -1.543 | 54.8% | 39.9%-68.8% | 0.54 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 72 | 28 | 44 | -1.242 | 38.9% | 28.5%-50.4% | 0.44 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
