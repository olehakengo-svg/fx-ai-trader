# SHADOW_PROMOTE R2 Alert - 2026-06-04T20:03:38.618712+00:00
...
| **CRITICAL** | `ema_trend_scalp` | `USD_CHF` | 76 | -1.907 | 3.9% | 1.4% | 0.20 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 30 | -0.933 | 30.0% | 16.7% | 0.59 |
...
| **WARN** | `ob_retest` | `USD_JPY` | 12 | -1.317 | 66.7% | 39.1% | 0.42 |
...
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 42 | -2.757 | 28.6% | 17.2% | 0.28 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 43 | -1.067 | 30.2% | 18.6% | 0.58 |
| **CRITICAL** | `sr_channel_reversal` | `USD_CHF` | 36 | -2.094 | 5.6% | 1.5% | 0.15 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 84 | -0.924 | 34.5% | 25.2% | 0.73 |
...
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 25 | -4.852 | 0.0% | 0.0% | 0.00 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 12 | -7.675 | 16.7% | 4.7% | 0.13 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 59 | -5.490 | 23.7% | 14.7% | 0.15 |
...
| CRITICAL | `ema_trend_scalp` | `USD_CHF` | 76 | 3 | 73 | -1.907 | 3.9% | 1.4%-11.0% | 0.20 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 30 | 9 | 21 | -0.933 | 30.0% | 16.7%-47.9% | 0.59 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `USD_JPY` | 12 | 8 | 4 | -1.317 | 66.7% | 39.1%-86.2% | 0.42 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 42 | 12 | 30 | -2.757 | 28.6% | 17.2%-43.6% | 0.28 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 43 | 13 | 30 | -1.067 | 30.2% | 18.6%-45.1% | 0.58 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 84 | 29 | 55 | -0.924 | 34.5% | 25.2%-45.2% | 0.73 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `turtle_soup` | `GBP_USD` | 8 | 4 | 4 | -4.475 | 50.0% | 21.5%-78.5% | 0.20 | `TURTLE_SOUP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 25 | 0 | 25 | -4.852 | 0.0% | 0.0%-13.3% | 0.00 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 9 | 3 | 6 | -0.989 | 33.3% | 12.1%-64.6% | 0.24 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `EUR_USD` | 59 | 14 | 45 | -5.490 | 23.7% | 14.7%-36.0% | 0.15 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
