# SHADOW_PROMOTE R2 Alert - 2026-09-02T10:38:23.601753+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_USD` | 29 | -2.241 | 34.5% | 19.9% | 0.36 |
| **CRITICAL** | `dt_sr_channel_reversal` | `USD_JPY` | 33 | -0.079 | 54.5% | 38.0% | 0.97 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 14 | -1.514 | 21.4% | 7.6% | 0.19 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 11 | -1.436 | 27.3% | 9.7% | 0.55 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 43 | -2.307 | 44.2% | 30.4% | 0.52 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 52 | -0.417 | 48.1% | 35.1% | 0.88 |
| **WARN** | `trend_rebound` | `USD_JPY` | 13 | -0.623 | 38.5% | 17.7% | 0.72 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 26 | -3.327 | 46.2% | 28.8% | 0.24 |
...
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 55 | -0.309 | 56.4% | 43.3% | 0.91 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 24 | -1.838 | 50.0% | 31.4% | 0.64 |
...
| WARN | `dt_sr_channel_reversal` | `GBP_USD` | 29 | 10 | 19 | -2.241 | 34.5% | 19.9%-52.7% | 0.36 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `engulfing_bb` | `EUR_USD` | 14 | 3 | 11 | -1.514 | 21.4% | 7.6%-47.6% | 0.19 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 11 | 3 | 8 | -1.436 | 27.3% | 9.7%-56.6% | 0.55 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ma_regime_switch` | `USD_JPY` | 9 | 2 | 7 | -3.944 | 22.2% | 6.3%-54.7% | 0.21 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 43 | 19 | 24 | -2.307 | 44.2% | 30.4%-58.9% | 0.52 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `USD_JPY` | 52 | 25 | 27 | -0.417 | 48.1% | 35.1%-61.3% | 0.88 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `USD_JPY` | 27 | 13 | 14 | +0.159 | 48.1% | 30.7%-66.0% | 1.07 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 26 | 12 | 14 | -3.327 | 46.2% | 28.8%-64.5% | 0.24 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vdr_jpy` | `USD_JPY` | 2 | 1 | 1 | -9.050 | 50.0% | 9.5%-90.5% | 0.35 | `VDR_JPY_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 55 | 31 | 24 | -0.309 | 56.4% | 43.3%-68.6% | 0.91 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 24 | 12 | 12 | -1.838 | 50.0% | 31.4%-68.6% | 0.64 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `wick_imbalance_reversion` | `EUR_USD` | 10 | 6 | 4 | +2.190 | 60.0% | 31.3%-83.2% | 1.79 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 25 | 18 | 7 | +3.780 | 72.0% | 52.4%-85.7% | 2.62 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
