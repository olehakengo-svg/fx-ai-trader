# SHADOW_PROMOTE R2 Alert - 2026-09-05T14:35:18.299194+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 25 | -3.580 | 52.0% | 33.5% | 0.38 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 31 | -1.984 | 35.5% | 21.1% | 0.39 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 25 | -1.260 | 48.0% | 30.0% | 0.63 |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 7 | 4 | 3 | -0.014 | 57.1% | 25.0%-84.2% | 0.99 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 25 | 13 | 12 | -3.580 | 52.0% | 33.5%-70.0% | 0.38 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 31 | 11 | 20 | -1.984 | 35.5% | 21.1%-53.1% | 0.39 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 25 | 12 | 13 | -1.260 | 48.0% | 30.0%-66.5% | 0.63 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `mtf_counter_trend_scalp` | `EUR_USD` | 5 | 0 | 5 | -2.760 | 0.0% | 0.0%-43.4% | 0.00 | `MTF_COUNTER_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
