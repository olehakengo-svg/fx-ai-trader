# SHADOW_PROMOTE R2 Alert - 2026-05-12T14:21:51.855828+00:00
...
| **CRITICAL** | `bb_rsi_reversion` | `USD_JPY` | 82 | -0.028 | 42.7% | 32.5% | 0.99 |
| **WARN** | `bb_squeeze_breakout` | `EUR_USD` | 12 | -0.192 | 8.3% | 1.5% | 0.93 |
| **CRITICAL** | `ema_trend_scalp` | `EUR_USD` | 66 | -0.632 | 21.2% | 13.1% | 0.74 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 81 | -0.510 | 23.5% | 15.6% | 0.84 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 218 | -1.527 | 22.0% | 17.0% | 0.59 |
| **WARN** | `engulfing_bb` | `EUR_USD` | 18 | -1.006 | 22.2% | 9.0% | 0.63 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 14 | -4.143 | 14.3% | 4.0% | 0.17 |
| **CRITICAL** | `engulfing_bb` | `USD_JPY` | 35 | -1.923 | 20.0% | 10.0% | 0.59 |
...
| **WARN** | `sr_break_retest` | `EUR_JPY` | 10 | -0.990 | 30.0% | 10.8% | 0.87 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 14 | -4.957 | 14.3% | 4.0% | 0.54 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 22 | -2.141 | 36.4% | 19.7% | 0.57 |
| **WARN** | `sr_channel_reversal` | `EUR_USD` | 25 | -2.536 | 12.0% | 4.2% | 0.29 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 32 | -3.181 | 15.6% | 6.9% | 0.31 |
| **CRITICAL** | `sr_channel_reversal` | `USD_JPY` | 58 | -1.686 | 20.7% | 12.3% | 0.47 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 30 | -1.570 | 16.7% | 7.3% | 0.60 |
...
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 33 | -0.370 | 33.3% | 19.8% | 0.95 |
| **WARN** | `xs_momentum` | `USD_JPY` | 11 | -3.391 | 36.4% | 15.2% | 0.55 |
...
| CRITICAL | `bb_rsi_reversion` | `USD_JPY` | 82 | 35 | 47 | -0.028 | 42.7% | 32.5%-53.5% | 0.99 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `GBP_USD` | 3 | 0 | 3 | -9.133 | 0.0% | 0.0%-56.2% | 0.00 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `GBP_USD` | 81 | 19 | 62 | -0.510 | 23.5% | 15.6%-33.8% | 0.84 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 218 | 48 | 170 | -1.527 | 22.0% | 17.0%-28.0% | 0.59 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `EUR_USD` | 18 | 4 | 14 | -1.006 | 22.2% | 9.0%-45.2% | 0.63 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 14 | 2 | 12 | -4.143 | 14.3% | 4.0%-39.9% | 0.17 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `USD_JPY` | 35 | 7 | 28 | -1.923 | 20.0% | 10.0%-35.9% | 0.59 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `GBP_USD` | 7 | 4 | 3 | -2.000 | 57.1% | 25.0%-84.2% | 0.68 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `EUR_JPY` | 10 | 3 | 7 | -0.990 | 30.0% | 10.8%-60.3% | 0.87 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `USD_JPY` | 22 | 8 | 14 | -2.141 | 36.4% | 19.7%-57.0% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_channel_reversal` | `EUR_USD` | 25 | 3 | 22 | -2.536 | 12.0% | 4.2%-30.0% | 0.29 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 32 | 5 | 27 | -3.181 | 15.6% | 6.9%-31.8% | 0.31 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `USD_JPY` | 58 | 12 | 46 | -1.686 | 20.7% | 12.3%-32.8% | 0.47 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 30 | 5 | 25 | -1.570 | 16.7% | 7.3%-33.6% | 0.60 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 5 | 0 | 5 | -6.000 | 0.0% | 0.0%-43.4% | 0.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `GBP_USD` | 33 | 11 | 22 | -0.370 | 33.3% | 19.8%-50.4% | 0.95 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 11 | 4 | 7 | -3.391 | 36.4% | 15.2%-64.6% | 0.55 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
