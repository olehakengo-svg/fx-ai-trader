# SHADOW_PROMOTE R2 Alert - 2026-09-07T11:35:35.650483+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `donchian_momentum_breakout` | `AUD_USD` | 11 | -4.200 | 45.5% | 21.3% | 0.24 |
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 13 | -2.546 | 38.5% | 17.7% | 0.49 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 14 | -1.929 | 14.3% | 4.0% | 0.27 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | -2.933 | 26.7% | 10.9% | 0.46 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 25 | -0.572 | 44.0% | 26.7% | 0.79 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 20 | -4.450 | 50.0% | 29.9% | 0.28 |
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 30 | -2.170 | 33.3% | 19.2% | 0.30 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 24 | -0.904 | 50.0% | 31.4% | 0.71 |
| **CRITICAL** | `london_breakout` | `EUR_USD` | 55 | -0.629 | 38.2% | 26.5% | 0.66 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `EUR_JPY` | 34 | -1.800 | 47.1% | 31.5% | 0.60 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 18 | -0.622 | 66.7% | 43.7% | 0.84 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 45 | -0.576 | 53.3% | 39.1% | 0.86 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 24 | -1.475 | 20.8% | 9.2% | 0.31 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 10 | -2.410 | 40.0% | 16.8% | 0.37 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 55 | -0.167 | 60.0% | 46.8% | 0.95 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 22 | -1.564 | 50.0% | 30.7% | 0.70 |
...
| WARN | `donchian_momentum_breakout` | `AUD_USD` | 11 | 5 | 6 | -4.200 | 45.5% | 21.3%-72.0% | 0.24 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 7 | 4 | 3 | -2.986 | 57.1% | 25.0%-84.2% | 0.56 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 5 | 2 | 3 | -1.100 | 40.0% | 11.8%-76.9% | 0.72 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 15 | 4 | 11 | -2.933 | 26.7% | 10.9%-52.0% | 0.46 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 25 | 11 | 14 | -0.572 | 44.0% | 26.7%-62.9% | 0.79 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 20 | 10 | 10 | -4.450 | 50.0% | 29.9%-70.1% | 0.28 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 30 | 10 | 20 | -2.170 | 33.3% | 19.2%-51.2% | 0.30 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `lin_reg_channel` | `EUR_USD` | 7 | 3 | 4 | -1.671 | 42.9% | 15.8%-75.0% | 0.40 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `london_breakout` | `EUR_USD` | 55 | 21 | 34 | -0.629 | 38.2% | 26.5%-51.4% | 0.66 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `london_session_breakout` | `GBP_USD` | 5 | 3 | 2 | +0.880 | 60.0% | 23.1%-88.2% | 1.24 | `LONDON_SESSION_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `orb_trap` | `EUR_USD` | 3 | 2 | 1 | +1.233 | 66.7% | 20.8%-93.9% | 1.47 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_anti_hunt_bounce` | `EUR_JPY` | 34 | 16 | 18 | -1.800 | 47.1% | 31.5%-63.3% | 0.60 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 45 | 24 | 21 | -0.576 | 53.3% | 39.1%-67.1% | 0.86 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_break_retest` | `USD_JPY` | 50 | 25 | 25 | +0.268 | 50.0% | 36.6%-63.4% | 1.10 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `EUR_USD` | 9 | 3 | 6 | +0.056 | 33.3% | 12.1%-64.6% | 1.05 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_GBP` | 3 | 1 | 2 | -2.900 | 33.3% | 6.1%-79.2% | 0.16 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `v_reversal` | `USD_JPY` | 3 | 2 | 1 | +0.133 | 66.7% | 20.8%-93.9% | 1.07 | `V_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 24 | 5 | 19 | -1.475 | 20.8% | 9.2%-40.5% | 0.31 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `GBP_USD` | 8 | 3 | 5 | -1.137 | 37.5% | 13.7%-69.4% | 0.50 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 10 | 4 | 6 | -2.410 | 40.0% | 16.8%-68.7% | 0.37 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 55 | 33 | 22 | -0.167 | 60.0% | 46.8%-71.9% | 0.95 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 22 | 11 | 11 | -1.564 | 50.0% | 30.7%-69.3% | 0.70 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `GBP_JPY` | 17 | 12 | 5 | +0.594 | 70.6% | 46.9%-86.7% | 1.15 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 24 | 18 | 6 | +3.783 | 75.0% | 55.1%-88.0% | 3.52 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
