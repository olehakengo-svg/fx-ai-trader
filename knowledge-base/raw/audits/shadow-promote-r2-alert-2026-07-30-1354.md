# SHADOW_PROMOTE R2 Alert - 2026-07-30T13:54:35.809032+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `AUD_JPY` | 33 | -1.736 | 51.5% | 35.2% | 0.52 |
...
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 26 | -1.138 | 65.4% | 46.2% | 0.67 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 82 | -1.776 | 26.8% | 18.4% | 0.25 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 31 | -0.900 | 38.7% | 23.7% | 0.66 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 49 | -1.043 | 36.7% | 24.7% | 0.55 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 15 | -0.773 | 46.7% | 24.8% | 0.74 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 46 | -2.880 | 50.0% | 36.1% | 0.43 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 30 | -5.907 | 50.0% | 33.2% | 0.21 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 38 | -1.689 | 52.6% | 37.3% | 0.52 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 29 | -1.976 | 44.8% | 28.4% | 0.42 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 13 | -0.223 | 53.8% | 29.1% | 0.81 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 55 | -0.216 | 54.5% | 41.5% | 0.92 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 66 | -0.748 | 37.9% | 27.1% | 0.64 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 17 | -0.806 | 41.2% | 21.6% | 0.51 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 16 | -1.819 | 31.2% | 14.2% | 0.38 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 16 | -4.312 | 43.8% | 23.1% | 0.31 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 14 | -0.279 | 71.4% | 45.4% | 0.93 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 13 | -4.415 | 38.5% | 17.7% | 0.12 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 12 | -3.992 | 41.7% | 19.3% | 0.12 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 43 | -1.347 | 60.5% | 45.6% | 0.52 |
...
| OK | `atr_regime_break` | `USD_JPY` | 3 | 3 | 0 | +1.867 | 100.0% | 43.8%-100.0% | n/a | `ALPHA_ATR_REGIME_BREAK_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `EUR_USD` | 1 | 1 | 0 | +9.600 | 100.0% | 20.7%-100.0% | n/a | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 10 | 8 | 2 | +2.200 | 80.0% | 49.0%-94.3% | 1.66 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `dt_sr_channel_reversal` | `AUD_JPY` | 33 | 17 | 16 | -1.736 | 51.5% | 35.2%-67.5% | 0.52 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 26 | 17 | 9 | -1.138 | 65.4% | 46.2%-80.6% | 0.67 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 17 | 10 | 7 | +1.512 | 58.8% | 36.0%-78.4% | 1.60 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `USD_JPY` | 9 | 5 | 4 | -1.600 | 55.6% | 26.7%-81.1% | 0.57 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 82 | 22 | 60 | -1.776 | 26.8% | 18.4%-37.3% | 0.25 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 31 | 12 | 19 | -0.900 | 38.7% | 23.7%-56.2% | 0.66 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 49 | 18 | 31 | -1.043 | 36.7% | 24.7%-50.7% | 0.55 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `USD_JPY` | 6 | 2 | 4 | -1.367 | 33.3% | 9.7%-70.0% | 0.63 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `EUR_USD` | 15 | 7 | 8 | -0.773 | 46.7% | 24.8%-69.9% | 0.74 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_anti_hunt_bounce` | `EUR_JPY` | 14 | 11 | 3 | +1.093 | 78.6% | 52.4%-92.4% | 1.74 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_anti_hunt_bounce` | `EUR_USD` | 16 | 9 | 7 | -1.881 | 56.2% | 33.2%-76.9% | 0.41 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_anti_hunt_bounce` | `GBP_JPY` | 4 | 3 | 1 | -0.000 | 75.0% | 30.1%-95.4% | 1.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 46 | 23 | 23 | -2.880 | 50.0% | 36.1%-63.9% | 0.43 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 30 | 15 | 15 | -5.907 | 50.0% | 33.2%-66.8% | 0.21 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `EUR_USD` | 13 | 7 | 6 | -0.223 | 53.8% | 29.1%-76.8% | 0.81 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `EUR_USD` | 8 | 4 | 4 | +1.262 | 50.0% | 21.5%-78.5% | 1.90 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vdr_jpy` | `USD_JPY` | 5 | 2 | 3 | -21.260 | 40.0% | 11.8%-76.9% | 0.03 | `VDR_JPY_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 55 | 30 | 25 | -0.216 | 54.5% | 41.5%-67.0% | 0.92 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 66 | 25 | 41 | -0.748 | 37.9% | 27.1%-49.9% | 0.64 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 17 | 7 | 10 | -0.806 | 41.2% | 21.6%-64.0% | 0.51 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `GBP_USD` | 16 | 5 | 11 | -1.819 | 31.2% | 14.2%-55.6% | 0.38 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `USD_JPY` | 8 | 3 | 5 | -0.462 | 37.5% | 13.7%-69.4% | 0.78 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 16 | 7 | 9 | -4.312 | 43.8% | 23.1%-66.8% | 0.31 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 14 | 10 | 4 | -0.279 | 71.4% | 45.4%-88.3% | 0.93 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `USD_JPY` | 12 | 5 | 7 | -3.992 | 41.7% | 19.3%-68.0% | 0.12 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `EUR_USD` | 43 | 26 | 17 | -1.347 | 60.5% | 45.6%-73.6% | 0.52 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 54 | 38 | 16 | +0.763 | 70.4% | 57.2%-80.9% | 1.25 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 43 | 27 | 16 | +1.267 | 62.8% | 47.9%-75.6% | 1.33 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
