# SHADOW_PROMOTE R2 Alert - 2026-07-08T08:24:19.882758+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 13 | -2.254 | 46.2% | 23.2% | 0.46 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 27 | -2.907 | 55.6% | 37.3% | 0.31 |
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_USD` | 35 | -0.520 | 60.0% | 43.6% | 0.67 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 83 | -0.620 | 43.4% | 33.2% | 0.69 |
| **CRITICAL** | `engulfing_bb` | `GBP_USD` | 40 | -0.172 | 47.5% | 32.9% | 0.92 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 12 | -3.250 | 33.3% | 13.8% | 0.22 |
| **WARN** | `london_breakout` | `EUR_USD` | 25 | -0.636 | 48.0% | 30.0% | 0.70 |
| **CRITICAL** | `london_breakout` | `GBP_USD` | 33 | -1.409 | 51.5% | 35.2% | 0.51 |
| **WARN** | `london_breakout` | `USD_CHF` | 20 | -1.885 | 20.0% | 8.1% | 0.19 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 73 | -1.526 | 37.0% | 26.8% | 0.34 |
...
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 31 | -2.055 | 64.5% | 46.9% | 0.48 |
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 34 | -2.047 | 70.6% | 53.8% | 0.57 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 50 | -0.454 | 66.0% | 52.2% | 0.84 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 34 | -1.176 | 58.8% | 42.2% | 0.66 |
| **WARN** | `trend_rebound` | `USD_JPY` | 10 | -2.180 | 20.0% | 5.7% | 0.11 |
| **WARN** | `trendline_sweep` | `EUR_GBP` | 22 | -1.600 | 54.5% | 34.7% | 0.39 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 15 | -1.887 | 66.7% | 41.7% | 0.31 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 12 | -1.858 | 66.7% | 39.1% | 0.36 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 31 | -3.365 | 25.8% | 13.7% | 0.21 |
| **WARN** | `vol_momentum_scalp` | `USD_JPY` | 23 | -0.417 | 52.2% | 33.0% | 0.82 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 22 | -2.173 | 27.3% | 13.2% | 0.19 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 17 | -0.200 | 52.9% | 31.0% | 0.90 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 27 | -2.752 | 66.7% | 47.8% | 0.53 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 10 | -3.630 | 40.0% | 16.8% | 0.12 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 34 | -2.029 | 58.8% | 42.2% | 0.47 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 35 | -4.414 | 57.1% | 40.9% | 0.29 |
...
| OK | `donchian_momentum_breakout` | `NZD_USD` | 5 | 4 | 1 | +1.380 | 80.0% | 37.6%-96.4% | 1.43 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `USD_JPY` | 5 | 1 | 4 | -17.860 | 20.0% | 3.6%-62.4% | 0.01 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_bb_rsi_mr` | `EUR_USD` | 5 | 0 | 5 | -8.260 | 0.0% | 0.0%-43.4% | 0.00 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_bb_rsi_mr` | `GBP_USD` | 13 | 6 | 7 | -2.254 | 46.2% | 23.2%-70.9% | 0.46 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 27 | 15 | 12 | -2.907 | 55.6% | 37.3%-72.4% | 0.31 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `dt_sr_channel_reversal` | `EUR_USD` | 35 | 21 | 14 | -0.520 | 60.0% | 43.6%-74.4% | 0.67 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 83 | 36 | 47 | -0.620 | 43.4% | 33.2%-54.1% | 0.69 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `GBP_USD` | 40 | 19 | 21 | -0.172 | 47.5% | 32.9%-62.5% | 0.92 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `inducement_ob` | `GBP_USD` | 3 | 2 | 1 | -1.867 | 66.7% | 20.8%-93.9% | 0.47 | `INDUCEMENT_OB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 12 | 4 | 8 | -3.250 | 33.3% | 13.8%-60.9% | 0.22 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `EUR_USD` | 25 | 12 | 13 | -0.636 | 48.0% | 30.0%-66.5% | 0.70 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 73 | 27 | 46 | -1.526 | 37.0% | 26.8%-48.5% | 0.34 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ob_retest` | `GBP_USD` | 9 | 4 | 5 | -6.078 | 44.4% | 18.9%-73.3% | 0.13 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ofi_mr` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `OFI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `orb_trap` | `EUR_USD` | 3 | 2 | 1 | +2.533 | 66.7% | 20.8%-93.9% | 2.12 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `orb_trap` | `GBP_USD` | 2 | 1 | 1 | -1.000 | 50.0% | 9.5%-90.5% | 0.83 | `ORB_TRAP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 31 | 20 | 11 | -2.055 | 64.5% | 46.9%-78.9% | 0.48 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 34 | 24 | 10 | -2.047 | 70.6% | 53.8%-83.2% | 0.57 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 50 | 33 | 17 | -0.454 | 66.0% | 52.2%-77.6% | 0.84 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 34 | 20 | 14 | -1.176 | 58.8% | 42.2%-73.6% | 0.66 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `EUR_USD` | 8 | 1 | 7 | -2.713 | 12.5% | 2.2%-47.1% | 0.07 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trend_rebound` | `USD_JPY` | 10 | 2 | 8 | -2.180 | 20.0% | 5.7%-51.0% | 0.11 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 12 | 8 | 4 | -1.858 | 66.7% | 39.1%-86.2% | 0.36 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 31 | 8 | 23 | -3.365 | 25.8% | 13.7%-43.2% | 0.21 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_momentum_scalp` | `USD_JPY` | 23 | 12 | 11 | -0.417 | 52.2% | 33.0%-70.8% | 0.82 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 22 | 6 | 16 | -2.173 | 27.3% | 13.2%-48.2% | 0.19 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `GBP_USD` | 6 | 2 | 4 | -1.400 | 33.3% | 9.7%-70.0% | 0.44 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `USD_CHF` | 3 | 2 | 1 | +0.533 | 66.7% | 20.8%-93.9% | 1.64 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `USD_JPY` | 17 | 9 | 8 | -0.200 | 52.9% | 31.0%-73.8% | 0.90 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vwap_mean_reversion` | `EUR_GBP` | 2 | 0 | 2 | -5.850 | 0.0% | 0.0%-65.8% | 0.00 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_JPY` | 18 | 14 | 4 | +0.072 | 77.8% | 54.8%-91.0% | 1.03 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `USD_JPY` | 10 | 4 | 6 | -3.630 | 40.0% | 16.8%-68.7% | 0.12 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `EUR_USD` | 34 | 20 | 14 | -2.029 | 58.8% | 42.2%-73.6% | 0.47 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 35 | 20 | 15 | -4.414 | 57.1% | 40.9%-72.0% | 0.29 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 21 | 15 | 6 | +0.167 | 71.4% | 50.0%-86.2% | 1.08 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
