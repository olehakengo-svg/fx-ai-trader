# SHADOW_PROMOTE R2 Alert - 2026-08-27T07:19:13.000967+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 30 | -1.697 | 23.3% | 11.8% | 0.24 |
...
| **WARN** | `ma_regime_switch` | `USD_JPY` | 26 | -0.958 | 53.8% | 35.5% | 0.77 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 35 | -2.506 | 42.9% | 28.0% | 0.50 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 11 | -4.764 | 54.5% | 28.0% | 0.42 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 11 | -8.200 | 45.5% | 21.3% | 0.24 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 60 | -1.715 | 51.7% | 39.3% | 0.64 |
| **WARN** | `trend_rebound` | `USD_JPY` | 10 | -0.230 | 40.0% | 16.8% | 0.90 |
| **WARN** | `trendline_sweep` | `GBP_USD` | 21 | -5.062 | 47.6% | 28.3% | 0.11 |
| **WARN** | `vol_momentum_scalp` | `GBP_USD` | 10 | -3.550 | 40.0% | 16.8% | 0.24 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 32 | -1.984 | 37.5% | 22.9% | 0.60 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 21 | -1.024 | 19.0% | 7.7% | 0.50 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -0.900 | 33.3% | 13.8% | 0.70 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 45 | -0.389 | 53.3% | 39.1% | 0.89 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 28 | -2.500 | 50.0% | 32.6% | 0.56 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 22 | -0.068 | 72.7% | 51.8% | 0.98 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 21 | -3.105 | 42.9% | 24.5% | 0.30 |
...
| OK | `donchian_momentum_breakout` | `NZD_JPY` | 2 | 1 | 1 | -0.150 | 50.0% | 9.5%-90.5% | 0.89 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `AUD_JPY` | 6 | 1 | 5 | -8.733 | 16.7% | 3.0%-56.4% | 0.12 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 27 | 13 | 14 | +0.122 | 48.1% | 30.7%-66.0% | 1.04 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 30 | 7 | 23 | -1.697 | 23.3% | 11.8%-40.9% | 0.24 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `lin_reg_channel` | `EUR_USD` | 7 | 1 | 6 | -5.514 | 14.3% | 2.6%-51.3% | 0.02 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ma_regime_switch` | `USD_JPY` | 26 | 14 | 12 | -0.958 | 53.8% | 35.5%-71.2% | 0.77 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 35 | 15 | 20 | -2.506 | 42.9% | 28.0%-59.1% | 0.50 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `GBP_USD` | 5 | 3 | 2 | -0.920 | 60.0% | 23.1%-88.2% | 0.66 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 60 | 31 | 29 | -1.715 | 51.7% | 39.3%-63.8% | 0.64 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trendline_sweep` | `EUR_USD` | 1 | 1 | 0 | +20.600 | 100.0% | 20.7%-100.0% | n/a | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `trendline_sweep` | `GBP_USD` | 21 | 10 | 11 | -5.062 | 47.6% | 28.3%-67.6% | 0.11 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `GBP_USD` | 10 | 4 | 6 | -3.550 | 40.0% | 16.8%-68.7% | 0.24 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 32 | 12 | 20 | -1.984 | 37.5% | 22.9%-54.7% | 0.60 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vwap_mean_reversion` | `EUR_JPY` | 6 | 5 | 1 | +2.233 | 83.3% | 43.6%-97.0% | 1.65 | `VWAP_MEAN_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 45 | 24 | 21 | -0.389 | 53.3% | 39.1%-67.1% | 0.89 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 22 | 16 | 6 | -0.068 | 72.7% | 51.8%-86.8% | 0.98 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 21 | 9 | 12 | -3.105 | 42.9% | 24.5%-63.5% | 0.30 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
