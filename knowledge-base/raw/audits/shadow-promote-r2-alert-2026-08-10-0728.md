# SHADOW_PROMOTE R2 Alert - 2026-08-10T07:28:06.315365+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | -3.596 | 33.3% | 18.0% | 0.35 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 17 | -0.112 | 52.9% | 31.0% | 0.96 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | -3.245 | 55.2% | 37.5% | 0.40 |
| **WARN** | `dt_sr_channel_reversal` | `USD_JPY` | 24 | -0.092 | 62.5% | 42.7% | 0.97 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 70 | -1.789 | 20.0% | 12.3% | 0.17 |
...
| **WARN** | `vol_surge_detector` | `USD_JPY` | 12 | -0.350 | 33.3% | 13.8% | 0.88 |
| **WARN** | `wick_imbalance_reversion` | `AUD_JPY` | 14 | -3.993 | 21.4% | 7.6% | 0.34 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 16 | -2.237 | 62.5% | 38.6% | 0.59 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 30 | -3.087 | 50.0% | 33.2% | 0.27 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 8 | 4 | 4 | -6.262 | 50.0% | 21.5%-78.5% | 0.38 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 24 | 8 | 16 | -3.596 | 33.3% | 18.0%-53.3% | 0.35 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 17 | 9 | 8 | -0.112 | 52.9% | 31.0%-73.8% | 0.96 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 29 | 16 | 13 | -3.245 | 55.2% | 37.5%-71.6% | 0.40 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_USD` | 19 | 13 | 6 | +3.153 | 68.4% | 46.0%-84.6% | 2.83 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `USD_JPY` | 24 | 15 | 9 | -0.092 | 62.5% | 42.7%-78.8% | 0.97 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 70 | 14 | 56 | -1.789 | 20.0% | 12.3%-30.8% | 0.17 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 7 | 4 | 3 | +0.686 | 57.1% | 25.0%-84.2% | 1.77 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `USD_JPY` | 12 | 4 | 8 | -0.350 | 33.3% | 13.8%-60.9% | 0.88 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `EUR_JPY` | 16 | 10 | 6 | -2.237 | 62.5% | 38.6%-81.5% | 0.59 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 30 | 15 | 15 | -3.087 | 50.0% | 33.2%-66.8% | 0.27 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
