# SHADOW_PROMOTE R2 Alert - 2026-05-20T20:12:37.634767+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `bb_rsi_reversion` | `EUR_USD` | 22 | -0.341 | 40.9% | 23.3% | 0.83 |
| **WARN** | `bb_rsi_reversion` | `GBP_USD` | 25 | -2.004 | 24.0% | 11.5% | 0.41 |
| **WARN** | `bb_rsi_reversion` | `USD_CHF` | 12 | -3.358 | 0.0% | 0.0% | 0.00 |
| **WARN** | `dt_bb_rsi_mr` | `GBP_USD` | 25 | -4.584 | 16.0% | 6.4% | 0.29 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 13 | -1.423 | 30.8% | 12.7% | 0.80 |
| **WARN** | `ema_trend_scalp` | `EUR_USD` | 23 | -0.609 | 21.7% | 9.7% | 0.72 |
| **CRITICAL** | `ema_trend_scalp` | `GBP_USD` | 45 | -1.533 | 15.6% | 7.7% | 0.52 |
| **CRITICAL** | `ema_trend_scalp` | `USD_JPY` | 110 | -1.303 | 20.0% | 13.6% | 0.61 |
...
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 34 | -0.965 | 26.5% | 14.6% | 0.74 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_JPY` | 46 | -10.487 | 10.9% | 4.7% | 0.37 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 64 | -3.272 | 21.9% | 13.5% | 0.55 |
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 44 | -1.380 | 20.5% | 11.2% | 0.65 |
| **WARN** | `vol_momentum_scalp` | `USD_JPY` | 15 | -3.000 | 6.7% | 1.2% | 0.14 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 14 | -4.993 | 14.3% | 4.0% | 0.16 |
| **WARN** | `wick_imbalance_reversion` | `USD_JPY` | 14 | -1.900 | 21.4% | 7.6% | 0.70 |
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 32 | -1.016 | 31.2% | 18.0% | 0.81 |
| **WARN** | `xs_momentum` | `GBP_USD` | 29 | -3.200 | 27.6% | 14.7% | 0.61 |
...
| WARN | `bb_rsi_reversion` | `EUR_USD` | 22 | 9 | 13 | -0.341 | 40.9% | 23.3%-61.3% | 0.83 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `bb_rsi_reversion` | `GBP_USD` | 25 | 6 | 19 | -2.004 | 24.0% | 11.5%-43.4% | 0.41 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `bb_rsi_reversion` | `USD_CHF` | 12 | 0 | 12 | -3.358 | 0.0% | 0.0%-24.3% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `bb_rsi_reversion` | `USD_JPY` | 38 | 19 | 19 | +0.800 | 50.0% | 34.8%-65.2% | 1.30 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 13 | 4 | 9 | -1.423 | 30.8% | 12.7%-57.6% | 0.80 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 2 | 1 | 1 | -0.300 | 50.0% | 9.5%-90.5% | 0.79 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `GBP_JPY` | 5 | 2 | 3 | -0.560 | 40.0% | 11.8%-76.9% | 0.93 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ema_trend_scalp` | `EUR_USD` | 23 | 5 | 18 | -0.609 | 21.7% | 9.7%-41.9% | 0.72 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ema_trend_scalp` | `USD_JPY` | 110 | 22 | 88 | -1.303 | 20.0% | 13.6%-28.4% | 0.61 | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `EUR_USD` | 34 | 9 | 25 | -0.965 | 26.5% | 14.6%-43.1% | 0.74 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_JPY` | 46 | 5 | 41 | -10.487 | 10.9% | 4.7%-23.0% | 0.37 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 64 | 14 | 50 | -3.272 | 21.9% | 13.5%-33.4% | 0.55 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `sr_fib_confluence` | `USD_JPY` | 20 | 5 | 15 | +1.080 | 25.0% | 11.2%-46.9% | 1.11 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `USD_JPY` | 8 | 3 | 5 | +2.288 | 37.5% | 13.7%-69.4% | 2.22 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_momentum_scalp` | `USD_JPY` | 15 | 1 | 14 | -3.000 | 6.7% | 1.2%-29.8% | 0.14 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_surge_detector` | `EUR_USD` | 4 | 1 | 3 | -1.900 | 25.0% | 4.6%-69.9% | 0.49 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 32 | 10 | 22 | -1.016 | 31.2% | 18.0%-48.6% | 0.81 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `GBP_USD` | 29 | 8 | 21 | -3.200 | 27.6% | 14.7%-45.7% | 0.61 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
