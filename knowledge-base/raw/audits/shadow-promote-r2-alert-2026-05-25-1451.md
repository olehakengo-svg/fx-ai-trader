# SHADOW_PROMOTE R2 Alert - 2026-05-25T14:51:08.912085+00:00
...
| **WARN** | `bb_rsi_reversion` | `GBP_USD` | 11 | -1.009 | 36.4% | 15.2% | 0.69 |
...
| **WARN** | `sr_anti_hunt_bounce` | `USD_JPY` | 25 | -1.928 | 0.0% | 0.0% | 0.00 |
...
| **WARN** | `sr_channel_reversal` | `USD_JPY` | 17 | -0.729 | 23.5% | 9.6% | 0.71 |
...
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 86 | -3.929 | 17.4% | 10.9% | 0.42 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 51 | -4.802 | 23.5% | 14.0% | 0.37 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 35 | -3.777 | 20.0% | 10.0% | 0.49 |
...
| WARN | `bb_rsi_reversion` | `GBP_USD` | 11 | 4 | 7 | -1.009 | 36.4% | 15.2%-64.6% | 0.69 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `USD_JPY` | 13 | 3 | 10 | +2.185 | 23.1% | 8.2%-50.3% | 1.77 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_anti_hunt_bounce` | `USD_JPY` | 25 | 0 | 25 | -1.928 | 0.0% | 0.0%-13.3% | 0.00 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_channel_reversal` | `USD_JPY` | 17 | 4 | 13 | -0.729 | 23.5% | 9.6%-47.3% | 0.71 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 86 | 15 | 71 | -3.929 | 17.4% | 10.9%-26.8% | 0.42 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 51 | 12 | 39 | -4.802 | 23.5% | 14.0%-36.8% | 0.37 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 35 | 7 | 28 | -3.777 | 20.0% | 10.0%-35.9% | 0.49 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
