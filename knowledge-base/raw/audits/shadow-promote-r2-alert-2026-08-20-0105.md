# SHADOW_PROMOTE R2 Alert - 2026-08-20T01:05:38.155934+00:00
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 45 | -1.949 | 20.0% | 10.9% | 0.17 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 31 | -1.365 | 45.2% | 29.2% | 0.66 |
| **WARN** | `ob_retest` | `USD_JPY` | 19 | -2.147 | 47.4% | 27.3% | 0.67 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 12 | -3.408 | 25.0% | 8.9% | 0.26 |
| **CRITICAL** | `sr_anti_hunt_bounce` | `EUR_JPY` | 32 | -1.497 | 46.9% | 30.9% | 0.65 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 17 | -1.594 | 58.8% | 36.0% | 0.62 |
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 31 | -3.139 | 38.7% | 23.7% | 0.41 |
| **WARN** | `sr_break_retest` | `EUR_JPY` | 16 | -3.081 | 62.5% | 38.6% | 0.53 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 17 | -6.529 | 41.2% | 21.6% | 0.26 |
| **WARN** | `sr_break_retest` | `GBP_USD` | 10 | -2.300 | 50.0% | 23.7% | 0.37 |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 45 | 9 | 36 | -1.949 | 20.0% | 10.9%-33.8% | 0.17 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 31 | 14 | 17 | -1.365 | 45.2% | 29.2%-62.2% | 0.66 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_anti_hunt_bounce` | `EUR_JPY` | 32 | 15 | 17 | -1.497 | 46.9% | 30.9%-63.6% | 0.65 | `SR_ANTI_HUNT_BOUNCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 31 | 12 | 19 | -3.139 | 38.7% | 23.7%-56.2% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `EUR_JPY` | 16 | 10 | 6 | -3.081 | 62.5% | 38.6%-81.5% | 0.53 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 17 | 7 | 10 | -6.529 | 41.2% | 21.6%-64.0% | 0.26 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_USD` | 10 | 5 | 5 | -2.300 | 50.0% | 23.7%-76.3% | 0.37 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `USD_JPY` | 17 | 9 | 8 | +1.306 | 52.9% | 31.0%-73.8% | 1.70 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `USD_JPY` | 23 | 14 | 9 | +0.643 | 60.9% | 40.8%-77.8% | 1.18 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
