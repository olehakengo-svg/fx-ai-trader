# SHADOW_PROMOTE R2 Alert - 2026-08-04T08:32:45.680875+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 16 | -3.337 | 50.0% | 28.0% | 0.32 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 24 | -2.617 | 62.5% | 42.7% | 0.43 |
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 75 | -1.817 | 21.3% | 13.6% | 0.18 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 28 | -1.314 | 32.1% | 17.9% | 0.56 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 22 | -2.459 | 40.9% | 23.3% | 0.29 |
| **WARN** | `london_breakout` | `EUR_USD` | 19 | -1.947 | 26.3% | 11.8% | 0.15 |
| **CRITICAL** | `london_breakout` | `GBP_USD` | 46 | -2.250 | 32.6% | 20.9% | 0.29 |
| **WARN** | `london_breakout` | `USD_JPY` | 16 | -3.650 | 25.0% | 10.2% | 0.17 |
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 51 | -0.341 | 49.0% | 35.9% | 0.86 |
| **WARN** | `ob_retest` | `USD_JPY` | 17 | -2.700 | 47.1% | 26.2% | 0.65 |
| **WARN** | `squeeze_release_momentum` | `EUR_USD` | 14 | -2.036 | 42.9% | 21.4% | 0.49 |
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 16 | -2.244 | 50.0% | 28.0% | 0.46 |
| **WARN** | `sr_anti_hunt_bounce` | `EUR_USD` | 15 | -1.207 | 60.0% | 35.7% | 0.62 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 22 | -0.955 | 59.1% | 38.7% | 0.76 |
| **CRITICAL** | `sr_break_retest` | `EUR_JPY` | 38 | -2.924 | 55.3% | 39.7% | 0.47 |
| **WARN** | `sr_break_retest` | `GBP_JPY` | 29 | -6.824 | 44.8% | 28.4% | 0.19 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 38 | -1.466 | 55.3% | 39.7% | 0.58 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 29 | -3.645 | 48.3% | 31.4% | 0.42 |
| **WARN** | `three_bar_reversal` | `EUR_USD` | 13 | -0.977 | 38.5% | 17.7% | 0.45 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 59 | -1.437 | 50.8% | 38.4% | 0.56 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 73 | -1.484 | 38.4% | 28.1% | 0.52 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 16 | -0.875 | 31.2% | 14.2% | 0.47 |
| **WARN** | `vol_surge_detector` | `GBP_USD` | 14 | -2.550 | 21.4% | 7.6% | 0.15 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 12 | -2.492 | 66.7% | 39.1% | 0.51 |
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 11 | -1.064 | 72.7% | 43.4% | 0.76 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 39 | -1.190 | 61.5% | 45.9% | 0.59 |
...
| OK | `donchian_momentum_breakout` | `AUD_JPY` | 9 | 5 | 4 | -6.000 | 55.6% | 26.7%-81.1% | 0.30 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `donchian_momentum_breakout` | `AUD_USD` | 7 | 3 | 4 | -3.500 | 42.9% | 15.8%-75.0% | 0.44 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `dt_bb_rsi_mr` | `USD_JPY` | 5 | 3 | 2 | -0.960 | 60.0% | 23.1%-88.2% | 0.62 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 16 | 8 | 8 | -3.337 | 50.0% | 28.0%-72.0% | 0.32 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `dt_sr_channel_reversal` | `EUR_USD` | 15 | 8 | 7 | +0.507 | 53.3% | 30.1%-75.2% | 1.22 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ema200_trend_reversal` | `USD_JPY` | 13 | 8 | 5 | +0.531 | 61.5% | 35.5%-82.3% | 1.21 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_cross` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_CROSS_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_pullback` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_PULLBACK_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_ribbon_ride` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_RIBBON_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `ema_trend_scalp` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `EMA_TREND_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `engulfing_bb` | `EUR_USD` | 75 | 16 | 59 | -1.817 | 21.3% | 13.6%-31.9% | 0.18 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 28 | 9 | 19 | -1.314 | 32.1% | 17.9%-50.7% | 0.56 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `htf_false_breakout` | `EUR_JPY` | 1 | 1 | 0 | +7.800 | 100.0% | 20.7%-100.0% | n/a | `HTF_FALSE_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 22 | 9 | 13 | -2.459 | 40.9% | 23.3%-61.3% | 0.29 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `london_breakout` | `EUR_USD` | 19 | 5 | 14 | -1.947 | 26.3% | 11.8%-48.8% | 0.15 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `london_breakout` | `GBP_USD` | 46 | 15 | 31 | -2.250 | 32.6% | 20.9%-47.0% | 0.29 | `LONDON_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 51 | 25 | 26 | -0.341 | 49.0% | 35.9%-62.3% | 0.86 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `GBP_USD` | 16 | 8 | 8 | -2.244 | 50.0% | 28.0%-72.0% | 0.46 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 22 | 13 | 9 | -0.955 | 59.1% | 38.7%-76.7% | 0.76 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `EUR_JPY` | 38 | 21 | 17 | -2.924 | 55.3% | 39.7%-69.9% | 0.47 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `GBP_JPY` | 29 | 13 | 16 | -6.824 | 44.8% | 28.4%-62.5% | 0.19 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `EUR_USD` | 13 | 5 | 8 | -0.977 | 38.5% | 17.7%-64.5% | 0.45 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `GBP_USD` | 7 | 1 | 6 | -4.186 | 14.3% | 2.6%-51.3% | 0.07 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `USD_JPY` | 10 | 6 | 4 | +1.480 | 60.0% | 31.3%-83.2% | 1.97 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `tokyo_nakane_momentum` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `TOKYO_NAKANE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `tokyo_range_breakout_up` | `-` | 0 | 0 | 0 | +0.000 | 0.0% | 0.0%-0.0% | n/a | `TOKYO_RANGE_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `trend_rebound` | `EUR_USD` | 11 | 4 | 7 | +0.155 | 36.4% | 15.2%-64.6% | 1.08 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 59 | 30 | 29 | -1.437 | 50.8% | 38.4%-63.2% | 0.56 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 73 | 28 | 45 | -1.484 | 38.4% | 28.1%-49.8% | 0.52 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 16 | 5 | 11 | -0.875 | 31.2% | 14.2%-55.6% | 0.47 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `GBP_USD` | 14 | 3 | 11 | -2.550 | 21.4% | 7.6%-47.6% | 0.15 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `AUD_JPY` | 9 | 0 | 9 | -7.622 | 0.0% | 0.0%-29.9% | 0.00 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 11 | 8 | 3 | -1.064 | 72.7% | 43.4%-90.3% | 0.76 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 39 | 24 | 15 | -1.190 | 61.5% | 45.9%-75.1% | 0.59 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `GBP_USD` | 57 | 44 | 13 | +1.533 | 77.2% | 64.8%-86.2% | 1.72 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `xs_momentum` | `USD_JPY` | 51 | 31 | 20 | +0.376 | 60.8% | 47.1%-73.0% | 1.08 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
