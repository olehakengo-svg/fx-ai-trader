# SHADOW_PROMOTE R2 Alert - 2026-09-24T16:30:19.653376+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `EUR_JPY` | 53 | -3.583 | 41.5% | 29.3% | 0.39 |
...
| **WARN** | `three_bar_reversal` | `USD_JPY` | 25 | -1.036 | 32.0% | 17.2% | 0.64 |
| **WARN** | `trend_rebound` | `USD_JPY` | 11 | -1.073 | 45.5% | 21.3% | 0.46 |
| **WARN** | `trendline_sweep` | `EUR_USD` | 11 | -0.373 | 54.5% | 28.0% | 0.91 |
| **CRITICAL** | `trendline_sweep` | `GBP_USD` | 32 | -2.341 | 59.4% | 42.3% | 0.32 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 22 | -2.700 | 13.6% | 4.7% | 0.04 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 56 | -2.114 | 50.0% | 37.3% | 0.57 |
...
| CRITICAL | `dt_sr_channel_reversal` | `EUR_JPY` | 53 | 22 | 31 | -3.583 | 41.5% | 29.3%-54.9% | 0.39 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `three_bar_reversal` | `USD_JPY` | 25 | 8 | 17 | -1.036 | 32.0% | 17.2%-51.6% | 0.64 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `trendline_sweep` | `GBP_USD` | 32 | 19 | 13 | -2.341 | 59.4% | 42.3%-74.5% | 0.32 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 22 | 3 | 19 | -2.700 | 13.6% | 4.7%-33.3% | 0.04 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 56 | 28 | 28 | -2.114 | 50.0% | 37.3%-62.7% | 0.57 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
