# SHADOW_PROMOTE R2 Alert - 2026-08-31T12:42:21.724505+00:00
...
| **WARN** | `dt_bb_rsi_mr` | `USD_JPY` | 20 | -0.880 | 55.0% | 34.2% | 0.73 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 11 | -2.373 | 9.1% | 1.6% | 0.06 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 26 | -2.615 | 30.8% | 16.5% | 0.50 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 23 | -0.570 | 43.5% | 25.6% | 0.79 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | -4.515 | 48.1% | 30.7% | 0.31 |
...
| **CRITICAL** | `sr_break_retest` | `AUD_JPY` | 40 | -2.100 | 47.5% | 32.9% | 0.53 |
...
| **WARN** | `vol_surge_detector` | `EUR_USD` | 22 | -1.059 | 22.7% | 10.1% | 0.48 |
| **WARN** | `vol_surge_detector` | `USD_JPY` | 13 | -1.415 | 30.8% | 12.7% | 0.58 |
| **CRITICAL** | `wick_imbalance_reversion` | `AUD_JPY` | 48 | -0.088 | 56.2% | 42.3% | 0.98 |
| **WARN** | `wick_imbalance_reversion` | `EUR_JPY` | 26 | -2.408 | 50.0% | 32.1% | 0.56 |
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 25 | -3.232 | 36.0% | 20.2% | 0.26 |
...
| WARN | `dt_bb_rsi_mr` | `USD_JPY` | 20 | 11 | 9 | -0.880 | 55.0% | 34.2%-74.2% | 0.73 | `DT_BB_RSI_MR_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 26 | 8 | 18 | -2.615 | 30.8% | 16.5%-50.0% | 0.50 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 23 | 10 | 13 | -0.570 | 43.5% | 25.6%-63.2% | 0.79 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 27 | 13 | 14 | -4.515 | 48.1% | 30.7%-66.0% | 0.31 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `lin_reg_channel` | `EUR_USD` | 6 | 3 | 3 | -0.133 | 50.0% | 18.8%-81.2% | 0.94 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `AUD_JPY` | 40 | 19 | 21 | -2.100 | 47.5% | 32.9%-62.5% | 0.53 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `three_bar_reversal` | `EUR_USD` | 7 | 1 | 6 | -1.429 | 14.3% | 2.6%-51.3% | 0.32 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `GBP_USD` | 5 | 1 | 4 | -2.720 | 20.0% | 3.6%-62.4% | 0.36 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `three_bar_reversal` | `USD_JPY` | 25 | 13 | 12 | +0.676 | 52.0% | 33.5%-70.0% | 1.34 | `THREE_BAR_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `tokyo_nakane_momentum` | `AUD_JPY` | 4 | 2 | 2 | -0.825 | 50.0% | 15.0%-85.0% | 0.85 | `TOKYO_NAKANE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `trend_rebound` | `EUR_USD` | 7 | 4 | 3 | +1.857 | 57.1% | 25.0%-84.2% | 3.95 | `TREND_REBOUND_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `vol_surge_detector` | `EUR_USD` | 22 | 5 | 17 | -1.059 | 22.7% | 10.1%-43.4% | 0.48 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `wick_imbalance_reversion` | `AUD_JPY` | 48 | 27 | 21 | -0.088 | 56.2% | 42.3%-69.3% | 0.98 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 25 | 9 | 16 | -3.232 | 36.0% | 20.2%-55.5% | 0.26 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
