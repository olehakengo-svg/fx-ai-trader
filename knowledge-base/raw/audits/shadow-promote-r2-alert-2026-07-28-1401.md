# SHADOW_PROMOTE R2 Alert - 2026-07-28T14:01:48.550940+00:00
...
| **WARN** | `dt_sr_channel_reversal` | `AUD_JPY` | 27 | -0.126 | 59.3% | 40.7% | 0.95 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 23 | -0.526 | 47.8% | 29.2% | 0.77 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_JPY` | 20 | -3.055 | 50.0% | 29.9% | 0.29 |
| **WARN** | `dt_sr_channel_reversal` | `EUR_USD` | 17 | -1.059 | 47.1% | 26.2% | 0.52 |
| **WARN** | `dt_sr_channel_reversal` | `GBP_JPY` | 24 | -1.708 | 62.5% | 42.7% | 0.53 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 84 | -1.210 | 34.5% | 25.2% | 0.40 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 29 | -1.124 | 41.4% | 25.5% | 0.57 |
| **WARN** | `lin_reg_channel` | `EUR_USD` | 22 | -1.782 | 50.0% | 30.7% | 0.36 |
...
| **CRITICAL** | `ma_regime_switch` | `USD_JPY` | 53 | -1.034 | 35.8% | 24.3% | 0.48 |
...
| **WARN** | `sr_break_retest` | `GBP_JPY` | 29 | -4.252 | 62.1% | 44.0% | 0.32 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 43 | -1.458 | 55.8% | 41.1% | 0.55 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 22 | -3.627 | 40.9% | 23.3% | 0.24 |
...
| **WARN** | `trendline_sweep` | `GBP_USD` | 13 | -2.992 | 69.2% | 42.4% | 0.25 |
| **CRITICAL** | `vol_momentum_scalp` | `USD_JPY` | 70 | -1.366 | 37.1% | 26.8% | 0.39 |
| **WARN** | `vol_surge_detector` | `EUR_USD` | 20 | -1.630 | 30.0% | 14.5% | 0.30 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_JPY` | 14 | -2.371 | 64.3% | 38.8% | 0.57 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 34 | -2.150 | 55.9% | 39.5% | 0.39 |
...
| OK | `donchian_momentum_breakout` | `USD_JPY` | 9 | 6 | 3 | +1.644 | 66.7% | 35.4%-87.9% | 1.42 | `DONCHIAN_MOMENTUM_BREAKOUT_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `dt_sr_channel_reversal` | `AUD_JPY` | 27 | 16 | 11 | -0.126 | 59.3% | 40.7%-75.5% | 0.95 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 23 | 11 | 12 | -0.526 | 47.8% | 29.2%-67.0% | 0.77 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_JPY` | 20 | 10 | 10 | -3.055 | 50.0% | 29.9%-70.1% | 0.29 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `EUR_USD` | 17 | 8 | 9 | -1.059 | 47.1% | 26.2%-69.0% | 0.52 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `dt_sr_channel_reversal` | `GBP_JPY` | 24 | 15 | 9 | -1.708 | 62.5% | 42.7%-78.8% | 0.53 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 84 | 29 | 55 | -1.210 | 34.5% | 25.2%-45.2% | 0.40 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 29 | 12 | 17 | -1.124 | 41.4% | 25.5%-59.3% | 0.57 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `lin_reg_channel` | `EUR_USD` | 22 | 11 | 11 | -1.782 | 50.0% | 30.7%-69.3% | 0.36 | `LIN_REG_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `ma_regime_switch` | `USD_JPY` | 53 | 19 | 34 | -1.034 | 35.8% | 24.3%-49.3% | 0.48 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_JPY` | 29 | 18 | 11 | -4.252 | 62.1% | 44.0%-77.3% | 0.32 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 43 | 24 | 19 | -1.458 | 55.8% | 41.1%-69.6% | 0.55 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 22 | 9 | 13 | -3.627 | 40.9% | 23.3%-61.3% | 0.24 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `trendline_sweep` | `GBP_USD` | 13 | 9 | 4 | -2.992 | 69.2% | 42.4%-87.3% | 0.25 | `TRENDLINE_SWEEP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `USD_JPY` | 70 | 26 | 44 | -1.366 | 37.1% | 26.8%-48.9% | 0.39 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `vol_surge_detector` | `EUR_USD` | 20 | 6 | 14 | -1.630 | 30.0% | 14.5%-51.9% | 0.30 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_JPY` | 14 | 9 | 5 | -2.371 | 64.3% | 38.8%-83.7% | 0.57 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 34 | 19 | 15 | -2.150 | 55.9% | 39.5%-71.1% | 0.39 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
