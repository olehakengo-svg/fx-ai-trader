# SHADOW_PROMOTE R2 Alert - 2026-07-15T02:13:23.126275+00:00
...
| **WARN** | `squeeze_release_momentum` | `GBP_USD` | 15 | -3.367 | 53.3% | 30.1% | 0.23 |
| **WARN** | `sr_anti_hunt_bounce` | `GBP_JPY` | 14 | -9.607 | 42.9% | 21.4% | 0.13 |
| **WARN** | `sr_break_retest` | `AUD_JPY` | 10 | -3.400 | 50.0% | 23.7% | 0.21 |
...
| OK | `ema200_trend_reversal` | `USD_JPY` | 18 | 10 | 8 | +0.000 | 55.6% | 33.7%-75.4% | 1.00 | `EMA200_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE`<br>`EMA200_TREND_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `squeeze_release_momentum` | `GBP_USD` | 15 | 8 | 7 | -3.367 | 53.3% | 30.1%-75.2% | 0.23 | `SQUEEZE_RELEASE_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `AUD_JPY` | 10 | 5 | 5 | -3.400 | 50.0% | 23.7%-76.3% | 0.21 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 8 | 5 | 3 | -0.487 | 62.5% | 30.6%-86.3% | 0.82 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
