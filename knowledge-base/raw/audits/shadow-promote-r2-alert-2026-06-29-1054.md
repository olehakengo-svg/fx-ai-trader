# SHADOW_PROMOTE R2 Alert - 2026-06-29T10:54:23.522015+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **WARN** | `dt_sr_channel_reversal` | `EUR_GBP` | 12 | -2.333 | 25.0% | 8.9% | 0.14 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 83 | -1.048 | 38.6% | 28.8% | 0.50 |
...
| **CRITICAL** | `sr_break_retest` | `GBP_JPY` | 40 | -3.042 | 62.5% | 47.0% | 0.47 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 47 | -2.413 | 51.1% | 37.2% | 0.41 |
| **WARN** | `sr_break_retest` | `USD_JPY` | 23 | -0.222 | 60.9% | 40.8% | 0.91 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 36 | -0.769 | 52.8% | 37.0% | 0.66 |
...
| **CRITICAL** | `vol_momentum_scalp` | `GBP_USD` | 38 | -3.424 | 23.7% | 13.0% | 0.15 |
...
| **WARN** | `xs_momentum` | `EUR_USD` | 27 | -3.296 | 48.1% | 30.7% | 0.38 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 31 | -3.961 | 58.1% | 40.8% | 0.29 |
...
| WARN | `dt_sr_channel_reversal` | `EUR_GBP` | 12 | 3 | 9 | -2.333 | 25.0% | 8.9%-53.2% | 0.14 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 83 | 32 | 51 | -1.048 | 38.6% | 28.8%-49.3% | 0.50 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `intraday_seasonality` | `EUR_GBP` | 4 | 3 | 1 | +4.425 | 75.0% | 30.1%-95.4% | 3.13 | `ALPHA_INTRADAY_SEASONALITY_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_break_retest` | `GBP_JPY` | 40 | 25 | 15 | -3.042 | 62.5% | 47.0%-75.8% | 0.47 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 47 | 24 | 23 | -2.413 | 51.1% | 37.2%-64.7% | 0.41 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `sr_break_retest` | `USD_JPY` | 23 | 14 | 9 | -0.222 | 60.9% | 40.8%-77.8% | 0.91 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 36 | 19 | 17 | -0.769 | 52.8% | 37.0%-68.0% | 0.66 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `vol_momentum_scalp` | `GBP_USD` | 38 | 9 | 29 | -3.424 | 23.7% | 13.0%-39.2% | 0.15 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
| OK | `vol_momentum_scalp` | `USD_JPY` | 5 | 2 | 3 | +0.960 | 40.0% | 11.8%-76.9% | 1.92 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `EUR_USD` | 27 | 13 | 14 | -3.296 | 48.1% | 30.7%-66.0% | 0.38 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 31 | 18 | 13 | -3.961 | 58.1% | 40.8%-73.6% | 0.29 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
