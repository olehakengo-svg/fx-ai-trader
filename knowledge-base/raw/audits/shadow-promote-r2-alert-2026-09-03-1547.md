# SHADOW_PROMOTE R2 Alert - 2026-09-03T15:47:06.735643+00:00
...
| **CRITICAL** | `dt_sr_channel_reversal` | `GBP_USD` | 33 | -2.397 | 33.3% | 19.8% | 0.29 |
...
| **WARN** | `wick_imbalance_reversion` | `GBP_USD` | 25 | -3.460 | 32.0% | 17.2% | 0.25 |
| **WARN** | `xs_momentum` | `GBP_USD` | 10 | -5.830 | 30.0% | 10.8% | 0.06 |
| **WARN** | `xs_momentum` | `USD_JPY` | 20 | -6.425 | 45.0% | 25.8% | 0.36 |
...
| CRITICAL | `dt_sr_channel_reversal` | `GBP_USD` | 33 | 11 | 22 | -2.397 | 33.3% | 19.8%-50.4% | 0.29 | `DT_SR_CHANNEL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `engulfing_bb` | `EUR_USD` | 2 | 1 | 1 | -0.050 | 50.0% | 9.5%-90.5% | 0.89 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `ma_regime_switch` | `USD_JPY` | 2 | 0 | 2 | -5.500 | 0.0% | 0.0%-65.8% | 0.00 | `MA_REGIME_SWITCH_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `sr_break_retest` | `EUR_JPY` | 3 | 2 | 1 | -1.167 | 66.7% | 20.8%-93.9% | 0.74 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `v_reversal` | `USD_JPY` | 4 | 1 | 3 | -0.350 | 25.0% | 4.6%-69.9% | 0.81 | `V_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_momentum_scalp` | `USD_JPY` | 1 | 0 | 1 | -3.400 | 0.0% | 0.0%-79.3% | 0.00 | `VOL_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE`<br>`VOL_MOMENTUM_SCALP_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `wick_imbalance_reversion` | `EUR_USD` | 10 | 6 | 4 | +1.540 | 60.0% | 31.3%-83.2% | 1.55 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `wick_imbalance_reversion` | `GBP_USD` | 25 | 8 | 17 | -3.460 | 32.0% | 17.2%-51.6% | 0.25 | `ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE`<br>`WICK_IMBALANCE_REVERSION_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `xs_momentum` | `GBP_USD` | 10 | 3 | 7 | -5.830 | 30.0% | 10.8%-60.3% | 0.06 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `xs_momentum` | `USD_JPY` | 20 | 9 | 11 | -6.425 | 45.0% | 25.8%-65.8% | 0.36 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
