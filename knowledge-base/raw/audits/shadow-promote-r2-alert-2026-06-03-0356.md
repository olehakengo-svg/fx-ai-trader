# SHADOW_PROMOTE R2 Alert - 2026-06-03T03:56:17.613324+00:00
...
|---|---|---|---:|---:|---:|---:|---:|
| **CRITICAL** | `bb_rsi_reversion` | `USD_CHF` | 42 | -2.321 | 0.0% | 0.0% | 0.00 |
...
| **CRITICAL** | `engulfing_bb` | `EUR_USD` | 32 | -0.597 | 28.1% | 15.6% | 0.74 |
| **WARN** | `engulfing_bb` | `GBP_USD` | 16 | -2.481 | 12.5% | 3.5% | 0.31 |
...
| **WARN** | `ob_retest` | `GBP_USD` | 12 | -4.058 | 33.3% | 13.8% | 0.40 |
...
| **WARN** | `sr_break_retest` | `GBP_JPY` | 29 | -5.097 | 13.8% | 5.5% | 0.38 |
| **CRITICAL** | `sr_break_retest` | `GBP_USD` | 61 | -1.313 | 29.5% | 19.6% | 0.70 |
| **CRITICAL** | `sr_break_retest` | `USD_JPY` | 39 | -1.626 | 17.9% | 9.0% | 0.63 |
| **CRITICAL** | `sr_channel_reversal` | `GBP_USD` | 46 | -1.207 | 21.7% | 12.3% | 0.59 |
| **CRITICAL** | `sr_channel_reversal` | `USD_CHF` | 33 | -1.655 | 3.0% | 0.5% | 0.17 |
| **CRITICAL** | `sr_fib_confluence` | `EUR_USD` | 83 | -0.958 | 31.3% | 22.4% | 0.74 |
| **CRITICAL** | `sr_fib_confluence` | `GBP_USD` | 83 | -6.160 | 8.4% | 4.1% | 0.15 |
...
| **CRITICAL** | `xs_momentum` | `EUR_USD` | 47 | -7.323 | 10.6% | 4.6% | 0.11 |
| **CRITICAL** | `xs_momentum` | `GBP_USD` | 35 | -2.454 | 25.7% | 14.2% | 0.66 |
...
| CRITICAL | `bb_rsi_reversion` | `USD_CHF` | 42 | 0 | 42 | -2.321 | 0.0% | 0.0%-8.4% | 0.00 | `BB_RSI_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `engulfing_bb` | `EUR_USD` | 32 | 9 | 23 | -0.597 | 28.1% | 15.6%-45.4% | 0.74 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
| WARN | `engulfing_bb` | `GBP_USD` | 16 | 2 | 14 | -2.481 | 12.5% | 3.5%-36.0% | 0.31 | `ENGULFING_BB_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `ob_retest` | `GBP_USD` | 12 | 4 | 8 | -4.058 | 33.3% | 13.8%-60.9% | 0.40 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| WARN | `sr_break_retest` | `GBP_JPY` | 29 | 4 | 25 | -5.097 | 13.8% | 5.5%-30.6% | 0.38 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `GBP_USD` | 61 | 18 | 43 | -1.313 | 29.5% | 19.6%-41.9% | 0.70 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_break_retest` | `USD_JPY` | 39 | 7 | 32 | -1.626 | 17.9% | 9.0%-32.7% | 0.63 | `SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `sr_channel_reversal` | `GBP_USD` | 46 | 10 | 36 | -1.207 | 21.7% | 12.3%-35.6% | 0.59 | `SR_CHANNEL_REVERSAL_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `sr_fib_confluence` | `GBP_USD` | 83 | 7 | 76 | -6.160 | 8.4% | 4.1%-16.4% | 0.15 | `SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| OK | `vol_surge_detector` | `EUR_USD` | 7 | 1 | 6 | -2.771 | 14.3% | 2.6%-51.3% | 0.30 | `VOL_SURGE_REDESIGN_V2_SHADOW_PROMOTE` |
...
| CRITICAL | `xs_momentum` | `EUR_USD` | 47 | 5 | 42 | -7.323 | 10.6% | 4.6%-22.6% | 0.11 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
| CRITICAL | `xs_momentum` | `GBP_USD` | 35 | 9 | 26 | -2.454 | 25.7% | 14.2%-42.1% | 0.66 | `XS_MOMENTUM_REDESIGN_V2_SHADOW_PROMOTE` |
