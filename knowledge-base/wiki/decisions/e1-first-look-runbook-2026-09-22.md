...
#      受容するなら (b) に --ohlcv-max-gap-bars N を明示 (manifest に残り verdict に併記)
python3 -B tools/e1_positioning_frozen_export.py --preflight-only
