...
| event 年 | events | hit | J |
|---|---:|---:|---:|
| 2022 (鈴木期) | 2 | 2 | **0.2494** |
| 2026 (片山期) | 5 | 1 | **0.0484** |

pass-1 で「2022 の 2 本だけで結論が反転しないか点検せよ」と書いた。点検結果は
**全体 J のほぼ全てを 2022 の 2 event が担っている**。検出器は「介入前の梯子」ではなく
せいぜい 2022 のエスカレーションの記述。リードは 15 営業日 (2022-09-29→10-21) と
3 営業日 (2026-04-24→04-30)、7 event 中 5 が false alarm。
