...
- [[vwap-mr-jpy-reconfirmation-2026-04-22]] — vwap_mean_reversion × {EUR_JPY, GBP_JPY} PAIR_PROMOTED 維持判断（fresh 365d × 15m BT で walk-forward 全窓正 EV を再確証）
- [[memory-system-claude-mem-2026-04-24]] — claude-mem 導入 (Option B): global install + fx-ai-trader では on-demand 検索のみ、KB は single source of truth 維持
