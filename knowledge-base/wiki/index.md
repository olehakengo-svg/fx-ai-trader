...
- 現在: **DD防御0.2x** (DD=🔴🔴🔴**100.01%** — **100%バリア突破 (first time)**, defensive mode — 2026-07-07) → 月利47%（BT推定、クリーンデータ蓄積中）
...
- Defensive mode: **0.2x** (DD=🔴🔴🔴**100.01%** / 1000.1pip — **100% BARRIER BREACHED (first time)** (+0.68pp vs 07-06's 99.33%, slow grind — 2-loss/−9.2pip window), eq_current=−$983.2 vs peak +$16.9 — Render API 2026-07-07. 30d Kelly=0.0% overall-edge (risk dash)=**-30.79%** (⚠️ **WORSENED −1.16pp vs 07-06's -29.63%** — broke the multi-window "eased on roll" pattern; the 2 fresh losses exceeded what aged out); prev snapshot 07-06 DD 99.33% / edge -29.63%)
...
- Ruin probability: **0.0%** ✅ (MC sims — Render API 2026-07-07; worst-case DD99=**215.76** (widened vs 212.58); median final eq=**838.83**/init 1000, vs 841.04) — 実現 ruin が 0% なのは 0.2× lot cap のみによる (原エッジは負のまま)
- Aggregate Kelly: **0.0%** ⚠️⚠️⚠️ (overall edge (risk dash)=**-30.79%** ⚠️ WORSENED vs 07-06's -29.63% — 2 fresh losses exceeded roll-off; DSR=0.0/haircut 100%/Sharpe -0.408; net -251.8/friction 4.02 per-trade; GBP_USD #1 30d drag -136.7 n=39; TRUE_LIVE SSOT: N=371 raw=-0.69. only bb_rsi_reversion shows +edge (Kelly +0.158, n=11). 🟢 agg-kelly gate remains the active safety net — 1 live fill #549086 passed & filled this window, 0 blocked)
...
- Last updated: 2026-07-07 (wiki-daily-update auto; N=**558** +2 fills **0W/2L** = −9.2pip; PnL −540.7/DD 🔴🔴🔴**100.01%** — **100% BARRIER BREACHED first time** (+0.68pp, eq −$983.2 vs peak +$16.9, slow grind); overall edge **-30.79%** ⚠️ WORSENED −1.16pp (2 fresh losses > roll-off); 🟢 **1 confirmed live fill #549086** dt_bb_rsi_mr/daytrade_gbpusd GBP_USD 1000u (open) — first since 06-24; 28 shadow/0 blocked/0 false-sent); prev: 2026-07-06
