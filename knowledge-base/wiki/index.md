...
- Defensive mode: **0.2x** (DD=**98.2%** / 982.0pip — ⚠️⚠️⚠️ **NEW HIGH — 100%接近** (+7.65pp vs 06-25 evening's 90.55%), eq_current=−$965.1 — Render API 2026-07-02; DD/eq **unchanged in evening re-run**. 30d Kelly=0.0% edge=**-35.72%** (evening re-run n=109; morning n=112 was -37.03% — window-roll eased +1.31pp, NOT a real edge gain; still ⚠️ 7th deteriorating window); prev snapshot 06-25 evening DD 90.55% / edge -27.77%)
...
- Last updated: 2026-07-02 **evening re-run** (wiki-daily-update auto, 2nd same-day run; N=542 **0 new fills**/DD 98.2% flat ⚠️⚠️⚠️ NEW HIGH; 30d window rolled n=112→109, edge -37.03→-35.72% eased; false-`sent` corrected); morning run same day; prev full: 2026-06-25 evening
