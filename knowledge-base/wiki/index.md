...
<!-- KB_PORTFOLIO_START -->
## Current Portfolio (auto-synced, 2026-07-28)
...
- Defensive mode: **0.2x** (DD=🔴🔴🔴**100.01%** / 1000.1pip — **100% barrier HELD, no new high** (flat vs 07-07 — 0 closed fills moved the book), eq_current=−$983.2 vs peak +$16.9 — Render API 2026-07-08. 30d Kelly=0.0% overall-edge (risk dash)=**-30.1%** (EASED +0.69pp vs 07-07's -30.79% — window-roll only, one EUR_JPY loser aged out, NOT a real edge gain); prev snapshot 07-07 DD 100.01% / edge -30.79%)
...
- Aggregate Kelly: **0.0%** ⚠️⚠️⚠️ (overall edge (risk dash)=**-30.1%** EASED +0.69pp vs 07-07's -30.79% — window-roll only (EUR_JPY loser aged out); DSR=0.0/haircut 100%/Sharpe -0.399; net -244.3/friction 4.01 per-trade; GBP_USD #1 30d drag -136.7 n=39; TRUE_LIVE SSOT: N=371 raw=-0.69. only bb_rsi_reversion shows +edge (Kelly +0.158, n=11). 🟢 agg-kelly gate remains the active safety net — 0 live fills this window, **1 blocked** (vsg_jpy_reversal EUR_JPY, agg_kelly=-0.333<0))
...
- Last updated: 2026-07-27 (wiki-daily-update auto; N=**563** **flat, 0 closed fills — 5th consecutive snapshot** since 07-16; PnL −552.7/DD 🔴🔴🔴**100.8%** — **100% barrier HELD, no new high** (book static); overall edge (risk dash) **−25.69%** eased +7.34pp vs 07-24 (window-roll only — net-negative 9-trade cohort aged out, n 47→38, NOT a real edge gain); ⚪ **0 live fills / 0 agg-kelly blocks / 0 false-sent**; 30 shadow; shadow_count 10,345→**10,456 (+111)**; ruin 0.0%; MC tail narrowed (worst DD99 170.0, median final eq 881.0); see [[2026-07-27]]); prev: 2026-07-24. ⚠️ **The System State body below remains stale at 2026-07-08 (N=558/−540.7/100.01%)** — the deep narrative reconciliation is tracked as a separate item; the current-state figures are the ones in this line + Session History top entry.
