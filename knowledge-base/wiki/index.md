...
- 現在: **DD防御0.2x** (DD=🔴🔴🔴**100.8%** — **100%バリア超え NEW HIGH** (+0.79pp vs 07-08、2損失で barrier 突破・held ではなくなった), defensive mode — 2026-07-13) → 月利47%（BT推定、クリーンデータ蓄積中）
...
- Defensive mode: **0.2x** (DD=🔴🔴🔴**100.8%** / 1008.0pip — **100% barrier EXCEEDED, NEW HIGH** (+0.79pp vs 07-08 — 2 closed losses pushed past the barrier that held flat on 07-08), eq_current=−$991.1 vs peak +$16.9 — Render API 2026-07-13, **5-day cadence gap 07-09→07-12**. 30d Kelly=0.0% overall-edge (risk dash)=**-40.0%** (**WORSENED −9.9pp vs 07-08's -30.1%** — per-trade −2.63→−3.52, window shrank n 93→64 dominated by worse recent trades, NOT window-roll easing); prev snapshot 07-08 DD 100.01% / edge -30.1%)
...
- Ruin probability: **0.0%** ✅ (MC sims — Render API 2026-07-08; worst-case DD99=**213.16** (narrowed vs 215.76); median final eq=**842.39**/init 1000, vs 838.83) — 実現 ruin が 0% なのは 0.2× lot cap のみによる (原エッジは負のまま)
- Aggregate Kelly: **0.0%** ⚠️⚠️⚠️ (overall edge (risk dash)=**-40.0%** WORSENED −9.9pp vs 07-08's -30.1% — per-trade −2.63→−3.52, window shrank n 93→64 (5-day gap aged out better older cohort), NOT window-roll; DSR=0.0/haircut 100%/Sharpe -0.553; net -225.6/friction 4.04 per-trade (n=64); GBP_USD #1 30d drag -99.9 n=25; TRUE_LIVE SSOT: N=371 raw=-0.69. no positive-edge strategy this window. 🟢 agg-kelly gate remains the active safety net — 0 live fills / **0 blocked** this window (no signal reached the gate; all shadow_tracking))
...
- Last updated: 2026-07-13 (wiki-daily-update auto; **5-day cadence gap 07-09→07-12**, cumulative delta; N=**560** **+2 fills 0W/2L**; PnL −556.4 (−15.7)/DD 🔴🔴🔴**100.8%** — **100% barrier EXCEEDED, NEW HIGH** +0.79pp; overall edge **-40.0%** WORSENED −9.9pp (per-trade −2.63→−3.52, window shrank n 93→64, NOT window-roll); ⚪ **0 live fills / 0 blocked** (all shadow_tracking, nothing reached the gate); 30 shadow/0 false-sent; MC tail widened (worst DD99 264.3, median final eq 788.65); shadow_count 9,304 +334); prev: 2026-07-08
