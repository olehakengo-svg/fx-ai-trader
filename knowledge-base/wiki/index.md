...
<!-- KB_PORTFOLIO_START -->
## Current Portfolio (auto-synced, 2026-08-23)
...
- Defensive mode: **0.2x** (DD=🔴🔴🔴**1218.9pip = 121.9%** on the legacy $1000 pip basis — **NEW HIGH again, +9.8pip vs 08-20's 1209.1pip/120.9%**, eq_current=−$1202.0 vs peak +$16.9 — Render API 2026-08-23. 30d Kelly=0.0%, overall-edge (risk dash)=**−26.46%** (🟢 eased +5.55pp vs 08-20's −32.01% — **window-roll arithmetic, not an edge gain**: the risk window went n=10→15 so the same 2 AUD_JPY disasters average over 5 more trades; risk-window WR flat at 40.0%); prev snapshot 08-20 DD 1209.1pip / edge −32.01%)
