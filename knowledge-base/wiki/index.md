...
- 現在: **DD防御0.2x** (DD=**98.97%** ⚠️⚠️⚠️ NEW HIGH — 100%接近 (<$28), defensive mode — 2026-07-03) → 月利47%（BT推定、クリーンデータ蓄積中）
...
- Defensive mode: **0.2x** (DD=**98.97%** / 989.7pip — ⚠️⚠️⚠️ **NEW HIGH — 100%接近 (<$28 from −$1000)** (+0.77pp vs 07-02's 98.2%, slow grind not spike), eq_current=−$972.8 — Render API 2026-07-03. 30d Kelly=0.0% edge=**-32.3%** (n=99; 07-02 evening n=109 was -35.72% — window-roll eased +3.42pp as USD_CHF + early-June trades aged out, NOT a real edge gain; realized DD hit new high same day); prev snapshot 07-02 DD 98.2% / edge -35.72%)
...
- Ruin probability: **0.0%** ✅ (MC sims — Render API 2026-07-03; median max DD(MC)=**172.3%** (>100%, ≈flat vs 175.08), worst-case DD99=**226.36%** (≈flat vs 227.92); median final eq=829.38/init 1000)
- Aggregate Kelly: **0.0%** ⚠️⚠️⚠️ (30d edge=-32.3%, WR=53.54%, odds 0.265 — eased +3.42pp on window-roll n 109→99, NOT real edge gain; DSR=0.0/haircut 100%/Sharpe -0.435/trials 15/n=99; TRUE_LIVE SSOT: N=371 raw=-0.69. 🟢 agg-kelly gate correctly blocked 1 live entry today `agg_kelly=-0.326<0`)
...
- Last updated: 2026-07-03 (wiki-daily-update auto; N=**555** +13 fills **9W/4L/0BE ≈69% decided WR** — best W/L mix in recent log; PnL −527.9 (−6.8pip mild)/DD **98.97%** ⚠️⚠️⚠️ NEW HIGH (+0.77pp, <$28 from −$1000, slow grind); 30d edge -32.3% eased on window-roll n 109→99; 🟢 agg-kelly gate blocked 1 live entry); prev: 2026-07-02 evening re-run
