...
- Ruin probability: **0.0%** ✅ (MC sims — Render API 2026-07-06; worst-case DD99=**212.58** (eased vs 226.36); median final eq=**841.04**/init 1000, marginally better vs 829.38)
- Aggregate Kelly: **0.0%** ⚠️⚠️⚠️ (overall edge (risk dash)=-29.63%, eased vs 07-03's -32.3% on window-roll, NOT real edge gain; DSR=0.0/haircut 100%/Sharpe -0.398; net -242.6/friction 3.98 per-trade; TRUE_LIVE SSOT: N=371 raw=-0.69. 🟢 agg-kelly gate remains the active safety net — 0 live/0 blocked in 07-06 audit window, no signals reached it)
