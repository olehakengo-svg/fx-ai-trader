...
- 現在: **DD防御0.2x** (DD=🔴🔴🔴**100.8%** — **100%バリア超え、held flat**（07-13 で barrier 突破後、07-14 は 0 closed fills で NEW HIGH なし・deepening せず）, defensive mode — 2026-07-14) → 月利47%（BT推定、クリーンデータ蓄積中）
...
- Defensive mode: **0.2x** (DD=🔴🔴🔴**100.8%** / 1008.0pip — **100% barrier EXCEEDED, held flat** (no new high vs 07-13 — **0 closed fills 07-14**, book static so DD did not deepen), eq_current=−$991.1 vs peak +$16.9 — Render API 2026-07-14, cadence resumed. 30d Kelly=0.0% overall-edge (risk dash)=**-40.0%** (flat vs 07-13; per-trade −3.52, n=64 unchanged); prev snapshot 07-13 DD 100.8% / edge -40.0%)
...
- Last updated: 2026-07-14 (wiki-daily-update auto; **cadence resumed, single-day window**; N=**560** **FLAT — 0 closed fills** (243W/284L/33BE identical); PnL −556.4 (flat)/DD 🔴🔴🔴**100.8%** — **barrier stays exceeded, NO new high** (book didn't move); overall edge **-40.0%** flat; ⚪ **0 live fills / 0 blocked** (all 30 shadow_tracking); 0 false-sent; MC tail flat (worst DD99 264.3, median final eq 788.65); shadow_count 9,441 +137; audit total 12,272 +156); prev: 2026-07-13
