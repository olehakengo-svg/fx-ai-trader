...
| 18 | level_failed_break_d1 (wave-4 L-a) | **pre-reg 🔒 FROZEN 2026-07-31** — [[level-failed-break-d1-explore-prereg-2026-07-31]] (敵対的検証 12 条件解決済み: 全 DoF 単一値凍結 / two-pass headroom-first / ISO 週 block permutation / Poisson N floor 200 / e20 歴史 swap proxy / #11 別 family 宣言)。単独 wave m=1 | 測定中 (explore 2014-2021、TV per-event export) |
