...
| 17 | fx_quote_spread_state (W3-2) | **観測前凍結 2026-07-30** — [[fx-quote-spread-state-explore-prereg-2026-07-30]] (単独 wave m=1。敵対的検証 6 条件解決済み: probe 実在確認 7/7 HTTP200 / coverage assert 全 3 ペア×8 年 PASS skip ゼロ / **headroom 事前ゲート PASS 13.5× (fwd return 非接触、EUR 19.3×・GBP 10.7×・JPY 14.1×、反実仮想 onset-RT 5.9-9.5p)** / entry=正常化後凍結 / NY ローカル grid + DST 不整合日除外 / primary fwd 24h 1 本)。パネル = 78,000 サンプル (2013-10〜2026-07、valid 98.0%) | 凍結コミット後に測定 — explore 2014-2021 (usable N=65)、OOS 未接触 |
