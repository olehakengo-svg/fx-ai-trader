...
| 3 | weekend_gap | **OOS verdict 完了 2026-07-24 (単一実行、期日 7 日前倒し)** — [[weekend-gap-oos-prereg-2026-07-24]] §11 | ✅ **family PASS 候補 (arm B)** — pooled exGBP 4h: N=177/112wk、gross +15.60p (weekend-block p<1e-4)、stressed-net (−6.56p) **+9.04p**、headroom 24.8p≥21.9p、knife-edge 4/4 flip なし (DST/8×/12×/spike-revert 除外)。❌ arm A (EUR_USD 4h+12h IUT) は 12h p=0.1189 で BH 落ち → 当該 arm クローズ。shrinkage 予測と逆転 (arm B +75% 増幅)。**即 live 禁止 — §9 R1 手続き (日曜 spread ≥8 週末実測 → stage-2 執行 pre-reg → user 承認) へ** |
