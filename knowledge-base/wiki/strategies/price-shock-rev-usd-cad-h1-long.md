...
- 期間: data/cache/massive/USD_CAD_1h.parquet 全期間 (12.3y MASSIVE)
...
## 関連
- 実装: `strategies/hourly/price_shock_rev_usd_cad_h1_long.py` (base: `price_shock_reversion_base.py`, percentile=0.01 / horizon=3 / vol_q=Q5)
