...
- **Status**: FORCE_DEMOTED (v8.2: BT EV=-0.799 structural deficit) — v9.1 PAIR_PROMOTED 死コード削除; v9.x (2026-04-20) demo_db legacy override も削除
...
- PAIR_PROMOTED: **なし** (v9.1 で全削除, v9.x 2026-04-20 で demo_db legacy override も削除。Historical: USD_JPY 5m EV=+1.030 WR=90.9% / EUR_USD 1m EV=+0.473 WR=73.7%)
