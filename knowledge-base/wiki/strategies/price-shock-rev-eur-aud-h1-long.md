...
- 期間: data/cache/massive/EUR_AUD_1h.parquet 全期間 (12.3y MASSIVE)
...
- Shadow 実績 (sentinel by_type all-time, 2026-06-08 時点): N=0 (未発火)
...
- **Cross-pair 制約**: EUR_GBP ([[price-shock-rev-eur-gbp-h1-long]]) と shared lock — 同時 active position 1 個まで

## 関連
- 実装: `strategies/hourly/price_shock_rev_eur_aud_h1_long.py` (base: `price_shock_reversion_base.py`, percentile=0.01 / horizon=12 / vol_q=Q5)
