...
- **registry** (`prereg-trigger-registry.json`、80 → 90 entry): 新規 `review-backlog-sprint0922-p2-deferrals` (索引 10-17 + 期日別 sub-entry `-0927/-1003/-1006/-1008`; 旧記載 10-08 は Codex P2 で訂正、P2 巡目上限到達で未修正のまま繰延した 9 件 — 全て実欠陥、個別期日 09-27 / 10-03 / 10-06 / 10-17) / `ud1-gold-screen-check` (09-23、user) / `e1-first-look-freeze-due` (10-08) / `storm-guard-enforce-decision` (10-20) / `wg-dst-cutoff-basis-r3` (10-25) / `sprint-0922-triage-close` (10-22)。既存 9 entry へ 09-22 追記 (message のみ、condition / since 不変): g0prime (**deadline 09-28 → 10-05**) / F2 / carry-dip-v3-revival-watch (broker realized 併記、凍結 estimand 不変) / rnb checkpoint-1・-2・shadow-forward (期日 ≠ 判定日、厳格 shadow 再計数) / edge-supply-scan-monthly (臨時スキャン記録) / review-backlog-253-257-digest (消化順序) / e1-prereg-verdict-deadline (手順書・tool)
