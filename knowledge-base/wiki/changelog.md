...
- ✅ **検出力不足ではない (positive control)** — **凍結検出器の実 armed 系列** (147/1,108 bd) に**合成ラベル**を置いて測ると **各 event 窓に陽性 1 つ (k=7) で p=0.0190** / armed 全日陽性で **p=0.0009**。観測された陽性数でも強い効果なら α を通せた ⇒ **測って分離が無かった**。E23 の UNDERPOWERED (測れなかった) とは性質が別
