...
> 📌 **2026-09-17 更新 (U1=(b))**: 本ページの「aspirational anchor に格下げ」処置は superseded — 21.6%/20% は記録から anchor 除去され、正式ミッション = M3 系列 (+2〜3%/月 複利)。決裁: [[u1-mission-redecision-2026-09-17]]。以下の本文は 2026-07-10 時点の導出記録として保存。
