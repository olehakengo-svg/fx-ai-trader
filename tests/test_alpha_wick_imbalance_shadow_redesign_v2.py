...
def test_default_path_keeps_current_bar_and_htf_hard_block(monkeypatch):
...
def test_v2_uses_closed_confirmation_and_removes_htf_hard_block(monkeypatch):
    monkeypatch.setenv("ALPHA_WICK_IMBALANCE_REDESIGN_V2", "1")
...
def test_v2_shadow_worker_registration_is_opt_in(monkeypatch):
    ...
    monkeypatch.setenv("ALPHA_WICK_IMBALANCE_REDESIGN_V2", "1")
    monkeypatch.setenv("ALPHA_WICK_IMBALANCE_REDESIGN_V2_SHADOW_PROMOTE", "1")
