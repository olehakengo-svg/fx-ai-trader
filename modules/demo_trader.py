...
KALMAN_D7_MIN_UNITS = 1000               # carve-out DRAFT 2026-09-01 — lot chain / FLAT 非適用
...
class DemoTrader:
    ...
    def _tick_entry(self, mode: str, cfg: dict, sig: dict,
        ...
        if entry_type in self._KALMAN_D7_LIVE_OVERRIDE:
            # Rule-1 DRAFT (2026-09-01 pre-reg、user 最終承認待ち): 05-28 決裁の
        ...
        if (
            ...
            # 2026-09-01 DRAFT: kalman_d7 ×3 は MIN lot 1000u 契約 — flat 上書き不可
    ...
    _AGG_KELLY_GATE_MINLOT_BYPASS_TYPES = frozenset({
        ...
        "price_shock_rev_nzd_jpy_h1_long",
        "price_shock_rev_aud_jpy_h1_long",
        # 2026-09-01 DRAFT (user 最終承認待ち): kalman_d7 ×3 — 05-28 決裁の live 化
