...
MFE_BE_LOCK_STRATEGY_TRIGGERS = {
    ...
    # OFF: price_shock_rev ×5 — Track C D-c-1 (user 承認 2026-07-28)。昇格根拠は
    # horizon-exit (12y+Bonferroni)。BE_LOCK は R1 未通過の実験レバーのため live 波及を
    # 遮断 (preserve-exit-overlay-2026-07-28 §5 案(a))。ATR-BE/trail の免除 (案(b)) は
    # shadow counterfactual 定量化後の第 2 段判断。
