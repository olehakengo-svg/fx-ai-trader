...
- pin: `tests/test_rnb_shadow_only_downstream_relax.py` (17 本、control / fail-closed / 対称側 2 系 / OANDA 送信ゼロ / スコープ pin)
- registry: LOCK `rnb-support-bounce-shadow-forward` AMENDMENT (変更前 N=2、旧/新層別既定) / checkpoint-1・-2 注記 / sub-entry -1003 resolved
