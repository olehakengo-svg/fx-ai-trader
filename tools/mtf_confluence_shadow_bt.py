#!/usr/bin/env python3
"""A/B BT filter for mtf_confluence redesign V2.1."""
...
FLAG = "MTF_CONFLUENCE_REDESIGN_V2"
SHADOW_PROMOTE_FLAG = "MTF_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE"
OUTFILE = ROOT / "bt-results" / "mtf_confluence-shadow-redesign-v2-2026-05-05.json"
...
def _build_ctx(df, tf, sr_levels, symbol, backtest_mode, bar_time, htf_cache):
    ...
    return SignalContext(
        ...
        macdh_prev2=float(prev2.get("macd_hist", 0.0) or 0.0),
...
def main() -> int:
    ...
    result = {
        ...
        "strategy": STRATEGY,
        "variant": "closed_bar_dedup_mr_geometry_v2",
        "flag": FLAG,
        ...
        "self_review": {
            ...
            "post_hoc_adjustment": "PASS: only closed_bar_dedup_mr_geometry_v2 is evaluated.",
