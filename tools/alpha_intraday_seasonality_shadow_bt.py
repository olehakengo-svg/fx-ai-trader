...
OUTFILE = ROOT / "knowledge-base/raw/bt-results/alpha_intraday_seasonality-shadow-bt-2026-05-05.json"
...
def _stats(result: dict) -> dict:
    ...
    return {
        ...
        "bt_error": result.get("error") if "trade_log" not in result else None,
...
def main() -> int:
    ...
    result = {
        ...
        "self_review": {
            ...
            "production_live_safety": "PASS: V2 behavior is default-off unless ALPHA_INTRADAY_SEASONALITY_REDESIGN_V2=1.",
