...
OUTFILE = ROOT / "knowledge-base/raw/bt-results/confluence_scalp-shadow-bt-2026-05-05.json"
...
def main() -> int:
    ...
    result = {
        ...
        "self_review": {
            ...
            "production_live_safety": "PASS: strategy behavior is default-off unless CONFLUENCE_SCALP_REDESIGN_V2=1.",
