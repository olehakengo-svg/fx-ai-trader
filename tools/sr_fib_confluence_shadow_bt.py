#!/usr/bin/env python3
"""A/B BT filter for sr_fib_confluence redesign V2.1."""
...
FLAG = "SR_FIB_CONFLUENCE_REDESIGN_V2"
SHADOW_PROMOTE_FLAG = "SR_FIB_CONFLUENCE_REDESIGN_V2_SHADOW_PROMOTE"
OUTFILE = ROOT / "bt-results" / "sr_fib_confluence-shadow-redesign-v2-2026-05-05.json"
...
def main() -> int:
    ...
    result = {
        ...
        "strategy": STRATEGY,
        "variant": "structured_layer3_fib_ob_gate_v2",
        "flag": FLAG,
