#!/usr/bin/env python3
"""A/B BT filter for sr_break_retest V2 closed-bar retest confirmation."""
...
FLAG = "SR_BREAK_RETEST_REDESIGN_V2"
SHADOW_PROMOTE_FLAG = "SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE"
OUTFILE = ROOT / "bt-results" / "sr_break_retest-shadow-redesign-v2-2026-05-05.json"


def _compute_sr_break_retest_only_signal(df, tf, sr_levels, symbol="USDJPY=X",
    ...
    if cand is None:
        return {
            ...
            "entry": entry,
            "entry_type": "wait",
            "reasons": ["sr_break_retest no signal"],
            "atr": atr,
            "mode": "daytrade",
    ...
    return {
        ...
        "reasons": ["✅ sr_break_retest strategy-filter BT"] + list(cand.reasons or []),
        "score": cand.score,
        "atr": atr,
        "mode": "daytrade",
        "layer_status": {},
...
def main() -> int:
    ...
    if missing:
        ...
        app.compute_daytrade_signal = _compute_sr_break_retest_only_signal
    ...
    result = {
        ...
        "strategy": STRATEGY,
        "variant": "closed_bar_retest_confirmation_v2",
        "flag": FLAG,
        ...
        "self_review": {
            ...
            "production_live_safety": "PASS: strategy behavior is default-off unless SR_BREAK_RETEST_REDESIGN_V2=1; shadow emit also requires SR_BREAK_RETEST_REDESIGN_V2_SHADOW_PROMOTE=1.",
            "post_hoc_adjustment": "PASS: only the pre-registered closed-bar retest confirmation V2 variant is evaluated.",
