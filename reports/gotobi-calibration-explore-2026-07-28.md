...
## Data note (2026-07-29 追記)

本 explore が使用した `USD_JPY_5m_2014_2026.parquet` は、探索窓内の **2019-09-14〜2019-10-05 / 2020-10-13〜2020-11-14 に MASSIVE ベンダー側のデータ穴** (当時 0 行) を含んでいた ([[massive-vendor-gap-backfill-2026-07-29]])。当該窓内の五十日イベントは測定母集団から欠落していたが、robustness は発見側で評価済みで **verdict (規約 B 較正成功 / sub-friction family クローズ) は不変**。2026-07-29 に OANDA v20 mid で backfill 済みのため、将来の再走は当該日を含む — ただし family クローズと再試行禁止スコープに変更はない。
