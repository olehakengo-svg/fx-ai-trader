...
## Trading Modes (15 modes, 12 active)
| Base Mode | Pairs | TF | Status |
|---|---|---|---|
| scalp | JPY, EUR, 5m×3 | 1m/5m | Active (EUR_JPY停止) |
| daytrade | JPY, EUR, GBP, EUR_GBP | 15m | Active (XAU停止) |
| daytrade_1h | JPY, EUR | 1h | Active |
| swing | — | 4h | Disabled |
