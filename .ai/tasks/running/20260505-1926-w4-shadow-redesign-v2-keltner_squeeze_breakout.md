---
id: 20260505-1926-w4-shadow-redesign-v2-keltner_squeeze_breakout
title: "[W4-Shadow-Redesign v2] keltner_squeeze_breakout (Tier 2 (Shadow)) — relaxed spec"
owner: codex
status: queued
priority: P1
created_at: 2026-05-05T19:26:00+0900
...
W4-EDA audit (`audits/edge_design/keltner_squeeze_breakout.md`):
...
## Step 1: 既存 audit 確認 (`audits/edge_design/keltner_squeeze_breakout.md`)

audit が指摘する redesign axis を読み、**最小 1 軸** で実装。

## Step 2: 実装 (flag 配下)

`KELTNER_SQUEEZE_BREAKOUT_REDESIGN_V2=1` 環境変数 / config flag で proposed variant を有効化。
...
- 失敗テスト緑
- BT report (`bt-results/keltner_squeeze_breakout-shadow-redesign-v2-2026-05-05.json`)
