---
id: 20260505-1900-w4-shadow-redesign-v2-adx_trend_continuation
title: "[W4-Shadow-Redesign v2] adx_trend_continuation (Tier 2 (Shadow)) — relaxed spec"
owner: codex
status: queued
priority: P1
created_at: 2026-05-05T19:00:00+0900
...
W4-EDA audit (`audits/edge_design/adx_trend_continuation.md`):
...
## Step 1: 既存 audit 確認 (`audits/edge_design/adx_trend_continuation.md`)

audit が指摘する redesign axis を読み、**最小 1 軸** で実装。

## Step 2: 実装 (flag 配下)

`ADX_TREND_CONTINUATION_REDESIGN_V2=1` 環境変数 / config flag で proposed variant を有効化。
...
- 失敗テスト緑
- BT report (`bt-results/adx_trend_continuation-shadow-redesign-v2-2026-05-05.json`)
