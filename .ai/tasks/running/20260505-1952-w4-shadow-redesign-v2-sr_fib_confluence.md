---
id: 20260505-1952-w4-shadow-redesign-v2-sr_fib_confluence
title: "[W4-Shadow-Redesign v2.1] sr_fib_confluence (Tier 3 (FORCE_DEMOTED)) — relaxed spec"
owner: codex
status: queued
priority: P1
created_at: 2026-05-05T19:52:00+0900
...
W4-EDA audit (`audits/edge_design/sr_fib_confluence.md`):
...
## Step 1: 既存 audit 確認 (`audits/edge_design/sr_fib_confluence.md`)

audit が指摘する redesign axis を読み、**最小 1 軸** で実装。

## Step 2: 実装 (flag 配下)

`SR_FIB_CONFLUENCE_REDESIGN_V2=1` 環境変数 / config flag で proposed variant を有効化。
...
- 失敗テスト緑
- BT report (`bt-results/sr_fib_confluence-shadow-redesign-v2-2026-05-05.json`)
