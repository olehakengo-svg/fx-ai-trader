---
id: 20260504T1850-w4-eda-alpha_wick_imbalance
title: "[W4-EDA] Edge Design Audit — alpha_wick_imbalance"
owner: codex
status: queued
priority: P1
created_at: 2026-05-04T18:50:00+0900
roadmap_gate: "W4 Edge Design Audit — alpha_wick_imbalance の 8 軸設計監査"
rule: R1
prereq_artifacts:
...
`alpha_wick_imbalance` (`Tier 2 (Shadow)` / `phase0_shadow`) について 8 軸で診断し、
...
```json
[{"tier": "phase0_shadow", "strategy": "alpha_wick_imbalance", "pair": "ALL", "tier_master_md_365d_BT_EV": "—"}]
```
...
ファイル `audits/edge_design/alpha_wick_imbalance.md` に以下フォーマットで **新規** 出力（既存があれば追記ではなく上書き）。
...
- `audits/edge_design/alpha_wick_imbalance.md` が §3 のテンプレ通りに存在する
- Verdict が 5 分類のいずれか
