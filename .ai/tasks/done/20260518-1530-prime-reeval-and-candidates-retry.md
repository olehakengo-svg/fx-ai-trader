---
id: 20260518-1530-prime-reeval-and-candidates
title: "[PRIME v2 re-evaluation] 6 PRIME 再評価 + 新候補抽出 (post-2026-05-15 freeze release)"
owner: codex
status: queued
priority: P1
...
## Re-queue note (2026-05-18T16:13+0900, orphan recovery)

Previous claim db964412 was orphaned at 06:00:26 UTC by container restart with
zero artifacts produced (Codex did not commit anything before restart). Same
restart wave also orphaned other tasks (f1e79007, ae50ffbd recoveries). This
is infrastructure churn, not a task-level failure.

P0 hot-fix `20260518-1500-prime-gate-order-hotfix` completed successfully at
05:59 UTC (commit f98b2acd). Render deploy is live (post-deploy log_count
reset confirms restart). PRIME-tagged LIVE fires not yet observed (predicates
fire ~0.2-0.6/day per design — 24h+ window needed for first signal).
