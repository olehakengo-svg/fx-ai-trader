---
id: 20260504T2314-w4-eda-vol_momentum
title: "[W4-EDA] Edge Design Audit — vol_momentum"
owner: codex
status: queued
priority: P1
created_at: 2026-05-04T23:14:00+0900
roadmap_gate: "W4 Edge Design Audit — vol_momentum の 8 軸設計監査"
rule: R1
prereq_artifacts:
...
`vol_momentum` (`Tier 2 (Shadow)` / `phase0_shadow`) について 8 軸で診断し、
...
```json
[{"tier": "phase0_shadow", "strategy": "vol_momentum", "pair": "ALL", "tier_master_md_365d_BT_EV": "—"}]
```
...
ファイル `audits/edge_design/vol_momentum.md` に以下フォーマットで **新規** 出力（既存があれば追記ではなく上書き）。
...
- `audits/edge_design/vol_momentum.md` が §3 のテンプレ通りに存在する
- Verdict が 5 分類のいずれか
