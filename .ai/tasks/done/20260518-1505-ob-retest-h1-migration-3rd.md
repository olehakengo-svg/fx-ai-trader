---
id: 20260518-1505-ob-retest-h1-migration-3rd
title: "[ob_retest_h1 migration 3rd-attempt] H1 新戦略追加 (R1 pre-reg LOCK) + M5 ob_retest FORCE_DEMOTE (R2)"
owner: codex
status: queued
priority: P0
...
> **Re-queue note (2026-05-18T15:05+0900, 3rd attempt)**: previous 2 attempts were orphaned by worker container OOM kill on starter plan (512 MB). Worker now upgraded to **Pro plan (4 GB / 2 CPU)** — manual user upgrade + render.yaml aligned (codex-runner commits `a7c91a4`, `9d3dccb`). Spec unchanged from 1st attempt. Previous failures:
> - `.ai/tasks/failed/20260518-1338-ob-retest-h1-migration.md` (1st)
> - `.ai/tasks/failed/20260518-1418-ob-retest-h1-migration-retry.md` (2nd)
