---
id: 20260505-1255-w4-shadow-redesign-macdh
title: "[W4-Shadow Phase 1] macdh (Tier 2 (Shadow)) — implement + shadow promote (BT light filter)"
owner: codex
status: queued
priority: P1
created_at: 2026-05-05T12:55:00+0900
...
W4-EDA audit (`audits/edge_design/macdh.md`) で **THESIS_VALID_DESIGN_BROKEN** / 推奨度 **B** と判定。
...
`knowledge-base/wiki/decisions/macdh-shadow-redesign-2026-05-05.md`:
...
`tests/test_macdh_shadow_redesign.py`

## Step 3: 実装

audit Axis 推奨に従い最小差分。**flag 配下** で実装 (`MACDH_REDESIGN_V2=1` 等)、デフォルトは現行維持。
...
# baseline
r0 = run_daytrade_backtest(pair=..., tf=..., days=365, strategies=['macdh'], variant=False)
# proposed
r1 = run_daytrade_backtest(pair=..., tf=..., days=365, strategies=['macdh'], variant=True)
"
```

`knowledge-base/raw/bt-results/macdh-shadow-bt-2026-05-05.json` に保存。
