---
id: 20260505-1204-w4-shadow-redesign-asia_range_fade_v1
title: "[W4-Shadow Phase 1] asia_range_fade_v1 (Tier 2 (Shadow)) — implement + shadow promote (BT light filter)"
owner: codex
status: queued
priority: P1
created_at: 2026-05-05T12:04:00+0900
...
W4-EDA audit (`audits/edge_design/asia_range_fade_v1.md`) で **THESIS_VALID_TIMING_BROKEN** / 推奨度 **A** と判定。
...
`knowledge-base/wiki/decisions/asia_range_fade_v1-shadow-redesign-2026-05-05.md`:
...
`tests/test_asia_range_fade_v1_shadow_redesign.py`

## Step 3: 実装

audit Axis 推奨に従い最小差分。**flag 配下** で実装 (`ASIA_RANGE_FADE_V1_REDESIGN_V2=1` 等)、デフォルトは現行維持。
...
# baseline
r0 = run_daytrade_backtest(pair=..., tf=..., days=365, strategies=['asia_range_fade_v1'], variant=False)
# proposed
r1 = run_daytrade_backtest(pair=..., tf=..., days=365, strategies=['asia_range_fade_v1'], variant=True)
"
```

`knowledge-base/raw/bt-results/asia_range_fade_v1-shadow-bt-2026-05-05.json` に保存。
