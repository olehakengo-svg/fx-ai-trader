---
id: 20260505-1308-w4-shadow-redesign-ema200_trend_reversal
title: "[W4-Shadow Phase 1] ema200_trend_reversal (Tier 1 (LIVE)) — implement + shadow promote (BT light filter)"
owner: codex
status: queued
priority: P1
created_at: 2026-05-05T13:08:00+0900
...
W4-EDA audit (`audits/edge_design/ema200_trend_reversal.md`) で **THESIS_VALID_INSUFFICIENT_EVIDENCE** / 推奨度 **A** と判定。
...
`knowledge-base/wiki/decisions/ema200_trend_reversal-shadow-redesign-2026-05-05.md`:
...
`tests/test_ema200_trend_reversal_shadow_redesign.py`

## Step 3: 実装

audit Axis 推奨に従い最小差分。**flag 配下** で実装 (`EMA200_TREND_REVERSAL_REDESIGN_V2=1` 等)、デフォルトは現行維持。
...
# baseline
r0 = run_daytrade_backtest(pair=..., tf=..., days=365, strategies=['ema200_trend_reversal'], variant=False)
# proposed
r1 = run_daytrade_backtest(pair=..., tf=..., days=365, strategies=['ema200_trend_reversal'], variant=True)
"
```

`knowledge-base/raw/bt-results/ema200_trend_reversal-shadow-bt-2026-05-05.json` に保存。
