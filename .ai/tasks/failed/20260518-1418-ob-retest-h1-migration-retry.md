---
id: 20260518-1418-ob-retest-h1-migration-retry
title: "[ob_retest_h1 migration RETRY] H1 新戦略追加 (R1 pre-reg LOCK) + M5 ob_retest FORCE_DEMOTE (R2)"
owner: codex
status: queued
priority: P0
...
> **Re-queue note (2026-05-18T14:18+0900)**: previous queue id `20260518-1338-ob-retest-h1-migration` was orphaned by worker container restart mid-execution (no progress, no commit, no work product). Spec unchanged — re-queueing verbatim. Previous failure record: `.ai/tasks/failed/20260518-1338-ob-retest-h1-migration.md`.
